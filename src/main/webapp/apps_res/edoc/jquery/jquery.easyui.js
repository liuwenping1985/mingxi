...
var t=$("<div id='" + opts.tools[i].id + "'></div>").addClass(opts.tools[i].iconCls).appendTo(tool);
...
var _238=$("<a class=\"tabs-inner\"></a>").appendTo(tab);
var _239=$("<span class=\"tabs-title\" title=\"" + (opts.spanTitle ? opts.spanTitle : opts.title) + "\"></span>").html(opts.title).appendTo(_238);
...
var _5a7=$("<input id=\"combo-text-id\" type=\"text\" class=\"combo-text\">").appendTo(span);
$("<span><span id=\"combo-arrow-id\" class=\"combo-arrow\"></span></span>").appendTo(span);
