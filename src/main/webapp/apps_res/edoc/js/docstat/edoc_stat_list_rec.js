 ...
 function loadCondition() {//搜索框
     ...
     conditionArray.push({id: 'docMark', name: 'docMark', type: 'input', text: $.i18n("edoc.element.fromWordNo"), value: 'docMark', maxLength:100 });//来文文号
     conditionArray.push({id: 'serialNo', name: 'serialNo', type: 'input', text: $.i18n("edoc.element.receive.serial_no"), value: 'serialNo', maxLength:100 });//收文编号
...
function loadData() {
   //表格加载
	...
	models.push({display: $.i18n("edoc.element.receive.serial_no"), name: 'serialNo', sortable : true, width: '10%' });//收文编号
	models.push({display: $.i18n("edoc.edoctitle.fromUnit.label"), name: 'sendUnit', sortable : true, width: '10%' });//来文单位
	if(isG6Version) {
		models.push({display: $.i18n("edoc.edoctitle.disDate.label"), name: 'startTimeView', sortable : true, width: '12%' });//分办日期
		models.push({display: $.i18n("edoc.element.receive.distributer"), name: 'startUserName', sortable : true, width: '10%', hide:true });//分办人
	} else {
		models.push({display: $.i18n("edoc.element.registration_date"), name: 'registrationDate', sortable : true, width: '12%' });//登记日期
		models.push({display: $.i18n("edoc.edoctitle.regPerson.label"), name: 'startUserName', sortable : true, width: '10%', hide:true });//登记人
	}
	...
	models.push({display: $.i18n("edoc.stat.result.list.hasAchrive"), name: 'hasArchiveView', sortable : true, width: '8%', hide:true });//是否归档
	models.push({display: $.i18n("edoc.stat.result.list.achriveName"), name: 'archiveName', sortable : true, width: '10%', hide:true });//归档路径
	models.push({display: $.i18n("edoc.element.undertakeUnit"), name: 'undertakenoffice', sortable : true, width: '10%', hide:true });//承办机构
