...
function govdocShowDocPage() {
  ...
  var url = _ctxPath+"/content/content.do?isFullPage=true&moduleId="+ nodeId + "&moduleType=1&viewState=3";
...
$(function() {
    ...
    toolbar =  $("#toolbar").toolbar({
       ...
       //信息报送新建
        ...
        // 公文修改按钮
          ...
          id : "moveTo",
          name : $.i18n('common.toolbar.move.label'),//启用
          ...
          id : "enable",
          name : $.i18n('common.toolbar.enable.label'),//停用
          ...
          id : "disable",
          name : $.i18n('common.toolbar.disable.label'),
    ...
    if(app == "4"){
        ...
        toolbar.hideBtn("enable");
        toolbar.hideBtn("disable");
        toolbar.hideBtn("replaceNode");
    }else{
    	toolbar.hideBtn("lianhe");
    }
	  ...
	  function dbclickRow(data,rowIndex, colIndex){
		 ...
		 if(categoryType === collCategory){
		   window.self.location= projectPath + "/collTemplate/collTemplate.do?method=systemNewTemplate&id="+id+"&categoryId="+categoryId;
	             ...
	             || sginReportCategory == categoryType){
	    	 if(app == "4"){
	    		 	window.self.location = projectPath + "/content/content.do?isFullPage=true&moduleId="+data.extraMap["formId"]+"&moduleType=35&rightId=-2&viewState=4";
		    	}else{
		    		window.self.location= projectPath + "/edocTempleteController.do?method=systemNewTemplete&templeteId="+id+"&from=SYS&categoryType="+categoryId;
		    	}
	     }else if(categoryType == infoCategory){
	      ...
	      if(data.type === "templete" || data.type === "template"){
	        ...
	        if(data.moduleType === 19){
	          ...
	          //return  $.i18n('template.categorytree.recidoctemplate.label');
	            ...
	            data.type = 'edoc_sign';//直接修改这个值，用于排序
	            return 'edoc_sign';
...
function loadTable(condition, value){
	  ...
	  if(app == 4){
	    	if(o.categoryType == 19){
	    		o.categoryType = 401;
	    		o.app = 401;
	    		o.categoryId = null;
	    	}else if(o.categoryType == 20){
	    		o.categoryType = 402;
	    		o.app = 402;
	    		o.categoryId = null;
	    	}else if(o.categoryType == 21){
	    		o.categoryType = 404;
	    		o.app = 404;
	    		o.categoryId = null;
	    	}else{
