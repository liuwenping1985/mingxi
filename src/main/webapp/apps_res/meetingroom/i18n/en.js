...
var officeLang = {
    ...
    detail_info_meetingroom_application: "<li> users to convey the application to the administrator of a conference room at a certain time of usage requirements, and can see the use of conference room </ li> ", 
    ...
    meetingRoom_name_length:"MeetingName:greater than 50,cannot input!",
    meetingRoom_not_null:"room name not allow null!", 
    meetingRoom_time_alert:"The start time can not be greater than the end of time! ",
    detail_info_meetingroom_count: "<li> Meeting Room Manager statistics of a time period of the meeting room usage. </ li> \ n <li> click the list header can be quickly sorted. </ li>"
}