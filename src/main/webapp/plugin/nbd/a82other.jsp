            ...
            <form class="layui-form" id="a82other_form" action="">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="width:300px">
                        <input type="text" v-model="name"  required lay-verify="required" placeholder="请输入名称"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="width:300px">
                        <select v-model="sLinkId"  id="a82other_data_link" name="sLinkId" lay-verify="required">
                                <option v-for="links in optionalData.linkItems" :value="links.sid" >{{links.name}}</option>
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:300px">
                            <input style="width:300px" type="text" name="exxportUrl" required lay-verify="required" placeholder="接口地址"
                                   autocomplete="off" class="layui-input">
                        </div>
                ...
                <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline" style="width:300px">
                            <select name="extString1" lay-verify="required">
                        ...
                        <div class="layui-input-inline" style="width:300px">
                                <input style="width:300px" type="text" name="extString2" required lay-verify="required" placeholder="自定义表名"
                                       autocomplete="off" class="layui-input">
                            </div>
