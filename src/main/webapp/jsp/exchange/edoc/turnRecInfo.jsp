...
<table width="400" style="margin-left:6px;" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td>
		<div style='border:0px;padding:3px;padding-bottom-width:1px;  width:460px; height:auto; LINE-HEIGHT: 20px; OVERFLOW: auto;overflow-x:visible;'>
	...
	<tr>
		...
		&nbsp;<div style="border:0px;padding:0px; PADDING:0px; width:480px; height:100%; LINE-HEIGHT: 20px; OVERFLOW: auto;overflow-x:visible;">
		${v3x:toHTML(opinion)}
		</div>
		</td>
	</tr>
