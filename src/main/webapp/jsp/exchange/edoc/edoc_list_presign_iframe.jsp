...
$(function(){
	...
	function editItem(id){
		openCtpWindow({
            url: '${exchange}?method=receiveDetail&id='+id+'&modelType=toReceive&userId=${current_user_id}&isOpenByToReceive=true',
            id : 'edocRec_' + id
        });
	}
	...
	function toNewRegister(registerId){
		window.parent.parent.location = "/seeyon/edocController.do?method=entryManager&entry=recManager&resourceCode=F07_recManager&toNewRegister=" + registerId;
	}
</script>
</head>
