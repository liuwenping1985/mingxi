...
<frameset rows="10,*" cols="*" framespacing="0" frameborder="no" border="0" scrolling="no">
  ...
  <frame noresize="noresize" frameborder="no" src="${detailURL}?method=categoryAdd&spaceType=${param.spaceType}&spaceId=${param.spaceId}" name="detailMainFrame" id="detailMainFrame" scrolling="no" />
</frameset>
