...
//TODO getA8 wanguangdong 2012-10-30
getA8Top().showLocation(2006, "<fmt:message key='menu.${param.flag}.inquiry.set${suffix}' bundle='${v3xMainI18N}'/>");
</c:if>
--%>
</script>
</head>
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
	    <td valign="top" width="100%" height="100%" id="inquiryIndexFrame" align="center">
		    <iframe width="100%" height="100%" frameborder="0" src="${detailURL}?method=inquiryFrame&spaceType=${param.spaceType}&spaceId=${param.spaceId}" />
		</td>
	</tr>
</table>
</body>		
