...
<table width="100%"  height="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td height="22" colspan="2" class="webfx-menu-bar-gray  ">
			<script type="text/javascript">
	...
	<tr>
		<td colspan="2" style="vertical-align: top;">
			...
			<fmt:message key="bul.type.typeName" bundle="${bulI18N}" var="plateName"/>			
				<v3x:table data="${list}" var="con" htmlId="list" isChangeTRColor="true" showPager="true" showHeader="true" subHeight="30">
					...
					<v3x:column width="25%" label="${plateName}"
						value="${con.name}" type="String" onClick="${click}" onDblClick="${onDbclick}" maxLength="25" symbol="..." className="cursor-hand sort" />
