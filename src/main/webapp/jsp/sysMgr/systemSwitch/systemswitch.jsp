...
<!--
	...
	function confirmthisform(){
		...
		if(result){
			...
			var userLoginCountValue = document.getElementById("userLoginCount").value;
			var forbiddenLoginTimeValue = document.getElementById("forbiddenLoginTime").value;
	...
	<br/><br/>
			...
			<%--启用消息声音提示 --%>
			 ...
			 <%--启用公文管理 
			  ...
			  <td width="60%">
			   <!-- <label for="pwdStrengthValidation0">
			      <input id="pwdStrengthValidation0" name="pwd_strength_validation" type="radio" value="0" ${pwd_strength_validation=='0' ? 'checked' : ''}>
			      <fmt:message key="common.pwd.pwdStrength.value0"/>
			   </label> -->
			  <label for="pwdStrengthValidation1">
			  	<input id="pwdStrengthValidation1" name="pwd_strength_validation" type="radio" value="1" ${pwd_strength_validation=='1' ? 'checked' : ''}>
			    <fmt:message key="common.pwd.pwdStrength.value1"/>
			  </label>
			  <label for="pwdStrengthValidation2">
			  	<input id="pwdStrengthValidation2" name="pwd_strength_validation" type="radio" value="2" ${pwd_strength_validation=='2' ? 'checked' : ''}>
			    <fmt:message key="common.pwd.pwdStrength.value2"/>
			  </label>
			   <label for="pwdStrengthValidation3">
			  	<input id="pwdStrengthValidation3" name="pwd_strength_validation" type="radio" value="3" ${pwd_strength_validation=='3' ? 'checked' : ''}>
			    <fmt:message key="common.pwd.pwdStrength.value3"/>
			  </label>
			  <!--  <label for="pwdStrengthValidation4">
			  	<input id="pwdStrengthValidation4" name="pwd_strength_validation" type="radio" value="4" ${pwd_strength_validation=='4' ? 'checked' : ''}>
			   ...
			   <!-- 新增是否启用密码修改 -->
			  <tr>
			  <td width="40%"><div align="right"><fmt:message key="systemswitch.archives.expireUpdate"/>:</div></td>
			  <td width="60%">
			  <label for="pwdneedupdateEnable">
			  	<input id="pwdneedupdatenEnable" name="pwd_needupdate" type="radio" value="enable" ${pwd_needupdate=='enable' ? 'checked' : ''}>
			    <fmt:message key="systemswitch.yes.lable"/>
			  </label>
			  <label for="pwdneedupdateDisable">
			      <input id="pwdneedupdateDisable" name="pwd_needupdate" type="radio" value="disable" ${pwd_needupdate=='disable' ? 'checked' : ''}>
			      <fmt:message key="systemswitch.no.lable"/>
			   </label>
			   </td>
			  </tr>
