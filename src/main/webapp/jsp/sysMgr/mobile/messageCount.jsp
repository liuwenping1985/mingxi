...
function submitQuery(){
    ...
    //  return false;
    //}
    document.getElementById("fm").action="${mobileManagerURL}?method=messageCount&startDate="+startDate+"&toDate="+toDate+"&tjType="+tjType+"&tjId="+tjId+"&tjValue="+tjValue+"&toType="+toType;
