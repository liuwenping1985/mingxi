...
var menuKey="${param.from=='audit'?'F13_appLog':'2103'}";
//showCtpLocation(menuKey);
	...
	if(${v3x:currentUser().administrator}){
		showCtpLocation("${v3x:getSystemProperty('system.logCode')}");
	}
...
function submitForm(){
  ...
  if(theForm) {
    ...
    theForm.action = "${appLog}?method=queryAppLog" ;
    theForm.submit() ;
