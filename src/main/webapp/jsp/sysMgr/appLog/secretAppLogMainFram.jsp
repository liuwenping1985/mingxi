...
<script type="text/javascript">
 showCtpLocation("F15_secret_guanliyaun");
...
function submitForm(){
  ...
  if(theForm) {
    ...
    theForm.action = "/seeyon/secret/secretSetController.do?method=queryAppLog" ;
    theForm.submit() ;
...
<v3x:selectPeople id="user" panels="Admin"   selectType="Account,Department,Member,Admin" departmentId="${v3x:currentUser().departmentId}"
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0"  class="page-list-border">
	...
	<tr>
		<td height="100%" valign="top" colspan="2" bgcolor="">
		    <iframe src="/seeyon/secret/secretSetController.do?method=listAllAppLogData" name="dataIFrame" id="dataIFrame"
