					...
					<div id='scrollborder' style='overflow:hidden; height: 26px;width:100%;padding: 0; margin: 0'>
						<div id="menuTabDiv" class="div-float" style="word-break:keep-all;white-space:nowrap; width: auto">
							...
							<span class="resCode" resCodeParent="${resCodeParent}">
								...
								<div id="firstTab" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);showEdocLocation();" url="<html:link renderURL='/govDoc/govDocController.do?method=listPending&app=4&sub_app=${sub_app }&govDocSendOrRecManage=1' />">在办</div>
							...
							<span class="resCode" resCodeParent="${resCodeParent}">
									<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
									<div class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);showEdocLocation();" url="<html:link renderURL='/govDoc/govDocController.do?method=listDone&app=4&sub_app=${sub_app }&workflowState=0&govDocSendOrRecManage=1' />">在办</div>
							...
							<span class="resCode" resCodeParent="${resCodeParent}">
									<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
									<div class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);showEdocLocation();" url="<html:link renderURL='/govDoc/govDocController.do?method=listDone&app=4&sub_app=${sub_app }&workflowState=1&govDocSendOrRecManage=1' />">办结</div>
									<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
									<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								</span>
							...
							<span class="resCode" resCodeParent="${resCodeParent}">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);showEdocLocation();" url="<html:link renderURL='/govDoc/govDocController.do?method=listWaitSendNew&app=4&sub_app=${sub_app }&govDocSendOrRecManage=1' />">待拟文</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
							...
							<span class="resCode" resCodeParent="${resCodeParent}">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div id="sent" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);showEdocLocation();" url="<html:link renderURL='/govDoc/govDocController.do?method=listSentNew&app=4&sub_app=${sub_app }&govDocSendOrRecManage=1' />">已拟文</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
							...
							<span class="resCode" resCodeParent="${resCodeParent}">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div  class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:window.open('/seeyon/collaboration/collaboration.do?method=newColl&templateId=-8920518773812738130&app=4&sub_app=1');" />新建</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
						</div>
