...
<body class="page_color">
    <div id="attribute" class="padding_10">
                ...
                <div class="form_area">
                    <table border="0" cellspacing="0" cellpadding="0" class="margin_l_10">
                        <tbody>
                            ...
                            <tr style="display: none"><%--BDGW-2464 去掉重要程度--%>
                                <td nowrap="nowrap">
            ...
            <c:if test="${not empty ffattribute.formOperation && openFrom ne 'edoc' && ffattribute.app ne '4'}">
                <fieldset class="fieldset_box margin_t_5" style="background:#FAFAFA;">
            ...
            <fieldset class="fieldset_box margin_t_5"  style="background:#FAFAFA;">
                ...
                <div class="common_checkbox_box clearfix margin_l_10 padding_b_10">
                    <label style="display: none;" for="canForward" class="margin_t_5 hand display_block">
                    ...
                    <label style="display: none;" for="" class="margin_t_5 hand display_block">
                    ...
                    <label style="display: none;" for="canAutoStopFlow" class="margin_t_5 hand display_block">
                     ...
                     <label style="display: none;" for="canMergeDeal" class="margin_t_5 hand display_block">
