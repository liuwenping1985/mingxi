...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="${path}/apps_res/govdoc/js/listSent.js${ctp:resSuffix()}"></script>
    <script type="text/javascript">
    	var sub_app = '${paramMap.sub_app}';
    	if(sub_app == null || sub_app == ""){
    		sub_app = "1,2,4";
    	}
    ...
    <div id='layout'>
        <div class="layout_north bg_color" id="north">
            ...
            <c:if test="${param.srcFrom ne 'bizconfig' && (param.govDocSendOrRecManage==null || param.govDocSendOrRecManage != 1) }">
                <div class="comp" comp="type:'breadcrumb',comptype:'location',code:'F20_gocDovSend'"></div>
            </c:if>
