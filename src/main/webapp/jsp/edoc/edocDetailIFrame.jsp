...
%>
	<meta http-equiv="X-UA-Compatible" content="IE=IE7;IE=8;IE=9;IE=10"/>
<%
    }
%>
<%--
...
<iframe id="edocDetailIframe" name="edocDetailIframe" src="edocController.do?method=detail&summaryId=${param.summaryId}&affairId=${ctp:toHTML(param.affairId)}&detailType=${ctp:toHTML(param.detailType)}&from=${ctp:toHTML(param.from)}&edocType=${ctp:toHTML(param.edocType)}&edocId=${param.edocId}&list={param.list}&sendSummaryId=${param.sendSummaryId}&canNotOpen=${param.canNotOpen}&openFrom=${param.openFrom}&openEdocByForward=${param.openEdocByForward}&isColl360=${param.isColl360}&isCollCube=${param.isCollCube}&isTransFrom=${param.isTransFrom}" FRAMEBORDER="0" marginheight="0" marginwidth="0" width="100%" height="100%" style="border:0px;"></iframe>
</body>
</html>
