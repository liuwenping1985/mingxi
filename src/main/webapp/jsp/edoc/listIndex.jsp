...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	   <tr id="tabTr" style="display:none"><%-----------------*** ltao 隐藏老公文页签 ***-----------------%>
				...
				<div class="div-float">
					...
					<c:choose>
						...
						<c:when test="${edocType==1}">
							...
							<c:set var="listRenderURL" value="edocController.do?method=listIndex&from=${listMethod }&edocType=${edocType}&listType=${listType}" />
							<span class="resCode" resCode="F07_recRegister" resCodeParent="F07_recManager" current="${isCurrentFrom ? 'true':'false'}">
								<div class="${isCurrentFrom ? 'tab-tag-left-sel':'tab-tag-left'}"></div>
	                            <div class="${isCurrentFrom ? 'tab-tag-middel-sel':'tab-tag-middel'} cursor-hand" onclick="javascript:location.href='<html:link renderURL='${listRenderURL }' />'">
							...
							<span class="resCode" resCode="F07_recListRegistering" resCodeParent="F07_recManager" current="${isCurrentFrom ? 'true':'false'}">
								<div class="${isCurrentFrom ? 'tab-tag-left-sel':'tab-tag-left'}"></div>
								<div class="${isCurrentFrom ? 'tab-tag-middel-sel':'tab-tag-middel'} cursor-hand" onclick="javascript:location.href='<html:link renderURL='${listRenderURL }' />'">
									<fmt:message key='edoc.workitem.state.register'/>
								</div>					
							...
							<span class="resCode" resCode="F07_recListWaitRegister" resCodeParent="F07_recManager" current="${isCurrentFrom ? 'true':'false'}">
								<div class="${isCurrentFrom ? 'tab-tag-left-sel':'tab-tag-left'}"></div>
								<div class="${isCurrentFrom ? 'tab-tag-middel-sel':'tab-tag-middel'} cursor-hand" onclick="javascript:location.href='<html:link renderURL='${listRenderURL }' />'">
							...
							<span class="resCode" resCode="F07_recListRegistered" resCodeParent="F07_recManager" current="${isCurrentFrom ? 'true':'false'}">
								<div class="${isCurrentFrom ? 'tab-tag-left-sel':'tab-tag-left'}"></div>
								<div class="${isCurrentFrom ? 'tab-tag-middel-sel':'tab-tag-middel'} cursor-hand" onclick="javascript:location.href='<html:link renderURL='${listRenderURL }' />'">
                            ...
                            <%--G6收文待分发 --%>
                            <c:if test="${isG6Ver}">
                            <!-- 2015年8月28日 修改isOpenRegister判断  简化公文交换环节，不显示待分发 xiex -->
                            <c:if test="${isOpenRegister != '3'}">
							...
							<span class="resCode" resCode="F07_recListFenfaing" resCodeParent="F07_recManager" current="${isCurrentFrom ? 'true':'false'}">
								<div class="${isCurrentFrom ? 'tab-tag-left-sel':'tab-tag-left'}"></div>
								<div class="${isCurrentFrom ? 'tab-tag-middel-sel':'tab-tag-middel'} cursor-hand" onclick="javascript:location.href='<html:link renderURL='${listRenderURL }' />'">
                            ...
                            <%--G6收文分发待发 --%>
                            <c:if test="${isG6Ver}">
                            <!-- 2015年8月28日 修改isOpenRegister判断  简化公文交换环节，不显示分发待发 xiex -->
                            <c:if test="${isOpenRegister != '3'}">
							...
							<span class="resCode" resCode="F07_recListWaitFenfa" resCodeParent="F07_recManager" current="${isCurrentFrom ? 'true':'false'}">
								<div class="${isCurrentFrom ? 'tab-tag-left-sel':'tab-tag-left'}"></div>
								<div class="${isCurrentFrom ? 'tab-tag-middel-sel':'tab-tag-middel'} cursor-hand" onclick="javascript:location.href='<html:link renderURL='${listRenderURL }' />'">
                            ...
                            <%--G6收文已分发 --%>
                            <c:if test="${isG6Ver}">
                            <!-- 2015年8月28日 修改isOpenRegister判断  简化公文交换环节，不显示已分发 xiex -->
                            <c:if test="${isOpenRegister != '3'}">
							...
							<c:set var="listRenderURL" value="edocController.do?method=listIndex&from=${listMethod }&edocType=${edocType}&listType=${listType}" />
							<span class="resCode" resCode="F07_recListFenfaed" resCodeParent="F07_recManager" current="${isCurrentFrom ? 'true':'false'}">
								<div class="${isCurrentFrom ? 'tab-tag-left-sel':'tab-tag-left'}"></div>
								<div class="${isCurrentFrom ? 'tab-tag-middel-sel':'tab-tag-middel'} cursor-hand" onclick="javascript:location.href='<html:link renderURL='${listRenderURL }' />'">
                            ...
                            <c:if test="${!isG6Ver}">
								...
								<c:set var="listMethod" value="listWaitSend" />
								<c:set var="listRenderURL" value="edocController.do?method=listIndex&from=${listMethod }&edocType=${edocType}&listType=${listType}" />		
	                            <span class="resCode" resCode="F07_recWaitSend" resCodeParent="F07_recManager" current="${isCurrentFrom ? 'true':'false'}">
	                            	<div class="${isCurrentFrom ? 'tab-tag-left-sel':'tab-tag-left'}"></div>
									<div class="${isCurrentFrom ? 'tab-tag-middel-sel':'tab-tag-middel'} cursor-hand" onclick="javascript:location.href='<html:link renderURL='${listRenderURL }' />'">
							...
							<c:set var="listMethod" value="listSent" />
							<c:set var="listRenderURL" value="edocController.do?method=listIndex&from=${listMethod }&edocType=${edocType}&listType=${listType}" />
							<span class="resCode" resCode="F07_recSent"  resCodeParent="F07_recManager" current="${isCurrentFrom ? 'true':'false'}">
			     				<div class="${isCurrentFrom ? 'tab-tag-left-sel':'tab-tag-left'}"></div>
								<div class="${isCurrentFrom ? 'tab-tag-middel-sel':'tab-tag-middel'} cursor-hand" onclick="javascript:location.href='<html:link renderURL='${listRenderURL }' />'">
						...
						<c:when test="${edocType==2}">
                            ...
                            <span class="resCode" resCode="F07_signNewEdoc" resCodeParent="F07_signReport" current="${isCurrentFrom ? 'true':'false'}">
								<div class="${isCurrentFrom ? 'tab-tag-left-sel':'tab-tag-left'}"></div>
								<div class="${isCurrentFrom ? 'tab-tag-middel-sel':'tab-tag-middel'} cursor-hand" onclick="javascript:location.href='<html:link renderURL='${listRenderURL }' />'">
                    	...
                    	<%-----------------*** 发文 ***-----------------%>
							...
							<c:set var="listRenderURL" value="edocController.do?method=listIndex&from=${listMethod }&edocType=${edocType}&listType=${listType}" />             		
	                    	<%-- 发文拟文 resCode="F07_sendNewEdoc" --%>
	                        <span class="resCode" resCode="F07_sendNewEdoc" resCodeParent="F07_sendManager" current="${isCurrentFrom ? 'true':'false'}">
								<div class="${isCurrentFrom ? 'tab-tag-left-sel':'tab-tag-left'}"></div>
								<div class="${isCurrentFrom ? 'tab-tag-middel-sel':'tab-tag-middel'} cursor-hand" onclick="javascript:location.href='<html:link renderURL='${listRenderURL }' />'">
									<fmt:message key='edoc.new.type.send'/>
								</div>	
							...
							<c:if test="${hasEdocLeft}">
								...
								<c:set var="listRenderURL" value="edocController.do?method=listIndex&from=${listMethod }&edocType=${edocType}&listType=${listType}" />
								<span class="resCode" resCode="F07_listFenfa" resCodeParent="F07_sendManager" current="${isCurrentFrom ? 'true':'false'}">
									<div class="${isCurrentFrom ? 'tab-tag-left-sel':'tab-tag-left'}"></div>
									<div class="${isCurrentFrom ? 'tab-tag-middel-sel':'tab-tag-middel'} cursor-hand" onclick="javascript:location.href='<html:link renderURL='${listRenderURL }' />'">
										<fmt:message key='edoc.element.receive.distribute' />
									</div>
