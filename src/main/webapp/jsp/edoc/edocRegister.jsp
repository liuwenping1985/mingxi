...
<script type="text/javascript" charset="UTF-8" src="<c:url value="/apps_res/edoc/jquery/jquery.plugin.js${v3x:resSuffix()}" />"></script>
<script type="text/javascript" charset="UTF-8" src="<c:url value="/apps_res/edoc/jquery/jquery.easyui.js${v3x:resSuffix()}" />"></script>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
						...
						<tr id="attachmentTrContent" >
							<td height="18" nowrap class="bg-gray" valign="top" style="padding-top:5px;">
									...
									<c:if test="${!canEditAtt }">
										<span id="normalText"  style="margin-left:10px; vertical-align:middle;color: #717171;font-family: Microsoft YaHei;"><fmt:message key="common.attachment.label" bundle="${v3xCommonI18N}" /></span> 
									</c:if>
									 : 
								</td>
								<td valign="middle" width="100%">
									<div class=" div-float" id="attDiv" style="margin-top: 4px;margin-left:4px;">
