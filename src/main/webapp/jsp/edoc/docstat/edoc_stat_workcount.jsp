...
<script type="text/javascript" charset="UTF-8" src="<c:url value="/apps_res/edoc/js/docstat/edoc_stat_workcount.js${v3x:resSuffix()}" />"></script>
      		...
      		<div class="border_alls">
           		<div class="form_area"  id="queryCondition" >
           			...
           			<div class="form_area set_search">          			  
                        <p class="statistics">
                   			 <c:forEach items="${statList}" var="content" varStatus="status">
                       			<label>
                            	 <input type="radio" value="${content.id}"  name="stat" id="stat" <c:if test="${status.index ==0 }"> checked </c:if>
                            	 class="radio_com m_enable">${content.name}
                                 </label>
                        	</c:forEach>
                        </p>
           					...
           					<tbody>
           						<tr class="margin_b_10" align="center">
           							<td nowrap="nowrap" class="padding_tb_5">
           								<label>公文文号：</label>
										<select name="docMarkSelect" id="docMarkSelect" class="comp" comp="type:'autocomplete',valueChange:docMarkChange" style="width:100px;">
           						    ...
           						    <td nowrap="nowrap" class="padding_tb_5">
           						    	<label>内部文号：</label>
           						    	<select name="serialNoSelect" id="serialNoSelect" class="comp" comp="type:'autocomplete',valueChange:docMarkChange" style="width:100px;">
           						        	<option value="-1" selected>全部</option>
           						    ...
           						    <td nowrap="nowrap" class="padding_tb_5">
           						    	<label>统计范围：</label>
										<select name="depts" id="depts" style="width:80px">
           						        	<option value="-1" selected>全部</option>											 
										</select>
           						    </td>
									<td nowrap="nowrap" class="padding_tb_5">
			...
			<div id="tabs" class="w100b h100b">
				<div id="tabBody" class="border_tb common_tabs_body stadic_layout_body stadic_body_top_bottom" style="top:0px;bottom:30px;overflow:hidden;">
				    <div style="position: absolute;height: 100%;left: 5px;top: 0px;right: 5px;">
				        <iframe id="content" name="content" width="100%" height="100%" src="" frameborder="0"/>
				    </div>
				</div>
			</div><!-- tabs -->
      	</div><!-- reportResult -->
