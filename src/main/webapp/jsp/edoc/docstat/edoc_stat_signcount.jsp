...
<script type="text/javascript" charset="UTF-8" src="<c:url value="/apps_res/edoc/js/docstat/edoc_stat_signcount.js${v3x:resSuffix()}" />"></script>
           			...
           			<div class="form_area set_search">          			  
                        <p class="statistics">
                   			 <c:forEach  items="${statList}" var="content" varStatus="status">
                       			<label>
                            	 <input type="radio" value="${content.id}"  name="stat" <c:if test="${status.index ==0 }"> checked </c:if>
           						...
           						<tr align="center">
           							<td class="align_center" colspan="2">
	           							<div style="padding-top:40px;"
	           							 class="align_center clear padding_lr_5 padding_b_10" id="button_div"> 
