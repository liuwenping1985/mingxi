    ...
    <div class="layout_north" id="north">
        ...
        <c:if test="${param.statConditionId!='' && statCondition!=null}">
		    <form id="statConditionForm" style="display:none">
		        <input type="hidden" id="condition_statTitle" name="condition_statTitle" value="${statCondition.title }" />
		...
		<form id="hiddenIframe" name="hiddenIframe" style="display:none" action="" method="post"></form>
    </div>
    <div class="layout_center over_hidden" id="center">
    	<table  class="flexme3" id="edocStatResultSign"></table>
	</div>
</div>
</body>
</body>
