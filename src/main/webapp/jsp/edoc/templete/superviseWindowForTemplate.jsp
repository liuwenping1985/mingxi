			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			    ...
			    <tr>
			        ...
			        <td width="83%">
			        	...
			        	<label for="senderDepManager"> <input type="checkbox" id="senderDepManager" name="senderDepManager" <c:if test="${senderDepManager!='' && senderDepManager!=null}" > checked </c:if>><fmt:message key="sys.role.rolename.SenderDepManager" bundle="${v3xSysI18N }"/></label>
			        </td>
			    </tr>
			    <tr>
