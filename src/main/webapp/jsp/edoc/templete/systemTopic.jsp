...
//目前只有这样特殊处理一下
function convertEdocMark(docmark){
	if(docmark){
...
function edocFormDisplay()
{
  ...
  var serial_no = document.getElementById("my:serial_no");
  convertEdocMark(docmark);
  convertEdocMark(docmark2);
  convertEdocMark(serial_no);
  return false;
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="" class="body-detail-HTML">
  <tr>
