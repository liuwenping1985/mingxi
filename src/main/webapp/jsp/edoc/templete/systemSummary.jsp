		...
		<td height="10" class="detail-summary">
			<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
				<tr>
					...
					<td title="${templete.subject}">
					<c:choose>
					<c:when test="${fn:length(templete.subject)<=10}">
						<c:out value="${templete.subject}" escapeXml="true"/>
					</c:when>
					<c:otherwise>
					   <c:out value="${fn:substring(templete.subject,0,10)}..." escapeXml="true"/>
					</c:otherwise>
					</c:choose>
				...
				<tr>
					...
					<td width="60px" class="bg-gray"><fmt:message key="common.remind.time.label" bundle='${v3xCommonI18N}' />:</td>
					<td>${remindLabel}&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr id="attachmentTr" style="display: none">
					...
					<td colspan='4'>
						<div class="div-float" onmouseover="exportAttachment(this)">
							<div class="div-float">(<span id="attachmentNumberDiv" class="font-12px"></span>个)</div>
