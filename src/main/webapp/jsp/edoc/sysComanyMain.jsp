...
function setDefaultTab_Edoc(pos) {
	...
	detailIframe.location.href = divs[pos*4+1+index].getAttribute('url') + "&app=${app}";
}
...
<%-- 							<span class="resCode" resCodeParent="F20_manage">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div id="firstTab" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);showEdocLocation();" url="<html:link renderURL='collTemplate/collTemplate.do?method=templateSysMgr&app=${app }&categoryType=${!empty param.categoryType ? v3x:toHTML(param.categoryType) : 4}' />"><fmt:message key='menu.edoc.templateManager'/></div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>--%>
...
<%-- 							<span class="resCode" resCodeParent="F20_manage">
							...
							<span class="resCode" resCodeParent="F20_manage">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);showEdocLocation();" url="${perm}?method=list&category=edoc&newEdoc=true"><fmt:message key='menu.edoc.auth'/></div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
							...
							<span class="resCode" resCodeParent="F20_manage">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);showEdocLocation();" url="<html:link renderURL='/edocMark.do?method=listMain&companyId=${sessionScope[\"com.seeyon.current_user\"].loginAccount}' />"><fmt:message key='menu.edoc.wordNoManager'/></div>
							...
							<span class="resCode" resCodeParent="F20_manage">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);showEdocLocation();" url="form/formList.do?method=index&property=myForm&formType=5&_resourceCode=T05_flowFormList">发文单</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
							...
							<span class="resCode" resCodeParent="F20_manage">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);showEdocLocation();" url="form/formList.do?method=index&property=myForm&formType=7&_resourceCode=T05_flowFormList">收文单</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
							...
							<span class="resCode" resCodeParent="F20_manage">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);showEdocLocation();" url="form/formList.do?method=index&property=myForm&formType=6&_resourceCode=T05_flowFormList">签收单</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
							</c:if>
...
<%--							<span class="resCode" resCodeParent="F20_manage">
							...
							<span class="resCode" resCodeParent="F20_manage">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);showEdocLocation();" url="form/formList.do?method=index&property=myForm&formType=8&_resourceCode=T05_flowFormList">签报单</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
							<!-- 套红模板 -->
							...
							<span class="resCode" resCodeParent="F20_manage">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);showEdocLocation();" url="${govdocOpenController}?method=showEdocOpenSet"><fmt:message key='menu.edoc.edocSwitchSet.label' bundle='${v3xEdocI18N}'/></div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>	
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>	
							</span>
							<!-- 公文统计 -->
							<span class="resCode" resCodeParent="F20_manage">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);showEdocLocation();" url="${edoc}?method=edocStatSet"><fmt:message key='menu.statisticsManager.label' bundle='${v3xEdocI18N}'/></div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>	
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>	
							</span>
							<!--<span class="resCode" resCodeParent="F07_edocSystem">
