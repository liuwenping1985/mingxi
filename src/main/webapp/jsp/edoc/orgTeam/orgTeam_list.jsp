...
<v3x:table data="teamList"   className="sort ellipsis" var="bean" htmlId="listTable" showHeader="true" showPager="true">
	...
	<v3x:column width="20%" type="String" onClick="singleClick('${bean.id}');" onDblClick="editPlan('${bean.id}');"
    ...
    <v3x:column width="5%" type="String" onClick="singleClick('${bean.id}');" onDblClick="editPlan('${bean.id}');"
		label="common.sort.label" className="cursor-hand sort" maxLength="30" symbol="..." alt="${bean.sortId}" value="${bean.sortId}">
