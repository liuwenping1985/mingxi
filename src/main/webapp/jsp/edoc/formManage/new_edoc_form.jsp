...
<body onload="edocFormDisplay();scrollList_fn();" class="h100b">
											...
											<td>
											 <div class="common_radio_box clearfix">
												...
												<label class="hand display_block" for="radio0">
												    <input type="radio" id="radio0" name="dealTimeFormt" value="0" <c:if test="${param.flag == 'readonly'}"> disabled="disabled"</c:if>/>
												    <fmt:message key="edoc.form.flowperm.dealDateTimeFormt" />
												</label>
												
												<!-- 日期 -->
                                                <label class="margin_t_5 hand display_block" for="radio1">
                                                    <input type="radio" id="radio1" name="dealTimeFormt" value="1" <c:if test="${param.flag == 'readonly'}"> disabled="disabled"</c:if>/>
                                                    <fmt:message key="edoc.form.flowperm.dealDateFormt" />
                                                </label>
                                                
                                                <!-- 无 -->
                                                <LABEL class="margin_t_5 hand display_block" for="radio2">
                                                    <input type="radio" id="radio2" name="dealTimeFormt" value="2" <c:if test="${param.flag == 'readonly'}"> disabled="disabled"</c:if>/>
...
<script type="text/javascript">
    ...
    function scrollList_fn(){
        var scrollListObj = document.getElementById("edoc_scrolling");
        if(scrollListObj && scrollListObj.style){
            scrollListObj.style.display = "none";
            scrollListObj.style.overflow = "auto";
            if(scrollListObj.parentNode && scrollListObj.parentNode.offsetHeight){
                scrollListObj.style.height = scrollListObj.parentNode.offsetHeight;
            }
            scrollListObj.style.display = "block";
        }
    }
</script>
