...
<v3x:selectPeople id="ExchangeUnit" panels="Account,Department,ExchangeAccount,OrgTeam" selectType="Account,Department,ExchangeAccount,OrgTeam" departmentId="${sessionScope['com.seeyon.current_user'].departmentId}" jsFunction="setExchangeUnitFields(elements)" viewPage="" minSize="0" maxSize="5000" showAllAccount="false" />
<%--OA-22641  lixsh在拟文时，发文部门子段点击不能弹出选人界面   --%>
