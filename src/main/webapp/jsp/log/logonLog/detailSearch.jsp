	...
	<td class="page-list-border-LRD" style="padding-top:6px">
		...
		<c:choose>
		  ...
		  <c:if test="${onlineModel != null }">
		  	<c:if test="${((result.logonTime.time/1000 - onlineModel.loginTime.time/1000)<=1 && (result.logonTime.time/1000 - onlineModel.loginTime.time/1000>=0)) || ((result.logonTime.time/1000 - onlineModel.loginTime.time/1000>=-1) && (result.logonTime.time/1000 - onlineModel.loginTime.time/1000<=0))}">
