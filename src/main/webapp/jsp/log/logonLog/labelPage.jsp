	...
	function changeLabel(which){
		switch (which){
			...
			case 4:
				...
				break;
			/**添加登录统计查询的选项卡 作者：zhangdong 日期：2017年3月21日 start**/
			case 5:
				location.href="<html:link renderURL='/logonLog.do?method=countlogSearch' />";
				break;
			/**添加登录统计查询的选项卡 作者：zhangdong 日期：2017年3月21日 end**/
		}
	}
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td valign="bottom" height="26" class="tab-tag" colspan="20">
			...
			<div id="div3_middel" class="${param.method=='detailSearch'?'tab-tag-middel-sel':'tab-tag-middel' }" onclick="javascript:changeLabel(3)">明细查询</div>
			...
			--%>
			<!-- 【添加登录统计查询的选项卡】 作者：zhangdong 日期：2017年3月21日 start -->
			<div id="div5_left" class="${param.method=='countlogSearch'?'tab-tag-left-sel':'tab-tag-left' }"></div>
			<div id="div5_middel" class="${param.method=='countlogSearch'?'tab-tag-middel-sel':'tab-tag-middel' }" onclick="javascript:changeLabel(5)">登录统计查询</div>
			<div id="div5_right" class="${param.method=='countlogSearch'?'tab-tag-right-sel':'tab-tag-right' }"></div>
			<div class="tab-separator"></div>
			<!-- 【添加登录统计查询的选项卡】 作者：zhangdong 日期：2017年3月21日  end -->
			</div>
		</td>
