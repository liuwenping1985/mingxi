	...
	<td class="webfx-menu-bar-gray" height="25">
		...
		<c:when test="${param.addressbookType == 1}">
			<script>
				...
				exportMenu.add(new WebFXMenuItem("VcrdExport","<fmt:message key='addressbook.toolbar.file.vcard' bundle='${v3xAddressBookI18N}' />","savevCard(1,'${param.accountId}','${param.deptId}','${param.addressbookType}')","","",""));
				exportMenu.add(new WebFXMenuItem("CsvExport","<fmt:message key='addressbook.toolbar.file.csv' bundle='${v3xAddressBookI18N}' />","saveCsv(1,'${param.accountId}','${param.deptId}','${param.addressbookType}')","","",null));
				if(v3x.getBrowserFlag('hideMenu')){
					<c:if test="${v3x:hasPlugin('uc')}">
						myBar1.add(new WebFXMenuButton("sendMessage", "<fmt:message key='message.sendDialog.title' bundle='${v3xAddressBookI18N}' />", "sendMessageForAddress()", [6,2], "", null));
					</c:if>
					...
					if('${param.click}' != 'dept'){
					    myBar1.add("<div class='webfx-menu--button'><input type='checkbox' disabled checked='checked' name='sonDepartmentMembers'/><fmt:message key='addressbook.toolbar.department.lable' bundle='${v3xAddressBookI18N}'/></div>");
					}else{
					    if('${param.isDepartment}'=='0'){
					        myBar1.add("<div class='webfx-menu--button'><input type='checkbox' name='sonDepartmentMembers' onclick=\"javascript:sonDepartmentMembers('searchForm',this.checked);\"/><fmt:message key='addressbook.toolbar.department.lable' bundle='${v3xAddressBookI18N}'/></div>");
						}else{
						    myBar1.add("<div class='webfx-menu--button'><input type='checkbox' checked='checked' name='sonDepartmentMembers' onclick=\"javascript:sonDepartmentMembers('searchForm',this.checked);\"/><fmt:message key='addressbook.toolbar.department.lable' bundle='${v3xAddressBookI18N}'/></div>");
						}
					}
				}
		...
		<c:when test="${param.addressbookType == 2}">
			<script>
				...
				exportMenu.add(new WebFXMenuItem("VcrdExport","<fmt:message key='addressbook.toolbar.file.vcard' bundle='${v3xAddressBookI18N}' />","savevCard(2,'${param.accountId}','${param.deptId}','${param.addressbookType}')","","",null));
				exportMenu.add(new WebFXMenuItem("CsvExport","<fmt:message key='addressbook.toolbar.file.csv' bundle='${v3xAddressBookI18N}' />","saveCsv(2,'${param.accountId}','${param.deptId}','${param.addressbookType}')","","",null));
					
				var importMenu = new WebFXMenu;
			    importMenu.add(new WebFXMenuItem("VcrdImport", "<fmt:message key='addressbook.toolbar.file.vcard' bundle='${v3xAddressBookI18N}' />","openImortWindow()","", "",null));
		        importMenu.add(new WebFXMenuItem("CsvImport", "<fmt:message key='addressbook.toolbar.file.csv' bundle='${v3xAddressBookI18N}' />","openCSVImport()","","", null));
		...
		<c:when test="${param.addressbookType == 3}">
			<script>
				...
				if(v3x.getBrowserFlag('hideMenu')){
					<c:if test="${v3x:hasPlugin('uc')}">
						myBar3.add(new WebFXMenuButton("sendMessage", "<fmt:message key='message.sendDialog.title' bundle='${v3xAddressBookI18N}' />", "sendMessageForAddress()", [6,2], "", null));
					</c:if>
					<c:if test="${isCanSendSMS}">
						myBar3.add(new WebFXMenuButton("sendSMS", "<fmt:message key='top.alt.sendMobileMsg' bundle='${v3xMainI18N}' />", "sendSMS()", [6,3], "", null));	
					</c:if>
					<c:if test="${showExportPrint}">
					  myBar3.add(new WebFXMenuButton("download", "<fmt:message key='addressbook.toolbar.download.label' bundle='${v3xAddressBookI18N}' />", "download('${param.accountId}','${param.deptId}','${param.addressbookType}')", [6,4], "", null));
					  if(v3x.getBrowserFlag('onlyIe')){
		...
		<c:otherwise>
			<script>
				...
				if(v3x.getBrowserFlag('hideMenu')){
					<c:if test="${v3x:hasPlugin('uc')}">
						myBar4.add(new WebFXMenuButton("sendMessage", "<fmt:message key='message.sendDialog.title' bundle='${v3xAddressBookI18N}' />", "sendMessageForAddress()", [6,2], "", null));
					</c:if>
					<c:if test="${isCanSendSMS}">
