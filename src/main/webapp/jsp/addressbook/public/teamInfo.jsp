  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
			...
			<td class="new-column" width="90%">
				<textarea class="input-100per" style="width: 245" name="memo" id="memo" rows="6" cols="" inputName="${descLable}" onKeyDown='checkLength(this,200)'  ${ro}>${team.description}</textarea>
			</td>
		</tr>
		</table>
