    	...
    	<fieldset style="width:95%;border:0px;" align="center">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
				<tr>
					...
					<td class="new-column" width="75%" nowrap="nowrap">
						<textarea name="description" id="description" rows="" cols="41" inputName="<fmt:message key='addressbook.account_form.memo.label' />" validate="maxLength" maxSize="200" ${dis } readonly="readonly" style="height: 90px;">${tel.description}</textarea>
					</td>
				</tr>
			</table>
		</fieldset>
