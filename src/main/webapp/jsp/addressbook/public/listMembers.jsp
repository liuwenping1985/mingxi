...
<div class="main_div_row2" id="listMember_div">
	<script type="text/javascript">
		...
		<c:if test="${v3x:hasPlugin('uc')}">
			rightMenu.AddItem("sendMessage","<fmt:message key='message.sendDialog.title' bundle='${v3xAddressBookI18N}' />","<c:url value='/apps_res/v3xmain/images/online.gif'/>","rbpm","sendMessage","sendMessage");
		</c:if>
  ...
  <div class="right_div_row2">
    ...
    <div class="center_div_row2" id="scrollListDiv" style="overflow: hidden;top:25px;">
		<form id="memberform" method="post">
			...
			<c:choose>
				...
				<c:otherwise>
                    ...
                    <c:choose>
                        ...
                        <v3x:column align="left" width="15%" label="addressbook.company.department.label" type="string" value="${v3x:showDepartmentFullPath(param.deptId)}" className="sort" alt="${v3x:showDepartmentFullPath(param.deptId)}"></v3x:column>
                        </c:when>
                        <c:otherwise>
			...
			<v3x:column align="left" width="12%"  label="addressbook.company.telephone.label" type="string"
            ...
            <v3x:column align="left" width="40%" label="addressbook.postAddress.label" type="string"
