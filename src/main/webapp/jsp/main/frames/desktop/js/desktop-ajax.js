...
jsonGateway:"/seeyon/ajax.do?method=ajaxAction&managerName=deskManager",
	 ...
	 deletePortletByMultiParam: function(){
                  return this.ajaxCall(arguments,"deletePortletByMultiParam");
},
     getAllPortlets: function(){
                  return this.ajaxCall(arguments,"getAllPortlets");
},
	 getAllPortletsForSection: function(){
				  return this.ajaxCall(arguments,"getAllPortletsForSection");
},
