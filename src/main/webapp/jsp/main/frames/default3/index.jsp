...
%>
    ...
    <script type="text/javascript"  src="${path}/main/frames/default3/frount-debug.js${ctp:resSuffix()}"></script>
    <link rel="stylesheet" type="text/css" href="${path}/main/frames/default3/frount.css${ctp:resSuffix()}" />
