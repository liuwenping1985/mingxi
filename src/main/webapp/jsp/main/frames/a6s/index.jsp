...
%>
    ...
    <script type="text/javascript"  src="${path}/main/frames/a6s/frount-debug.js${ctp:resSuffix()}"></script>
    <link rel="stylesheet" type="text/css" href="${path}/main/frames/a6s/frount.css${ctp:resSuffix()}" />
            ...
            if("${CurrentUser.admin}" != "true"){
            	try {
                  ...
                  success : function (lineDate){
						...
						$("#timeLine_box").css({"background-color":"#e6ebea"});
                  }
                });
                ...
                <div class="banner clearfix" id="head_banner">
                    <div class="area_l clearfix" id="area_l">
                        <div class="left logoDiv">
                            <img src="${path}/main/frames/frount2/images/logo.png${ctp:resSuffix()}" id="logo" height="64"  border="0" />
                        </div>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <div id="frount_nav_div" class="frount_nav h100b left">
                                ...
                                <div class="frount_nav_seprater_line_up"></div>
                                ...
                                <div id="remind_msg" class="remind_msg">
                                    <a id="remind_msga">${ctp:i18n('menu.personal.msg.label')}</a>
                                </div>
                            </div>
                        </c:otherwise>
                    </c:choose>
