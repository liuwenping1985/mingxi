...
%>
    ...
    <script type="text/javascript"  src="${path}/main/frames/default2/frount-debug.js${ctp:resSuffix()}"></script>
    <link rel="stylesheet" type="text/css" href="${path}/main/frames/default2/frount.css${ctp:resSuffix()}" />
          ...
          if(templates.length>0){
            ...
            for(var i = 0;i < hotspots.length;i++){
              ...
              if(key == "backpic"){
                ...
                if(hotspot.tiling==1){
                  $("#stadic_layout").css({ "background-repeat": "" });
                 }else{
              ...
              if(key == "sbcolor"){
                //空间页签背景颜色
                $("#space li").css({"background-color":value});
