...
<html class="h100b over_hidden">
	<head>
		...
		<link id="skinFrameCSS" type="text/css" href="${path}/main/skin/frame/${skinPathKey}/default.css${ctp:resSuffix()}" rel="stylesheet" />
		...
		<script type="text/javascript" src="${path}/main/frames/defaultV51/frount-debug.js${ctp:resSuffix()}"></script>
	</head>
	<body class="w100b h100b" style="background-image:none">
		...
		<div id="space_pop" class="space_pop"></div>
        <iframe id="space_iframe" class="space_iframe"  frameborder="0"></iframe>
	                ...
	                <div class="area_r right">
		                	<c:choose>
		                		...
		                		<c:otherwise>
					                ...
					                <c:if test="${CurrentUser.systemAdmin && ctp:getSystemProperty('portal.about') != 'NC' && ctp:getSystemProperty('portal.about') != 'U8'}">		                
									<div class="banner_line right"></div>
				                	<div class="area_r_icon right">
                ...
                <div class="layout_left">
                       <c:choose>
                           ...
                           <c:otherwise>
		                    ...
		                    <div class="line">
		                    	<div class="avatar hand"><img src="" width="94" height="91"></div>
	                                <div class="vst_online hand"  id="vst_online">
	                                	<div class="vst_online_box">
	                                		<span id="vst_online_state">
		                                        <em class="skin_ico16 online1"></em><span class="padding_l_5"></span>
		                                    </span>
		                                    <span id="online_uc" style="cursor:pointer;"><span id="onlineNum" name="onlineNum">${onlineNumber}</span>${ctp:i18n('portal.onlineNum.label')}</span>
							...
							<div class='shortcut_nav_item' id='myShortcutDiv'>
								<div class='mynav_box_bgcolor'></div>
								<div class='mynav_box_color'></div>
								<span class='nav_icon'><span class="portal_menu_icon portalIndex_shortcut" style="display: inline-block;"></span></span>
								<!-- 我的快捷 -->
								<span class='nav_title' id="shortCutTitle">${ctp:i18n('portal.menu.shortcut.label')}</span>
							</div>
							<c:if test="${hasAgent}">
								<div class='nav_border'></div>
								<div class='agent_nav_item' id='agentNav'>
									...
									<!-- 代理事项 -->
									<span class='nav_title' id="agentNavTitle">${ctp:i18n('menu.personal.agent.label')}</span>
								</div>
							</c:if>
                           </c:otherwise>
                        </c:choose>
                    <div class="nav" pager="1">
