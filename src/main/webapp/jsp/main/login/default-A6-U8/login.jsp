...
<head>
			...
			if($.ctx.hotSpots){
			  for(var i = 0; i < $.ctx.hotSpots.length; i++){
		        if($.ctx.hotSpots[i].hotspotkey == "note"){
		          ...
		          if(picHotSpot.hotspotvalue != "default-A6/images/main_content_ie6.jpg" && picHotSpot.hotspotvalue != "default-A6/images/main_content_ie6.png") {
	                $(".showArea").hide();
	                $(".logoArea").hide();
	              }
	...
	<link rel="stylesheet" type="text/css" href="${path}/main/login/default-A6-U8/css/login.css${ctp:resSuffix()}" />
</head>
