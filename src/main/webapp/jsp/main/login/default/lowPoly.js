$(function() {
    $.fn.bannerShow = function(g) {
        ...
        return this.each(function() {
            ...
            var j = $("#bnav"),
            k = $("li", j);
            var h = [["#002c4a", "#005584"], ["#35ac03", "#3f4303"], ["#ac0908", "#cd5726"], ["18bbff", "#00486b"]];
            $(this).hover(function() {
                g.isAuto = false
            },
            function() {
    ...
    if (!!document.createElement("canvas").getContext) {
        $.getScript("main/login/default/cav.js",
        function() {
            var t = {
                width: 1.5,
                height: 1.5,
    ...
    window.online_resp = function(g) {
        if (g && g.c) {
            $("#cur_online").text(g.c.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,"));
            $("#max_online").text(g.h.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,"))
        }
    };
