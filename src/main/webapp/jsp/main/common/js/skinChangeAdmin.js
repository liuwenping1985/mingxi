  ...
  this.p = $.extend(
          {
            ...
            templateId : '141322537970846464',
            topBgImg : 'main/skin/frame/harmony/images/header1.png',// 自定义banner图片
            logoImg : 'main/skin/frame/harmony/images/header1.png',// 自定义logo图片
            ...
            **/
            ...
            data : [ {
              ...
              logo:'main/skin/frame/harmony/images/header1.png'
            }, {
              id : 'peaceful',
              templateId : '141322537970846464',
              name : '宁静之韵',
              ...
              logo:'main/skin/frame/peaceful/images/peaceful_head.png'
            }, {
              id : 'wisdom',
              name : '智慧之美',
              templateId : '141322537970846464',
              ...
              logo:'main/skin/frame/wisdom/images/wisdom_head.png'
            } ],
            colorList : [
                {
                  'model' : '#303030',
...
CtpSkinChange.prototype.initDefault = function(){
	var _skinSetHtmlString = "";
		/**
		_skinSetHtmlString+='<div class="skin_set_title"><span class="skin_set_text left">' + $.i18n('portal.skin.set') + '</span><span id="skin_set_close" class="skin_set_close"></span></div>';
		 **/
		_skinSetHtmlString+='<div class="skin_content" style="width:auto;">';
      // 布局选择
      _skinSetHtmlString+='<div class="clearfix">';
        _skinSetHtmlString+='<div style="height:45px;line-height:45px;background:#e3e3e3;margin-top:0px;padding-left:20px;" class="clearFix"><span class="left">' + $.i18n('portal.skin.layoutskin.setting') + '</span></div>';
        _skinSetHtmlString+='<div class="left padding_tb_20" style="width:485px;padding-left: 37px;">'
          _skinSetHtmlString+='<div class="skin_admin_content_tabs clearfix">';
        	_skinSetHtmlString+='<a templateId="141322537970846464" class="current">' + $.i18n('portal.skin.layout.left') + '</a>';
            _skinSetHtmlString+='<a templateId="8950558293947007546">' + $.i18n('portal.skin.layout.up') + '</a>';
          _skinSetHtmlString+='</div>';
        _skinSetHtmlString+='</div>';

        _skinSetHtmlString+='<div id="allowTemplateChooseDiv" style="padding:36px 0 36px 36px;float:left;width:488px;float:left">';
          //_skinSetHtmlString+='<input type="checkbox">aaaaaaaaaaaaaa';
        _skinSetHtmlString+='</div>';
      _skinSetHtmlString+='</div>';

  		// 推荐配色
      _skinSetHtmlString+='<div class="clearfix">';
    		_skinSetHtmlString+='<div class="recommend_skin clearFix" style="display: ' + (getCtpTop().systemProductId == 7? 'none':'') + '" >';
    			_skinSetHtmlString+='<div style="height:45px;line-height:45px;background:#e3e3e3;margin-top:0px;padding-left:20px;" class="clearFix"><span class="left">' + $.i18n('portal.skin.recommendcolor') + '</span></div>';
    			_skinSetHtmlString+='<div class="left" style="width:485px;padding-left: 37px;">'
    				_skinSetHtmlString+='<div class="content clearFix" style="width:285px;float:left;margin-left:37px;margin-top:30px;">';
    					_skinSetHtmlString+='<ul class="list clearFix" id="recommend_list" style="height:auto;">';
    					_skinSetHtmlString+='</ul>';
    				_skinSetHtmlString+='</div>';
    				_skinSetHtmlString+='<a style="float:left;margin-left:30px;margin-top:30px;" id="reDefaultBtn" class="common_button common_button_gray right hand" >' + $.i18n('portal.skin.recover') + '</a>';
    			_skinSetHtmlString+='</div>';
    		_skinSetHtmlString+='</div>';

    		_skinSetHtmlString+='<div id="recommend_right" class="left" style="float:left;width:200px;padding-top: 30px;position:relative; padding-left: 37px; display: ' + (getCtpTop().systemProductId == 7? 'none':'') + '">'
    		_skinSetHtmlString+='</div>';
  		_skinSetHtmlString+='</div>';

  		if(getCtpTop().isA6s == "true"){
  		  // 自定义界面设置  A6-s
  	      _skinSetHtmlString+='<div class="clearfix '+ (this.p.changeBg==0? "to_gray":"") +'">';
  	        _skinSetHtmlString+='<div style="height:45px;line-height:45px;background:#e3e3e3;margin-top:0px;padding-left:20px;vertical-align:middle;"><span class="left">' + $.i18n('portal.skin.customsetting') + '</span></div>';

  	        _skinSetHtmlString+='<div class="left" style="width:485px; padding: 30px 0 30px 37px; font-size:12px;">';
  	          _skinSetHtmlString+='<img src="' + _ctxPath + "/" + this.p.logoImg + '" height="48" class="border_all left skin_logo hand">';
  	          _skinSetHtmlString+='<span class="left color_gray margin_l_10 margin_t_15">' + $.i18n('portal.skin.logoInstruction') + '</span>';
  	        _skinSetHtmlString+='</div>';
  	      _skinSetHtmlString+='</div>';
  		} else {
  		  // 自定义界面设置
  	      _skinSetHtmlString+='<div class="clearfix '+ (this.p.changeBg==0? "to_gray":"") +'">';
  	        ...
  	        _skinSetHtmlString+='<div class="left" style="width:485px; padding: 30px 0 30px 37px; font-size:12px;">';
  	          //左右布局
  	          _skinSetHtmlString+='<table templateId="141322537970846464" class="skin_template hidden" width="300" height="200" border="0" cellpadding="0" cellspacing="0">';
  	          _skinSetHtmlString+='<tr>';
  	          _skinSetHtmlString+='<td align="center" style="background:#dbf0fa;"><span class="hand color_blue skin_logo">LOGO</span></td>';
  	          _skinSetHtmlString+='<td height="30" align="center" style="background:#86d6fa; color:#004767"><span></span><span><span class="hand skin_head_img">' + $.i18n('portal.skin.head') + $.i18n('portal.skin.bgImg') + '</span><span style="margin-top:-2px;margin-left:3px;display:none" class="ico16 close_16 skin_head_img_remove" templateId="141322537970846464"></span></span><span><!--' + $.i18n('portal.skin.and') + '-->、</span><span class="hand skin_head_color">' + $.i18n('portal.skin.color') + $.i18n('portal.skin.modify') + '</span></td>';
  	          _skinSetHtmlString+='</tr>';
  	          _skinSetHtmlString+='<tr>';
  	          _skinSetHtmlString+='<td align="center" width="40" style="background:#00466A;color:#fff"><span>' + $.i18n('portal.skin.menu') + '</span><br><span style="color:#fff" class="hand color_blue skin_nav_color">' + $.i18n('portal.skin.color') + "<br/>" + $.i18n('portal.skin.modify') + '</span></td>';
  	          //_skinSetHtmlString+='<td align="center" style="background:#dbf0fa;"><span class="hand color_blue skin_mainBody_img">' + $.i18n('portal.skin.pageBgImg') + '</span> <span class="hand color_blue skin_mainBody_color">' + $.i18n('portal.skin.bgColor') + '</span><span class="ico16 close_16 skin_mainBody_img_remove"></span> <span class="hand color_blue skin_column_color">' + $.i18n('portal.skin.sectionHeadingColor') + '</span></td>';
              ...
              _skinSetHtmlString+='<div style="float:left;width:115px; display:inline-block; text-align:center; margin:5px 0 0 5px;"><div style="width:115px; padding: 5px 0px; background-color:#fff; "><span class="hand skin_column_color"  style="color:#0c76ae">' + $.i18n('portal.skin.sectionHeadingColor') + $.i18n('portal.skin.modify') + '</span></div>';
              _skinSetHtmlString+='<div style="width:115px; padding: 20px 0px; background-color:#B9D6E6;"><span class="hand color_blue skin_sectionContent_color" style="display: inline-block;color:#00466a">' + $.i18n('portal.skin.sectionContentColor') + $.i18n('portal.skin.modify') + '</span></div></div>';
  		      	_skinSetHtmlString+='<div style="float:left; width:110px; padding-left:5px; display:inline-block; margin:25px 0 0 5px;"><div style="width:110px;"><span style="color:#fff;"><span class="hand skin_mainBody_img">' + $.i18n('portal.skin.pageBgImg') + $.i18n('portal.skin.modify') + '</span><span style="margin-top:-2px;margin-left:3px;display:none" class="ico16 close_16 skin_mainBody_img_remove" templateId="141322537970846464"></span></span></div>';
  	          ...
  	          //上下布局
  	          _skinSetHtmlString+='<table templateId="8950558293947007546" class="skin_template hidden" width="300" height="200" border="0" cellpadding="0" cellspacing="0">';
  	          _skinSetHtmlString+='<tr>';
  	          _skinSetHtmlString+='<td width="40" align="center" style="background:#dbf0fa;"><span class="hand skin_logo">LOGO</span></td>';
  	          _skinSetHtmlString+='<td height="30" align="center" style="background:#86d6fa; color:#004767"><span></span><span><span class="hand skin_head_img">' + $.i18n('portal.skin.head') + $.i18n('portal.skin.bgImg') + '</span><span style="margin-top:-2px;margin-left:3px;display:none" class="ico16 close_16 skin_head_img_remove" templateId="8950558293947007546"></span></span><span><!--' + $.i18n('portal.skin.and') + '-->、</span><span class="hand skin_head_color">' + $.i18n('portal.skin.color') + $.i18n('portal.skin.modify') + '</span></td>';
  	          _skinSetHtmlString+='</tr>';
  	          _skinSetHtmlString+='<tr>';
  	          _skinSetHtmlString+='<td height="30" colspan="2" align="center" style="background:#00466A; color:#fff;"><span class="hand skin_nav_color">' +$.i18n('portal.skin.menu') + $.i18n('portal.skin.color') + $.i18n('portal.skin.modify') + '</span></td>';
  	          _skinSetHtmlString+='</tr>';
  	          _skinSetHtmlString+='<tr>';
  	          //_skinSetHtmlString+='<td align="center" colspan="2" style="background:#dbf0fa;"><span class="hand color_blue skin_mainBody_img">' + $.i18n('portal.skin.pageBgImg') + '</span> <span class="hand color_blue skin_mainBody_color">' + $.i18n('portal.skin.bgColor') + '</span><span class="ico16 close_16 skin_mainBody_img_remove"></span> <span class="hand color_blue skin_column_color">' + $.i18n('portal.skin.sectionHeadingColor') + '</span></td>';
  	          _skinSetHtmlString+='<td colSpan="2" align="left" style="background:#1877AD;padding:5px 0 10px 10px; vertical-align:top;">';
  		      	_skinSetHtmlString+='<div class="font_12" style="background:url(/seeyon/main/skin/frame/harmony/menuIcon/personal_16.png) left center no-repeat; background-size:16px 16px; padding-left: 20px; color: #fff;  height: 28px;line-height: 28px;"><span class="hand bread_font_color ">' + $.i18n('portal.skin.breadFontColor') + $.i18n('portal.skin.modify') + '</span></div>';
              ...
              _skinSetHtmlString+='<div style="width:115px; padding: 20px 0px; background-color:#B9D6E6;"><span class="hand color_blue skin_sectionContent_color" style="display: inline-block;color:#00466a">' + $.i18n('portal.skin.sectionContentColor') + $.i18n('portal.skin.modify') + '</span></div></div>';
  		      	...
  		      	_skinSetHtmlString+='<div style="float:left;width:110px; padding-left:5px; display:inline-block; margin:25px 0 0 5px;"><div style="width:110px;"><span style="color:#fff;"><span class="hand skin_mainBody_img">' + $.i18n('portal.skin.pageBgImg') + $.i18n('portal.skin.modify') + '</span><span style="margin-top:-2px;margin-left:3px;display:none" class="ico16 close_16 skin_mainBody_img_remove" templateId="8950558293947007546"></span></span></div>';
  		      	_skinSetHtmlString+='<div style="width:110px;" class="margin_t_10"><span style="color:#fff;" class="hand skin_mainBody_color">' + $.i18n('portal.skin.bgColor') + $.i18n('portal.skin.modify') + '</span></div></div> ';
  	          ...
  	          _skinSetHtmlString+='<div style="color:#a1a1a1;position:relative;line-height:150%;">';
  	            _skinSetHtmlString+=$.i18n('common.instructions.label') + ':<br>';
  	            _skinSetHtmlString+='1、' + $.i18n('portal.skin.logoInstruction') + '<br>';
  	            _skinSetHtmlString+='2、' + $.i18n('portal.skin.hbackpicInstruction') + '<br>';
  	            _skinSetHtmlString+='3、' + $.i18n('portal.skin.bigBackpicInstruction');
  	          _skinSetHtmlString+='</div>';
  	        _skinSetHtmlString+='</div>';

  	        _skinSetHtmlString+='<div style="float:left;width:200px;padding-top: 30px; padding-left: 37px;padding-top:100px;height:163px;position:relative; " class="skin_content_admin_bg" id="skin_right">';
  	        _skinSetHtmlString+='</div>';
  	      _skinSetHtmlString+='</div>';
  		}
      ...
      // 其他设置
      _skinSetHtmlString+='<div class="clearfix">';
  			_skinSetHtmlString+='<div style="height:45px;line-height:45px;background:#e3e3e3;margin-top:0px;padding-left:20px;vertical-align:middle;"><span class="left">' + $.i18n('portal.skin.othersetting') + '</span></div>';
  			_skinSetHtmlString+='<div style="padding-left:37px;padding-top:30px;" id="group-bottom"></div>';
  			
  			_skinSetHtmlString+='<div class="bg_color_skin">';
  				_skinSetHtmlString+='<div class="content">';
  					...
  					_skinSetHtmlString+='<div id="skin_column_op_div" class="clearfix" style="height:30px;line-height:30px;font-size:12px;"><a id="clearColor" class="common_button  common_button_gray margin_t_5">' + $.i18n('portal.skin.clear') + '</a> <span id="colorOpacitySpan" style="float:right">' + $.i18n('portal.skin.opacity') + ':<input id="skin_column_op_input" value="100" style="width:25px;"  type="text" maxlength="3" /><span id="skin_column_op_span">%</span></span></div>';
  					//_skinSetHtmlString+='<a id="clearColor" class="common_button common_button_gray margin_t_5">' + $.i18n('portal.skin.clear') + '</a>'
  				_skinSetHtmlString+='</div>';
        _skinSetHtmlString+='</div>';
			_skinSetHtmlString+='</div>';
			
		_skinSetHtmlString+='<input id="hiddenLogoImg" type="hidden" />';	
		...
		$(".skin_admin_content_tabs a").removeClass("current");
		$(".skin_admin_content_tabs a").removeClass("skinSwitchDisabled");
		$(".skin_admin_content_tabs a[templateId='" + this.p.templateId + "']").addClass("current");
		if(this.p.allowTemplateSwitch == "0"){
			$(".skin_admin_content_tabs a[templateId!='" + this.p.templateId + "']").addClass("skinSwitchDisabled");
		}
		if(this.p.topBgImg != ""){
			$(".skin_head_img_remove[templateId='" + this.p.templateId + "']").parents("span").css("background-color", "#fff");
		...
		changeTemplateSkinMore(this.p.templateId);
		...
		for(var i =0;i<this.p.data.length;i++){
			...
			$('#recommend_list').append('<li id="'+_id+'" class="item '+_last+'  hoverFlag '+ (this.p.changeSkin==0? "to_gray":"") +'" style="background:url(' + _ctxPath +'/main/skin/frame/' + this.p.skinId + '/images/'+_image+');'+(this.p.data.length==2?'margin-right:50px;':'')+'"></li>');
    	(function(obj) {
    ...
    //根据模版不同，展示不同换肤更多
    function changeTemplateSkinMore(templateId) {
      $(".skin_template[templateId='" + templateId + "']").show();
    }
		...
		if(this.p.render!=null){
			...
			$('#skin_column_op_input').unbind("blur").blur(function(){
				...
				if(_tar == ".skin_nav_color"){
					...
					if(portalskinChange.p.lBgColor.color != "transparent"){
						getCtpTop().setNavMenuColor(portalskinChange.p.lBgColor.color, colorOpacity);
					}
				} else if(_tar == ".skin_head_color"){
					portalskinChange.p.topBgColor.colorOpacity = colorOpacity;
					if(portalskinChange.p.topBgColor.color != "transparent"){
						getCtpTop().setTopBgColor(portalskinChange.p.topBgColor.color, colorOpacity);
					}
				} else if(_tar == ".skin_column_color"){
					portalskinChange.p.cBgColor.colorOpacity = colorOpacity;
					if(portalskinChange.p.cBgColor.color != "transparent"){
						getCtpTop().resetSectionTabColor(portalskinChange.p.cBgColor.color, colorOpacity / 100);
					}
				} else if(_tar == ".skin_sectionContent_color"){
					portalskinChange.p.sectionContentColor.colorOpacity = colorOpacity;
					if(portalskinChange.p.sectionContentColor.color != "transparent"){
						getCtpTop().setContentAreabgc(portalskinChange.p.sectionContentColor.color, colorOpacity);
					}
				} else if(_tar == ".skin_mainBody_color"){
					portalskinChange.p.mainBgColor.colorOpacity = colorOpacity;
					if(portalskinChange.p.mainBgColor.color != "transparent"){
						getCtpTop().setMainBgColor(portalskinChange.p.mainBgColor.color, colorOpacity);
					}
				}
...
CtpSkinChange.prototype.setPersonalData = function(){
	...
	$('#logo_div_img').attr('src',_ctxPath + '/' + this.p.logoImg);
...
CtpSkinChange.prototype.resetData = function(op){
	this.p = $.extend({
        ...
        logoImg : 'main/skin/frame/harmony/images/header1.png',// 自定义banner图片
        ...
        data:[{
			...
			colorList:[{
				...
				'model':'#feab07',
				'list':["#6c2c13","#8f4c00","#ad6500","#cb7e00","#eb9900","#ffb317","#4d2600","#683b00","#835300","#a06c13","#bc852f","#da9f49","#472900","#5f3f0b","#7a5723","#96703b","#b18952","#cea36c"]
			},{
				'model':'#ffc91e',
				...
				'model':'#009bf0',
				'list':["#002568","#003981","#00509b","#0068b7","#0082d4","#009bf0","#002149","#003661","#004c7a","#1e6494","#407eaf","#5c97ca","#001f36","#12334d","#2b4964","#44627e","#5e7b98","#1389b9"]
			},{
				'model':'#006afe',
...
CtpSkinChange.prototype.createBgColorSkin = function(_currentMap){
	...
	$('.colorItem,#clearColor').unbind("click").click(function(){
		...
		//这里是透明度值
		var _op = $('#skin_column_op_input').val();
		//这里处理透明度...可以直接存也可以转化成小数
...
//logo上传回调动作
function logoImgUploadCallBack(attachment){  
  getCtpTop().$("#logo").attr("src",_ctxPath + "/fileUpload.do?method=showRTE&fileId=" + attachment.instance[0].fileUrl + "&type=image");
  $(".skin_logo").attr("src", _ctxPath + "/fileUpload.do?method=showRTE&fileId=" + attachment.instance[0].fileUrl + "&type=image");
  portalskinChange.p.logoImg = "fileUpload.do?method=showRTE&fileId=" + attachment.instance[0].fileUrl + "&type=image";
  updateSkinSwitchDatas(portalskinChange.p);
  if(portalskinChange.p.onChange!=null) portalskinChange.p.onChange();
}
...
function topBgImgUploadCallBack(attachment){
  ...
  updateSkinSwitchDatas(portalskinChange.p);
  if(portalskinChange.p.onChange!=null) portalskinChange.p.onChange();
  $(".skin_head_img_remove[templateId='" + portalskinChange.p.templateId + "']").parents("span").css("background-color", "#fff");
...
function getOpacityRgb(color1,Alpha1,color2,Alpha2){
	...
	if(color2 == undefined){
		...
		if(color2.indexOf("rgb(")!=-1){
			R2 = parseInt(color1.substring(4,7));
			G2 = parseInt(color1.substring(8,11));
			B2 = parseInt(color1.substring(12,15));
		}
	}
	color1 = color1+"";
	if(color1.indexOf("#")!=-1){
	...
	if(color1.indexOf("rgb(")!=-1){
		R1 = parseInt(color1.substring(4,7));
		G1 = parseInt(color1.substring(8,11));
		B1 = parseInt(color1.substring(12,15));
	}
