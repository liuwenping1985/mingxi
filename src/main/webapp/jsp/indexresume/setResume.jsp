...
<fmt:setBundle
	...
	var="v3xMainI18N" />
<fmt:setBundle basename="com.seeyon.apps.nc.i18n.NCResources" var="ncRe" />
<fmt:setBundle
										...
										<table width="100%" id="autoSynchOption" border="0"
											...
											<tr>
												...
												<td align="left" style="vertical-align: bottom;"><fmt:message
														key="nc.org.auto.everyday" bundle="${ncRe }" /> <select
													name="starHour"
												...
												</select> <fmt:message key="nc.org.auto.hour" bundle="${ncRe }" /> <select
													name="starMin"
													${resumeInfo.enableState=='true'? '':'disabled'}
													id="setOption1">
												...
												</select> <fmt:message key="nc.org.auto.min" bundle="${ncRe }" /></td>
											</tr>
											<tr>
												<td nowrap="nowrap" align="right"
												...
												<td align="left"
													style="vertical-align: bottom; border-bottom: 2px solid;">
													<fmt:message key="nc.org.auto.everyday" bundle="${ncRe }" />
													<select name="endHour"
													${resumeInfo.enableState=='true'? '':'disabled'}
													id="setOption2">
												...
												</select> <fmt:message key="nc.org.auto.min" bundle="${ncRe }" />
												</td>
											</tr>
											<tr>
