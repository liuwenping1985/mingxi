...
<html>
	...
	<%@ include file="simpleheader.jsp" %>
		...
		var indexFlag = 0;
        var xTicks = [{label: "<fmt:message key='hr.statistic.oneYear.label' bundle='${v3xHRI18N}' />", v: 0},
        			  {label: "<fmt:message key='hr.statistic.oneToThreeYear.label' bundle='${v3xHRI18N}' />", v: 1},
                      {label: "<fmt:message key='hr.statistic.threeToFiveYear.label' bundle='${v3xHRI18N}' />", v: 2},
                      {label: "<fmt:message key='hr.statistic.fiveToTenYear.label' bundle='${v3xHRI18N}' />", v: 3},
                      {label: "<fmt:message key='hr.statistic.tenToFifteenYear.label' bundle='${v3xHRI18N}' />", v: 4},
                      {label: "<fmt:message key='hr.statistic.fifteenToThirty.label' bundle='${v3xHRI18N}' />", v: 5},
                      {label: "<fmt:message key='hr.statistic.ThirtyHereinbefore.label' bundle='${v3xHRI18N}' />", v: 6}
                      ];
...
<form id="statisticForm" name="statisticForm" method="post" action="${hrStatisticURL}?method=workTimeDistributing&newOrChanged=changed">
		...
		<td class="categorySet-head" height="23">
			<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td class="categorySet-title" width="80" nowrap="nowrap"><fmt:message key="hr.statistic.workTime.label" bundle="${v3xHRI18N}" /></td>
