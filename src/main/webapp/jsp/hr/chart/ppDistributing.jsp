...
<html>
	...
	<%@ include file="simpleheader.jsp" %>
		...
		var indexFlag = 0;
        var xTicks = [{label: "<fmt:message key='hr.staffInfo.position.${politicalKeys[0]}' bundle='${v3xHRI18N}' />", v: 0},
        			  {label: "<fmt:message key='hr.staffInfo.position.${politicalKeys[1]}' bundle='${v3xHRI18N}' />", v: 1}, 
        			  {label: "<fmt:message key='hr.staffInfo.position.${politicalKeys[2]}' bundle='${v3xHRI18N}' />", v: 2},
                      {label: "<fmt:message key='hr.staffInfo.position.${politicalKeys[3]}' bundle='${v3xHRI18N}' />", v: 3}
                      ];
		...
		function easyDrawGraph() {
			...
			var opts = {
   			...
   			var data1 = [[0, ${political[0]}],[1, ${political[1]}], [2, ${political[2]}], [3, ${political[3]}]];
   			if (hasCanvas) {
...
<form id="statisticForm" name="statisticForm" method="post" action="${hrStatisticURL}?method=ppDistributing&newOrChanged=changed">
		...
		<td class="categorySet-head" height="23">
			<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td class="categorySet-title" width="80" nowrap="nowrap"><fmt:message key="hr.staffInfo.position.label" bundle="${v3xHRI18N}" /></td>
