            ...
            <div id="main-table">
        		...
        		<div id='scrollborder' style='overflow:hidden; height: 26px;width:100%;padding: 0; margin: 0;float:left;'>
                    <div id="menuTabDiv" class="div-float" style="word-break:keep-all;white-space:nowrap;width: auto;">
                        ...
                        <div id="m-1" class="tab-tag-middel-sel" style="word-break:keep-all;white-space:nowrap;clear: right;width:70px;" onclick="javascript:changedType(1,this);" ><fmt:message key='hr.staffInfo.label' bundle='${v3xHRI18N}' /><input type="hidden" name="flagInput"/></div>
                        ...
                        <div id="m-2" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;width:70px;" onclick="javascript:changedType(2,this);" ><fmt:message key='hr.staffInfo.contactInfo.label' bundle='${v3xHRI18N}' /><input type="hidden" name="flagInput"/></div>
                        ...
                        <div id="m-3" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;width:70px;" onclick="javascript:changedType(3,this);" ><fmt:message key='hr.staffInfo.family.label' bundle='${v3xHRI18N}' /><input type="hidden" name="flagInput"/></div>
                        ...
                        <div id="m-4" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;width:70px;" onclick="javascript:changedType(4,this);" ><fmt:message key='hr.staffInfo.workRecord.label' bundle='${v3xHRI18N}' /><input type="hidden" name="flagInput"/></div>
                        ...
                        <div id="m-5" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;width:70px;" onclick="javascript:changedType(5,this);" ><fmt:message key='hr.staffInfo.eduAndTrain.label' bundle='${v3xHRI18N}' /><input type="hidden" name="flagInput"/></div>
                        ...
                        <div id="m-6" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;width:70px;" onclick="javascript:changedType(6,this);" ><fmt:message key='hr.staffInfo.postchange.label' bundle='${v3xHRI18N}' /><input type="hidden" name="flagInput"/></div>
                        ...
                        <div id="m-7" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;width:70px;" onclick="javascript:changedType(7,this);" ><fmt:message key='hr.staffInfo.assess.label' bundle='${v3xHRI18N}' /><input type="hidden" name="flagInput"/></div>
                        ...
                        <div id="m-8" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;width:70px;" onclick="javascript:changedType(8,this);" ><fmt:message key='hr.staffInfo.rewardsAndPunishment.label' bundle='${v3xHRI18N}' /><input type="hidden" name="flagInput"/></div>
