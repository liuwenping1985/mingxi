...
<!--
	...
	function init(){			
		document.getElementById("mainDiv").style.width=document.body.clientWidth-20;		
	}
//-->
</script>
</head>
...
<c:set value="height: 98%;" var="heightcss"></c:set>
<c:set value="display:none;" var="displays"></c:set>
<c:if test="${show}">
<c:set value="height: 60%;" var="heightcss"></c:set>
...
<div style="${displays}height: 200px;width: 100%;overflow-x:hidden;overflow-y:auto;">
