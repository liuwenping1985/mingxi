...
<table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0" class="popupTitleRight" >
	...
	<tr valign="middle">
		...
		<td class="new-column"><input type="password" width="80%" maxlength="50" id="newPassword" class="input-60per" inputName="<fmt:message key="sys.password.lable" />" name="newPassword" validate="notNull"></td>
	</tr>
