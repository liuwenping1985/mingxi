			...
			<div class="scrollList">
				<form id="salaryform" method="post">
					<v3x:table data="${pages}" var="page" leastSize="${leastSize }" htmlId="salarylist" subHeight="30">
						...
						<v3x:column width="25%" label="hr.userDefined.name.english.label" type="String" onDblClick="${Dclick}" value="${page.labelName_en}" onClick="${click}" className="cursor-hand sort" symbol="..." alt="${page.pageName_en}" maxLength="18" />
