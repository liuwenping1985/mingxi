			...
			<div class="scrollList">
				<form id="salaryform" method="post">
					<v3x:table data="${properties}" var="property" htmlId="salarylist" subHeight="30">
						...
						<v3x:column width="10%" type="String" label="hr.userDefined.notNull.label"  onDblClick="${Dclick}" onClick="${click}" className="cursor-hand sort" symbol="..." alt="${property.not_null}">
