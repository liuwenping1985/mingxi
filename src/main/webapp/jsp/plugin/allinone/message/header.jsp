...
_ = v3x.getMessage;
v3x.loadLanguage("/apps_res/plugin/nc/js/i18n");
...
<html:link renderURL="/ncOrgController.do" var="urlNCSynchron" />
<html:link renderURL="/ncFilderController.do" var="ncFilderSynchron" />    
