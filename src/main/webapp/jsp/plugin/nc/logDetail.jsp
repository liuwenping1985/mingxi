...
<title><fmt:message key="nc.org.synchron.log.detail"/></title>
</head>
...
<div class="scrollList" id="scrollListDiv">
	<form name="listForm" target="_self" id="listForm" method="get" onsubmit="return false" style="margin: 0px">
		<v3x:table data="detailList" var="detail" className="sort ellipsis">
			<v3x:column width="15%" type="String" label="nc.org.synchLog.option" className="sort" alt="${detail.action}">
				${detail.action}
			</v3x:column>
			<v3x:column width="40%" type="String" label="nc.org.synchLog.data" className="sort" alt="${detail.data}">
				${detail.data}
			</v3x:column>
			<v3x:column width="45%" type="String" label="nc.org.synchLog.desc" className="sort" alt="${detail.memo}">
				${detail.memo}
			</v3x:column>
		</v3x:table>
	</form>
