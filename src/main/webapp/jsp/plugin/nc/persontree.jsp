...
{
var  displayName="<fmt:message key='nc.user.filder.person.question'/>";
return displayName;
}
...
function  savePerson()
{
	...
	if(items==null||items.length==0)
	{
	   alert("<fmt:message key='nc.user.filder.title.person'/>");
	   return;
	}
...
window.onload = function(){
		...
		function deleteFilderPerson(ncorgCorp,pk_psndoc)
	{
          try
          {
			...
			{
			//alert("<fmt:message key='nc.user.filder.person.success'/>");
			}
          }catch(ex1)
          {
          alert("Exception : " + ex1);
		...
		<table width="100%" height="100%" border="0"
			...
			<tr align="center">
				...
				<td align="left" class="PopupTitle">
					<fmt:message key='nc.user.filder.title.person'>
					</fmt:message>
				</td>
			</tr>
			<tr>
