  ...
  <div class="right_div_row2">
					...
					<div class="div-float">
				  	...
				  	<div id="importantLevelDiv" class="div-float hidden">
				  		<select name="importantLevel" class="textfield" id="importantLevel">
				  			...
				  			<option value="require" ${importantLevel == 'require'?'selected':''}><fmt:message key="nc.org.synchron.type.require"/></option>
				  		</select>	
				  	</div>
    ...
    <div class="center_div_row2" id="scrollListDiv">
    	<form name="listForm" id="listForm" method="post" onsubmit="return false">
				...
				<v3x:column width="8%" type="String" label="nc.org.synchron.synType" className="sort">
					<fmt:message key="nc.org.synchron.synType.${synchLog.synType}"/>
				</v3x:column>
				<v3x:column width="8%" type="String" label="nc.org.synchron.type" className="sort">
					<fmt:message key="nc.org.synchron.type.${synchLog.opType == 0?'auto':(synchLog.opType == 1 ? 'hand':'require')}"/>
				</v3x:column>
				<v3x:column width="15%" type="String" label="nc.org.auto.time" className="sort">
					<fmt:formatDate value="${synchLog.dt}" pattern="yyyy-MM-dd HH:mm:ss" />
				</v3x:column>
				<v3x:column width="5%" type="Integer" label="nc.org.synchron.sucess" className="sort">
                    ${synchLog.oknum}
                </v3x:column>
                <v3x:column width="5%" type="Integer" label="nc.org.synchron.fail" className="sort">
                    <c:choose>
				...
				<v3x:column width="10%" label="nc.org.synchron.log.detail" className="cursor-hand like-a sort">
					<a href="javascript:openDetailWin('${synchLog.id}')"><fmt:message key="nc.org.synchron.log.detail.${synchLog.synType}" /></a>
				</v3x:column>
				</v3x:table>
				</form>
    </div>
