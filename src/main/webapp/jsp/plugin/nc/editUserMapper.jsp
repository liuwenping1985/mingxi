...
<script type="text/javascript">
	...
	function submitForm(){
        ...
        if(flag==true){
        	alert('<fmt:message key="nc.user.mapper.depulyname"/>');
            return;
        }
        var ncBusinessCodes = "";
  ...
  <tr valign="top">
    ...
    <fieldset style="width:95%;border:0px;" align="center">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
			...
			<tr>
			  	<td class="bg-gray" width="25%" nowrap="nowrap"><fmt:message key="nc.user.mapper.shareBinding"/>:</td>
				<td class="new-column" width="75%" nowrap="nowrap">
			...
			<tr>
				...
				<td class="new-column" width="75%" nowrap="nowrap"><font color="#008000"><fmt:message key="nc.user.account.label"/>
				<c:if test="${ncbusinessEnable == 'true' }"><fmt:message key="nc.user.account.business.label"/></c:if>
				</font></td>
			</tr>
			<fmt:setBundle basename="com.seeyon.v3x.organization.resources.i18n.OrganizationResources"/>
		</table>
