...
<head>
    ...
    <script type="text/javascript">
        var menus=[
            ...
            {name:"${ctp:i18n('system.menuname.dataSource')}", url:"/deeDataSourceController.do?method=dataSourceFrame"}
        ];
        var listTable;
...
<div id='layout'>
    ...
    <div class="layout_center over_hidden" id="center">
        ...
        <div id="grid_detail" class="h100b">
            <iframe id="dataSourceDetail" name="dataSourceDetail" width="100%" height="100%" frameborder="0" class='calendar_show_iframe' style="overflow-y:hidden"></iframe>
        </div>
    </div>
</div>
