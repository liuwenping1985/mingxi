...
<html:link renderURL="/orgSyncController.do" var="urlNCSynchron" />
<html:link renderURL="/orgSyncController.do" var="ncFilderSynchron" />    
...
<fmt:setBundle basename="com.seeyon.apps.orgsync.i18n.OrgSyncResources"/>
