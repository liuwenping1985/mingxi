				...
				<table width="100%" border="0">
				  <tr>
					<td width="100%" align="center">
						<input id="submintConfig" type="button" onclick="submitForm(1)" ${v3x:outConditionExpression(edit == "1", 'disabled', '')} value="<fmt:message key='nc.org.hand.save.list'/>" class="button-default-2">
