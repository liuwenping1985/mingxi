...
<title><fmt:message key='nc.org.synchron.hand.org' /></title>
<script type="text/javascript">
	   //getA8Top().showLocation(null, "<fmt:message key='nc.org.synchron' />", "<fmt:message key='nc.org.synchron.hand.org' />");
	   getA8Top().endProc();
