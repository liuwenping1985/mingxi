...
<table  width="90%" height="100%" border="0" cellspacing="0" cellpadding="0"  align="center">
	...
	<tr>
		<td class="bg-gray"  nowrap="nowrap"><label for="person.sortId"><fmt:message key="nc.org.user.type" />:</label></td>
		<td class="new-column" nowrap="nowrap">
		<label for="incremental">
        	...
        	<fmt:message key="nc.org.hand.incremental"/>
            </label>
        	<label for="full">
            ...
            <fmt:message key="nc.org.hand.all"/>
        </label>
		</td>
	</tr>
	<tr>
		...
		<td class="new-column" width="75%" nowrap="nowrap">
			<font color="#008000"><fmt:message key="nc.org.user.desc" /></font>
		</td>
