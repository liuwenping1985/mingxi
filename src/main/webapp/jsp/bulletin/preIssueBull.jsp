...
function OK(){
	...
	result = [ scopePeople , selectedValue , allowPrintStr , toPDFStr , noteCallInfo , showPublishUserFlag];
...
<table class="popupTitleRight" width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td height="20" class="PopupTitle"><fmt:message key="bulletionaudit.space" bundle='${v3xCommonI18N}' />:</td>
	</tr>
	<tr>
		<td class="bg-advance-middel">
			<div style="border: solid 1px #666666;  overflow-y:auto; height:332px">
