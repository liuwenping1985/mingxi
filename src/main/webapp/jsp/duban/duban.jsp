...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        ...
        <button class="layui-btn layui-btn-sm xad_filter_btn " lay-event="getApprovingTask" lay-data="duban">审批(签收)中</button>
...
<script type="text/html" id="barDemo2">
    <a class="layui-btn layui-btn-xs" lay-event="pishi">批示</a>
</script>
...
<script type="text/javascript" src="/seeyon/apps_res/duban/js/dubanTask.js"></script>
