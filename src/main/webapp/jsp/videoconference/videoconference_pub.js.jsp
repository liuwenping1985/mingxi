 ...
 */
function joinVideoconference(joinType, confKey, meetingPassword, failureUrl) {
    //如果视频会议系统瘫痪
    ...
    if(joinType == "1"){
        dataForm.action = "${videoconfURL}?method=startVideoMeeting";
    } else if(joinType == "2"){
        dataForm.action = "${videoconfURL}?method=joinVideoMeeting";
    }
