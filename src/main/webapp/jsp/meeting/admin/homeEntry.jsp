...
-->	
 	<tr>
		<td class="page-list-border">
			<iframe src="${mtContentTemplateURL}?method=listMain" noresize="noresize" frameborder="no" id="detailIframe" name="detailIframe" style="width:100%;height: 100%;" border="0px"></iframe>					
		</td>
	</tr>
</table>
</body>
