...
<form id="dataForm" name="dataForm" action="${meetingSummaryURL}" method="post" class="h100b">
...
<tr class="bg-summary">
	...
	<td rowspan="3" width="1%" nowrap="nowrap" class="border-left">
		<a href="javascript:void(0)" id='send' onClick="toSend('${hasNoSaveBtn?'save':'send'}')" class="margin_lr_10 display_inline-block align_center new_btn">${sendBtn }</a>
	</td>
...
<tr class="bg-summary">
	...
	<c:if test="${hasMeetingType }">
		<th nowrap="nowrap" align="right">
			<div class="padding_r_5">${meetingCategory }${colonLabel }</div>
		</th>
		<td>
		<div class="common_txtbox_wrap">
