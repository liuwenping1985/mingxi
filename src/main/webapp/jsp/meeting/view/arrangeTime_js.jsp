...
function initPersonTab() {
	...
	divTab = '<li class="current"><a index="0" id="${CurrentUser.id}" hideFocus="true" style="border-left: 1px solid #B6B6B6; border-right: 1px solid #B6B6B6;border-top: 1px solid #B6B6B6;" href="javascript:void(0)" onClick="changePersonTab(this.id)" title="${CurrentUser.name}">'+name+'</a></li>';
	middleTab += divTab;
