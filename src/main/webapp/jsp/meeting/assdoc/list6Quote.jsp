...
<script type="text/javascript" src="${path}/ajax.do?managerName=meetingManager"></script>
...
$(document).ready(function () {
	...
	function render(text, row, rowIndex, meetingIndex, meeting){
		...
		if(meeting.name=="title") {
			...
			//视频会议图标
			if(row.mtMeeting.meetingType ==  '2'){
    ...
    <div id='layout'>
        <div class="layout_north bg_color" id="north">
            <div class="common_radio_box clearfix" style="padding-top: 8px;">
                <label for="pendingC" class="resCode margin_r_10 hand" resCode="F09_meetingPending">
                ...
                <label for="doneC" class="resCode margin_r_10 hand" resCode="F09_meetingDone">
