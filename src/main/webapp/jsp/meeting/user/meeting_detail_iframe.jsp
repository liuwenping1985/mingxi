...
<frameset rows="0,*" cols="*" framespacing="0" frameborder="no" border="0" scrolling="no" id="df">
  ...
  <frameset  rows="*" cols="*,50" framespacing="0" id="zy">
    ...
    <frame frameborder="no" src="${mtMeetingURL}?method=showMtDiagram&id=${id}&fisearch=${fisearch}&fagent=${fagent}&fromdoc=${param.fromdoc}&proxy=${proxy}&proxyId=${proxyId}&eventId=${param.eventId}&isQuote=${param.isQuote}&openfrom=${param.openfrom}&baseObjectId=${param.baseObjectId}&category=${param.category}&isImpart=${isImpart}" name="detailRightFrame" scrolling="no" id="detailRightFrame" />
  </frameset>
</frameset>
<noframes>
<body scroll="no">
