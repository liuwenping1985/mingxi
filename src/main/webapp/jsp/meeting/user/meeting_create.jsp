...
function showMTRoom(){
    ...
    var retObj = window.showModalDialog("${mrUrl}?method=mtroom&returnMr="+returnMr+"&action="+action+"&meetingId="+meetingId+"&date="+new Date(),self,"dialogHeight: "+h1+"px; dialogWidth:"+w+"px;dialogTop:"+t+";dialogLeft: "+l+";center: yes;help:no; status=no");
