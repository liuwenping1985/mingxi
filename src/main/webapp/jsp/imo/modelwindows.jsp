...
function deleall(){
	if(document.getElementById("isDelAllDate").checked)
	{
      alert('<fmt:message key="org.synchron.delstart" />');
	}
}
</script>
</head>
<body>
	<table class="sort manage-stat-1" width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
		  <tr>
		    <td width="20%" align="left" nowrap="nowrap"><input type="checkbox" id="isDelAllDate" name="isDelAllDate" onclick="deleall()"><fmt:message key="org.synchron.del.data" /></td>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;<input type="button" id="startSynchron" name="startSynchron" value="<fmt:message key="org.synchron.startwindow" />" class="button-default-2" onclick="showSendResult()">
		    </td>
		    <td width="45%"></td>
		  </tr>
		</table>
