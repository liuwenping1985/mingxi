...
getA8Top().hiddenNavigationFrameset();
		function chang(index){			
			...
			if(index == 1){
			    document.mainframe.location.href ="${imoURL}?method=framesetThree";
			}else if(index == 2){
			    document.mainframe.location.href="${imoURL}?method=frame";
			}
		}
</script>
</head>
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td class="tab-body-bg" style="margin: 0px;padding:0px">
			<iframe frameborder="0" src="${imoURL}?method=framesetThree" id="mainframe" name="mainframe" style="width:100%;height: 100%;" border="0px"></iframe>			
		</td>
	</tr>
</table>
</body>
