...
<script type="text/javascript">
		getA8Top().showLocation(null,"<fmt:message key='org.synchron.imo'/>","<fmt:message key='org.synchron.autotimeset'/>");
	</script>
<script type="text/javascript">
	function cancel(){
		document.location.href = "${imoURL}?method=showAccountState";
	}
	function startAutoSyn()
		...
		for(var i = 0 ; i < enable.length; i++){
		  ...
		  var requestCaller = new XMLHttpRequestCaller(this, "ajaxIMOSynchronController", "startAutoSynchron",false);
