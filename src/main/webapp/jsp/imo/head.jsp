...
<fmt:setBundle basename="com.seeyon.v3x.imo.resource.i18n.IMOSynchronResources"/>
<html:link renderURL="/imo.do" var="imoURL"/>
...
var imoURL = "<html:link renderURL='/imo.do' />";
</script>
