...
<v3x:selectPeople id="surrogate" panels="Department" selectType="Member" departmentId="${v3x:currentUser().departmentId}" 
	jsFunction="dataToSurrogate(elements)" maxSize="1" showMe="false" />
...
<tr>
	...
	<td class="new-column" width="80%" id="agentOptionTD" align="left">
        <div>
		<label for="edoc" class="margin_r_10" style="display : ${((v3x:hasPlugin('edoc'))&&(v3x:getSysFlagByName('edoc_notShow') == 'false'))  ? '' : 'none'}" >
