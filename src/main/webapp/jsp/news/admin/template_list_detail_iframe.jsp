	...
	<tr>
		<td height="10" class="detail-summary">
			<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
				<tr>
					<td width="90" height="28" nowrap class="subjectView" align="right"><fmt:message key="news.template.templateName" /><fmt:message key="label.colon" /></td>
