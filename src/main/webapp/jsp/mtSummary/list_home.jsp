	...
	<tr>
		<td valign="bottom" height="26" class="tab-tag">
			<div id="menuTabDiv" class="div-float">
				...
				<%-- 待记录的会议纪要 --%>
				<span class="resCode" resCode="F09_mtSummaryCreate">
				...
				<%-- 草稿箱 --%>
				<span class="resCode" resCode="F09_mtSummaryWatiSend">
				...
				<%-- 会议纪要 --%>
				<span class="resCode" resCode="F09_mtSummaryPublish">
				...
				<%-- 我审核的会议纪要 --%>
				<span class="resCode" resCode="F09_mtSummaryPerm">
					<% if(com.seeyon.v3x.meeting.contants.MeetingConfig.HAS_MEETING_SUMMARY_PERM) { %>
						<div class="tab-separator"></div>
