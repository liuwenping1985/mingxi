...
<table bgcolor="#ffffff" style='width: 250px; height: 100px; border: 0px' >
	...
	<tr>
		<td height="42" align="right" class="bg-advance-bottom">
			<input type="button" onclick='submitMenuDiv();' value="<fmt:message key='common.button.ok.label' bundle='${v3xCommonI18N}' />" class="button-default-2">&nbsp;
						...
						<td>
							<div class="float-right" id="specialDaySyncDiv" style="display: none;">
								<form id='specialDaySyncForm'>
									...
									<input type="button" onclick='submitSyncSpecialDateDiv();' value="<fmt:message key='common.button.ok.label' bundle='${v3xCommonI18N}' />" class="button-default-2">&nbsp;
								</form>
							</div>
						</td>
					</tr>
				...
				<div>
					<table width="100%">
						<tr>
							...
							<input type="submit" id="submitBtn" class="button-default-2" value="<fmt:message key='mr.button.set'/>"
