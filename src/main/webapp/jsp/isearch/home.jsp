                                            ...
                                            <table id="tab1" width="100%" height="100%" border="0" class="noWrap">
                                                <tr>
                                                    ...
                                                    <td width="38%" nowrap="nowrap">
                                                        ...
                                                        <select onchange="onChangeAppType(this)" id="condition" name="condition" style="width:200px">
                                                    ...
                                                    <td width="38%" nowrap="nowrap"><input type="text" name="beginDate" id="beginDate"  style="width:90px"  class="input-date" onclick="whenstart('${pageContext.request.contextPath}',this,575,140);" readonly >
                                                        <fmt:message key="isearch.jsp.home.to" bundle="${isearchI18N}"/>
                                                        <input type="text" name="endDate" id="endDate" class="input-date" style="width:90px"  onclick="whenstart('${pageContext.request.contextPath}',this,675,140);" readonly ></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" nowrap="nowrap"><fmt:message key="common.subject.label" bundle="${v3xCommonI18N}"/>:</td>
                                                    <td nowrap="nowrap"><input type="text" name="title" id="title"  style="width:200px" 
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="" align="right" id="key1"><fmt:message key="doc.metadata.def.keywords"/>:</td>
                                                    <td width="" id="key2"><input type="text" name="keywords" id="keywords" validate="maxLength" inputName="<fmt:message key='doc.metadata.def.keywords'/>" maxSize="60" style="width:200px" disabled="disabled" /></td>
                                                </tr>
                                                <tr>
                                                    <td  align="center" colspan="4"><input  type="submit" class="deal_btn" onmouseover="javascript:this.className='deal_btn_over'" onmouseout="javascript:this.className='deal_btn'" name="b1" id="b1" onClick="isdefault()" value="<fmt:message key="isearch.jsp.home.search" bundle="${isearchI18N}"/>"   class="button-default-2"></td>
                                                </tr>
                                            </table>
                                            </form>
                                        </td>
