						    ...
						    <div class="scrollList">
						  		<form>
									<v3x:table htmlId="projectComposeList"  data="${projectComposeList}" var="projectCompose" pageSize="20" showHeader="true" showPager="true" size="1" subHeight="70">
								    		...
								    		<v3x:column align="left" width="30%" label="project.body.projectName.label"className="sort" maxLength="20" alt="${v3x:toHTML(projectCompose.projectSummary.projectName)}" symbol="...">    									
								    			<a onClick="forwardProjectSpace('${projectCompose.projectSummary.id}')" class="title-more">${v3x:toHTML(projectCompose.projectSummary.projectName)}</a>			
								    		</v3x:column>
								    		...
								    		<v3x:column label="project.body.responsible.label" value="${v3x:showOrgEntities(projectCompose.principalLists, 'id', 'entityType', pageContext)}" width="15%" className="sort" maxLength="15" alt="${v3x:showOrgEntities(projectCompose.principalLists, 'id', 'entityType', pageContext)}" symbol="...">
											</v3x:column>
