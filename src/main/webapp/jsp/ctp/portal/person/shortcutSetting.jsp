...
<body class="h100b over_auto page_color_write align_center" style="background:#fafafa;">
    <fieldset class="shortcut_set" style="border:none;padding:0;">
        <legend style="margin:0 auto;">${ctp:i18n('personalSetting.shortcut.setting')}&nbsp;&nbsp;<span class="color_gray">(${ctp:i18n("short.jsp.sort.opera")})</span></legend>
        <table id="selectTable" width="60%" height="100%" align="left" style="margin-left: 100px;">
