...
<body class="h100b over_hidden">
    <div id="personalSet" class="stadic_layout">
        ...
        <div class="stadic_layout_footer stadic_footer_height align_center ${fn:indexOf(targetURL,'hrViewSalary.do') > -1 ? 'hidden' : ''}" id="btn">
            <div class="border_tb padding_tb_5">
                ...
                <a href="javascript:void(0)" id="toDefaultBtn" class="common_button common_button_gray" style="color:#ffffff; background-color: #99948c">${ctp:i18n('space.button.toDefault')}</a>  
                <a href="javascript:void(0)" id="cancelbtn" class="common_button common_button_gray" style="color:#ffffff; background-color: #99948c">${ctp:i18n("common.button.cancel.label")}</a>
            </div>
        </div>
    </div>
</body>
