...
$().ready(function(){
   var enabled = ${enabled};
  if(enabled == 0){
    $('#unbind_cloudapp').hide();
    $('#bind_cloudapp').hide();
  } else{
    var isBind = ${isBind};
    if(isBind == true){
      $('#unbind_cloudapp').show();
      $('#bind_cloudapp').hide();
    }else{
      $('#unbind_cloudapp').hide();
      $('#bind_cloudapp').show();
  ...
  $('#unbind_cloudapp').bind('click' , function(){
    $.ajax({
      url : '/seeyon/portal/portalController.do',
      type : 'POST',
      sync : true,
      data : {
        method : 'del'
...
function showCurrentHref(obj,url,bool,isShow){
    if(isShow){
...
<style type="text/css">
    .li_t{
        ...
        <div class="list_ul" id="list_ul">
            ...
            <div class="li_t">
                ...
                <div class="set_content">
                    <table class="div_t" align="center" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <!-- 个人模板设置 -->
                        <tr>
                            <td class="file_name" onclick="showCurrentHref(this,'/mytemplate.do?method=myTemplate&type=col',false,true)">${ctp:i18n('menu.individual.template.set')}</td>
                        </tr>
                        <!-- 消息提示设置 -->
                        <tr>
            ...
            <div class="li_t">
                ...
                <div class="set_content">
                    <table class="div_t" align="center" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr id="unbind_cloudapp">
							<!--
                            <td class="file_name">云应用中心解绑</td>
							-->
							<td class="file_name">${ctp:i18n('cloudapp.unbind.label') }</td>
                        </tr>
                        <tr id="bind_cloudapp">
							<!--
                            <td class="file_name" onclick="openCurrentHref(this,'/cloudapp.do',false,true)">云应用中心集成</td>
							-->
							<td class="file_name" onclick="openCurrentHref(this,'/cloudapp.do',false,true)">${ctp:i18n('cloudapp.bind.label') }</td>
						</tr>
            ...
            <div class="li_t">
                ...
                <div class="set_content">
                    <table class="div_t" align="center" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <!-- 薪资查看 -->
                        <c:if test ="${(v3x:getSysFlagByName('hr_showSalary') == 'true')}">
	                        <tr>
                        ...
                        <c:if test="${cardEnabled == true }">
                            <tr>
                                <td class="file_name" onclick="showCurrentHref(this,'/hrRecord.do?method=initRecord',false,true)">${ctp:i18n('menu.hr.personal.attendance.manager')}</td>
                            </tr>
                        </c:if>
                    </table>
                </div>
            ...
            <!-- 栏目设置 -->
            <div class="li_t">
                <div id="space_setting" class="set_page_4" > </div>
                <div class="set_content">
                    <table class="div_t" align="center" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="title">${ctp:i18n('portal.space.setting')}</td>
                        </tr>
                        <!-- 空间栏目 -->
                        <tr>
                            <td class="file_name" onclick="showCurrentHref(this,'/portal/spaceController.do?method=showSpacesSetting',true,true)">${ctp:i18n('menu.space.setting')}</td>
                        </tr>
                        <!-- 主题栏目 -->
                        <c:if test="${ctp:getSystemProperty('portal.themSpaceFlag')}">
                            <tr id="themSpaceSetting">
                                <td class="file_name" onclick="showCurrentHref(this,'/portal/spaceController.do?method=showThemSpacesSetting',true,true)">${ctp:i18n('portal.them.navigationConfig.label')}</td>
                            </tr>
                        </c:if>
                    </table>
                </div>
            ...
            <div class="li_t">
                ...
                <div class="set_content">
                    <table class="div_t" align="center" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="title">${ctp:i18n('menu.personalSet.PortalSet')}</td>
                        </tr>
                        <!-- 菜单设置 -->
                        <tr id="a_showMenuSetting">
                            <td class="file_name" onclick="showCurrentHref(this,'/portal/portalController.do?method=showMenuSetting',true,true)">${ctp:i18n('personalSetting.menu.label')}</td>
                        </tr>
                        <!-- 快捷设置 -->
                        <tr id="a_showShortcutSet">
                            <td class="file_name" onclick="showCurrentHref(this,'/portal/portalController.do?method=showShortcutSet',true,true)">${ctp:i18n('personalSetting.shortcut.label')}</td>
                        </tr>
                        <!-- 空间导航设置 -->
                        <tr>
                            <td class="file_name" onclick="showCurrentHref(this,'/portal/portalController.do?method=showSpaceNavigation',true,true)">${ctp:i18n('menu.space.navigationConfig')}</td>
                        </tr>
                        <c:if test="${productId != 'a6s'}">
                            <!-- 首页模板设置
                            <tr>
                                <td class="file_name" onclick="showCurrentHref(this,'/portal/portalTemplateController.do?method=portalTemplateMainV51',false,true)">${ctp:i18n('portal.skin.set')}</td>
                            </tr>
                            -->
                        </c:if>
                    </table>
                ...
                <div class="set_content">
                    <table class="div_t" align="center" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <c:if test="${personModifyPwd}">
                            <tr>
                                <td class="file_name" onclick="showCurrentHref(this,'/individualManager.do?method=managerFrame',true,true)">${ctp:i18n('menu.login.pwd.modify')}</td>
                            </tr>
                        </c:if>
                        <!-- 印章密码管理 -->
                        ...
                        <!-- 查看存储空间 -->
                        <tr>
                            <td class="file_name" onclick="showCurrentHref(this,'/docSpace.do?method=storeSpaceLook',true,true)">${ctp:i18n('personalInfo.storeSpace.look')}</td>
                        </tr>
                    </table>
                </div>
            </div>
