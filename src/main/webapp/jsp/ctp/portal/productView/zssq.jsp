        ...
        function changeImgUrl(option) {
            ...
            switch (obj.attr("alt")) {
                ...
                case "关闭按钮":
                    ...
                    break;
                case "进入主题":
                    if("${ctp:hasResourceCode('F04_showKnowledgeNavigation')}" == "true"){
                        getCtpTop().gotoDefaultPortal();
                        productTop.showMenu("${path}/doc/knowledgeController.do?method=personalKnowledgeCenterIndex&openFlag=docRead");
                        productTop.productView_Obj.close();
                        productTop.productView_Obj = null;
                    }else{
...
<body class="over_hidden">
    <img id="map" usemap="#map" src="${path}/skin/${CurrentUser.skin}/images/productView/zssq.jpg">
