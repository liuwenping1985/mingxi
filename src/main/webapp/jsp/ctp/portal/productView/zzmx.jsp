        ...
        function changeImgUrl(option) {
            ...
            switch (obj.attr("alt")) {
                ...
                case "关闭按钮":
                    ...
                    break;
                case "进入主题":
                    if("${ctp:hasPlugin('hr') && ctp:hasResourceCode('F03_hrOrgMgr')}" == "true"){
                        getCtpTop().gotoDefaultPortal();
                        productTop.showMenu("${path}/hrOrgMgr.do?method=orgMgrHome");
                        productTop.productView_Obj.close();
                        productTop.productView_Obj = null;
                    }else{
...
<body class="over_hidden">
    <img id="map" usemap="#map" src="${path}/skin/${CurrentUser.skin}/images/productView/zzmx.jpg">
