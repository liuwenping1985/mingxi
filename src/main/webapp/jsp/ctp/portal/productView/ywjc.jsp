        ...
        function changeImgUrl(option) {
            ...
            switch (obj.attr("alt")) {
                ...
                case "关闭按钮":
                    ...
                    break;
                case "进入主题":
                    if("${ctp:hasResourceCode('T03_linkSystemView')}" == "true"){
                        getCtpTop().gotoDefaultPortal();
                         productTop.showMenu("${path}/portal/linkSystemController.do?method=linkSystemMore&doType=0");
                        productTop.productView_Obj.close();
                        productTop.productView_Obj = null;
                    }else{
...
<body class="over_hidden">
    <img id="map" usemap="#map" src="${path}/skin/${CurrentUser.skin}/images/productView/ywjc.jpg">
