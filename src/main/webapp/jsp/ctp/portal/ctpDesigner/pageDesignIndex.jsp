...
<title>首页设计</title>
<script type="text/javascript" charset="UTF-8" src="${path}/common/designer/js/pageDesignIndex.js${ctp:resSuffix()}"></script>
<script type="text/javascript" src="${path}/ajax.do?managerName=pageLayoutManager"></script>
<script type="text/javascript">
    var portalContextPath= "${path}";
	$(function(){
		//初始化toolbar
		initToolbar();
		//初始化查询
...
<body>
    <div id='layout' class="comp page_color" comp="type:'layout'">
    	<div class="comp" comp="type:'breadcrumb',code:'T3_pageDesign'"></div>
