...
<title>首页设计</title>
<script type="text/javascript" charset="UTF-8" src="${path}/common/designer/js/loginDesignIndex.js${ctp:resSuffix()}"></script>
...
<body>
    <div id='layout' class="comp page_color" comp="type:'layout'">
    	<div class="comp" comp="type:'breadcrumb',code:'T3_loginDesignIndex'"></div>
