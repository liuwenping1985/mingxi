...
<style type="text/css">
#systemMenuTree {width:300px;height:500px;overflow-y:auto;overflow-x:auto;}
</style>
  ...
  new portalSYSMenuManager().getPortalSYSMenus({
    success : function(portalSYSMenus){
      if(portalSYSMenus){
        ...
        $("#systemMenuTree").width($("#shortcut_set").width());
      }
    }
  });
}
...
<body style="h100b over_hidden page_color_write align_center">
    <div class="comp" comp="type:'breadcrumb',code:'T03_portalSYSMenuSort'"></div>
    <fieldset id="shortcut_set" class="shortcut_set" style="margin-bottom:5px;">
