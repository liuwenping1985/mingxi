        ...
        <tr>
            <td>
                <fieldset style="margin-left:32px;margin-right:30px" class="form_area padding_5 margin_t_5">
                    <legend>&nbsp;${ctp:i18n('form.trigger.automatic.billtarget.label')}&nbsp;
                    </legend>
                                                ...
                                                <tr>
                                                        ...
                                                        <td width="400" class="padding_t_10">
                                                            <div class="common_txtbox clearfix">
                                                                <div  class="w100b" style="border-style: none;white-space:pre-wrap " readonly="readonly" disabled="disabled">${targetData}</div>
                                                            </div>
                                                        </td>
                                                </tr>
                                            </table>
