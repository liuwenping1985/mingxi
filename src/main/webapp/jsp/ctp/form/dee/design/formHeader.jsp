...
<fmt:setBundle
	basename="com.seeyon.ctp.form.i18n.FormResources" />

<fmt:message key="common.datetime.pattern" var="datetimePattern"
	bundle="${v3xCommonI18N}" />
<fmt:message key="common.date.pattern" var="datePattern"
	bundle="${v3xCommonI18N}" />
...
<html:link renderURL="/dee/deeTrigger.do" var="triggerURL" />
<link rel="STYLESHEET" type="text/css"
	href="<c:url value="/apps_res/form/css/form.css${v3x:resSuffix()}" />">
<link rel="stylesheet" type="text/css"
	href="<c:url value="/common/css/default.css${v3x:resSuffix()}" />">

<link rel="STYLESHEET" type="text/css"
	href="<c:url value="/apps_res/form/css/tableselect.css${v3x:resSuffix()}" />">
<script type="text/javascript"
	src="<c:url value="/apps_res/form/css/tableselect.js${v3x:resSuffix()}" />"></script>
