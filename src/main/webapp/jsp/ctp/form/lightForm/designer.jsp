...
<div class="form_layout">
    <div class="form_top">
        <ul>
            <li class="li_active">表单设计</li>
        </ul>
    </div>
    <div class="form_left">
        <p>表单控件库</p>
        <div class="form_left_content">
            <p class="contents_type plan_model">格式控件</p>
    ...
    <div class="form_right">
        ...
        <div class="form_right_content">
            ...
            <div class="contents_content apply_model_right ele_hide">
                ...
                <div>
                    <h3>【菜单按钮权限设置】</h3>
                    <p><input type="checkbox"/>新建</p>
                    <p><input type="checkbox"/>修改</p>
                    <p><input type="checkbox"/>删除</p>
                </div>
                <div>
                    <h3>【菜单重命名设置】</h3>
                    <p class="apply_set_p">新建<input type="text" /></p>
                    <p class="apply_set_p">修改<input type="text" /></p>
                </div>
                <div class="apply_font_set">
                    <h3>【字段设置】</h3>
                    <p><input type="button" value="列表字段设置"/></p>
                    <p><input type="button" value="排序字段设置"/></p>
                    <p><input type="button" value="查询字段设置"/></p>
                </div>
                <div class="clearFlow">
