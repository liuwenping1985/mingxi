    ...
    <tr>
        <td height="35">
	     ...
	     <div class="clearfix">
	       ...
	       <div class="left" style="text-align: right;margin-top: 5px"><font color='red' size="2">${ctp:i18n('form.create.manualcannotinput.label')}</font></div>
	     </div>
...
function OK(){
	...
	if(_fieldType == "DECIMAL"){
		...
		if(hv && hv.indexOf(".") > -1){
			...
			if(getLength($("#data_datavalue").val()) > parseInt($(":selected","#select2").attr("fieldLength"))){
				$.alert("${ctp:i18n('form.designauth.defaultvalue.overlength')}");
				return "error";
			}
		}
	...
	ffMap[fieldName+"_isInitNull"] = $("input[name='isInitNull_']:checked").val();
	return ffMap;
}
