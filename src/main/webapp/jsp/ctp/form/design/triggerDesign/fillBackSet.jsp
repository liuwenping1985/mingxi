            ...
            <td>
                <fieldset class="form_area padding_5 margin_t_5 margin_lr_10">
                    ...
                    <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="5%"></td>
                            <td align="right" width="13%">${ctp:i18n('form.source.label')}：</td>
                            <td width="32%" title="${fromFormBean.formName}">${ctp:getLimitLengthString(fromFormBean.formName, 20, '...')}</td>
                            <td align="right" width="18%">${ctp:i18n('form.target.label')}：</td>
                            <td width="27%" title="${toFormBean.formName}">${ctp:getLimitLengthString(toFormBean.formName, 20, '...')}</td>
                            <td width="5%"></td>
                        </tr>
                        <tr height="5">
                            <td colspan="6">
                        ...
                        <table id="dataTable" border="0" cellspacing="0" cellpadding="0" width="430" align="center" style="overflow: auto;">
                            <tr height="22">
                                <td width="35%" height="20">
                                    <select style="width: 130px" id="fromField" name="fromField" onchange="">
                                ...
                                <td width="35%">
                                    <select style="width: 130px" id="toField" name="toField" onchange="">
                                        <option value="">${ctp:i18n('form.trigger.triggerSet.fillback.select')}</option>
                                        <c:forEach items="${toFormFields}" var="field">
                                            <option value="${field.ownerTableName}.${field.name}" tablename="${field.ownerTableName}" inputtype="${field.inputType}" fieldtype="${field.fieldType}" title="${field.display}" isMaster="${field.masterField}"><c:if test="${field.masterField}">[${ctp:i18n('form.base.mastertable.label')}]</c:if><c:if test="${!field.masterField}">[${ctp:i18n('formoper.dupform.label')}${field.extraMap.subTableIndex}]</c:if>${field.display}</option>
                                        </c:forEach>
                    ...
                    <fieldset class="form_area padding_5 margin_t_5 margin_lr_10">
                        ...
                        <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="5%"></td>
                                <td align="right" width="13%">${ctp:i18n('form.source.label')}：</td>
                                <td width="32%">${fromFormBean.formName}</td>
                                <td align="right" width="18%">${ctp:i18n('form.target.label')}：</td>
                                <td width="27%">${toFormBean.formName}</td>
                                <td width="5%"></td>
                            </tr>
                            <tr height="5">
                                <td colspan="6">
                        ...
                        <div style="height: 125px;overflow: auto;">
                            <table id="dataTable1" border="0" cellspacing="0" cellpadding="0" width="430" align="center" style="overflow: auto;">
                                <tr height="22">
                                    <td width="35%" height="20">
                                        <select style="width: 130px" id="fromField1" name="fromField1" onchange="">
                                            <option value="">${ctp:i18n('form.trigger.triggerSet.fillback.select')}</option>
                                            <c:forEach items="${fromFormFields}" var="field">
                                                <option value="${field.ownerTableName}.${field.name}" tablename="${field.ownerTableName}" inputtype="${field.inputType}" fieldtype="${field.fieldType}" title="${field.display}" isMaster="${field.masterField}"><c:if test="${field.masterField}">[${ctp:i18n('form.base.mastertable.label')}]</c:if><c:if test="${!field.masterField}">[${ctp:i18n('formoper.dupform.label')}${field.extraMap.subTableIndex}]</c:if>${field.display}</option>
                                            </c:forEach>
                                    ...
                                    <td width="35%">
                                        <select style="width: 130px" id="toField1" name="toField1" onchange="">
                                            <option value="">${ctp:i18n('form.trigger.triggerSet.fillback.select')}</option>
                                            <c:forEach items="${toFormFields}" var="field">
                                                <option value="${field.ownerTableName}.${field.name}" tablename="${field.ownerTableName}" inputtype="${field.inputType}" fieldtype="${field.fieldType}" title="${field.display}" isMaster="${field.masterField}"><c:if test="${field.masterField}">[${ctp:i18n('form.base.mastertable.label')}]</c:if><c:if test="${!field.masterField}">[${ctp:i18n('formoper.dupform.label')}${field.extraMap.subTableIndex}]</c:if>${field.display}</option>
                                            </c:forEach>
                                    ...
                                    <td width="15%">
                                        <span id="del1" class="ico16 revoked_process_16 repeater_reduce_16"></span>
                                        <span id="add1" class="ico16 repeater_plus_16"></span>
                                    </td>
                                </tr>
                            </table>
                        </div>
