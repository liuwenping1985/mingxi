...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            var selectModuleType = '${moduleType}';
            function OK(param){
                ...
                o.moduleType = selectModuleType;
                return o;
          }

            function selectTemplate(node){
                $("#selectColumns option").remove();
                selectModuleType = node.data.moduleType;
	       ...
	       <table>
            ...
            <tr height="170">
                ...
                <td width="270" style="text-align: center;">
                    <div id="allColumns" class="border_all padding5" style="height: 330px">
                        <iframe name="allColumnsIFrame" id="allColumnsIFrame" src="${path }/form/triggerDesign.do?method=triggerTemplateTree&type=showAll&templateId=" height="100%" width="100%" frameBorder="no" ></iframe>
                    </div>
                </td>
                ...
                <td width="260">
                    ...
                    <table width="100%" height="100%" cellpadding="0" cellspacing="0" style="table-layout: fixed;">
                        <tr>
                            <td>
                                <div id="selectedColumns" class="padding5" style="height: 330px">
