...
$(document).ready(function(){
	var timequartz = $("#timeQuartz",parWin.document).val();
...
<div style="height: 100%;width: 100%;font-size: 12px;overflow: hidden;padding-top: 20px">
    ...
    <div style="margin: 5px;margin-left: 30px;margin-top:5px;line-height: 30px;" class="hidden" id="SpecifiedTimeCalDiv">
        ...
        <input id="SpecifiedTimeCal" type="text" style="width: 137px;" readonly="readonly" class="comp"  validate="notNull:true,name:'${ctp:i18n('form.trigger.triggerSet.cyclePeriodical.specifiedTime.label')}'" comp="type:'calendar',cache:false,isOutShow:true,ifFormat:'%Y-%m-%d',showsTime:false">
    </div>
