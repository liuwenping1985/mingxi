	            	...
	            	<div class="col2" id="triggerSet" style="float: left">
						...
						<fieldset class="form_area" id="">
							<legend>${ctp:i18n('form.trigger.triggerSet.definition.label') }</legend>
								<table width="100%" border="0" cellpadding="0" cellspacing="0"
									height="67px;" id="triggerNameSet">
									<tr>
										<td align="left" rowspan="3" width="4%"></td>
										<td width="22%" align="right" nowrap="nowrap"><label class="" for="text"><font
											color="red">*</font>${ctp:i18n('form.trigger.triggerSet.name.label') }：</label></td>
										<td nowrap="nowrap">
									...
									<tr>
										...
										<label class="" for="text"><font color="red"></font>${ctp:i18n('form.trigger.triggerSet.state.label') }：</label></td>
										<td nowrap="nowrap">
											...
											<div class="common_radio_box clearfix">
											    ...
											    <label class="margin_r_10 hand" for="status2"><input class="radio_com" id="status2" name="state" checkId="state" type="radio" value="0">${ctp:i18n('form.stop.label' )}</label>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td align="right" nowrap="nowrap">
										<label class="margin_r_10" for="text"><font color="red"></font>${ctp:i18n('form.trigger.triggerSet.fillback.template') }：</label></td>
										<td nowrap="nowrap">
						...
						<fieldset class="form_area padding_5 margin_t_10">
							...
							<table width="100%" border="0" cellpadding="2" cellspacing="0"
								height="65px;" id="triggerConditionSet">
								<tr>
									<td align="left" rowspan="3" width="4%"></td>
									<td width="22%" align="right" nowrap="nowrap"><label><font color="red">*</font></label>${ctp:i18n('form.trigger.triggerSet.triggerPoint.label')}：</td>
									<td nowrap="nowrap">
								...
								<tr id="triggerTimeQuartz">
									...
									<td nowrap="nowrap">
									<input type="hidden" id="runConditionDataId">
									<input type="hidden" id="stopConditionDataId">
									<input type="hidden" id="runConditionData">
									<input type="hidden" id="stopConditionData">
									...
									<tr onclick="">
										...
										<table width="100%" border="0" cellpadding="2" cellspacing="0" height="117px;">
											<tr>
												...
												<td align="right" nowrap="nowrap"><label><font
													color="red"></font></label>${ctp:i18n('form.trigger.triggerSet.type.label')}：</td>
												<td nowrap="nowrap">
											...
											<tr>
												<td width="22%" align="right" nowrap="nowrap"><label><font
													color="red">*</font></label>${ctp:i18n('form.trigger.triggerSet.processInitiator.label')}：</td>
												<td nowrap="nowrap">
												<div class="clearfix">
												...
												<input class="radio_com" disabled="disabled" type="radio" style='' id="memType2" name="memType" value="currentFlowStartMember">${ctp:i18n('form.trigger.triggerSet.currentSponsors.label')}</label>
											...
											<tr>
												<td align="right" nowrap="nowrap">
												<label><font color="red">*</font>${ctp:i18n('form.trigger.triggerSet.processTemplates.label')}：</label></td>
												<td nowrap="nowrap">
											...
											<tr>
												...
												<font color="red"></font>${ctp:i18n('form.trigger.triggerSet.copyData.label')}：</label></td>
                                            ...
                                            <tr>
                                                ...
                                                <td nowrap="nowrap"><input type="hidden"  />
                                                    <div style="width: 180px;">
                                                   <textarea
                                                    style="width: 160px;" readonly="readonly" class="validate" validate="name:'${ctp:i18n('form.trigger.triggerSet.msgTemplates.label') }',type:'string',notNull:true"></textarea>
                                                   </div>
                                                </td>
                                            </tr>
                                            <tr class="hidden">
                                                <td width="22%" align="right" nowrap="nowrap"><label><font
                                                    color="red">*</font>${ctp:i18n('form.trigger.triggerSet.bindTask.label')}：</label></td>
                                                <td nowrap="nowrap"><input type="hidden"  /> <input
                                                     readonly="readonly" class="validate" validate="type:'string',notNull:true,errorMsg:'${ctp:i18n('form.trigger.triggerSet.taskList.must') }'"/></td>
                                            </tr>
										</table>
										<p />
										<hr>
		                    	...
		                    	<c:forEach var="trigger" items="${formBean.triggerList }" varStatus="status">
		                    	    <c:if test="${trigger.type==type }">
			                    		<tr class="hand <c:if test="${(counts % 2) == 1 }">erow</c:if>">
		                            		...
		                            		<td onclick="showTrigger(this,'${trigger.id }')">${trigger.stateName }
		                            		</td>
		                        		</tr>
							...
							<table width="100%" border="0" cellpadding="2" cellspacing="0"
								...
								<tr id="label">
									...
									<td align="right" nowrap="nowrap"><input type="hidden"
										id="actionId" /> <label><font color="red"></font></label>${ctp:i18n('form.trigger.triggerSet.type.label')}：
									</td>
									<td nowrap="nowrap"><select class="" id="actionType" style="width: 160px;">
										<c:forEach var="action" items="${actionList }" varStatus="status">
                                                    <option <c:if test="${status.index eq 0 }">selected="selected"</c:if> value="${action.id }">${action.name }</option>
                                                    </c:forEach>
									</select></td>
								...
								<tr class="flow unflow hidden">
									<td width="22%" align="right" nowrap="nowrap"><label><font color="red">*</font></label><span id="creator">${ctp:i18n('form.trigger.triggerSet.processInitiator.label')}</span>：</td>
								...
								<tr class="flow unflow hidden">
									<td align="right" nowrap="nowrap"><label><font
										color="red">*</font><span id="flowLabel">${ctp:i18n('form.trigger.triggerSet.processTemplates.label')}：</span></label></td>
									<td ><input type="hidden" id="formId" /> <input
										type="hidden" id="templateId" />
										<input type="hidden" id="moduleType"/>
										<div style="width: 180px;">
										<textarea id="content"
										readonly="readonly" name="content" style="width: 160px;" class="validate" validate="errorMsg:'${ctp:i18n('form.trigger.triggerSet.template.notnull') }',type:'string',notNull:true,isDeaultValue:true,deaultValue:'${ctp:i18n('form.trigger.triggerSet.clickToTemplate.label')}'">${ctp:i18n('form.trigger.triggerSet.clickToTemplate.label')}</textarea>
										</div>
									</td>
								</tr>
								<tr class="flow unflow hidden">
									<td align="right" nowrap="nowrap"><label> <font
										color="red" id="unflowFont"></font>${ctp:i18n('form.trigger.triggerSet.copyData.label')}：</label>
									</td>
									<td nowrap="nowrap"><input id="fillBackType" type="hidden" /> <input
										id="fillBackKey" type="hidden" /> <input id="fillBackValue"
										type="hidden" /> <a
										class="common_button common_button_gray margin_l_5"
										href="javascript:void(0)" id="copySet">${ctp:i18n('form.trigger.triggerSet.set.label')}</a>
									</td>
								</tr>
								...
								<tr class="hidden message">
									<td width="22%" align="right" nowrap="nowrap"><label><font
										color="red">*</font>${ctp:i18n('form.trigger.triggerSet.msgTemplates.label')}：</label></td>
									<td ><input type="hidden" id="msgId" />
									   <div style="width: 180px;">
									   <textarea
										id="msgContent" name="msgContent" style="width: 160px;" readonly="readonly" class="validate" validate="name:'${ctp:i18n('form.trigger.triggerSet.msgTemplates.label') }',type:'string',notNull:true"></textarea></td>
									   </div>
								</tr>
                                ...
                                <tr class="hidden message sms">
									...
									<td nowrap="nowrap" id ="smshtml">
									   ...
									   <input type="hidden"  id = "sendsms" name = "sendsms" value = "false">
					                    <label class="margin_r_10 hand" for="sendsmsradio1">
					                        <input name="sendsmsradio" class="radio_com" id="sendsmsradio1" type="radio" value="true">${ctp:i18n('common.yes') }</label>
					                    <label class="margin_r_10 hand" for="sendsmsradio4">
					                        <input name="sendsmsradio" class="radio_com" id="sendsmsradio4" type="radio" value="false">${ctp:i18n('common.no') }</label>
					                </div>
									</td>
								</tr>
                                ...
                                <c:forEach var="actionDesign" items="${actionList}" varStatus="s">
                                    <c:if test="${!(empty actionDesign.configPageURL) && (actionDesign.id ne 'taskDEE') && (actionDesign.id ne 'message') && (actionDesign.id ne 'unflow') && (actionDesign.id ne 'calculate') && (actionDesign.id ne 'flow')}">
                                        <tr class="hidden ${actionDesign.id}">
                                            <td colspan="2">
                                                <input name="ConfigValue" id="ConfigValue" type="hidden" value="">
                                                <iframe id="DesignIframe" name="DesignIframe" dsrc="${actionDesign.configPageURL}" width="100%" height="100" frameborder="0" marginheight="0" marginwidth="0"></iframe>
                                            </td>
                                        </tr>
                                    </c:if>
