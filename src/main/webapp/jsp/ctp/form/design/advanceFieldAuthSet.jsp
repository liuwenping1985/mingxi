					...
					<td width="43%" valign="middle" align="left" class=" padding_t_5">
                        ...
                        <tr>
                            <td colspan="5" class="font_size12">
                                [<c:if test="${field.masterField}">${ctp:i18n("form.base.mastertable.label")}</c:if><c:if test="${!field.masterField}">${ctp:i18n("formoper.dupform.label")}${field.extraMap.subTableIndex }</c:if>]&nbsp${field.display}:
                            </td>
                        </tr>
