...
function init(){
	...
	newOption ="<select name='dataarea' id='formdataarea' multiple='multiple' style='width:200px;height:355px;'  ondblClick=\"selecttoright('up');\">";
	...
	for(var i=0;i<fieldlstsize ;i++){
        ...
        if(newFieldTypeArray[i]=="VARCHAR"||newFieldTypeArray[i]=="DECIMAL"||newFieldTypeArray[i]=="TIMESTAMP"||newFieldTypeArray[i]=="DATETIME"){
                if( newInputTypeArray[i]== "lable" || newInputTypeArray[i]=="text"  || newInputTypeArray[i]=="radio"|| newInputTypeArray[i]=="select" ||newInputTypeArray[i]=="textarea" || newInputTypeArray[i] == "externalwrite-ahead" || newInputTypeArray[i] == "exchangetask" || newInputTypeArray[i] == "querytask"  )  {
                  ...
                  if (formatTypeArray[i] && (formatTypeArray[i].indexOf("multi") != -1 || formatTypeArray[i].indexOf("mapmarked") != -1 || formatTypeArray[i]=="attachment" || formatTypeArray[i]=="image" || formatTypeArray[i]=="document" || formatTypeArray[i]=="checkbox")){
                    ...
                    newOption += " <option table='"+newTableArray[i]+"' fieldtype='"+newInputTypeArray[i] +"' value='"+newFieldNameArray[i]+"' >"+displayName+"</option>";
                      ...
                      if(newInputTypeArray[i]=="member"||newInputTypeArray[i]=="level"||newInputTypeArray[i]=="account" ||newInputTypeArray[i]=="department"||newInputTypeArray[i]=="post"||newInputTypeArray[i]== "date" ||newInputTypeArray[i]=="datetime"||newInputTypeArray[i]=="project" ){//关联的属性为空说明是扩展控件
                            newOption += " <option table='"+newTableArray[i]+"' fieldtype='"+newInputTypeArray[i] +"' value='" + newFieldNameArray[i] +"' >"+displayName+"</option>";
                      }else if(newInputTypeArray[i]=="relationform" && refInputAtthArray[i]!="flowName" ){
                            ...
                            if(typeof (finalInputType)!="undefined"){
                                  ...
                                  if(finalArray != null && finalArray[1] != "flowName" && (finalArray[0]== "lable" || finalArray[0]=="text"
                                          ...
                                          ||finalArray[0]== "date" ||finalArray[0]=="datetime"||finalArray[0]=="project"
                          ...
                          if(refInputTypeArray[i]== "1" || refInputTypeArray[i]== "3" || refInputTypeArray[i]== "8" || refInputTypeArray[i]== "6" || refInputTypeArray[i]== "7" || refInputTypeArray[i]== "9" ){//数据关联 关联人员 枚举 dee任务
                            ...
                            if(refInputTypeArray[i]== "7"){
                              ...
                              if( finalInputType!=null && typeof (finalInputType)!="undefined" && finalInputType != "NOT" ){
                                  var finalArray = finalInputType;//finalInputType.split(",");
                                  if(finalArray[1] != "flowName" && (finalArray[0]== "lable" || finalArray[0]=="text"  || finalArray[0]=="radio"|| finalArray[0]=="select" ||finalArray[0]=="textarea"||finalArray[0]=="member"||finalArray[0]=="level"||finalArray[0]=="account" ||finalArray[0]=="department"||finalArray[0]=="post"||finalArray[0]== "date" ||finalArray[0]=="datetime"||finalArray[0]=="project" )){
                                      newOption += " <option table='"+newTableArray[i]+"' fieldtype='"+newInputTypeArray[i]  +"' value='"+newFieldNameArray[i] +"' >"+displayName+"</option>";
                                	}
                              }
                          }
...
function toSearchFinalType(refParamsId,refInputAtth){
	...
	return refInputAtth == null ? "NOT" : oo.getFinalInputType(refParamsId,refInputAtth);
}
...
<form method="post" action="" >
    <div class = "margin_t_5 font_size12 clearfix">
        <div style="width: 200px;margin-left: 10px;" class="left margin_l_5 margin_t_5" id="leftSelect">
            <div>${ctp:i18n('form.compute.formdata.label')}:</div>
        ...
        <div style="width: 250px;overflow-y: auto;overflow-x: hidden;" class="left margin_l_5 margin_t_5" id="rightSelect">
            <div class="clearfix hidden" id="uniqueMarket1" style="width: 100%;" onclick="changeCurrentDiv(this)">
                ...
                <div type="data" class="left" style="width: 190px;">
                    <div type = "title">${ctp:i18n('form.base.uniqueFlag.member') }1：</div>
                    <div type=selectdata>
                        <select name="dataarea1" id="uniquedataarea1" style="width: 190px;" multiple="multiple" ondblClick="setParent4CurrentDiv(this);delOption();" >
                        </select>
                    </div>
                </div>
            </div>
            <div class="clearfix hidden margin_t_10" id="uniqueMarket2" style="width: 100%;" onclick="changeCurrentDiv(this)">
                ...
                <div type="data"  class="left" style="width: 190px;">
                    ...
                    <div type=selectdata>
                        <select name="dataarea2" id="uniquedataarea2" size="4" style="width: 190px;" multiple="multiple" ondblClick="setParent4CurrentDiv(this);delOption();" >
                        </select>
                    </div>
                </div>
            </div>
            <div class="clearfix hidden margin_t_10" id="uniqueMarket3" style="width: 100%;" onclick="changeCurrentDiv(this)">
                ...
                <div type="data"  class="left" style="width: 190px;">
                    ...
                    <div type=selectdata>
                        <select name="dataarea3" id="uniquedataarea3" size="4" style="width: 190px;" multiple="multiple" ondblClick="setParent4CurrentDiv(this);delOption();" >
                        </select>
                    </div>
                </div>
            </div>
            <div class="clearfix hidden margin_t_10" id="uniqueMarket4" style="width: 100%" onclick="changeCurrentDiv(this)">
                ...
                <div type="data"  class="left" style="width: 190px;">
                    ...
                    <div type=selectdata>
                        <select name="dataarea4" id="uniquedataarea4" size="4" style="width: 190px;" multiple="multiple" ondblClick="setParent4CurrentDiv(this);delOption();" >
                        </select>
                    </div>
                </div>
            </div>
            <div class="clearfix hidden margin_t_10" id="uniqueMarket5" style="width: 100%" onclick="changeCurrentDiv(this)">
                ...
                <div type="data"  class="left" style="width: 190px;">
                    ...
                    <div type=selectdata>
                        <select name="dataarea5" id="uniquedataarea5" size="4" style="width: 190px;" multiple="multiple" ondblClick="setParent4CurrentDiv(this);delOption();" >
                        </select>
                    </div>
                </div>
            </div>
            <div class="clearfix hidden margin_t_10" id="uniqueMarket6" style="width: 100%" onclick="changeCurrentDiv(this)">
                ...
                <div type="data"  class="left" style="width: 190px;">
                    ...
                    <div type=selectdata>
                        <select name="dataarea6" id="uniquedataarea6" size="4" style="width: 190px;" multiple="multiple" ondblClick="setParent4CurrentDiv(this);delOption();" >
                        </select>
                    </div>
                </div>
            </div>
