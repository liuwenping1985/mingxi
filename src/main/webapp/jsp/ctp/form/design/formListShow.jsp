...
<c:if test="${formType eq enu.Enums$FormType.govDocSendForm || formType eq enu.Enums$FormType.govDocReceiveForm || formType eq enu.Enums$FormType.govDocExchangeForm || formType eq enu.Enums$FormType.govDocSignForm }">
<div class="comp" comp="type:'breadcrumb',comptype:'location',code:'F07_edocSystem'"></div>
</c:if>
...
<div class="comp" comp="type:'breadcrumb',comptype:'location',code:'T05_formManager'"></div>
    ...
    <div class="layout_center" id="center" style="overflow:hidden;">
        <table class="flexme3" style="display: none" id="mytable" width="100%"></table>
        <div id='grid_detail'>  
 ...
 <script type="text/javascript" src="${path}/ajax.do?managerName=govdocRelationManager"></script>
 <script type="text/javascript" src="${path }/ajax.do?managerName=govdocTemplateDepAuthManager"></script>
...
<script type="text/javascript" charset="UTF-8" src="${path}/apps_res/template/js/template_pub.js"></script>
