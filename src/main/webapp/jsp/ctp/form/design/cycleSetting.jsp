            ...
            <td>
                <table cellspacing="2" cellpadding="2" width="95%" border="0">
                    ...
                    <tr height="40">
                        ...
                        <td class="padding_t_10" colspan="2" valign="middle">
                            <span class="margin_r_5 left" style="margin-top:5px">${ctp:i18n('form.bind.set.autosend.time.start.label')}</span>
                            ...
                            <span class="margin_l_10 margin_r_5 left" style="margin-top:5px">${ctp:i18n('form.bind.set.autosend.time.end.label')}</span>
