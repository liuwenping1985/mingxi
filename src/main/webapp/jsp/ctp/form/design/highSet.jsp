...
$(document).ready(function () {
    var parentTbody = $("#eventBindDiv", parent.window.document);
        ...
        if (bindEventId) {
            ...
            if (bindEventIdVal) {
                ...
                for (var i = 0; i < params.length; i++) {
                    ...
                    createEvent(params[i], $("input[id='name" + params[i] + "']", parentTbody).val(), $("input[id='operationType" + params[i] + "']", parentTbody).val(), $("input[id='model" + params[i] + "']", parentTbody).val(), $("input[id='taskType" + params[i] + "']", parentTbody).val(), $("input[id='taskName" + params[i] + "']", parentTbody).val(), "", null);
                }
                $("#tbody").html($("#eventBindTableDiv", parent.window.document).html());
            }
        }
    }
