  ...
  <div class="clearfix margin_5">
    <div class="left" style="width:260px">
      ...
      <div id="sysDiv">
        ...
        <div>
          <select name="sysList" id="sysList" style="width: 260px;" size="6" multiple="multiple" class="margin_t_5"></select>
        </div>
      </div>
    </div>
    ...
    <div class="left" style="width: 260px">
      ...
      <div id="valueBody">
        <select name="selectValue" id="selectValue" size="24" style="width: 260px" multiple="multiple" class="margin_t_5"></select>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  function newSort(pre,next,selected){
    ...
    initOption(valueArray,$("#selectValue"),true);
    $("option[value='"+selected +"']",$("#selectValue")).prop("selected",true);
  }
  ...
  function initHtml(){
    ...
    if (dialogArg.showSysArea) {
      ...
      $("#sysDiv").show();
      $("#fieldList").prop("size",16);
    } else {
      $("#sysDiv").hide();
      $("#fieldList").prop("size",24);
    }
