    ...
    <script type="text/javascript">
            ...
            $("#select_ico").click(function () {
                ...
                if (returnValue) {
                    ...
                    unselectObj.each(function () {
                        var selectedObj = $("#selected option[value='" + $(this).val() + "']");
                    });
                }
            });
        ...
        function initShowData() {
            ...
            for (var i = 0; i < showDataList.length; i++) {
                ...
                type = isColumn(showDataList[i].code) ? "column":"unselect";
                
                if($.inArray(showDataList[i].title, parentTitles) == -1){
                	$("#unselect").append(
                        "<option title='" + showData.title +
                        "' type='" + type + "'>" + showData.title +
                        "</option>");
                }else{
                	$("#unselect").append(
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" class="font_size12">
        ...
        <tr>
            <td valign="top" width="260">
                <select class="font_size12" style="width:260px; height: 340px;" id="unselect" size="20" multiple></select>
            </td>
