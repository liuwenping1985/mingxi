               			...
               			buttons: [{
                			...
                			handler: function () {
                     			...
                     			if(rSelect.length==0){
                     				...
                     				"' title='"+returnObj.selectSortTitle+" "+returnObj.sortName+
                     				"' value='"+returnObj.sortType+
                     				"' staticType='"+staticType+
                     				"'>"+returnObj.selectSortTitle+" "+returnObj.sortName+"</option>");
                     				//置灰
            ...
            for (var i = 0; i < sortColumnVal.length; i++) {
            	...
            	if(sortColumnVal[i]!=""){
                	$("#unselect").append(
                        ...
                        "' dataType='fieldData" +
                        "' type='unselect'>"+sortColumnTitle[i]+
                        "</option>");
                 }
            ...
            if(sortCrossColumnVal!=""){
            	//交叉项
            		$("#unselect").append(
                        ...
                        "' dataType='crossData" +
                        "' type='unselect'>"+sortCrossColumnTitle+
                        "</option>");
            }
        ...
        <tr>
            <td class="margin_t_5>
                <p class="font_size12 margin_b_5 margin_t_10">
                    <span class="left"><label id="formdataTitle">${ctp:i18n('form.forminputchoose.formdata')}</label>:
