...
<head>
    ...
    <script type="text/javascript">
		...
		var govDocFormType =parentPara.govDocFormType;
        ...
        $(function () {
			...
			if(govDocFormType==5||govDocFormType==6||govDocFormType==7){
				$("#formdataTitle").text("${ctp:i18n('form.compute.edocformdata.label')}");
			}
        });
        //判断图是否设置了选中字段
        ...
        function showSelectedModifyDialog(obj) {
            ...
            if (from === showDataList) {
                ...
                if(((!$.isNull(obj.attr("enumchangeold")) && obj.attr("enumchangeold") != "0" ) || ( !$.isNull(objChange) && !$.isNull(objChange.trim()) && objChange != "0" ))
                	&& obj.attr("repeat") == "false" && (parentPara.formType == "3" || parentPara.formType == "2")){
            ...
            try {
                for (var i = 0; i < len; i++) {
                	...
                	if(selfObj.attr("type") == "unselect"){
                		if(name === $(obj[i]).attr("newShowTitle")){
                			hasRepeat = true;
                		}
                	}else{
        ...
        function appendField(result) {
            ...
            for (var i = 0; i < result.length; i++) {
                var field = result[i];
                var repeatField = field.ownerTableName.indexOf("formson") == -1?"false":"true";//重复表字段
                $("#unselect").append(
            ...
            $("#unselect option[enumchange!='0'][repeat!='true']").each(function(){
            	var value = $(this).attr("value");
            	//在已经设置的枚举里面添加重复字段判断
            	$("#selected option[value='"+value+"']").attr("repeat","false");
            });
            ...
            if (from === setCrossColumn) {
                if (!$.isNull(parentPara.selectedValue)) {
                    ...
                    obj.text(parentPara.selectedShowTitle);
        ...
        <tr>
            <td class="margin_t_5>
                <p class="font_size12 margin_b_5 margin_t_10">
                    <span class="left"><label id="formdataTitle">${ctp:i18n('report.reportDesign.dialog.formdatadomain')}:</label>
                ...
                <tr class="margin_5">
                    ...
                    <td width="100%">
                        <div class="common_txtbox_wrap">
                            <input class="validate font_size12 left" type="text" id="reportHeadNameModify" name="reportHeadNameModify" value="" validate="type:'string',name:'${ctp:i18n('report.reportDesign.dialog.title')}',notNull:true,maxLength:255,avoidChar:'!,@#$%^:&*()\\\/\'&quot;?<>'" />
                        </div>
                    </td>
                </tr>
                <tr class="margin_5">
        ...
        <div class="align_center form_area" layout="border:false">
            <table>
                ...
                <tr class="margin_5">
                    ...
                    <td width="100%">
                        <div class="common_txtbox_wrap">
                            <input class="validate font_size12 left" type="text" id="showDataListNameModify" value="" validate="type:'string',name:'${ctp:i18n('report.reportDesign.dialog.title')}',notNull:true,maxLength:255,avoidChar:'!,@#$%^:&*()\\\/\'&quot;?<>'" />
                        </div>
                    </td>
                </tr>
                <tr class="margin_5">
        ...
        <div class="align_center form_area" layout="border:false">
            <table>
                ...
                <tr class="margin_5">
                    ...
                    <td width="100%">
                        <div class="common_txtbox_wrap">
                            <input class="validate font_size12 left" type="text" id="countColumnName" value="" validate="type:'string',name:'${ctp:i18n('report.reportDesign.dialog.title')}',notNull:true,maxLength:255,avoidChar:'!,@#$%^:&*()\\\/\'&quot;?<>'" />
                        </div>
                    </td>
                </tr>
                <tr class="margin_5">
