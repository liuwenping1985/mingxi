...
<c:set var="url_ajax_reportingManager" value="${path}/ajax.do?managerName=reportingManager"></c:set>
<c:set var="url_ajax_reportViewManager" value="${path}/ajax.do?managerName=reportViewManager"></c:set>
...
var url_ajax_reportingManager = "${url_ajax_reportingManager}";
var url_ajax_reportViewManager = "${url_ajax_reportViewManager}";
