        ...
        $("#formColumnTree").tree({
            ...
            onClick : function(e, treeId, node){
                if(node.categoryId != 0 && node.categoryId != 1){
                    $("iframe").prop("src","${path }/report/queryReport.do?method=goIndexRight&type=query&fromPortal=true&reportId="+node.data.queryId);
                }
            },
...
<body class="h100b overflow_hidden page_color" id='layout'>
    ...
    <div class="comp" comp="type:'breadcrumb',comptype:'location'"></div>
        ...
        <div class="layout_center" id="center" style="overflow:hidden;">
            <iframe frameborder="0" width="100%" height="100%" src="${path }/form/formSection.do?method=statisticsMain&sectionId=${param.sectionId}"> </iframe>
        </div>  
    </div>
</body>
</html>
