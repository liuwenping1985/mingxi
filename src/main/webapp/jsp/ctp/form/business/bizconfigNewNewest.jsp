...
<div class="stadic_layout over_hidden">
				...
				<tr style="width: 800px;">
					<td style="width: 500px">
					   <div class="clearfix" style="line-height: 20px;margin-top: 5px;width: 500px">
					       ...
					       <div class="left" style="width: 160px;">
								...
								<input type="text" id="bizConfigName" name="bizConfigName" value="${bizConfig.name}"  class="validate" validate='avoidChar:"\\/|<>:*?\"",type:"string",name:"${ctp:i18n('formsection.config.name.label') }",notNull:true,maxLength:25,notNullWithoutTrim:true'>
								</div>
					       </div>
					       <div class="left">
					       		<!-- 一级菜单 -->
					...
					<td rowspan="2"  style="width: 400px;">
                        <div class="clearfix"  style="width: 400px;">
                            ...
                            <div class="left" title="${ctp:i18n('form.business.upload.icon.label')}" style="margin-left: 10px;margin-top: 16px;" onclick="imageUpload('bizimage1')">
                                <a id="btnupload" class="common_button common_button_gray" style="padding:0 8px;" href="javascript:void(0)">${ctp:i18n('bizconfig.business.image.upload') }</a>
                            </div>
                            <div class="left" style="margin-left: 10px;margin-top: 16px;" onclick="setDefalutImage();return false;">
                                <a id="btnclose" class="common_button common_button_gray" style="padding:0 8px;" href="javascript:void(0)">${ctp:i18n('bizconfig.business.image.default') }</a>
                            </div>
							<div class="left" style="margin-left: 10px;margin-top: 16px;">
								<a id="setMobileHome" href="javascript:void(0)" style="padding:0 8px;" class="common_button common_button_gray" title="${ctp:i18n('bizconfig.business.mobile.set.label') }"><em class="phone ico16 ${hasMobileSet?'formPhone_16':'toGray'}"></em>${ctp:i18n('bizconfig.business.mobile.set.label') }</a>
								<!-- ctp:toHTML -->
								<input type="hidden" id="mobileConfig" name="mobileConfig" value='${mobileConfig}'/>
							</div>
                        </div>
                    </td>
				</tr>
				<tr style="width: 500px;">
				    <td style="width: 500px"  nowrap="nowrap">
					   <div class="clearfix" style="line-height: 20px;margin-top: 5px;margin-bottom: 5px;width: 500px">
					       ...
					       <div class="left common_txtbox_wrap" style="width: 150px;text-align: left;">
					           <input type="hidden" name="bizConfigId" id="bizConfigId" value="${bizConfig.id}">
			                    ...
			                    <div class="" id="defalutImage" noWrap="" style="width: 32px; height: 32px; line-height: 14px; float: left;display: none;">
			                     <img src="/seeyon/main/skin/frame/default/menuIcon/common_second_5.png" style="">&nbsp;
			                    </div>
					       </div>
						   ...
						   <div id="people">
							   ...
							   <input type="hidden" id="ownerId" name="ownerId" readonly="readonly" value="${bizConfig.createUser}"/>
						   </div>
				        </div>
				    </td>
				</tr>
    ...
    <div class="stadic_layout_body border_t clearfix over_hidden" style="top: 70px;bottom: ${empty param.from ? 30 : 0}px;padding-top: 5px;margin-left: 5px;">
        <div class="left" style="width: 60%;height: 95%;position: absolute;left: 0px;">
	            <div id = "parentTable" style="height: 100%;position: absolute;left: 0px; right:40px;">
					<div id="tabs" class="comp" comp="type:'tab',parentId:'parentTable',height:400">
				        ...
				        <div id='tabs_body' class="common_tabs_body border_all" style="padding:0 0px;">
        ...
        <div class="right" style="width:40%; height: 95%;position: absolute;right: 0px;">
            <div style="height: 100%;position: absolute; left:0; right: 42px;">
				<div id="domain2" style="overflow: auto;width: 100%;height: 90%;" class="border_all">
					<c:forEach items="${bizConfig.items}" var="item">
						...
						<div id="tr<%=random%>"  onclick="selectTrObj(this);" ondblclick="removeTrObj(this);" class="font_size12" name="menuItemTr">
						   <div id="title<%=random%>" title="${item.title}" class='clearfix' style="line-height: 20px;margin: 3px;">
							   <div class="left">
								   [${item.sourceTypeName}]
							   </div>
							   <div class="padding_l_5 left">
							         <div class="left" style="width: 160px;">
									 <div class="font_size12 common_txtbox_wrap" style="width: 150px;text-align: left;"><INPUT id="menuName" name="menuName" value="${item.name}" businessId="${item.sourceId}" class="validate" validate="avoidChar:'\\/|<>:*?;\'&%$#&#34;',name:'${ctp:i18n('form.menu.menuname.label')}',notNull:true,isWord:true,maxLength:25" type="text" /></div>
							         </div>
                ...
                <div id="domain3" style="width: 100%;height: 10%;margin-top: 10px;">
                    <div class="left" style="width: 116px;margin-top:6px;">
                        <label class="margin_r_5 hand" for="bizMerge">
                            <input id="bizMerge" name="bizMerge" type="checkbox" style="margin-top:0px;" onclick="selectBizMerge()" ${bizConfig.bizMerge == '1' ? 'checked' : ''}>
                            ${ctp:i18n('bizconfig.flowtemplate.list')}
                        </label>
                    </div>
                    <div class="left common_txtbox_wrap" style="width: 204px;">
                        <input id="bizMergeName" name="bizMergeName" type="text" value="${bizConfig.bizMergeName}" defaultValue="${ctp:i18n('bizconfig.flowtemplate.list.merge1')}" class="validate" validate='avoidChar:"\\/|<>:*?\"",type:"string",name:"${ctp:i18n('bizconfig.flowtemplate.list.merge2')}",notNull:true,notNullWithoutTrim:true,maxLength:25' />
                    </div>
                </div>
            </div>
            <!-- 上下按钮 -->
