...
<div class="stadic_layout over_hidden">
    <div class="stadic_layout_head" style="height: 65px;">
			<table id="domain1" align="center" border="0" width="100%">
				...
				<tr style="width: 500px;">
				    <td>
				    	<div class="left clearfix" style="line-height: 20px;margin-top: 5px;margin-bottom: 5px;">
				    		<div class="left" style="width:100px;text-align: right;">
					          ${ctp:i18n("form.bizconfigNew.memo") }：
					       </div>
				    		<div class="left common_txtbox_wrap" style="width: 150px; height:23px; text-align: left;">
								<input type="text" id="memo" name="memo" value="${bizConfig.memo}"  />
				    		</div>
				    	</div>
					   <div class="left clearfix" style="line-height: 20px;margin-top: 5px;margin-bottom: 5px;">
					       <div class="left" style="width:100px;text-align: right;">
        ...
        <div class="right" style="width:40%; height: 95%;position: absolute;right: 0px;">
            <div style="height: 100%;position: absolute; left:0; right: 42px;">
				<div id="domain2" style="overflow: auto;width: 100%;height: 90%;" class="border_all">
					<c:forEach items="${bizConfig.extraMap.BIZ_CONFIG_ITEM_LIST}" var="item">
						...
						<div id="tr<%=random%>" onclick="selectTrObj(this);" ondblclick="removeTrObj(this);" class="font_size12" name="menuItemTr">
						   <div class='clearfix' style="line-height: 20px;margin: 3px;">
							   ...
							   <div class="padding_l_5 left">
									...
									<c:if test="${item.sourceType==1 || item.sourceType==401 || item.sourceType==402 ||item.sourceType==403 ||item.sourceType==404}">
                ...
                <div id="domain3" style="width: 100%;height: 10%;margin-top: 5px;">
                	<div class="clearfix">
                    ...
                    <div class="clearfix" style="margin-top:5px">
                		<div class="left" style="width: 110px;">
	                        <label class="margin_r_5 hand" for="bizEdocMerge">
	                            <input id="bizEdocMerge" name="bizEdocMerge" type="checkbox" onclick="selectEdocBizMerge()" ${bizConfig.bizEdocMerge == '1' ? 'checked' : ''}>
									合并公文流程:
	                        </label>
                   		 </div>
	                    <div class="left common_txtbox_wrap" style="width: 210px;">
	                        <input id="bizEdocMergeName" name="bizEdocMergeName" type="text" value="${bizConfig.bizEdocMergeName}" defaultValue="${ctp:i18n('bizconfig.flowtemplate.list.merge1')}" class="validate" validate='avoidChar:"\\/|<>:*?\"",type:"string",name:"${ctp:i18n('bizconfig.flowtemplate.list.merge2')}",notNull:true,notNullWithoutTrim:true,maxLength:15' />
	                    </div>
                	</div>
                </div>
            </div>
