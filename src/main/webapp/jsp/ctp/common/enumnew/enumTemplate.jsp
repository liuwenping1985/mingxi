...
<title>枚举模板页面</title>
<script type="text/javascript" src="${path}/ajax.do?managerName=enumManager"></script>
</head>
<body scrolling="no">
	<div class="comp" comp="type:'layout'" id="layout">
        ...
        <div class="layout_center" id="center" style="overflow:hidden;">
        	<div id="center_north" class="page_color clearfix" style="width:100%;">
        		<div id="toolbar_center" class="left"></div>
	        	<div id="searchSys" class="right hidden font_size12">
			...
			<div class="" id="content" style="width:100%;height:300px;bottom:0;top:0;border-left: 1px solid #b6b6b6;">
