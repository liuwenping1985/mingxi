...
<body  class="h100b">
	<div class="form_area align_center" style="position:absolute; bottom:35px; top:0; width:100%;left:0;height:85%;overflow:auto;">
	<form id="tableForm" class="align_center" action="${path}/enum.do?method=saveOrUpdateEnumItem&parentType=${parentType}&parentId=${parentId}&tabType=${tabType}">
	    <table id="enumItemArea" border="0" cellSpacing="0" cellPadding="0"  align="center">
	        ...
	        <tr>
	            ...
	            <td><div class="common_txtbox_wrap">
	            	<input id="sortnumber" class="validate" name="sortnumber" value="" type="text" validate="name:'${ctp:i18n("common.sort.label")}',maxValue:9999,notNull:true,isInteger:true">
	            </div></td>
	        </tr>
            <c:if test="${tabType != 5}">
                <tr>
            ...
            <c:if test="${tabType == 5}">
                <tr>
                    ...
                    <td>
                    <input id="imageUrl" class="validate" name="imageUrl" style="width:80%;height:20;" value="" readOnly="readonly" type="text" validate="name:'${ctp:i18n("metadata.unitImageEnum.imageUrl.label")}',notNull:true,maxLength:4000">
