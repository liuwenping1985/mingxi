...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	   <tr>
	      <td valign="bottom" height="26" class="tab-tag">
				<div class="div-float">
					...
					<div class="tab-tag-middel cursor-hand" onclick="javascript:location.href='${metadataMgrURL}?method=showSystemMetadata'">
	  ...
	  <tr>
	    <td valign="top" width="100%" height="100%" align="center" class="page-list-border-LRD" style="padding-top:1px;">
		    <iframe width="100%" height="100%" frameborder="0" src="${metadataMgrURL}?method=showOrgMetadata" name="mainIframe" id="mainIframe" />
		</td>
	</tr>
</table>
</form>
