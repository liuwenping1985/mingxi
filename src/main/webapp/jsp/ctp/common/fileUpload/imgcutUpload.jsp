...
<body style="font-size: 14px; overflow: hidden; position: relative; ">
    ...
    <table border="0" cellSpacing="0" cellPadding="0" style="margin-top: 35px; margin-left: 64px;">
        <tr>
            <td style="position: relative;">
	            <div id="div_imgShow" style="float:left; text-align:center; background-color: #f5f5f5; border: 1px #e1e1e1; color: #aaaaaa" >
	            	<div id="headImgInstruction" style="margin-top: 45px">${ctp:i18n("personal.headImg.instruction")}</div>
	            </div>
    ...
    <div style="margin-bottom: 5px; margin-left: 64px;">
    	<input id="selectImgBtn" type="button" class="button-default-2" style="width:140px;height:30px;font-size: 15px;" value="${ctp:i18n("privilege.menu.selectpic.label")}" />
    </div>
    <div class="align_right bg-advance-bottom" style="width: 100%">
        <input id="submitBtn" type="button" class="button-default_emphasize" style="width:84px;height:30px;margin-top: 6px;font-size: 15px" value="${ctp:i18n("common.button.ok.label")}" />
        &nbsp;&nbsp;<input id="cancelBtn" type="button" class="button-default-2" style="width:84px;height:30px;margin-top: 6px;margin-right: 20px;font-size: 15px" value="${ctp:i18n("common.button.cancel.label")}" />
    </div>
</body>
</html>