            ...
            <tr>
                ...
                <td width="100%">
                	<div class="common_txtbox_wrap">
                    	<input id="column_label" type="text" name="column_label" class="validate" validate="type:'string',name:'${ctp:i18n('metadata.column.label')}',notNull:true,minLength:1,maxLength:20,avoidChar:'\'\\/|><:*?&quot&%$'">
                	</div>
                </td>
            </tr>
            <tr>
                <th nowrap="nowrap"><label class="margin_r_10" for="text">${ctp:i18n('metadata.column.name')}：</label></th>
                <td>
	                <div class="common_txtbox_wrap" id="column_name_div">
	                    <input id="column_name" type="text" name="column_name" class="validate" onfocus='this.blur();' validate="type:'string',name:'${ctp:i18n('metadata.column.name')}',notNull:true,minLength:1,maxLength:250,avoidChar:'\'\\/|><:*?&quot&%$'">
	                </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
	                <div class="common_txtbox_wrap">
	                    <input id="column_alias" type="text" name="column_alias" class="validate" validate="type:'string',name:'${ctp:i18n('metadata.column.alias')}',notNull:true,minLength:1,maxLength:20,avoidChar:'\'\\/|><:*?&quot&%$'" />
	                </div>
                </td>
            </tr>
            <tr>
                <th nowrap="nowrap"> <label class="margin_r_10" for="text"><span class="color_red">*</span>${ctp:i18n('metadata.column.type')}：</label></th>
                <td>
	                <div class="common_selectbox_wrap">
	                    <select id="column_type" name="column_type" class="codecfg" codecfg="codeType:'java',codeId:'com.seeyon.ctp.common.metadata.enums.AddressBookColumnTypeEnum'" value="-1"></select>
	                </div>
                </td>
            </tr>
           
            <!-- 隐藏小数位数  固定：最长12位：整数部分最大八位，小数部分最大4位 -->
<%--             <tr id="tr_digit" class="data_type" hidden="true">
            ...
            <input type="radio" id="date_rd" name="date_type"  value="4" checked="checked" style="display: none"/>
             <!-- 隐藏日期类型，默认格式为 yyyy-mm-dd -->
<%--         	<tr id="tr_date_type" class="data_type" hidden="true">
...
<%--         	<tr id="tr_selected_enum" class="data_type" hidden="true">
...
<%--         	<tr>
        	...
        	<tr>
            	<th nowrap="nowrap"><label class="margin_r_10" for="text">${ctp:i18n('metadata.addressbook.showpersonalinformation')}：</label></th>
	            <td>
	                <div class="common_radio_box clearfix">
					    <label for="yes_rd_pinfo" class="margin_r_10 hand"><input type="radio" id="yes_rd_pinfo" name="is_showinpersoninfo" class="radio_com" value="1">${ctp:i18n('common.yes')}</label>
					    <label for="no_rd_pinfo" class="margin_r_10 hand"><input type="radio" id="no_rd_pinfo" name="is_showinpersoninfo" class="radio_com" value="0" checked="checked">${ctp:i18n('common.no')}</label>
					</div>
	            </td>
        	</tr>
        	<!-- 隐藏显示在人员卡片 -总是显示 -->
<%--         	<tr>
            	<th nowrap="nowrap"><label class="margin_r_10" for="text">${ctp:i18n('metadata.addressbook.showpersonalcard')}：</label></th>
	            <td>
	                <div class="common_radio_box clearfix">
					    <label for="yes_rd_pcard" class="margin_r_10 hand"><input type="radio" id="yes_rd_pcard" name="is_showinpersoncard" class="radio_com" value="1">${ctp:i18n('common.yes')}</label>
					    <label for="no_rd_pcard" class="margin_r_10 hand"><input type="radio" id="no_rd_pcard" name="is_showinpersoncard" class="radio_com" value="0" checked="checked">${ctp:i18n('common.no')}</label>
					</div>
	            </td>
        	</tr> --%>
        	<!--  属性类别，默认就是当前：通讯录-->
        	<tr hidden="true">
              <%--   <th nowrap="nowrap"> <label class="margin_r_10" for="text">${ctp:i18n('metadata.column.category')}：</label></th> --%>
                <td>
	                <div class="common_selectbox_wrap">
	<!--                     <select id="category" name="category" value="8069846100545390249">
	                    </select> -->
	                    <input type="hidden" id="old_category" name="old_category" value="8069846100545390249"/>
	                    <input type="hidden" id="category" name="category" value="8069846100545390249"/>
                    </div>
                </td>
            </tr>
            <tr>
	            ...
	            <td>
	                <div class="common_txtbox_wrap">
						<input id="sort_txt" type="text" name="sort_txt" class="validate" validate="type:'number',name:'${ctp:i18n('metadata.column.sort')}',notNull:true,isInteger:true,maxLength:3,minValue:1" value="1"/>
		            </div>
	            </td>
        	</tr>
        	<tr>
