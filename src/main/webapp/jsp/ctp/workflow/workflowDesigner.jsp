...
<body onkeydown="listenerKeyESC();"  onUnload="finish()" marginheight="0" marginwidth="0" class="over_hidden h100b" style="background: white;">
</c:when>
<c:otherwise>
<body onkeydown="listenerKeyESC();"  marginheight="0" marginwidth="0" class="over_hidden h100b" style="background: white;">
</c:otherwise>
</c:choose>
...
<%--                         <td width="30px"  nowrap="nowrap" align="left" class="padding_5" >
                        ...
                        <c:if test="${isShowAdvancedSetting == 'true' && scene == '0'}">
                        	<td class="padding_5" align="left">[<a href="#" onclick="openEventAdvancedSetting();">开发高级</a>]</td>
                        </c:if>
                        <td class="padding_5">
    ...
    <td colspan="3" valign="top">
      <div id="flashContainer" style="width:100%; height:100%">
        <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="860" height="600" id="monitor" align="middle">
            ...
            <!-- 非IE浏览器:开始 -->
            <script type="text/javascript">
                if(!$.browser.msie || ($.browser.msie && parseInt($.browser.version)>=11)){
                  //IE11需要走这里
...
<tr id="theStepBackNodeTR" class="display_none" style="height: 100%">
    <td colspan="3" height="35" style="font-size: 12px;font-weight: normal;" valign="top">
        <table align="center" width="95%" border="0" style="table-layout:fixed;">
            <tr>
                <td id="theStepBackNodeInfo" align="left" class="padding_5 text_overflow"  nowrap="nowrap" >被回退节点处理后：</td>
            </tr>
            <tr>
                <td>
                    <table width="100%" border="0" style="table-layout:fixed;">
                        <td id="theStepBackNodeInfoAction" align="left"  class="padding_5 text_overflow" width="10%"  nowrap="nowrap">被回退节点处理后动作：</td>
                        <c:choose>
                        ...
                        <td  class="padding_5" id="tomeTipInfo" width="70%" nowrap="nowrap" align="left"></td>
                    </table>
                </td>
            </tr>
        </table>
