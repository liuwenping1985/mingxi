...
<fieldset class="margin_10"><%-- 运行情况 --%>
    <legend>动作执行情况</legend>
    <div class="form_area relative margin_l_10">
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr><%-- 收到时间，年月日时分秒，19位标准时间，简单输出 --%>
                <th style="line-height: 24px;" nowrap="nowrap" width="80"><label class="my_label"  for="text">调用时间:</label></th>
                <td width="140" class="padding_l_5">
                    ${invokeTime}
                </td>
                <td width="90"></td>
            ...
            <tr><%-- 处理时间，如果没有的话，显示为无，直接显示就行了 --%>
                <th style="line-height: 24px;" nowrap="nowrap" width="80"><label class="my_label"  for="text">返回时间:</label></th>
                <td width="140" class="padding_l_5">
                    ${returnTime }
                </td>
                <td width="90"></td>
            ...
            <tr><%-- 容错模式 --%>
                <th style="line-height: 24px;" nowrap="nowrap" width="80"><label class="my_label"  for="text">返回消息:</label></th>
                <td width="140" class="padding_l_5">
                    ${control.returnMsg }
                </td>
                <td width="90"></td>
