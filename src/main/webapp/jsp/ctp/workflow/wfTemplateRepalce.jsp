...
<table width="100%" height="100%" border="0" align="center" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <td>
        	<a id="btnsearch" class="common_button common_button_gray margin_r_5" href="javascript:void(0)">&nbsp;&nbsp;
    ...
    <tr id="">
        ...
        <td>
        	<a id="btnreplace" class="common_button common_button_gray margin_r_5" href="javascript:void(0)">&nbsp;&nbsp;
