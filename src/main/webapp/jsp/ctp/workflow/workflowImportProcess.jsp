        ...
        <table class="form_area only_table edit_table margin_l_10" id="formTable" style="margin-top: 0px; table-layout: fixed;width:98%" border="0" cellspacing="0" cellpadding="0">
            <thead>
                <tr>
                    ...
                    <th style="width: 340px;">类型</th>
                    <th style="width: 100px;">位置</th>
                    <th style="width: 140px;">对象值</th>
                    <th style="width: 80px;">重定向</th>
                </tr>
             </thead>
    ...
    function modifyWorkflowTemplate(ptemplateId,nodeId){
      ...
      workfowFlashDialog = $.dialog({
            ...
            transParams : {
              ...
              verifyResultXml:"<vr s=\"false\"><n id=\""+nodeId+"\"><r0>false</r0><r0msg>不存在</r0msg><r1>true</r1><r1msg></r1msg><r2>true</r2><r2msg></r2msg></n></vr>"
            },
            closeParam : {
              'show' : true
              ,handler : function(){
