...
<%@ include
	file="/WEB-INF/jsp/ctp/view/operationcenter/constdef/newConstDef_js.jsp"%>
<html>
<head>
<title></title>
<style>
					...
					<table border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							<th width="100px"><font color="red">*</font><label
								class="margin_r_10" for="text">常量名:</label></th>
							<td>
								<div class="common_txtbox_wrap">
									<input type="text" id="constKey" class="validate"
										validate="type:'string',name:'constKey',notNull:true" />
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<input type="radio" name="constType" value="1" checked> 数值
								<input type="radio" name="constType" value="2"> 字符
								<input type="radio" name="constType" value="3"> 表达式
								<input type="radio" name="constType" value="4"> 宏替换
							</td>
						</tr>
