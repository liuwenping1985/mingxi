...
<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%" bgcolor="#FFFFFF">
	...
	<tr>
		<td colspan="2"><iframe id="htmlFrame" ${param.scrolling eq 'hidden' ? 'scrolling="no"' : ''} src="/seeyon/office/cache/${param.fileCreateDate}/${param.fileId}/${param.fileId}.html?rnd=<%=(Math.random() * 100000)%>" frameborder="0" marginheight="0" marginwidth="0" width="99%" height="100%" onreadystatechange="reloadExcelSheet();"></iframe></td>
	</tr>
</table>
