...
<script type="text/javascript" charset="UTF-8" src="${path}/apps_res/collaboration/js/templateChoose.js${ctp:resSuffix()}"></script>
...
<body>
        ...
        <div class="layout_center over_hidden" layout="border:true" id="layout_center_id">
            <div class="common_tabs clearfix">
                <ul class="left">
					...
					<li id="govdocArticleBut" style="display:none" class="current"><a hidefocus="true" href="javascript:govdocShowDocPage()" class="border_b">${ctp:i18n('template.templateChoose.textAlone')}</a></li><!-- 文单 -->
					<li id="govdocContentBut" style="display:none"><a hidefocus="true" href="javascript:showGovdocContent()">${ctp:i18n('collaboration.summary.text')}</a></li><!-- 新公文正文 -->
	...
	<iframe	id="editFrame" name="editFrame" src="${path }/form/bindDesign.do?method=editFrame" style="height:0;width:0;"></iframe>
</body>
</html>