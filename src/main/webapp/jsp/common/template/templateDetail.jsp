                ...
                <div id="tabs2_body" class="common_tabs_body border_all over_auto">
                    ...
                    <div id="tab2_div" class="hidden">
                        <table class="font_size12 line_height100 margin_t_10" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <c:if test="${v3x:getSysFlagByName('col_showRelatedProject') == true}">
                            <tr>
                            ...
                            <tr>
                                <td width="60" align="right" class="padding_r_10">是否追溯流程：</td><!-- 预归档到 -->
                                <td>
                                ...
                                <td>
                                    <div class="common_checkbox_box clearfix ">
                                        <label for="Checkbox5" class="margin_t_5 hand display_block">
                                            <input type="checkbox" value="0" id="Checkbox5" name="option" disabled='true' <c:if test="${summary.canForward}">checked</c:if> class="radio_com">${ctp:i18n('common.toolbar.transmit.collaboration.label')}</label><!-- 转发 -->
