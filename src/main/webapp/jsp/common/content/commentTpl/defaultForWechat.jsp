...
<c:choose>
    <c:when test="${fromTemplate == 'true'}">
        <li class="view_li padding_b_10" id="postscriptli" style="width:100%;"><span
    ...
    <li class="padding_tb_10" style="width:100%;">
                    ...
                    <div class="processing_view font_size12 padding_b_10"><c:forEach
                        ...
                        varStatus="statusForwardValue">
                            ...
                            <div class="content font_size12 padding_l_15"><c:forEach
                                ...
                                <c:set var="_sscounter" value="${_sscounter+1}"></c:set><span class="color_gray2" style="font-weight: normal;">${comment.createDateStr}</span> </span><span class="right"> <span
            ...
            <li id="replyContent_sender" class="view_li padding_b_10" style="width:100%;">
        ...
        <c:if
            ...
            <%-- 当前协同评论回复区 --%>
            <li class="view_li margin_b_10" id="currentComment" style="width:100%;">
              <div class="li_title">
                <c:choose>
                   ...
                   <c:otherwise>
                     <span class="font_bold font_size12">${ctp:i18n_2('collaboration.opinion.handleOpinion',fn:length(commentList),praiseToSumNum)}</span>
                   </c:otherwise>
                </c:choose>
              </div>
              <div class="processing_view font_size12" style="line-height: 20px;">
                <div class="content">
                  <c:forEach items="${commentList}" var="comment" varStatus="status">
                    <h3 class="per_title">
                      <span id="${comment.id}" class="left title font_size12">
                        ...
                        <span class="margin_l_${ctp:isBlank(comment.extAtt1)?1:2}0 font_bold">${ctp:i18n(comment.extAtt1)}</span><span class="margin_l_10 font_bold">${ctp:i18n(comment.extAtt3)}</span>
                        <span class="color_gray margin_l_10" style="font-weight: normal;">${comment.createDateStr}</span>
                     </span>
                     <span class="right">
                       <c:set var="_sscounter" value="${_sscounter+1}"></c:set>
                  ...
                  <ul id="ulcomContent${comment.id}">
                    <li id="licomContent${comment.id}" style="word-break: normal; word-wrap: break-word; text-justify: auto; text-align: justify; clear: both;">
...
<div id="commentHTMLDiv" style="display: none">
  ...
  <div class="common_txtbox clearfix margin_t_20">
    <!-- 意见回复 -->
    <textarea id="content" name="content" cols="10" rows="3" style="font-size: 12px;width:90%;"></textarea>
