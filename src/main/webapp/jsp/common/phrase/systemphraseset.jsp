...
${ctp:i18n('phrase.sys.cyycd')}
                    ...
                    <tr>
                        <td class="align_center padding_10"><a href="javascript:void(0)" id="okBtn" class="common_button common_button_gray">${ctp:i18n('phrase.sys.makesure')}</a>&nbsp;<a href="javascript:void(0)" id="cancelBtn" class="common_button common_button_gray">${ctp:i18n('phrase.sys.makecancle')}</a></td>
                    </tr>
                </table>
                </div>
