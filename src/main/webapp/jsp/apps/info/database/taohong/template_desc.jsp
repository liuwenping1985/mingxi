...
<body class="color_gray">
    <div class="clearfix">
        <h2 class="left">${ctp:i18n('infosend.format.desc.lable')}</h2>
    ...
    <div class="line_height160 font_size12 margin_l_10">
              <p><span class="font_size12">●</span>${ctp:i18n('infosend.format.desc.lable1')}</p>
              <p><span class="font_size12">●</span>${ctp:i18n('infosend.format.desc.lable2')}</p>
    </div>
</body>
</html>
