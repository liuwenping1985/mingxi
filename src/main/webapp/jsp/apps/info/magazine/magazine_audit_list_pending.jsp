...
<head>
<%-- 待审核期刊列表 --%>
<title>${ctp:i18n("infosend.score.magazine.auditPending.title")}</title>
...
<script type="text/javascript" src="${path}/apps_res/info/js/magazine/magazine_audit_list_pending.js${ctp:resSuffix()}"></script>
