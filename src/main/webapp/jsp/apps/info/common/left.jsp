...
<script type="text/javascript">
        ...
        function initUrl() {
            ...
            $("span[resCode='F18_magazineManager']").find("a").eq(0).click(function() {//期刊管理
...
<div class="info_left_nav">
    ...
    <div class="info_box resCode" resCode="F18_infoReport">
    ...
    <div class="info_box resCode" resCode="F18_infoAudit">
        <div class="info_box_title">
    ...
    <div class="info_box resCode" resCode="F18_magazine">
        <div class="info_box_title">
        ...
        <div class="info_box_display">
			...
			<c:if test="${hasMagazineManagerRole }">
         	<span class="resCode" resCode="F18_magazineManager">
			...
			<c:if test="${hasMagazineAuditRole }">
	        	<span class="resCode" resCode="F18_magazineAudit">
			...
			<c:if test="${hasMagazinePublishRole }">
	            <span class="resCode" resCode="F18_magazinePublish">
			...
			<c:if test="${hasInfoCheckRole }">
	            <span class="resCode" resCode="F18_magazineCheck">
	...
	<c:if test="${hasInfoQueryAndStatRole }">
    <div class="info_box resCode" resCode="F18_infoQueryAndStat">
        <div class="info_box_title">
        ...
        <div class="info_box_display">
        	<c:if test="${hasInfoQueryRole }">
        	<span class="resCode" resCode="F18_infoQuery">
           	...
           	<c:if test="${hasInfoStatRole }">
            <span class="resCode" resCode="F18_infoStat">
    ...
    <%-- 应用设置 --%>
    <c:if test="${isInfoAdmin }">
    <div class="info_box resCode" resCode="F18_infoDatabase">
    	<div class="info_box_title">
