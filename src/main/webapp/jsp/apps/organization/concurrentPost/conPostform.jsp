        ...
        <div class="one_row">
            <table border="0" cellspacing="0" cellpadding="0">
                <tbody>
                    ...
                    <tr>
                        <th nowrap="nowrap">
                        <label class="margin_r_10" for="cDept"><font color="red">*</font>${ctp:i18n('org.dept.parttime.department')}:</label>
                        </th>
                        <td width="100%">
                            <div class="common_txtbox_wrap">
                    ...
                    <tr>
                        <th nowrap="nowrap">
                        <label class="margin_r_10" for="cPost"><font color="red">*</font>${ctp:i18n('org.dept.parttime.jobs')}:</label>
                        </th>
                        <td width="100%">
                            <div class="common_txtbox_wrap">
