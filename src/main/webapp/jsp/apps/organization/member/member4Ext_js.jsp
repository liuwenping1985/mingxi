  ...
  */
      ...
      ok_fn: function() {
        imanager.canIO({
          success: function(rel) {
            if ('ok' == rel) {
              var downloadUrl_e = "${path}/organization/member.do?method=exportExtMembers&condition="+encodeURI($.toJSON(s));
  ...
  $("#btnok").click(function() {
    ...
    if ($("#id").val() === '-1') {
      ...
      mManager.createExtMember($("#memberForm").formobj(), {
  ...
  $("#extRoles").click(function() {
    ...
    dialog4Role = $.dialog({
      url: "<c:url value='/organization/member.do' />?method=member2Role4Ext",
  ...
  var searchobj = $.searchCondition({
    ...
    },
    {
      ...
      comp: "type:'selectPeople',panels:'Outworker',selectType:'Department',maxSize:1,showAllOuterDepartment:'true', returnValueNeedType:'false'"
    }, {
      id: 'search_enable',
      name: 'search_enable',
      type: 'select',
