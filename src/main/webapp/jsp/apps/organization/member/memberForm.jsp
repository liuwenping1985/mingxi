...
<form id="memberForm" name="memberForm" method="post" action="">
    <div class="left" style="width:45%;">
        ...
        <table width="90%" border="0" cellspacing="0" cellpadding="0" class="margin_l_10">
            ...
            <!-- 最高学历初中、高中、中专、职高、大专、大学、硕士研究生、博士研究生、在职大专、在职大学、在职研究生、党校大专、党校大学、党校研究生；-->
            <tr>
                ...
                <td><div class="common_selectbox_wrap">
                        <select id="eduBack" class="w100b">
                            ...
                            <option value="7">在职大专</option>
                           
                            
                            <option value="10">在职大学</option>
                            <option value="10">在职研究生</option>
                            <option value="11">党校大专</option>
                            <option value="12">党校大学</option>
                            <option value="13">党校研究生</option>
                        </select>
                    </div>
                </td>
            </tr>
        ...
        <div class="">
            ...
            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr class="forInter">
                    ...
                    <td width="100%"><div class="common_txtbox_wrap">
                            <input type="text" id="deptName" name="deptName" readonly="readonly" class="validate" validate="type:'string',name:'${ctp:i18n('org.member_form.deptName.label')}',notNull:true,maxLength:255"/>
                        </div>
                    </td>
                </tr>
                <!--extAccountName-->
