...
$().ready(function() {
  ...
  $("#toolbar").toolbar({
    ...
    },
    {
      ...
      click: function() {
        location.href = "${path}/organization/department.do?method=showDepartmentFrame&style=tree";
      }
    }]
  });
  ...
  var searchobj = $.searchCondition({
    ...
    },
    {
      ...
      value: 'path',
      comp: "type:'selectPeople',panels:'Department',selectType:'Department',maxSize:'1'"
    }]
  });
  function getCount() {
    cnt = mytable.p.total;
