...
<script type="text/javascript" src="${path}/ajax.do?managerName=orgManager,departmentManager,roleManager"></script>
<script type="text/javascript">
  ...
  $(function() {
    ...
    var isoutworker = "";
    if(o.isGroup()==false&&(!o.isBaseRole(role.code)||role.code=="ExternalStaff"||role.code=="GeneralStaff")){
    	...
    	if(role.code=="DepLeader"){
    	 ...
    	 $.selectPeople({
    	        ...
    	        callback : function(ret) {
                 var check = rm.checkOnlyOneRole('${roleId}',ret.value,deptid);
...
<div class="layout_center" layout="sprit:false">
  ...
  <form id="myfrm" name="myfrm" method="post" class="font_size12">
    ...
    <div style="float:left;margin-left:15px;">选择人员：</div>
    <div>
