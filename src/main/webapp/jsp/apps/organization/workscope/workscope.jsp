...
<script type="text/javascript" src="${path}/ajax.do?managerName=workscopeManager"></script>
<script type="text/javascript">
$().ready(function() {
    var pManager = new workscopeManager();
    var levelscope = pManager.editScope();
    $("#button").hide();
    ...
    $("#btnok").click(function() {
        ...
        pManager.saveScope($("#levelScope").val(), {
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <div>
                                            ...
                                            codecfg="codeType:'java',codeId:'com.seeyon.ctp.organization.enums.LevelScopeEnum'" >
