  ...
  function onloadFunction(){
	  var source = "${param.source}";
	    ...
	    if(typeof(source)!="undefined" && typeof(info)!="undefined" && source =="portal" && info=="done"){
	    	...
	    	setDefaultTab_Edoc(tabIndex);onLoadLeft();initPage();
	    }
  }
</script>
<%-- 写到header.jsp中去 --%>
				...
				<td style="padding: 0; margin: 0">
					<div id='scrollborder' style='overflow:hidden; height: 26px;width:100%;padding: 0; margin: 0'>
						<div id="menuTabDiv" class="div-float" style="word-break:keep-all;white-space:nowrap; width: auto">
							...
							<!-- 我的分管事项 -->
							<span class="resCode" resCodeParent="${resCodeParent}">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div id="firstTab" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);" url="<html:link renderURL='/supervision/supervisionController.do?method=getList&supType=20' />">我的分管事项</div>
							...
							<span class="resCode" resCodeParent="${resCodeParent}">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div id="done" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);" url="<html:link renderURL='/supervision/supervisionController.do?method=getList&supType=30' />">我关注事项</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
							...
							<span class="resCode" resCodeParent="${resCodeParent}">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);" url="<html:link renderURL='/supervision/supervisionController.do?method=getList&supType=80' />">责任事项台账</div>
							...
							<span class="resCode" resCodeParent="${resCodeParent}">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);" url="<html:link renderURL='/supervision/supervisionController.do?method=getList&supType=90' />">由我办理事项</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;" url="dd"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
							<!-- 督办事项台账 -->
							<span class="resCode" resCodeParent="${resCodeParent}">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);" url="<html:link renderURL='/supervision/supervisionController.do?method=getListFrame&supType=70' />">督办事项台账</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
							...
							<span class="resCode" resCodeParent="${resCodeParent}">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);" url="<html:link renderURL='/supervision/supervisionController.do?method=getList&supType=40' />">我督办事项</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
							...
							<!-- 超期督办 -->
							<%-- <%if(com.seeyon.v3x.common.SystemEnvironment.hasPlugin("officeOcx")){ %> --%>
							<span class="resCode" resCodeParent="${resCodeParent}">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);" url="<html:link renderURL='/supervision/supervisionController.do?method=getList&supType=50' />">超期事项</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
							...
							<span class="resCode" resCodeParent="${resCodeParent}">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div id="sent" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);" url="<html:link renderURL='/supervision/supervisionController.do?method=getListFrame&supType=2' />">来文办件</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
							<!-- 领导交办事项 -->
							<span class="resCode" resCodeParent="${resCodeParent}">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div id="sent" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);" url="<html:link renderURL='/supervision/supervisionController.do?method=getListFrame&supType=3' />">领导交办事项</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
							<!-- 会议议定事项 -->
							<span class="resCode" resCodeParent="${resCodeParent}">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div id="sent" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);" url="<html:link renderURL='/supervision/supervisionController.do?method=getListFrame&supType=1' />">会议议定事项</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
							<!-- 重点事项 -->
							<span class="resCode" resCodeParent="${resCodeParent}">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div id="sent" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);" url="<html:link renderURL='/supervision/supervisionController.do?method=getListFrame&supType=0' />">重点事项</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span>
							<!-- 已反馈事项
							<span class="resCode" resCodeParent="${resCodeParent}">
								<div class="tab-tag-left" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div id="sent" class="tab-tag-middel" style="word-break:keep-all;white-space:nowrap;clear: right;" onclick="javascript:changeMenuTab(this);" url="<html:link renderURL='/supervision/supervisionController.do?method=getList&supType=60&formTemplateId=-1422325728687405410' />">已反馈事项</div>
								<div class="tab-tag-right" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
								<div class="tab-separator" style="word-break:keep-all;white-space:nowrap;clear: right;"></div>
							</span> -->
						</div>
