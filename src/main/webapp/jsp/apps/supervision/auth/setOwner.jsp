...
<title>设置所属人</title>
	...
	$().ready(function(){
		...
		function initSelected(){
			var ownerId=$("#ownerId",window.dialogArguments.window.document).val();
			if(ownerId!=""){//当表单所属人当前不存在时，则不初始化选中框
	...
	<table class="margin_t_5 margin_l_5 font_size12" align="center" width="380" height="70%" style="table-layout:fixed;">
		<tr height="310">
			<td valign="top" width="260" height="100%">
				<p align="left" class="margin_b_5">备选</p>
			...
			<td valign="top" width="260" height="70%">
				<p align="left" class="margin_b_5 w100b">已选</p>
