        ...
        $(document).ready(function () {
            ...
            grid = $('#listStatistic').ajaxgrid({
                colModel: [{
                    ...
                    display: "${ctp:i18n('performanceReport.workflow.processing.times')}",//处理次数
                    name: 'count',
                    sortable : true,
                    width: '20%'
                },{
                    display: "${ctp:i18n('performanceReport.workFlowAnalysis.chartOverTimeRatio')}",//超时率
                    name: 'overRadio',
                    width: '20%'
                },{
                    ...
                    display: "${ctp:i18n('performanceReport.workflow.handling.time')}",//平均处理时间
                    name: 'avgRunTime',
                    width: '20%'
                }],
                render:rend,
                ...
                managerMethod : "getNodeAnalysisNameList"
            });
            //页面底部说明加载
