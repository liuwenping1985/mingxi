...
//    }
  ...
  //报表统计按钮设置 
      function getButton() {
          ...
          "<a href='javascript:void(0)' class='common_button common_button_gray margin_r_10' id='querySave' onclick='executeStatistics()'>${ctp:i18n('performanceReport.queryMain.button.start')}</a>" +
...
//流程状态
  ...
  function getAccount(){
	  ...
	  hh+="<td nowrap='nowrap'><label for='toDep'><input type='radio' name='statWhat' id='toDep' value='${accountId==null ? 'Department' : 'Account' }' ${isGroupAdmin ? '' : 'checked' } onclick='switchIt(this)'>"+getName("${ctp:i18n('performanceReport.queryMain.reports.department')}")+"</label>"+
	    ...
	    hh+="<td width='60px' id='depContent' nowrap='nowrap'><div class='common_txtbox_wrap' style='padding:0'>"+
