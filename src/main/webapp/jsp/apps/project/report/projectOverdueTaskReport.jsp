...
function showBarChart(reportResult) {
	if(reportResult.chartData==undefined || reportResult.chartData.chartData==undefined || $.isNull(reportResult.chartData.chartData)){
    ...
    <c:if test="${reportPage eq 'projectMemberTaskReport'}">
    	//$("#taskChartReport").width($(".stadic_layout_body").width()-128).css({"margin-right":"128px"});
