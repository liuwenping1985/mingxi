...
<span id="reportTitle" style="font-family:'Microsoft YaHei',SimSun,Arial,Helvetica,sans-serif;font-size:14px;width:80%;text-align:center;color:#414141" class="margin_t_10 left">
</span>
