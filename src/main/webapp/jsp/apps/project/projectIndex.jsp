...
<script type="text/javascript" charset="UTF-8" src="${path}/apps_res/project/js/projectIndexEvent.js${ctp:resSuffix()}"></script>
		...
		<div class="stadic_layout_head stadic_head_height">
			<div class="projects_head clearfix">
				<ul class="projectTask_dimensionTab" id="project_tabs">
                    <li class="current" title="${ctp:i18n("project.display.panel")}" dimension_value="card"><em id="card_icon" class="ico16 switchView_card_current_16"></em></li>
                    <li title="${ctp:i18n("project.display.list")}" dimension_value="list"><em id="list_icon" class="ico16 switchView_list_16"></em></li>
                </ul>
