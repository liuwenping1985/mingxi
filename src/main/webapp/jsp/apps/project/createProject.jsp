            ...
            <div id="tab1_div" class="padding_lr_24">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="table-layout:fixed;">
                    ...
                    <tr>
                        <td class="padding_r_15 padding_t_10">
                            <div class="common_txtbox_wrap">
                                <input id="begintime" type="text" class="comp" comp="type:'calendar',ifFormat:'%Y-%m-%d'" validate="name:'${ctp:i18n('project.body.startdate.label')}',type:'3',notNull:true"/>
                            </div>
                        </td>
                        <td class="padding_l_15 padding_t_10">
                            <div class="common_txtbox_wrap">
                                <input id="closetime" type="text" class="comp" comp="type:'calendar',ifFormat:'%Y-%m-%d'" validate="name:'${ctp:i18n('project.body.enddate.label')}',type:'3',notNull:true"/>
                            </div>
                        </td>
                    </tr>
                ...
                <div class="list_content relative" style="height:125px;">
                    <div class=" table_head relative"><!--表头-->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="only_table edit_table">
                            <tbody>
                                <tr>
                                    <th width="20" align="center"><input type="checkbox" class="padding_l_3" onclick="selectAll(this);"/></th>
