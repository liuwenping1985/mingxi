        ...
        <script type="text/javascript">
            ...
            $(function(){
                ...
                $(".common_send .common_send_textarea").keyup(function(){
                    ...
                    var n = 300 - isOverBytes(sss) / 2;
                    var __ll = 300-_length;
                    __ll = __ll - imgl;
                    ...
                    if(body.length > 0 || $('#common_send_file').html().indexOf('jid') > 0){
                    	if($(this)[0].className != 'common_send_box_btnSubmit common_button right common_button_disable'){
	                    	...
	                    	$('#common_send_file').removeClass('margin_b_10');
	                     	...
	                     	$(".common_send .common_send_textarea_length").html('300');
                    	}
                    }
        ...
        <div class="uc_layout_sideL">
            <div class="clearfix layout_bg">
                <div class="gravatar left margin_r_20 ucFaceImage">
                    <img id="uc_photo" class="img" src="" width="72" height="72" alt=""/>
                </div>
                <div class="over_auto font_size12 line_height180">
                    <p id="uc_name" class="margin_t_10"></p>
                    <p id="uc_post"></p>
            ...
            <div class="uc_menu clearfix" style="padding-left: 0px;">
                    ...
                    <div class="margin_t_10 clearfix">
                        <div class="common_tabs clearfix left uc_tabs">
                            <ul class="left" id="common_menu">
                                <li class="current">
                                    <a hidefocus="true" href="javascript:void(0)" id="all_msg" title="${ctp:i18n('uc.messageType.all.js')}" onclick="javascript:queryTalk('')">${ctp:i18n('uc.messageType.all.js')}</a>
                                </li>
                                <li>
                        ...
                        <li class="pageChatAreaMy">
                            ...
                            <div class="pageChatAreaMy_Send">
                                ...
                                <div class="font_size12 margin_t_10" id = 'messageli'>
                                    ...
                                    <span class="color_gray2 font_size12">${ctp:i18n('uc.message.enter.check1.js')}<span class="pageChatArea_textarea_length color_black font_size16">300</span>${ctp:i18n('uc.message.enter.check2.js') }</span></span>
                ...
                <div class="uc_shortcut">
                    <c:if test="${param.from == 'a8'}">
                        <c:if test="${ctp:hasResourceCode('F13_mailinbox') && !v3x:getSysFlagByName('email_notShow')}"> <!-- 邮件是否启用 -->
                        ...
                        <c:if test="${ctp:hasResourceCode('F09_meetingPending') && v3x:getSysFlagByName('uc_showSphy')}"> <!-- uc视频会议是否启用 -->
                        <span class="uc_tool_font hand" id="uc_sphy"><em class="ico24 video_24"></em><span class="uc_tool_span">${ctp:i18n('uc.tool.sphy.js')}</span></span>
                        </c:if>
                        <c:if test="${isShowSMS}">
                        <span class="uc_tool_font hand" id="uc_dx"><em class="ico24 sms_24"></em><span class="uc_tool_span">${ctp:i18n('uc.tool.dx.js')}</span></span>
                        </c:if>
                    </c:if>
                </div>
                <!--本部门-->
                <div id="Uc_Org_Content" class="hidden">
                    <div class="clearfix font_size12 margin_t_10 " style="padding-left: 10px;">
                    	<div id='sendMessageBydept' class="left margin_t_5 hidden"></div>
                        <div class="right common_search_box clearfix">
                            <ul class="common_search">
                                <li id="inputBorder" class="common_search_input">
                                    <input class="search_input" type="text" id="queryOrgMember" maxlength="25" value="${ctp:i18n('uc.staff.name.js')}" onblur="queryTitleClasse(this)" onkeyup="reomveClassby(this)" onfocus="queryTitleClass(this)" />
                                </li>
                                <li>
                                    <a class="common_button common_button_gray search_buttonHand" href="javascript:void(0)" onclick="queryOrgMembers()"> <em></em></a>
                                </li>
                            </ul>
                        </div>
                        <div class="right margin_t_5 common_checkbox_box clearfix">
                            <label for="showOrgOffLine" class="margin_r_10 hand color_gray">
                                <input type="checkbox" value="0" id="showOrgOffLine" class="radio_com" onclick="showOrgOffLine()" />${ctp:i18n('uc.staff.showOffline.js')}
                            </label>
                        </div>
                        <span class="right margin_t_5 margin_r_10 color_gray">${ctp:i18n('uc.tab.member.js') }:<span class="font_bold green" id="online_num"></span>/<span id="total_num"></span></span>
                    </div>
                    <div class="clearfix margin_t_10">
	                    <div id="layout" style="width:810px;height:680px;">
	                    	<div id="layout_west" class="layout_west">
		                        <div id="deptTree" style="overflow:hidden;width:100%;">
		                            <div id="select_input_div" class="select_input_div margin_tb_2 margin_l_2 margin_r_2" style="width:97%;">
		                                <input name="currentAccountId" id="currentAccountId" type="text" class="select_input" readonly="readonly" value="" />
		                            </div>
		                            <ul id="deptList" class="ztree margin_l_2 margin_r_2" style="border:0;_width:97%;height:100%;background:url()"></ul>
		                        </div>
	                    	</div>
	                    	<div id="layout_center" class="layout_center">
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="only_table" id="only_table">
									<thead><tr height="27"><th width="120">${ctp:i18n('uc.staff.name.js')}</th><th width="100">${ctp:i18n('uc.staff.dept.js')}</th><th width="100">${ctp:i18n('uc.staff.post.js')}</th><th>${ctp:i18n('uc.staff.mood.js')}</th></tr></thead>
									<tbody id="memberList"></tbody>
									<tfoot>
										<tr><td colspan='4' class='border_t_gray'>
											<div class="right common_over_page margin_r_2 margin_tb_2">
												<a title="${ctp:i18n('uc.page.prev.js')}" class="common_over_page_btn" id="Org_prevPage" onclick="orgPrevPage()"><em class="pagePrev"></em></a>
												<span class="margin_l_10">${ctp:i18n('uc.page.current.js')}</span><span id="Org_currentPage">1</span>/<span id="Org_totalPage">1</span>${ctp:i18n('uc.page.total.js')}
												<a title="${ctp:i18n('uc.page.next.js')}" class="common_over_page_btn" id="Org_nextPage" onclick="orgNextPage()"><em class="pageNext"></em></a>
											</div>
										</td></tr>
									</tfoot>
								</table>
