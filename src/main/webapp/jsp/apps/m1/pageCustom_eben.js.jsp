...
<style type="text/css">
	...
	#dv1{position: relative;z-index:0;top:1%;left:10%;width:40%;height:95%;text-align:center;}
	#bgv{position:absolute;left:0px;top:0px;width:100%;height:100%;z-Index:-1; border:1px solid white；}
	#dv2{border-top:2px solid red;border-left:2px solid red;border-bottom:2px solid red;border-right:2px solid red;filter:alpha(opacity=75);background:#ffffff;position: absolute;top:11%;left:13%;width:67%;height:70%;}
