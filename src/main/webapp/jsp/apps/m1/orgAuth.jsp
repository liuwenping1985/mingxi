						...
						<fieldset ><legend><font><fmt:message key="label.mm.orgauth.legend" bundle="${mobileManageBundle}"/>
							...
							<c:if test = "${ authedType > 1 && available  == true }">
								<tr class="trstyle">
									...
									<c:if test="${authedType == 22 }"> 
									 ...
									 <c:if test="${authedType == 23 }"> 
									 	<td class="bg-gray"  nowrap="nowrap"><fmt:message key="label.mm.orgauth.allorgcount" bundle="${mobileManageBundle}"/>:</td>
								...
								<tr class="trstyle">
								    ...
								    <c:if test="${authedType == 23 }"> 
								 	 	<td class="bg-gray"  nowrap="nowrap"><fmt:message key="label.mm.orgauth.allorgauthedcount" bundle="${mobileManageBundle}"/>:</td>
							   ...
							   <tr class="trstyle">
								   ...
								   <c:if test="${authedType == 23 }"> 
								 	 	<td class="bg-gray"  nowrap="nowrap"><fmt:message key="label.mm.orgauth.allorgeffectivecount" bundle="${mobileManageBundle}"/>:</td>
