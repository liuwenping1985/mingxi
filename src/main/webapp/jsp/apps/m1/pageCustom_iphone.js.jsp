...
<style type="text/css">
	#dv2{border-top:2px solid red;border-left:2px solid red;border-bottom:2px solid red;border-right:2px solid red;filter:alpha(opacity=70);background:#ffffff;position: absolute;top:22%;left:12%;width:77%;height:57%;}
	#dv1{position: relative;z-index:0;top:0%;left:18%;width:22%;height:98%;text-align:bottom;}
	...
	#dv5{border-top:2px solid red;border-left:2px solid red;border-bottom:2px solid red;border-right:2px solid red;filter:alpha(opacity=70);background:#ffffff;position: absolute;top:28%;left:29%;width:42%;height:22%;}
