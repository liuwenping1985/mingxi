    ...
    <div id='layout' class="comp" comp="type:'layout'">
        <div class="layout_north" layout="height:28,maxHeight:100,minHeight:30,sprit:false">
            ...
            <div class="common_tabs clearfix page_color">
                <ul class="left">
                    <li id="tab1" class="current"><a class="no_b_border" hidefocus="true" href="javascript:void(0)" tgt="tab1_iframe"><span><fmt:message key="label.mm.orgbind.bindmanage" bundle="${mobileManageBundle}"/></span></a></li>
                    <li id="tab4"><a hidefocus="true" href="javascript:void(0)" tgt="tab4_iframe" class="last_tab no_b_border"><span><fmt:message key="label.mm.orgbind.setsafelevel" bundle="${mobileManageBundle}"/></span></a></li>
                	<li id="tab7"><a hidefocus="true" href="javascript:void(0)" tgt="tab7_iframe" class="last_tab no_b_border"><span><fmt:message key="label.mm.orgbind.setbindnum" bundle="${mobileManageBundle}"/></span></a></li>
