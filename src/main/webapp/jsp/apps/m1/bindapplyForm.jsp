		...
		<div class="one_row">
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tbody>
					...
					<tr>
						<th nowrap="nowrap"><label class="margin_r_10" for="text">${ctp:i18n('m1.bind.apply.memberNum')}:</label></th>
						<td>
					...
					<tr>
						<th nowrap="nowrap"><label class="margin_r_10" for="text">${ctp:i18n('m1.bind.clientName')}:</label></th>
						<td>
							<div class="common_txtbox_wrap">
					...
					<tr>
						<th nowrap="nowrap"><label class="margin_r_10" for="text">${ctp:i18n('m1.bind.clientType')}:</label></th>
						<td>
							<div class="common_txtbox_wrap">
					...
					<tr>
						<th nowrap="nowrap"><label class="margin_r_10" for="text">${ctp:i18n('m1.bind.apply.applyClientNum')}:</label></th>
						<td>
							<div class="common_txtbox_wrap">
					...
					<tr>
						<th nowrap="nowrap"><label class="margin_r_10" for="text">${ctp:i18n('m1.bind.apply.applyDate')}:</label></th>
						<td>
							<div class="common_txtbox_wrap">
