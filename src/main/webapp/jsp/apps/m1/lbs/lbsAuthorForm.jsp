			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tbody>
					<tr>
						...
						<td>
							<div class="common_txtbox_wrap">
								...
								validate="type:'string',name:'${ctp:i18n('m1.lbs.authorUser')}',notNull:true,minLength:1,maxLength:85,avoidChar:'\\\/|><?&%$|'">
							</div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div class="common_txtbox_wrap">
								<textarea id="scopes"  name = "scopes" rows="5" cols="60"  style="color:gray;overflow-y:auto"
								validate="type:'string',name:'${ctp:i18n('m1.lbs.authorScope')}',notNull:true,minLength:1,maxLength:85,avoidChar:'\\\/|><?&%$|'"></textarea>
							</div>
						</td>
					</tr>
				</tbody>
