...
$().ready(function(){
	...
	$("#detailRightFrame").attr("src","plan.do?method=getPlanSummary&planId=${param.planId }&path=${commentMaxPathStr}&readOnly=${param.readOnly}");
...
<body class="page_color bg_color"  onbeforeunload="removeCtpWindow('${param.planId}',2)">
	...
	<div id="detailLayout" class="comp " comp="type:'layout'">
        ...
        <c:if test="${isRef eq false}">
	        <div class="layout_east" layout="border:false,width:45,minWidth:45,maxWidth:310,sprit:false">
