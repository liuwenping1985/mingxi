...
<body scroll="no" onload="init()" class="h100b over_hidden page_color bg_color">
    <div id="tabs" class="comp margin_t_5" comp="type:'tab',height:410" >
        ...
        <div id="tabs_body" class="common_tabs_body" style="overflow:hidden;">
            <iframe id="tab_iframe_0" border="0" src="plan.do?method=planReferTome&curPlanId=${empty param.curPlanId ? -1 : param.curPlanId}&formId=${param.formId}&subTableName=${param.subTableName}&needDisplayNames=${param.needDisplayNames}" frameBorder="no" width="100%" class="hidden"></iframe>
            <iframe id="tab_iframe_1" border="0" src="plan.do?method=getPlanRefers&curPlanId=${empty param.curPlanId ? -1 : param.curPlanId}" frameBorder="no" width="100%" class="hidden"></iframe>
            <iframe id="tab_iframe_3" border="0" src="plan.do?method=getMyTaskList" frameBorder="no" width="100%" class="hidden"></iframe>
            <iframe id="tab_iframe_4" border="0" src="plan.do?method=getMeetingList" frameBorder="no" width="100%" class="hidden"></iframe>
        </div>
    </div>
