...
<div class="stadic_layout">
    ...
    <div id="tabs" class="comp" comp="type:'tab',parentId:'divId'">
      ...
      <div id="tabs_body" class="common_tabs_body border_all">
        <iframe id="imageAuto" class="calendar_show_iframe frameColor" border="0" src="${path}/office/autoUse.do?method=autoOrderImage&applyUserId=${param.applyUserId}&applyOuttime=${param.applyOuttime}&applyBacktime=${param.applyBacktime}&isAdmin=${param.isAdmin}" frameBorder="0" width="100%"></iframe>
        <iframe id="listAuto" class="calendar_show_iframe frameColor" name ="listAuto" border="0" frameBorder="0" width="100%" src="${path}/office/autoUse.do?method=autoOrderList&applyUserId=${param.applyUserId}&applyOuttime=${param.applyOuttime}&applyBacktime=${param.applyBacktime}&isAdmin=${param.isAdmin}"></iframe>
      </div>
    </div>
    </div>
</div>
