...
function fnPrint(){
  ...
  obj.$("td:has(#applyDepartType)").attr("id","tempSelect").html("<DIV id='applyDepartTypeDiv' class='common_txtbox_wrap'><input disabled='disabled' class='validate font_size12 w100b' id='applyDep' type='text' maxLength='80' value='"+applyDepartType+"' validate='type:'string',name:'出发地'' _da='true'></div>");
  if(method=="sendEdit"){
