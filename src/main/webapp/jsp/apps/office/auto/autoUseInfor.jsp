...
<!--申请数据区域-->
<table id="autoUseTab"  class="w90b" border="0" cellSpacing="2" cellPadding="0" align="center" style="table-layout:fixed;">
  <!-- 申请 -->
  <tr>
  ...
  <tr nodePostion="send" nodeAcl="sendOut">
      ...
      <td align="left" colspan="2">
       <div class="common_txtbox_wrap ">
         <input id="applyOuttime" class="comp font_size12 validate w90b" style="width:98%" type="text" comp="type:'calendar',ifFormat:'%Y-%m-%d %H:%M',showsTime:true" validate="name:'${ctp:i18n('office.autoapply.udate.js')}',notNull:true" readonly>
      </div>
      </td>
