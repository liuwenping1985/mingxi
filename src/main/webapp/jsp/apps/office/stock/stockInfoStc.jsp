...
<%@ include file="/WEB-INF/jsp/apps/office/officeHeader.jsp"%>
  ...
  <script type="text/javascript" charset="UTF-8"
  src="${path}/apps_res/office/js/stock/stockInfoStc.js${ctp:resSuffix()}"></script>
  <script type="text/javascript">
      var stockParam = {stockHouses:'${stockHouses}',stockCategorys:'${stockCategorys}',option:'${option}'};
  </script>
...
<body>    
     <div id='layout' class="comp bg_color" comp="type:'layout'">
        <div class="layout_north" id="layout_north" layout="height:170,maxHeight:180,minHeight:100,spiretBar:{show:true,handlerT:function(){layout.setNorth(0);},handlerB:function(){layout.setNorth(170);}}">
