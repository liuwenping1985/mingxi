...
<script type="text/javascript" charset="UTF-8" src="${path}/apps_res/office/js/stock/stockHouseEdit.js"></script>
</head>
<body class="h100b over_hidden">
  <div class="stadic_layout h100b font_size12">
    <div class="stadic_layout_head stadic_head_height bg_color_gray">
      <!--上边区域-->
      <div class="clearfix ">
        <span class="left margin_5 font_bold color_blue">${ctp:i18n('office.stock.house.set.js')}</span><span class="right margin_5 green">*${ctp:i18n('office.auto.must.enter.js') }</span>
      </div>
    </div>
    <div id="centerDIV" class="stadic_layout_body stadic_body_top_bottom margin_b_5">
      <!--中间区域-->
      <div id="stockHouseDiv" class="form_area set_search align_center">
        <table border="0" cellSpacing="0" cellPadding="0" align="center" style="table-layout: fixed;" width='500'>
          <tr>
            <th class="padding_r_5" width="100" noWrap="nowrap" align="right"><span class="color_red">*</span><label for="text">${ctp:i18n('office.stock.house.js') }:</label>
            </th>
            <td>
              <div class="common_txtbox_wrap">
                <input id="name" class="validate font_size12" type="text" maxlength="85" validate="type:'string',name:'${ctp:i18n('office.stock.house.name.js')}',notNull:true,notNullWithoutTrim:true"> <input id="id" type="hidden">
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <div class="common_txtbox_wrap">
                ...
                <input id="managertxt" class="validate font_size12" type="text" readonly="readonly" validate="type:'string',name:'${ctp:i18n('office.auto.admin.js')}',notNull:true" value=""/>
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td align="left">
              <div class="common_txtbox clearfix">
                <textarea id=scope name="scope" class="comp w100b validate font_size12" style="height: 70px;" 
                  ...
                  comp="type:'selectPeople', panels:'Account,Department,Team,Post,Level',selectType:'Account,Department,Team,Post,Level,Member'"></textarea>
              </div>
            </td>
          </tr>
        </table>
