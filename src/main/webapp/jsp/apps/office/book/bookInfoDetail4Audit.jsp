...
<script type="text/javascript" charset="UTF-8"
	src="${path}/apps_res/office/js/book/bookInfoDetail4Audit.js"></script>
</head>
				...
				<div id="mainbookInfo">
					...
					<table border="0" cellSpacing="3" cellPadding="0" align="center"
						...
						<tr>
							...
							<input type="hidden" id="bookImage" name="bookImage" value="${bookApplyVO.bookInfoVO.bookImage}" /> 
...
<!-- 								</div> -->
						...
						<tr>
							...
							<td colspan="5" align="left">
								<div>
									<textarea class="validate" id="auditOpinion" name="auditOpinion" 
										${bookApplyVO.bookApplyPO.bookApplystate != '1'?'disabled':''}
										style="width: 102%; height: 50px;" validate="maxLength:800,name:'${ctp:i18n('office.book.bookInfoDetail4Audit.pspyj.js') }'">${bookApplyVO.auditOpinion}</textarea>
								</div></td>
						</tr>
					</table>
				</div>
		...
		<c:if test="${bookApplyVO.bookApplyPO.bookApplystate == '1'}">
			<div id="btnDiv" class="stadic_layout_footer stadic_footer_height padding_tb_5 align_right bg_color_black">
				<a id="btnok" class="common_button margin_r_5 common_button_emphasize" href="javascript:void(0)" onclick="javascript:fnOK('passAndLend')">${ctp:i18n('office.book.bookInfoDetail4Audit.ptgbjc.js') }</a> 
				<a id="btncancel" class="common_button common_button_emphasize margin_r_5" href="javascript:void(0)" onclick="javascript:fnOK('pass')">${ctp:i18n('office.book.bookInfoDetail4Audit.ptg.js') }</a> 
				<a id="btncancel" class="common_button common_button_grayDark margin_r_5" href="javascript:void(0)" onclick="javascript:fnOK('noPass')">${ctp:i18n('office.book.bookInfoDetail4Audit.pbtg.js') }</a>
			</div>
		</c:if>
	</div>
</body>
