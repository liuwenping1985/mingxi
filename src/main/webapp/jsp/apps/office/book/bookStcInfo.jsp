...
<%@ include file="/WEB-INF/jsp/apps/office/officeHeader.jsp"%>
  ...
  <script type="text/javascript" charset="UTF-8"
  src="${path}/apps_res/office/js/book/bookStcInfo.js${ctp:resSuffix()}"></script>
  <script type="text/javascript">
      var bookParams = {bookHouse:'${bookHouse}',bookCategroy:'${bookCategroy}',option:'${option}',isBooksAdmin:'${isBooksAdmin}'};
  </script>
...
<body>    
     <div id='layout' class="comp bg_color" comp="type:'layout'">
        <div class="layout_north" id="layout_north" layout="height:140,maxHeight:180,minHeight:100,spiretBar:{show:true,handlerT:function(){layout.setNorth(0);},handlerB:function(){layout.setNorth(140);}}">
        ...
        <div class="layout_center stadic_layout margin_l_5" layout="border:true" >
                ...
                <table class="w100b">
                    <tr>
                        <td colspan="2">
                            ...
                            <a class="img-button margin_r_5" href="javascript:void(0)" id="reportToExcel" onclick="fnDownExcel()"><em class="ico16 export_excel_16"></em>${ctp:i18n('office.asset.assetInfoStc.pdc.js') }</a> 
                            <a class="img-button margin_r_5" href="javascript:void(0)" id="printReport" onclick="printColl()"><em class="ico16 print_16"></em>${ctp:i18n('office.asset.assetInfoStc.pdy.js') }</a> 
                            </span>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="stadic_layout_body stadic_body_top_bottom" id="reportResult">
                <div id="tabs"  class="stadic_layout" style="*position:absolute;height:98%;width:100%">
                    <ul id="queryResult" class="align_center border_tb common_tabs_body stadic_layout_body stadic_body_top_bottom" style="top:40px;bottom:35px;overflow:auto; background:#fff;">
                    </ul>
