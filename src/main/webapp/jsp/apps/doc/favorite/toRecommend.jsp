...
<div class="form_area h100b ">
  <FORM id=tableForm action="${path}/doc/knowledgeController.do?method=docRecommend">
	    <table class="font_size12 bg_color_white w100b "style="height:170px;padding-top:5px;" border="0" cellspacing="0" cellpadding="0" align="center">
	          <tr>
	            <td nowrap="nowrap" class="align_right padding_r_5" style="width:20%;"><font class="color_red">*</font>${ctp:i18n('doc.log.recommend.toSomebody')}:</td>
	            <td style="width:80%;"><div class="common_txtbox_wrap w90b" style="margin-left:0;">
	            	<input type="text" id="person" name="person" style="border:0;" class="comp validate w100b font_size12"
      ...
      validate="name:'${ctp:i18n('doc.recommend.warn.person')}',notNull:true"/>
	        ...
	        <tr>
	            <td nowrap="nowrap" class="align_right padding_t_5 padding_r_5" valign="top"  style="width:20%;"><font class="color_red">*</font>${ctp:i18n('doc.description')}:</td>
	            <td style="width:80%;"><div class="common_txtbox_wrap w90b" style="margin-left:0;">
  ...
  <div class="align_right bg_color_black" style="height: 40px;padding: 7px;margin: 10px 0;">
     <a id="btnok" class="common_button common_button_emphasize margin_r_10">${ctp:i18n('common.button.ok.label')}</a>
     <a id="btncancel" class="common_button common_button_grayDark margin_r_10">${ctp:i18n('common.button.cancel.label')}</a>
  </div>
  </FORM>
</div>
</body>
