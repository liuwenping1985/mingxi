...
<script type="text/javascript">
  ...
  function fnBtnOk(){
      ...
      strs = keyWords.split(" ");
      if (strs.length > 3) {
          $.infor($.i18n('doc.label.count.limit'));
          $("#btnok").enable();
      }else{
...
<div class="form_area h100b bg_color_white">
      ...
      <div id='favoritedDiv'>
         ...
         <div id='favoritednew' class="align_center">
            <table class="align_center w100b" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="align_left padding_t_5">${ctp:i18n_1('doc.log.favorite.save',2)}<a onclick="upOrDownDiv()">${ctp:i18n_1('doc.log.favorite.save',3)}</span><c:if test="${empty param.flag}"><span id="upDownIco" class="ico16 arrow_2_t"></span></c:if></a></td>
              </tr>
              </table>
         </div>
         </c:if>
    ...
    <div id="divCenter" class="border_t">
        <table class="w100b" border="0" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td></td>
                <td>
              		<div class="common_txtbox clearfix over_auto border_all padding_t_5" style="height: 180px; width: 210px;">
  ...
  <div id="divBottom" class="stadic_layout_footer stadic_footer_height align_right border_t bg_color_black padding_t_5">
    ...
    <a id="btncancel" class="common_button common_button_grayDark">${ctp:i18n('common.button.cancel.label')}</a>
    &nbsp;&nbsp;&nbsp;
  </div>
