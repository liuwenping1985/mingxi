    ...
    $('#myajaxgridbar').ajaxgridbar( {
      ...
      callback : function(fpi) {
        ...
        for(var i=0; i<resultLength; i++) {
          ...
          var divStr = "<div class=\"file_box_area\"><div class=\"clearfix padding_10\"><span class=\""+icoClass+"\"></span><div class=\"over_auto_hiddenY left_ie6\"><p class=\"file_box_area_title\" title=\""+docName+"\"><a href=\"javascript:openDocOnlyId(\'"+sourceId+"\');\">"+docName+"</a></p><span class=\""+star+"\"></span><p class=\"margin_t_5 color_gray\">作者："+author+"</p></div></div>"+
          "<div class=\"clearfix border_t\"><span class=\"color_gray left padding_tb_5 padding_l_10\">收藏("+collection+")&nbsp;评价("+evaluation+")</span><span class=\"right\"><span class=\"file_box_menu\"><a href=\"javascript:doc_recommend(\'"+docId+"\');\" class=\"ico16 FBM_recommend\" title=\"推荐\"></a><a href=\"#\" class=\"ico16 FBM_setting\" title=\"操作\"></a></span>"+
          "<div class=\"file_box_menu_list\"><ul class=\"lvl1\"><li><a href=\"#\">发送到</a><span class=\"ico16 arrow_gray_r left\"></span><div class=\"lvl2_box\"><ul class=\"lvl2\"><li><a href=\"javascript:sendToCommonDoc(\'"+docId+"\');\">常用文档</a></li><li style=\"display:"+display3+"\"><a href=\"javascript:sendToMyStudy(\'"+docId+"\');\">个人学习文档</a></li><li style=\"display:"+display3+"\"><a href=\"javascript:sendToSpecificLocation(\'"+docId+"\',\'"+parentId+"\',\'"+docLibId+"\');\">指定位置</a></li></ul></div></li>"+
          "<li style=\"display:"+display3+"\"><a href=\"#\">转发</a><span class=\"ico16 arrow_gray_r left\"></span><div class=\"lvl2_box\"><ul class=\"lvl2\"><li><a href=\"javascript:forwardDocToCol(\'"+docId+"\');\">转发协同</a></li><li><a href=\"javascript:forwardDocToEmail(\'"+docId+"\');\">转发邮件</a></li></ul></div></li><li style=\"display:"+display2+"\"><a href=\"javascript:downloadDoc(\'"+docId+"\',\'"+docName+"\',\'"+docMimeType+"\',\'"+_sourceId+"\',\'"+createDate+"\');\">下载</a></li><li style=\"display:"+display2+"\"><a href=\"javascript:edit(\'"+docId+"\',\'"+docName+"\',\'"+docMimeType+"\');\">编辑</a></li><li><a href=\"javascript:moveDoc(\'"+docId+"\',\'"+parentId+"\',\'"+docLibId+"\');\">移动</a></li><li style=\"display:"+display1+"\"><a href=\"javascript:replaceDoc(\'"+docId+"\',\'"+parentId+"\',\'"+docName+"\');\">替换</a></li><li><a href=\"javascript:deleteDoc(\'"+docId+"\');\">删除</a></li><li style=\"display:"+display3+"\"><a href=\"javascript:renameDoc(\'"+docId+"\');\">重命名</a></li><li style=\"display:"+display3+"\"><a href=\"javascript:borrowDoc(\'"+docId+"\');\">借阅</a></li><li><a href=\"javascript:docProperties(\'"+docId+"\');\">属性</a></li></ul></div></span></div></div>";
                    ...
                    <div class="font_size12 padding_l_10 padding_r_5 right" style="width: 251px;">
                        <div class="border_all bg_color_white clearFlow">
                            ...
                            <div class="clearfix padding_lr_10 margin_t_20">
                                ...
                                <span class="line_height200 right">我分享了${personStaut.shareNum}份文档</span>
                            </div>
                            ...
                            <div class="common_tabs2">
                                ...
                                <div class="tab_iframe tab_iframe1">
                                    <ul class="line_height200 margin_l_10">
                                        <li><a href="#" class="text_overflow color_black w160b"><span class="ico16 word_16 margin_r_5"></span>他人推荐</a><span class="color_gray margin_l_10">2012-12-12</span></li>
                                ...
                                <div class="tab_iframe tab_iframe2 hidden">
                                    <ul class="line_height200 margin_l_10">
                                        <li><a href="#" class="text_overflow color_black w160b"><span class="ico16 word_16 margin_r_5"></span>个人安排</a><span class="color_gray margin_l_10">2012-12-12</span></li>
                                        <li><a href="#" class="text_overflow color_black w160b"><span class="ico16 word_16 margin_r_5"></span>1致远协同软件安装1致远协同软件安装</a><span class="color_gray margin_l_10">2012-12-12</span></li>
                                        <li><a href="#" class="text_overflow color_black w160b"><span class="ico16 word_16 margin_r_5"></span>1致远协同软件安装1致远协同软件安装</a><span class="color_gray margin_l_10">2012-12-12</span></li>
                                        <li><a href="#" class="text_overflow color_black w160b"><span class="ico16 word_16 margin_r_5"></span>1致远协同软件安装1致远协同软件安装</a><span class="color_gray margin_l_10">2012-12-12</span></li>
                                        <li><a href="#" class="text_overflow color_black w160b"><span class="ico16 word_16 margin_r_5"></span>1致远协同软件安装1致远协同软件安装</a><span class="color_gray margin_l_10">2012-12-12</span></li>
                                ...
                                <div class="common_tabs2">
                                    ...
                                    <div class="tab_iframe tab_iframe1">
                                        <ul class="line_height200 clearfix">
                                            <li class="clearfix">
                                                <a href="#" class="text_overflow color_black w115b"><span class="ico16 word_16 margin_r_5"></span>个人常用链接</a>
                                                <a href="#" class="text_overflow color_black w115b"><span class="ico16 word_16 margin_r_5"></span>1致远协同软件安装1致远协同软件安装</a>
                                            </li>
                                            <li class="clearfix">
                                                <a href="#" class="text_overflow color_black w115b"><span class="ico16 word_16 margin_r_5"></span>网易</a>
                                                <a href="#" class="text_overflow color_black w115b"><span class="ico16 word_16 margin_r_5"></span>网易</a>
                                            </li>
                                            <li class="clearfix">
                                                <a href="#" class="text_overflow color_black w115b"><span class="ico16 word_16 margin_r_5"></span>网易</a>
