...
var jsURL = "${detailURL}";
    ...
    function saveIt(isFile, canEditOnline) {
        ...
        if(newName && oldName != newName){      
            ...
            return true;
            /*if('${param.openFrom}' === 'docCenterEdit') {
            	parent.frames["main"].frames["rightFrame"].location.reload(true);
            	getA8Top().dialog.close();
            } else {
            	window.parentDialogObj['uploadFileDialog'].close();
            }*/
...
<body scroll="no" onunload="unlockAfterAction('${doc.id}');">
        ...
        <c:if test="${!isCanEditOnline}">
            <tr class="padding_b_10">
                 <th nowrap="nowrap" colspan="5">
                     <div class="common_radio_box clearfix align_left margin_l_10">
            ...
            <tr class="padding_t_10">
                ...
                <td id="assdoc" noWrap="nowrap" class="border_t padding_t_10">
