...
<form method="get" action="${mainURL}">
	...
	<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    <td class="tab-body-bg" style="border-width: 0px" width="100%" align="center">
        <div class="scrollList">
        <table width="450" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
              <tr>
		        <td width="100%">
				<table class="border_all" width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr align="center">
			  	...
			  	<c:if test="${v3x:hasPlugin('webmail') == true && !(v3x:getSysFlagByName('email_notShow'))}">
			  	<tr align="center">
			  	...
			  	<c:if test="${v3x:getSystemProperty('doc.blogFlag') && v3x:isEnableSwitch('blog_enable')}">
			  	<tr align="center">
