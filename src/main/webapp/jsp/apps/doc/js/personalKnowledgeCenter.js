...
function fnDocComment(){
    ...
    $('#contentArea').html("<div class=\"border_b_gray margin_t_10 padding_b_5 clearFlow\"><div id=\"div_other_forum\" class=\"display_inline-block padding_lr_10 padding_tb_5 bg_color hand left\">${ctp:i18n('doc.jsp.knowledge.others.evaluation')}</div><div id=\"div_my_forum\" class=\"display_inline-block padding_lr_10 padding_tb_5 hand left\">${ctp:i18n('doc.jsp.knowledge.my.evaluation')}</div><div id=\"searchDiv_forum\" class=\"right\"></div></div><ul id=\"ulwithlis_docForum\" class=\"bg_color_white clearfix margin_t_10\"></ul>");
            ...
            if(queryObj.flag==1) { // 他人评论
                ...
                for (var i = 0, len = fpi.data.length; i < len; i++) {
                    ...
                    if(o.createUserValid!=null&&o.createUserValid){//离职人员处理
                        strHtml.append("' class='radius left margin_l_10 margin_b_10 margin_r_20 hand' src='" + fpi.data[i].userImageSrc + "' width='42' height='42' onclick='$.PeopleCard({memberId:\"");
                        strHtml.append(o.createUserId);
                    ...
                    strHtml.append("</a><span class='left margin_r_5'>"+target+"</span><span class='left ico16 fileType2_");
                    ...
                    if((!o.isPersonLib &&(o.potent.all || o.potent.read || o.potent.create || o.potent.edit || o.potent.readOnly))||(o.isPersonLib && !isDocCreateUser )){
                        ...
                        strHtml.append(" class='right margin_l_10 "+sShow+"'>${ctp:i18n('doc.jsp.knowledge.collection')}(");
                        ...
                        strHtml.append(o.docResourceId+"\",false,3,"+i+");'");
                        strHtml.append(" class='right margin_l_10 "+sHide+"'>${ctp:i18n('doc.jsp.cancel.collection')}(");
                        strHtml.append(o.collectCount.toString());
                        strHtml.append(")</a>");
                ...
                for ( var i = 0, len = fpi.data.length; i < len; i++) {
                    ...
                    strHtml.append("<span class='left margin_r_5'>${ctp:i18n('doc.jsp.knowledge.others.doc.label')}");
    ...
    $("#div_other_forum").click(function() {//他人评论
        ...
        $("#div_other_forum").addClass("bg_color");
        $("#div_my_forum").removeClass("bg_color");
        queryObj.flag = 1;
        queryObj.condition = "";
        $('#ajaxgridbar').ajaxgridbarLoad(queryObj);
    ...
    $("#div_my_forum").click(function() {//我的评论
        ...
        $("#div_my_forum").addClass("bg_color");
        $("#div_other_forum").removeClass("bg_color");
        queryObj.flag = 0;
        queryObj.condition = "";
        $('#ajaxgridbar').ajaxgridbarLoad(queryObj);
...
function fnMyDocLib(){
    ...
    $('#contentArea').html("");
    $('#contentArea').html("<div class=\"area_operation\" style='*position:relative; *overflow:visible;'><div id=\"docNavigation\" class=\"area_operation_item\"><a href=\"javascript:showDocOfTheFolder('"+myDocLib+"');\" id=\"docNavigator_"+myDocLib+"\" class=\"current\"><strong>${ctp:i18n('doc.jsp.knowledge.all')}</strong></a></div><div class=\"area_operation_btn\" >" +
            "<span class=\"area_operation_btn_shang\"><em></em></span><span class=\"area_operation_btn_xia\"><em></em></span></div></div><div class='clearFlow'><style>.common_search_condition{_float:right;}</style><div id=\"searchDiv\" class=\"align_left padding_10 right\"></div></div><div id=\"docContentList\" class=\"clearFlow\"></div>" +
            "<div id=\"myajaxgridbar\" class=\"number margin_t_10 padding_tb_5 align_center border_all\" ><a href=\"javascript:void(0);\" id=\"_afpNext\" >${ctp:i18n('doc.jsp.knowledge.personal.viewMore')}</a></div>");
    ...
    knowledgeManagerAjax.getFirstLevelFolder(userId, {
        success: function(levelOneFolders){
            for(var i=0; i<levelOneFolders.length; i++){
                ...
                var aStr = "<a id=\"docNavigator_"+folderId+"\" title=\""+folderName+"\" href=\"javascript:showDocOfTheFolder('"+folderId+"');\">"+folderName+"</a>";
    ...
    $('#myajaxgridbar').ajaxgridbar( {
      ...
      callback : function(fpi) {
        ...
        for(var i=0; i<resultLength; i++) {
          ...
          var icoClass = "ico32 "+sOpenSquare+"fileType_"+result[i].doc.mimeTypeId+" margin_r_10 left";
          ...
          var divStyle = ((i+1)%3 == 0) ? "" : "margin_r_42";
          var isForward = "";
          var forwardColl = "";
          var forwardMail = "";
          ...
          var divStr = "<div class=\"file_box_area "+divStyle+" margin_t_10 \"><div class=\"clearfix padding_10\"><span class=\""+icoClass+"\"></span><div class=\"over_auto_hiddenY left_ie6\"><p class=\"file_box_area_title\" title=\""+docTitle+"\"><a href=\"javascript:fnOpenKnowledge(\'"+docId+"\');\">"+docAttsTitle+"</a>";
          ...
          var cssStr=!createUserValid?("class='left text_overflow disabled_color' style='display: inline-block;width: 50px;' title='"+userValid+"'"):"class='left text_overflow' style='display: inline-block;width: 50px;'";
          ...
          +"<span class=\"ico16 arrow_gray_r left\"></span><div class=\"lvl2_box\"><ul class=\"lvl2\"><li style=\"display:"+display7+"\">"
          ...
          +"<ul class=\"lvl2\"><li style=\"display:"+forwardColl+"\">"
          ...
          +"<li><a href=\"javascript:docProperties(\'"+docId+"\','"+ isPig(docType) +"','"+result[i].doc.v+"');\">"
...
function docReadDisplay(result, docLocation){
    ...
    for (var i=0; i<result.length; i++) {
        ...
        var liClass = "margin_l_30";
        if (i == 0 || i%3 == 0) {
            liClass = "";
        }
        var hrStr = "";
        if (i != 0 && i%3 == 0) {
            hrStr = "<li class=\"line\"></li>";
        }
        var liStr = hrStr + "<li class=\""+liClass+"\"><span class=\""+icoClass+"\"></span><div class=\"clearFlow\"><div class=\"fixedHeigh\"><a href=\"javascript:fnOpenKnowledge(\'"+sourceDocId+"\');\" class=\"t color_black\" title=\""+docTitle+"\">"+docName+"</a>";
        if(!isPig) {
            liStr = liStr + "<div class=\"clearFlow\"><span title='${ctp:i18n('doc.knowledge.doc.score')}:"+avgScore+"' class=\""+star+" margin_t_5 left\"></span></div>";
        }
        if(createUserValid == null || !createUserValid){
            liStr = liStr + "</div><p class=\"color_gray2 margin_t_5\"><a id=\"user"+flag+i+"\" userId=\"" + docUserId +"\" isValid=\"false\" class=\"disabled_color\" title='"+userValid+"' >"+docUser+"</a>(" + result[i].createTime + ")</p></div></li>";
        }else{
            liStr = liStr + "</div><p class=\"color_gray2 margin_t_5\"><a id=\"user"+flag+i
...
function initDynamic() {
    ...
    $('A[name^=A_get]').click(function(){
       ...
       // 如果是全部动态，就不加载搜索框
       if (index === '3') {
           $('#contentArea').html("<ul id=\"ulwithlis_"+ index +"\" class=\"bg_color_white clearfix margin_t_10\"></ul>");
       }else {
           if (index === '4') {
        	   openFlag = "docTrends4";
               $('#contentArea').html(
                       "<div class='clearFlow margin_t_10'><div class=\"common_crumbs left\">" +
...
function showDocOperateDiv(o, isDocCreateUser, strOperator) {
    ...
    if(o.mimeTypeId !== '51') {
        ...
        if (((o.personal&&(o.sourceType==3||o.sourceType==4))
            ...
            strOperateDiv.append(" class='right margin_l_10 "+sShow+"'>${ctp:i18n('doc.jsp.knowledge.collection')}(");
            ...
            strOperateDiv.append(o.id+"\",false,3,"+_index+");'");
            strOperateDiv.append(" class='right margin_l_10 "+sHide+"'>${ctp:i18n('doc.jsp.cancel.collection')}(");
            strOperateDiv.append(o.collectCount.toString());
            strOperateDiv.append(")</a>");
        ...
        case 3:// 动态：alert,orgPush,recommend
        {
            for ( var i = 0, len = fpi.data.length; i < len; i++) {
                ...
                if(fpi.data[i].actionType==13 || fpi.data[i].actionType==21 || fpi.data[i].actionType==22) {
                    ...
                    if(fpi.data[i].isFromAcl == "true"){
                        fromType = "<a class=\"right\" name=\"A_get1\" index=\"1\" href=\"javascript:void(0);\">${ctp:i18n('doc.jsp.knowledge.orgPush')}</a>";
                        strOperator = "<span class='left margin_r_10 color_gray' title='"+fpi.data[i].actionUserName+"'>${ctp:i18n('doc.jsp.knowledge.pusher.label')}" + fnSubString(fpi.data[i].actionUserName,6) + "</span>";
                        strHtml.append(showOrgPush(fpi.data[i], fromType, i, isDocCreateUser, showDocOperateDiv(fpi.data[i], isDocCreateUser, strOperator)));
                    } else {
...
function showOtherRecommend(o, fromType, i, isDocCreateUser, strDocOperateDiv) {
	...
	if(o.actionType == 13){//他人推荐给我的动态
	    ...
	    if(o.actionUserValid!=null&&o.actionUserValid){//离职人员处理
	        strHtml.append("' class='radius hand' src='" + o.userImageSrc + "' width='42' height='42' onclick='$.PeopleCard({memberId:\"");
	        strHtml.append(o.actionUserId);
	        strHtml.append("\"});' /></div><div class='over_hidden' style='_width:570px; min-height:71px;'><div class='clearfix'><span class='left'><a onclick='javascript:$.PeopleCard({memberId:\"");
	        strHtml.append(o.actionUserId);
	        ...
	        strHtml.append("' class='radius hand common_disable' src='" + o.userImageSrc + "' width='42' height='42' ");
	        strHtml.append(o.actionUserId);
	        strHtml.append(" title='"+userValid+"' /></div><div class='over_hidden' style='_width:570px; min-height:71px;'><div class='clearfix'><span class='left'><a href='javascript:void(0);' ");
	        strHtml.append(o.actionUserId);
	        strHtml.append(" title='"+userValid+"' class='left margin_r_5 disabled_color'>");
	        strHtml.append(fnSubString(o.actionUserName,6));
	    }
	    ...
	    if(o.actionUserValid!=null&&o.actionUserValid){//离职人员处理
	        strHtml.append("' class='radius hand' src='" + o.userImageSrc + "' width='42' height='42' onclick='$.PeopleCard({memberId:\"");
	        strHtml.append(o.actionUserId);
	        strHtml.append("\"});' /></div><div class='over_hidden' style='_width:570px; min-height:71px;'><div class='clearfix'><span ");
	        strHtml.append(o.actionUserId);
...
function fnBtnShangClick() {
    var _obj = $(".area_operation_item");
    _obj.css({ overflow: "block", height: "auto" });
    var _allHeight = _obj.height();
    _obj.css({ overflow: "", height: "" });
    
    $(".area_operation_btn .area_operation_btn_xia").show();
    $(".area_operation_btn .area_operation_btn_shang").hide();
    
    if ($.browser.msie) {
        if ($.browser.version == "6.0") {
            if (_allHeight > 51) {
                _obj.css({"overflow-y": "auto" });
            }
            _obj.css({ height: "51px" });
            return;
        }
    }
    
    _obj.animate({ height: "51px" }, "fast", function () {
    	 if (_allHeight > 51) {
    		 _obj.css({ "overflow-y": "auto","height": "" });
    	 }
    });
}
        ...
        success:function(list) {
            ...
            if(list.length > 0){
                for(var i=0; i< list.length; i++) {
                    var o = list[i];
                    strHtml += 
                    "<a target='blank' href='" + o.url + "' class='left margin_l_5 text_overflow color_black w100 display_block' title='"+o.title+"' ><img src='${path}" 
                ...
                strHtml = "<div id='knowledgeNoneLink' class=\"color_gray align_center padding_10\">${ctp:i18n('doc.knowledge.blank.warning')}</div>";
...
function fnBtnXiaClick() {
    ...
    $(".area_operation_btn .area_operation_btn_shang").show();
    if ($.browser.msie) {
        if ($.browser.version == "6.0") {
            _obj.css({ "height": "" });
            _obj.scrollTop(0);
    ...
    if(_allHeight > 125){
		 _obj.animate({ height: "125px" }, "fast", function () {
			_obj.css({"overflow-y": "auto" });
		});
    }else if(_allHeight>50){
    	 _obj.animate({ height: _allHeight + "px" }, "fast", function () {
 			_obj.css({"overflow-y": "" });
 		});
    }else{
    	 _obj.animate({ height: "51px" }, "fast", function () {
