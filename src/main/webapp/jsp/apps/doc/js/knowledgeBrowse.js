	            ...
	            toolbar : [  {
	                                ...
	                                buttons: [{
	                                    ...
	                                    handler: function () {
	                                    	...
	                                    	if(returnValue) {
	                                        	...
	                                        	// 刷新知识查看页面
	                                        	if(window.parentDialogObj) {
	                                        		getA8Top()._dialog = window.parentDialogObj['docOpenDialogOnlyId'];
	                                        		window.parentDialogObj['docOpenDialogOnlyId'].reloadUrl();	                                        		
	                                        	} else {
	                                        		getA8Top()._dialog.reloadUrl();
	                                        	}
	                                    	}                                    	
	                                    }
	                                }, {
	                ...
	                subMenu : [{
	                    ...
	                    click : function() {
	                        ...
	                        sendToCollOrEmail(colUrl, '${doc.id}', '${doc.docLibId}','${param.entranceType}');
	                    }
	                }, {
	                    id : "sendToEmail",
