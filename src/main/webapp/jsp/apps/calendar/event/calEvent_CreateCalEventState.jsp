...
<script type="text/javascript" src="${path }/apps_res/calendar/js/calEvent_CreateCalEventState.js"></script>
</head>
<body
  onload="loadData(${calEventInfoBO.weeks},${calEventInfoBO.calEventPeriodicalInfo.periodicalType});">
  <form id="createCalEventState" action="#">
    <div class="form_area margin_10">
      <table width="100%">
        ...
        <tr>
          <td colspan="4" class="margin_r_5">${ctp:i18n("calendar.event.create.periodicalStyle")}:</td>
        </tr>
        <tr>
