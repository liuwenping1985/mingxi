...
<script type="text/javascript">
    ...
    */
    function checkTaskContetnNum(maxNum) {
        ...
        if (total > maxNum) {
            bool = false;
            $.alert("${ctp:i18n_2('taskmanage.alert.feedback_content_more_than_maxnum','"+maxNum+"','"+total+"')}");
        }
        return bool;
    }
   ...
   function yesido(){
           ...
           $("#autofinishrate").html("<font color='grey'>${ctp:i18n('taskmanage.auto_completion_rate')}"+ $("#taskInfoAutoFinishRate").val()+"%</font>");
		   var autoActualTaskTimeTips="${ctp:i18n('taskmanage.auto_time_consuming')}" + $("#taskInfoAutoActualTaskTime").val() + "${ctp:i18n('common.time.hour')}";
		   $("#autoActualTaskTime").html("<font color='grey' title='"+autoActualTaskTimeTips+"'>"+autoActualTaskTimeTips+"</font>");
		   $("#canhandwrite").val("1");
