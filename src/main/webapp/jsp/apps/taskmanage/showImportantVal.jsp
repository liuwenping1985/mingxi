...
<body style="height:96%">
  <table class="margin_l_10" style="font-size:14px;width:95%;">
    ...
    <tr>
      <td colspan="2"><input type="checkbox" name="checkboxMilestone" value="1" onclick="checkNotNull(this)">${ctp:i18n("taskmanage.marked.milestone.label")}</td>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var defaultVal = "important=1,2,3&,state=1,2,3,4&,risk=0,1,2,3&,milestion=0,1&,"+defaultOverdue;
    </c:when>
    <c:otherwise>
    var defaultVal = "important=1,2,3&,state=1,2,3&,risk=0,1,2,3&,milestion=0,1&,"+defaultOverdue;
    </c:otherwise>
  </c:choose>
