...
<li class="tabs_reply_list clearfix">
    ...
    <ul class="tabs_reply_content">
        ...
        <li class="tabs_reply_content_list" cid="${comment.id }" mtp="${comment.moduleType }" mid="${comment.moduleId }">
            ...
            <p class="tabs_reply_content_list_content" style="word-wrap: break-word;word-break: break-all;"><c:out value="${comment.content }" escapeXml="false"/></p>
        ...
        <li class="tabs_reply_content_list">
            ...
            <p class="tabs_reply_content_list_content" style="word-wrap: break-word;word-break: break-all;"><c:out value="${comm.content }" escapeXml="false"/></p>
