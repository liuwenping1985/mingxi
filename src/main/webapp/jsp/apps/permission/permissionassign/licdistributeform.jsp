						...
						<td>
							...
							<td nowrap="nowrap">
								<label class="margin_r_10" for="text">
									...
									"${ctp:i18n('licensePermission.totalnum')}":server(<label id="totalservernum"></label>);M1(<label id="totalm1num"></label>) 
								</label>
							</td>
						</tr>	
						<tr>
						<td>
							...
							<td nowrap="nowrap">
								<label class="margin_r_10" for="text">
									...
									"${ctp:i18n('licensePermission.unusernum')}":server(<label id="levelservernum"></label>);M1(<label id="levelm1num"></label>)
								</label>
							</td>
