...
//	alert(flag);
	...
	function replyPost(){
		...
		//alert(genericURL+"?method=showPost&articleId=${article.id}&resourceMethod=${resourceMethod}");
	//	window.location.href=genericURL+"?method=showPost&articleId=${article.id}&resourceMethod=${resourceMethod}&from=section";
	//	window.location.href=genericURL+"?method=showPostPro&articleId=${article.id}&resourceMethod=${resourceMethod}&familyId=&from=section&t=" + new Date();
		//window.location.href = window.location.href;
		//articleRefresh();
	//	window.location.reload(true);
	}
	function reloadPage() {
		window.location.href=genericURL+"?method=showPostPro&articleId=${article.id}&resourceMethod=${resourceMethod}&familyId=&from=section&t=" + new Date() + "&v=${v}";
		window.location.reload(true);
	}
