...
<script type="text/javascript" src="${path}/ajax.do?managerName=traceWorkflowManager"></script>
<title></title>
...
window.onload = function(){
    ...
    //撤销/回退人   
    colModel.push({ display : "撤销/回退人",name : 'operationName',width : '15%',sortable : true});
    //撤销/回退时间       
    colModel.push({ display : "撤销/回退时间",name : 'operationTime',width : '20%',sortable : true});
	//操作内容
    colModel.push({ display : "操作内容",name : 'trackType',width : '10%',sortable : true});
    /**定义列表结束**/
