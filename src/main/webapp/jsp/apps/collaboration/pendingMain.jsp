...
<c:if test="${'listAndStatisticalGraph' eq columnsStyle }">
	...
	<!-- echarts.js和seeyon.ui.echarts3.js暂时采用此方法加载 -->
...
<body class="h100b bg_color_white bg_color_none" onunload="removeChart()">
...
<table id="pendingTable" width="100%"  cellpadding="0" cellspacing="0" border="0">
	<tr>
		<!--单列表 -->
		<c:if test="${columnsStyle eq 'orderList'}">
		...
		<!-- 双列表  -->
		<c:if test="${columnsStyle eq 'doubleList'}">
