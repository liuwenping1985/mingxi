...
<head>
    ...
    <script type="text/javascript"><!--
        ...
        $(document).ready(function () {
            ...
            function peixundone(){
                window.location.href='/seeyon/collaboration/collaboration.do?method=moreDone&fragmentId=-3740902489223051789&ordinal=0&rowStr=subject,createDate,receiveTime,sendUser,deadline,category&columnsName=培训记录&isGroupBy=false';
                hideTimeLineView();
            }
            ...
            function kaoqinsent(){
                window.location.href='/seeyon/collaboration/collaboration.do?method=moreSent&fragmentId=-6995269010076581759&ordinal=0&rowStr=subject,publishDate,currentNodesInfo&columnsName=考勤记录';
            ...
            function doneEdocgw(){
                window.location.href='/seeyon/collaboration/collaboration.do?method=moreDone&fragmentId=-980409522573917801&ordinal=0&rowStr=subject,createDate,receiveTime,edocMark,sendUnit,currentNodesInfo,sendUser,deadline&columnsName=已办公文&isGroupBy=true';
            }
             function todoEdoc2(){
            ...
            function doneEdoc2(){
               window.location.href='/seeyon/collaboration/collaboration.do?method=moreDone&fragmentId=-980409522573917801&ordinal=1&rowStr=subject,createDate,receiveTime,edocMark,sendUnit,currentNodesInfo,sendUser,deadline&columnsName=已阅公文&isGroupBy=false';
            }
            ///seeyon/fileUpload.do?type=0&applicationCategory=1&extensions=&maxSize=&isEncrypt=&popupTitleKey=&attachmentTrId=showAttFile
...
window.parent.$(".layout_content_main_content").css("top","50px");
           if("${param.columnsName}"=="待办公文"){
            toolbarmenu.push({id: "todo-edoc",name: "待办",className: "ico16 batch_16",click:todoEdoc});
             toolbarmenu.push({id: "done-edocgw",name: "已办",className: "ico16 forwarding_16",click:doneEdocgw});
           ...
           } else if("${param.columnsName}"=="考勤记录"){
            toolbarmenu.push({id: "create-edoc",name: "已发",className: "ico16 sent_16",click:kaoqinsent});
                        toolbarmenu.push({id: "done-edoc",name: "待处理",className: "ico16 forwarding_16",click:kaoqinpending});
