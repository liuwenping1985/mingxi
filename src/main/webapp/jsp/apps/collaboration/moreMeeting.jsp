        ...
        $(document).ready(function () {
            ...
            function rend(txt, data, r, c, col) {
                ...
                if(col.name == "subject"){
                    ...
                    txt = "<a class='color_black' href='javascript:void(0)' onclick='linkToSummary(\""+data.entityId+"\",\""+data.subject+"\","+data.applicationCategoryKey+",\""+data.objectId+"\")'>"+txt+"</a>";
    ...
    <div id='layout' class="font_size12">
        <div class="layout_north bg_color" id="north">
            <div class="border_lr border_t" style="padding-bottom:35px;">
                <div class="clearfix">
                    <span class="left color_gray font_size24 padding_l_10 padding_t_5">${ctp:i18n_1('collaboration.protal.more.done.label',total)}</span><!-- 已发事项 -->
                    <!-- <span id="backLink" class="right ico16 home_16 margin_r_10 margin_t_5"></span> --> <!-- 返回 -->
                </div>
                <div id="toolbars"> </div> 
            </div> 
        </div>
