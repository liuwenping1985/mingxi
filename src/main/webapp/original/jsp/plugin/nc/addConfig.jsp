...
getDetailPageBreak();
    function submitForm(onlyMap){
        ...
        if(checkForm(form)){
          ...
          form.submit();
          setTimeout("parent.parent.window.location.reload()",500);
        }
    }
    function cancel(){
    	previewFrame('Down');
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" align="down" class="categorySet-bg">
    <tr>
			...
			<table width="100%" border="0">
			  <tr>
				<td  width="100%" align="center">
					<input id="submintConfig" type="button" onclick="submitForm(1)" value="<fmt:message key='ntp.org.hand.save.list'/>" class="button-default-2">
