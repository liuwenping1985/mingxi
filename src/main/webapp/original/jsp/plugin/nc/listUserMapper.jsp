...
<script type="text/javascript">
		...
		//待修改getA8Top().showLocation(null, "<fmt:message key='menu.organization.info.manage' bundle='${v3xMainI18N}' />", "<fmt:message key='ntp.user.mapper' />");
</script>
</head>
		...
		<td id="grayTd" class="webfx-menu-bar">
			<form name="searchForm" id="searchForm" method="post"  action="${urlNCUserMapper}?method=listUserMapper&ncid=${v3x:toHTML(ncid)}" onkeypress="doSearchEnter()">
				<div class="div-float-right">
					<div class="div-float">
						<select style="height: 30px;width: 120px" name="condition" class="condition"
