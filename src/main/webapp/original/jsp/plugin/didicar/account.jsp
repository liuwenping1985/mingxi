			...
			<div class="form_area">
				<div class="one_row"
					...
					<div style="float: left; width: 40%; height: 100%;">
						<img src="/seeyon/apps_res/didicar/images/accountinfor.jpg" width="100%"
							height="100%">
					</div>
					<div
						...
						<div id="accountInfo">
							...
							<p id="didiMessage" class="hidden"><font color="#008000">${ctp:i18n('didicar.plugin.account.message.label')}</font></p>
							</div>
