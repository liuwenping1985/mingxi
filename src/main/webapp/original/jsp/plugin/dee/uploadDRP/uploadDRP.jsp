...
<script>
    var menus = [ {
        ...
        url : "/deeDeployDRPController.do?method=show&time="+Math.random()
    } ];
    if("no" == ${time}.key){
        ...
        $.infor({
            ...
            ok_fn : function() {
                location.href = _ctxPath
                        + "/deeDeployDRPController.do?method=show&time="+Math.random();
            },
            close_fn : function() {
                location.href = _ctxPath
                        + "/deeDeployDRPController.do?method=show&time="+Math.random();
			...
			<tr>
					...
					<div class="uploaddiv2">
						<div class="uploaddiv4">
							<form method="post" id="formFile" action="${urlDeeDeploy}?method=deployDRP&time=0.01"
