...
<script type="text/javascript">
    ...
    function nodeClk(e, treeId, node) {
    	var ids = "'" + node.id + "'";
    	ids = getAllChildrenNodes(node, ids);
    	$("#treeType").val(ids);
        var o = {};
        o.flowType = ids;
    ...
    function initTable() {
        ...
        gridObj = $deeTable.ajaxgrid({
            colModel: [
                ...
                {
                    display: "<fmt:message key='dee.deleteFlow.flowOtherName.label'/>",
                    name: 'fLOW_OTHER_NAME',
                    width: '10%'
                },
                {
                ...
                {
                    display: "${ctp:i18n('dee.delete.lable.datasource')}",
                    name: 'eXT3',
                    width: '20%'
                }
            ],
            managerName: "deeTriggerDesignManager",
            managerMethod: "getFlowListByConditions",
