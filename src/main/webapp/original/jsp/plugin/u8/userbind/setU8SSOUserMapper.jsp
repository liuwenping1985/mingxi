		...
		if (root.tagName=="ufsoft") {
			var fNodelist = root.childNodes;
				if (fNodelist!=null){
					...
					temptable.append("<tr><td style=\"background:#DFDEDC; border-left:1px solid #FFFFFF; border-right:1px solid #ACA899; text-align:center;\">${ctp:i18n('u8.message.sso.accountno')}</td><td style=\"background:#DFDEDC; text-align:left; border-left:1px solid #fff;\">${ctp:i18n('u8.message.sso.accountname')}</td></tr>");
