               ...
               if (root.tagName=="ufsoft") {
                 ...
                 if (fNodelist!=null){
                   ...
                   if (fNodelist!=null){
                      var flen = fNodelist.length;
                      var facccode,faccname;
                      temptable.append("<tr><td style=\"background:#DFDEDC; border-left:1px solid #FFFFFF; border-right:1px solid #ACA899; text-align:center;\"><fmt:message key='u8.message.sso.accountno'/></td><td style=\"background:#DFDEDC; text-align:center; border-left:1px solid #fff;\"><fmt:message key='u8.message.sso.accountname'/></td></tr>");
                      for (var i = 0; i < flen; i++) {
