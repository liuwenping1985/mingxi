			    ...
			    <tr class="page2-header-line">
					<td width="100%" height="41" valign="top" class="page-list-border-LRD">
						 <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
					     	<tr class="page2-header-line">
									<td id="notepagerTitle1" class="page2-header-bg">&nbsp;<fmt:message key='u8.user.mapper' /></td>
								...
								<c:if test="${userMapperList!=null}">
									<tr>
										<td class="bg-gray" width="20%" nowrap="nowrap">
											<fieldset>
												<legend>
													<fmt:message key='u8.current.mapper' /><fmt:message key='u8.user.account' />
												</legend>
												<table width="70%" border="0" cellspacing="0"
													cellpadding="0" align="center">
													<form id="postForm" method="post" action="${ncUserMapper}?method=deleteBindingMapper" onsubmit="return confirm('<fmt:message key='u8.user.confirm.delete'/>')" target="addConfigFrame">
													<tr>
										...
										<fieldset>
											<legend>
												<fmt:message key='addressbook.toolbar.new.select.label'
													bundle="${v3xCommonI18N}" /><fmt:message key='u8.currentuser.mapper' />
											</legend>
											<table width="70%" border="0" cellspacing="0" cellpadding="0"
												...
												<tr>
													<td class="bg-gray" width="20%" nowrap="nowrap">
														<fmt:message key='u8.user.account' />
														:
														<input style="height:20px;border:1px solid #8f9385"  onclick="this.value=''"  value=" " type="text" name="ncUserLoginName" id="ncUserLoginName" validate="notNull" inputName="<fmt:message key='u8.user.account' />"/>
														<fmt:message key='u8.org.user.password'/>:
														<input  value="" type="password" name="userPassword" validate="notNull" inputName="<fmt:message key='u8.org.user.password'/>"/>
													</td>
													<td class="bg-gray" width="20%" nowrap="nowrap">
														<input type="button"
