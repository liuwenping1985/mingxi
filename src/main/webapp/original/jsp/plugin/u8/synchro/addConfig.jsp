...
getDetailPageBreak();
    function submitForm(onlyMap){
        ...
        var u8Corp = document.getElementById("ncId").value;
        if(u8Corp == ""){
        	alert("<fmt:message key='u8.common.message.save.nou8corp'/>");
        	return;
        }
        if(checkForm(form)){
        	...
        	if(!isMenberChecked&&!departMentCheckBox&&!postMentCheckBox&&!levelMentCheckBox){
        		alert("<fmt:message key='u8.common.message.save.notSelect'/>");
        		return;
        	}
			...
			<table width="100%" border="0">
			  <tr>
				<td  width="100%" align="center">
					<input id="submintConfig" type="button" onclick="submitForm(1)" value="<fmt:message key='u8.org.hand.save.list'/>" class="button-default-2">
