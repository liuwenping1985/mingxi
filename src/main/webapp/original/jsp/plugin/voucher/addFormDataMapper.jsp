...
$().ready(function(){
	if("${mapper.extAttr1}"!=''){
		$("#type").val("${mapper.extAttr1}");
	}
	if("${mapper.id}"!=""){
		$("#type").attr("disabled","disabled");
	}
	$("#type").change(function(){
		location.href = "${path}/voucher/documnentationMapperController.do?method=addFormDataMapper&type="+$(this).val();
	});
	...
	$("#addImg").click(function(){
		...
		html = "<td width='20.5%'><select class='w100b select' id='"+type+"_7_bindType_"+newNum+"' name='${ctp:i18n('voucher.formmapper.bindType')}'>    <option selected='selected' value='1'>${ctp:i18n('voucher.formmapper.bindType.fixed')}</option><option value='2'>${ctp:i18n('voucher.formmapper.bindType.bindData')}</option></select></td>"+
		...
		<div class="one_row" style="width:70%;">
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tbody>
					...
					<tr>
						<th nowrap="nowrap"><label class="margin_r_10" for="text">${ctp:i18n('voucher.plugin.cfg.accountCfg.type')}:</label></th>
						<td width="25%">
							<div style="width:100%;">
				...
				<fieldset id="form_head" style=" width: 100%;border: 1;">
					...
					<div  style="width: 100%;border: 0px;" align="left">
				        ...
				        <table id="mytable" class="flexme3" border="0" cellspacing="1" cellpadding="0" width="100%">
				        	...
				        	<c:forEach	items="${mapper.headList}" var="headField" varStatus="status">
				        		<tr>
				        		<td width="6%"><span>${status.count}</span></td><td width="15">${ctp:i18n(headField.name)}</td>
				        		<td width="18%">
                                        <select class="select" id="head_${headField.num }_bindType" name="${ctp:i18n('voucher.formmapper.bindType')}" class="w100b">
				...
				<fieldset id="form_debit" style=" width: 100%;height: 300;border: 1;">
					...
					<div style="width: 100%;border: 0px;" align="center">
				        ...
				        <table class="flexme3" border="0" cellspacing="1" cellpadding="0" width="100%">
				        	...
				        	<c:forEach	items="${mapper.debitList}" var="debitField" varStatus="status">
				        		<tr>
				        		<td width="6%">${status.count}</td><td width="16%">${ctp:i18n(debitField.name)}
				        		</td>
				        		<c:if test="${debitField.num!=7 }">
					        			<td width="16%">
	                                        <select class="select w100b" id="debit_${debitField.num}_bindType" name="${ctp:i18n('voucher.formmapper.bindType')}">
				        				...
				        				<table width="100%" id="debit_assist">
				        					<c:forEach items="${mapper.debitAssist}" var="assist">
				        						<tr class="assist" id="debit_assist_${assist.num}">
				        							<td width="20.5%"><select class="select w100b"  id="debit_${debitField.num}_bindType_${assist.num}" name="${ctp:i18n('voucher.formmapper.bindType')}">
				...
				<fieldset id="form_credit" style=" width: 100%;height: 300;border: 1;">
					...
					<div style="width: 100%;border: 0px;" align="center">
				        ...
				        <table class="flexme3" border="0" cellspacing="1" cellpadding="0" width="100%">
				        	...
				        	<c:forEach	items="${mapper.creditList}" var="creditField" varStatus="status">
				        		<tr>
				        		<td width="6%">${status.count}</td><td width="16%">${ctp:i18n(creditField.name)}</td>
				        		<c:if test="${creditField.num!=7}">
				        				<td width="16%">
	                                        <select class="select w100b"  id="credit_${creditField.num}_bindType" name="${ctp:i18n('voucher.formmapper.bindType')}">
				        			...
				        			<div style="width: 100%;border: 1px; margin: 0px; padding: 0px;" align="center">
				        				<table width="100%" id="credit_assist">
				        					<c:forEach items="${mapper.creditAssist}" var="assist">
				        						...
				        						<td width="20.5%"><select class="select w100b"  id="credit_${creditField.num}_bindType_${assist.num}" name="${ctp:i18n('voucher.formmapper.bindType')}">
		                                            <c:if test="${assist.bindType==1 }">
		                                        		<option value="1" selected="selected">${ctp:i18n('voucher.formmapper.bindType.fixed')}</option>
		                                            	<option value="2">${ctp:i18n('voucher.formmapper.bindType.bindData') }</option>
		                                        	</c:if>
				...
				<fieldset id="form_reversal" style=" width: 100%;height: 300;border: 1;">
					...
					<div style="width: 100%;border: 0px;" align="center">
				        ...
				        <table class="flexme3" border="0" cellspacing="1" cellpadding="0" width="100%">
				        	...
				        	<c:forEach	items="${mapper.reversalList}" var="reversalField" varStatus="status">
				        		<tr>
				        		<td width="6%">${status.count}</td><td width="16%">${ctp:i18n(reversalField.name)}</td>
				        		<c:if test="${reversalField.num!=7}">
				        				<td width="16%">
	                                        <select class="select w100b"  id="reversal_${reversalField.num}_bindType" name="${ctp:i18n('voucher.formmapper.bindType')}">
				        			...
				        			<div style="width: 100%;border: 1px; margin: 0px; padding: 0px;" align="center">
				        				<table width="100%" id="reversal_assist">
				        					<c:forEach items="${mapper.reversalAssist}" var="assist">
				        						...
				        						<td width="20.5%"><select class="select w100b"  id="reversal_${reversalField.num}_bindType_${assist.num}" name="${ctp:i18n('voucher.formmapper.bindType')}">
		                                            <c:if test="${assist.bindType==1 }">
		                                        		<option value="1" selected="selected">${ctp:i18n('voucher.formmapper.bindType.fixed')}</option>
		                                            	<option value="2">${ctp:i18n('voucher.formmapper.bindType.bindData') }</option>
		                                        	</c:if>
