...
window.onload = function(){
	...
	$("fieldset").each(function(){//如果<fieldset>中没有内容，就隐藏
		var ths = $(this);
		if(ths.find("input").size() == 0){
			ths.parents("td").hide();
		}
	});
...
<div class="scrollList" id="scrollListDiv" style="padding:0px 5px;background: #fafafa;">
...
<table align="center" width="100%" border="0" class="padding_t_5">
	...
	<td width="50%" height="100%" valign="top">
		<table border="0" width="100%" cellspacing="10" cellpadding="0">
			<tr>
				<td>
				<fieldset style="border: 1px solid rgb(223,223,223);">
					<legend>
	 					<label for="App_Col">
	 						<input style="margin-left:3px" type="checkbox" id="App_Col" name="App" onclick="checkAll('App_Col')" value="A___1" ><span style="color:#333;" class="padding_l_5">${ctp:i18n('application.1.label')}</span>
	 					</label>
					</legend>
					<table width="100%" style="border-spacing: 5px;color:#333;">
						<tr>
  ...
  <c:if test ="${ctp:hasPlugin('edoc')}">
		...
		<table border="0" width="100%" cellspacing="10" cellpadding="0">
			<tr>
				...
				<fieldset style="border: 1px solid rgb(223,223,223);">
					<legend>
	 					<label for="App_Fa">
	 						<input style="margin-left:3px" type="checkbox" id="App_Fa" name="App"  onclick="checkAll('App_Fa')" value="A___19" ><span class="padding_l_5">${ctp:i18n('application.19.label')}</span>
	 					</label>
					</legend>
					<table width="100%" style="border-spacing: 5px;color:#333;">
						<tr>
		...
		<table border="0" width="100%" cellspacing="10" cellpadding="0">
			<tr>
				...
				<fieldset style="border: 1px solid rgb(223,223,223);">
					<legend>
	 					<label for="App_Shou">
	 						<input style="margin-left:3px" type="checkbox" id="App_Shou" name="App"  onclick="checkAll('App_Shou')" value="A___20" ><span style="color:#333;" class="padding_l_5">${ctp:i18n('application.20.label')}</span>
	 					</label>
					</legend>
					<table width="100%" style="border-spacing: 5px;color:#333;">
						<!--关闭了区分阅文、办文开关  -->
		...
		<table border="0" width="100%" cellspacing="10" cellpadding="0">
			<tr>
				...
				<fieldset style="border: 1px solid rgb(223,223,223);">
					<legend>
	 					<label for="App_Qian">
	 						<input style="margin-left:3px" type="checkbox" id="App_Qian" name="App" value="A___21" onclick="checkAll('App_Qian')" ><span style="color:#333;" class="padding_l_5">${ctp:i18n('application.21.label')}</span>
	 					</label>
					</legend>
					<table width="100%" style="border-spacing: 5px;color:#333;">
						<tr>
						...
						<fieldset style="border: 1px solid rgb(223,223,223);">
							<legend>
			 					<label for="App_Meeting">
			 						<input style="margin-left:3px;" type="checkbox" id="App_Meeting" name="meeting"  onclick="checkAll('App_Meeting')" value="A___30" ><span style="color:#333;" class="padding_l_5">${ctp:i18n('application.6.label')}</span>
			 					</label>
							</legend>
							<table width="100%" style="border-spacing: 5px;color:#333;">
								<tr>
   ...
   <c:if test="${!(param.type ne null && param.type ne '') && openFrom ne 'doneSection' && openFrom ne 'trackSection'}">
		<td width="50%" height="100%" valign="top" class="padding_t_5">
			<table border="0" width="100%" cellspacing="10" cellpadding="0" style="color:#333;">
				<tr>
					<td>
					<fieldset style="border: 1px solid rgb(223,223,223);">
						<legend>
		 					<label for="App_Other">
		 						<b style="color:#333;">${ctp:i18n('common.other.label')}<fmt:message key="common.other.label" bundle="${v3xCommonI18N}" /></b>
		 					</label>
						</legend>
						<table width="100%" style="border-spacing: 5px;color:#333;">
							<tr>
              <c:if test="${ctp:hasPlugin('inquiry')  and openFrom == 'pendingSection'}">
								<td><%--待填写调查 --%>
									<label for="app_10">
								...
								<c:if test="${ctp:hasPlugin('edoc') and isInternal}">
  									<td><%--公文交换 --%>
  										<label for="app_23">
              ...
              <c:if test="${openFrom == 'pendingSection'}">
                <c:if test="${ctp:hasPlugin('news') or ctp:hasPlugin('bulletin')}">
  								<td>
                    <%--公共信息审批 --%>
  									<label for="app_8">
               ...
               <c:if test="${ctp:hasPlugin('office')}">
								<td><%--综合办公审批 --%>
									<label for="app_26">
