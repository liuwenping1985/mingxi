...
<body class="page_color font_size12">
            <div class="padding_10 line_height160">
              <c:if test = "${param.name ne 'newCol'}">
              ...
              <!-- 【协同新建属性】: 打印、撤销、归档、上传附件、关联文档、转发、编辑流程、重复发起      -->
              <c:if test="${param.name eq 'newCol'}">
              		<div class="border_all padding_5   margin_t_10">
                        <!-- 【打 印】:  此处设置发起人在已发事项中查看协同，是否显示打印操作-->
                        <p>${ctp:i18n('template.common.description.label39')}</p>
                        <p class="text_indent">${ctp:i18n('template.common.description.label409')}</p>
                    </div>
                    
              		<div class="border_all padding_5   margin_t_10">
                        <!-- 【撤 销】: 此处设置当流程发出后，发起人在已发事项中是否可撤销-->
                        <p>${ctp:i18n('template.common.description.label45')}</p>
                        <p class="text_indent">${ctp:i18n('template.common.description.label402')}</p>
                    </div>
                    
                    <div class="border_all padding_5   margin_t_10">
                        <!-- 【归档】:此处设置发起人在已发/待发事项中是否允许归档 -->
                        <p>${ctp:i18n('template.common.description.label411')}</p>
                        <p class="text_indent">${ctp:i18n('template.common.description.label403')}</p>
                    </div>
              		
              		<div class="border_all padding_5   margin_t_10">
                        <!-- 【上传附件】: 此处设置发起人在新建、已发事项中是否可插入附件  -->
                        <p>${ctp:i18n('element.info.help27.label')}</p>
                        <p class="text_indent">${ctp:i18n('template.common.description.label404')}</p>
                    </div>
                    
                     <div class="border_all padding_5   margin_t_10">
                        <!-- 【关联文档】:此处设置发起人在新建、已发事项中是否可插入关联文档 -->
                        <p>${ctp:i18n('template.common.description.label43')}</p>
                        <p class="text_indent">${ctp:i18n('template.common.description.label405')}</p>
                    </div>
                    
                    <div class="border_all padding_5  margin_t_10">
                        <!-- 【转 发】: 此处设置发起人在已发/待发事项中是否允许转发-->
                        <p>${ctp:i18n('template.common.description.label11')}</p>
                        <p class="text_indent">${ctp:i18n('template.common.description.label406')}</p>
                    </div>
                    
                    <div class="border_all padding_5  margin_t_10">
                        <!-- 【编辑流程】:此处设置发起人在已发事项中是否允许编辑流程 -->
                        <p>${ctp:i18n('template.common.description.label412')}</p>
                        <p class="text_indent">${ctp:i18n('template.common.description.label407')}</p>
                    </div>
                    
                    <div class="border_all padding_5  margin_t_10">
                        <!-- 【重复发起】:此处设置发起人在已发/是否允许重复发起 -->
                        <p>${ctp:i18n('template.common.description.label413')}</p>
                        <p class="text_indent">${ctp:i18n('template.common.description.label408')}</p>
                    </div>
              </c:if>
    </div>
</body>
