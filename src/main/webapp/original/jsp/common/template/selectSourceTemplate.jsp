...
$(document).ready(function() {
    ...
    var grid = $("#collaborationTemplateTable").ajaxgrid({
      ...
      display : "${param.categoryType==null || param.categoryType=='1'?ctp:i18n('template.selectSourceTem.modifyname'):ctp:i18n('template.selectSourceTem.belongsToPeople')}", //所属人
      name : 'createrName',
      width : '13%',
      sortable : true
    }],
    ...
    managerMethod : "selectTempletesForCopy",
