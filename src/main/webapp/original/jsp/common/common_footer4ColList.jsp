...
<script type="text/javascript" src="/seeyon/common/js/jquery.code-debug.js"></script> <!--codeOption -->
<script type="text/javascript" src="/seeyon/common/js/ui/searchBox-debug.js"></script> <!--searchCondition-->
 <script type="text/javascript" src="/seeyon/common/js/ui/seeyon.ui.grid-debug.js"></script> 
<script type="text/javascript" src="/seeyon/common/js/ui/seeyon.ui.toolbar-debug.js"></script><!-- WebFXMenuBar-->
<script type="text/javascript" src="/seeyon/common/js/ui/seeyon.ui.calendar-debug.js"></script>
 <script type="text/javascript" src="/seeyon/common/js/jquery.comp-debug.js"></script><!--releaseOnunload  -->
<%
    } else {
%>
<script type="text/javascript" src="/seeyon/common/coll-min.js${ctp:resSuffix()}"></script>
<script type="text/javascript" src="/seeyon/common/colList-min.js${ctp:resSuffix()}"></script>
<%
    }
%>
