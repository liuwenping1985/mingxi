...
<%-- $.ctx.customize = <c:out value="${ctp:getCustomizeJsonStr()}" default="null" escapeXml="false"/>; --%>
...
var v3x = new V3X();
v3x.init(_ctxPath, '<%=com.seeyon.ctp.common.i18n.LocaleContext.getLanguage(request)%>');
$.v3x = v3x;
$.content = {
    callback : {}
};
