...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td  class="webfx-menu-bar-gray" style="height:40px;">
			<script type="text/javascript">
		...
		<div class="div-float-right">
				...
				<div id="unitNameDiv" class="div-float hidden"><input type="text" id="textfield" name="textfield" class="textfield" style="height:24px;"></div>
