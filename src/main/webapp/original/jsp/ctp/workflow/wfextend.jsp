...
<body scroll="no">
    <form name="formulaDateDiffer" id="formulaDateDiffer" method="post">
        <div class="form_area">
                                    ...
                                    <td width="70%"><c:choose>
                                    		<c:when test="${type=='text' }">
                                    			<div id="type1Content" class="common_txtbox_wrap">
                									<input type="text" id="hand" value="" class="validate" validate="type:'string',name:'${ctp:i18n('workflow.formBranch.manualInput.vLabel') }',notNull:false,isDeaultValue:true,avoidChar:'><~!@#$%^&*()_+=&#34;\'{}[]\\/?|:\'&#34;',maxLength:255">
            									</div></c:when>
