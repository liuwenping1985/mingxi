...
$(document).ready(function(){
    ...
    if(_locale=='en'){
    	$("#selectorTab").width($("#selectorTab").width()+50);
    }
});
      ...
      if("true" == isMulti){
        if(selectedNodes.length>=10){
          $.messageBox({
            ...
            'type': 0,
            'msg': "<span class='msgbox_img_2 left'></span><span class='margin_l_5'>${ctp:i18n_2('space.alertSection1_3',10,10)}</span>",
             ok_fn: function() {
...
<body class="dialog_bg">
    ...
    <c:choose>
      <c:when test="${param.count != null && param.count <= 3 }">
          <div id="selectorTab" class="common_tabs clearfix" style="width: 698px; margin-left: 20px;">
              <ul class="left" id="selectorUl">
              </ul>
          </div>
      </c:when>
      <c:otherwise>
        <div id="selectorTab" class="common_tabs clearfix" style="width: 670px; margin-left: 20px;">
                <ul class="left" id="selectorUl">
                </ul>
            </div>
      </c:otherwise> 
        ...
        <div class="left">
            <table width="100%" height="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="padding-T padding-L" style="padding-left:20px;">
                        <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td height="20" class="padding_b_5" style="color:#666;">${ctp:i18n('channel.optional.label')}</td>
                            ...
                            <tr id="commonTR">
                                <td height="100%" valign="top" colspan="3">
                                    <div style="width:303px; height:370px; background:#FFF; border:solid 1px rgb(215,218,220);overflow:auto;">
                    ...
                    <td width="51px" align="center" valign="middle">
                    ...
                    <td class="padding-T padding-L">
                        <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td height="20" class="padding_b_5" style="color:#666;">${ctp:i18n('channel.selected.label')}</td>
                            </tr>
                            <tr>
                                <td height="100%" valign="top">
                                    <div  style="width:300px; height:370px; background:#FFF; border:solid 1px rgb(215,218,220);overflow:auto;">
