                        	...
                        	<tr>
                                <td>
                                    <div class="common_checkbox_box clearfix" style="margin-left: 210px; margin-bottom: 10px">
                                        <label class="hand" for="spacePubinfoEnable"><input id="spacePubinfoEnable" class="radio_com" name="spacePubinfoEnable" value="1" type="checkbox"></label>
                                        <label class="margin_r_10" for="text">${ctp:i18n("space.menu.pubinfo.enabled")}</label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="common_checkbox_box clearfix" style="margin-left: 210px; margin-bottom: 10px">
                                        <label class="hand" for="spaceMenuEnable"><input id="spaceMenuEnable" class="radio_com" name="spaceMenuEnable" value="1" type="checkbox"></label>
