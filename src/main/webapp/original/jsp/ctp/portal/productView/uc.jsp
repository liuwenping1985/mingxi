...
<head>
    ...
    <script>
        function downloadZX() {
            ...
            if (mac) {
                msg = "如需使用聊天功能,请使用致信pc端。" + "<br><a href='#' onclick=" + "javascript:window.open('/seeyon/autoinstall/zxsetup.dmg')" + ">点击下载致信pc端</a>";
            } else {
                msg = "如需使用聊天功能,请使用致信pc端。" + "<br><a href='#' onclick=" + "javascript:window.open('/seeyon/autoinstall/zxsetup.exe')" + ">点击下载致信pc端</a>";
            }
            var confirm = $.infor(msg);
        }
...
<body class="over_hidden">
    <img id="map" usemap="#map" src="${path}/skin/${CurrentUser.skin}/images/productView/uc.jpg">
