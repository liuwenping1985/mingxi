        ...
        function changeImgUrl(option) {
            ...
            switch (obj.attr("alt")) {
                ...
                case "关闭按钮":
                    ...
                    break;
                case "进入主题":
                  if("${ctp:hasPlugin('meeting') && ctp:hasResourceCode('T03_meeting_manage')}" == "true"){
                    getCtpTop().gotoDefaultPortal();
                    productTop.showMenu("${path}/portal/spaceController.do?method=showThemSpace&themType=22");
                    productTop.productView_Obj.close();
                    productTop.productView_Obj = null;
                  }else{
...
<body class="over_hidden">
    <img id="map" usemap="#map" src="${path}/skin/${CurrentUser.skin}/images/productView/hygl.jpg">
