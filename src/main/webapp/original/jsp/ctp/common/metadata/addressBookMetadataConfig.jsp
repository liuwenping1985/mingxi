...
<body>
    ...
    <div class="comp" comp="type:'breadcrumb',code:'F111_addressBookFieldSettings'"></div>
        <div class="layout_north" id="north" layout="height:40,sprit:false,border:false">
            <div id="toolbar"></div>
            <div id="searchDiv"></div>
        </div>
         <div id="west" layout="width:200" style="display: none" hidden="true">
            ...
            <div id="grid_detail">
                    ...
                    <div id="content_area" class="clearfix" style="position: relative;">
                        <div id="welcome">
                            <div class="color_gray margin_l_20">
                                <div class="clearfix">
                                    <h2 class="left" style="font-size: 26px;font-family: Verdana;font-weight: bolder;color: #888888;">${ctp:i18n("system.menuname.addressbookfieldsettings")}</h2>
             ...
             <!--                    <div class="line_height160 font_size14">1、新建属性</div> -->
                        ...
                        <div class="form_area" id="metadata_column">
                            <%@ include file="addressBookMetadataConfigEdit.jsp"%>
                        </div>
                    </div>
                    <div id="btnArea">
...
<%--     <%@ include file="/WEB-INF/jsp/common/common_footer.jsp"%> --%>
    ...
    <script type="text/javascript" charset="UTF-8" src="${path}/common/metadata/addMetadataConfigSearchBox.js${ctp:resSuffix()}"></script>
    <script type="text/javascript" charset="UTF-8" src="${path}/common/metadata/metadataConfigToolbar.js${ctp:resSuffix()}"></script>
    <script type="text/javascript" charset="UTF-8" src="${path}/common/metadata/addMetadataConfigColumnList.js${ctp:resSuffix()}"></script>
    <script type="text/javascript" charset="UTF-8" src="${path}/common/metadata/addMetadataConfigEdit.js${ctp:resSuffix()}"></script>
