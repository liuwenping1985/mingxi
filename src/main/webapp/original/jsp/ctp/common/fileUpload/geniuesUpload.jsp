...
<%--         <tr>
        ...
        <tr>
        	<td valign="top">
        		<div style="height:188px;overflow-y:auto; overflow-x:hidden; ">
			                ...
			                <div class="file_box padding_5" >
				                <div id="fileInputDiv" style="height: 30px;">
				                    <div id="fileInputDiv1" style="" class="file_unload clearfix">
				                        ...
				                        <INPUT type="button" size="51" name="file1" id="file1" onchange="addNextInput(this)" onkeydown="return false" onkeypress="return false">
				                        </a>
				                    </div>
				                </div>
			                </div>
		...
		<tr>
			<td align="right" valign="top" class="bg-advance-bottom padding_lr_10">
				<input type="button" id="b1" name="b1" onclick="onUpload()" value="<fmt:message key='common.button.ok.label' bundle="${v3xCommonI18N}" />" class="button-default_emphasize margin_r_10"><input type="button" id="b2" name="b2" onclick="windowClose()" value="<fmt:message key='common.button.cancel.label' bundle="${v3xCommonI18N}" />" class="button-default-2 margin_r_10">
			</td>
		</tr>
	</table>
