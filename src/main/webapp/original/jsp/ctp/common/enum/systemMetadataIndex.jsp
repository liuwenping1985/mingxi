...
<script type="text/javascript">
//getA8Top().showLocation(5101, "<fmt:message key='metadata.manager.system' bundle='${v3xMainI18N}'/>");
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
	    <td valign="top" width="100%" height="100%" align="center" class="page-list-border-LRD" style="padding-top:1px;">
		    <iframe width="100%" height="100%" frameborder="0" src="${metadataMgrURL}?method=systemMetadataMainIframe" name="mainIframe" id="mainIframe" />
		</td>
	</tr>
</table>
</form>
