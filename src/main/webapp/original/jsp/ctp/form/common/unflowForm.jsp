...
<title>${ctp:i18n("form.base.formtype.basedata")}</title>
</c:if>
<c:if test="${formType=='2' }">
<title>${ctp:i18n("form.base.formtype.message")}</title>
</c:if>
...
<c:if test="${formType=='5' }">
<div class="comp" comp="type:'breadcrumb',code:'T05_wfdynamic'"></div>
</c:if>
<c:if test="${formType=='3' }">
<div class="comp" comp="type:'breadcrumb',code:'T05_unflowBasicData'"></div>
    ...
    <div class="comp" comp="type:'layout'" id="layout1">
        ...
        <div class="layout_west border_tb border_r" style="background: #fff;">
		        <div class="condition_box form_area margin_l_5 margin_r_5 margin_b_5 margin_t_10" id="condition_box" style="float:none;">
					<table width="100%"  border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="30%">
								<div class=" common_selectbox_wrap">
									<select id="condition" name="condition" class="margin_l_5 font_size12" style="width: 95px;height:22px" onChange="showNextSpecialCondition(this)">
        ...
        <div class="layout_center" style="overflow: hidden;">
            ...
            <iframe id="masterDataListFrame" width="100%" height="100%" frameBorder="no" scrolling="no"></iframe>
        </div>
    </div>
