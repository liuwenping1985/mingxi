...
<body class="h100b over_hidden">
    <div class="stadic_layout">
        <div class="stadic_left">
            ...
            <table width="100%" height="420" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td height="100%">
                        <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr>
                                <td id="tree_td" height="390" valign="top">
                                    <div id="tree_div" style="width: 100%; height: 385px; padding-top: 5px;">
        ...
        <div class="stadic_right">
            <div class="stadic_content">
                ...
                <div class="left" style="width: 388px; height: 420px;">
                    <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td height="35">
