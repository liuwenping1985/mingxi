...
<script type="text/javascript" charset="UTF-8" src="<c:url value="/apps_res/form/js/formquery/query_commselcondition.js${ctp:resSuffix()}"/>"></script>
    ...
    <td class="bg-advance-middel">
                <div id="tabs2" class="comp" comp="type:'tab',width:510,height:300">
                    <div id="tabs2_head" class="common_tabs clearfix">
                        <ul class="left">
                            <li class="current"><a id="data_clk" class="no_b_border" href="javascript:void(0)" tgt="data">						
							<!-- 表单数据域 -->
						  		${ctp:i18n('form.compute.formdata.label') }</a></li>
                            <li><a id="system_clk" class="no_b_border last_tab" href="javascript:void(0)" tgt="system">
					  		<!-- 系统变量 -->
                    ...
                    <div id="tabs2_body" class="common_tabs_body border_all">
                        <div id="data">
						<select  name="formdata" size="23" style="width:100%;height:100%"
                        ...
                        <div id="system">
							<select name="systemset" size="23" style="width: 100%;height:100%" id="systemselect" onclick="selectArgs(this,'systemselect');"
						ondblclick="">
