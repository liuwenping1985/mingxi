        ...
        <div class="color_gray margin_l_20">
		    <div class="clearfix margin_t_20 margin_b_10">
		        ...
		        <div class="font_size12 left  margin_l_10">
		            <div class="margin_t_10 font_size14">${ctp:i18n('formsection.infocenter.total')} <span id="listcount" class="font_bold color_black">${ctp:toHTML(param.size) }</span> ${ctp:i18n('formsection.infocenter.num')}</div>
		        </div>
		    </div>
