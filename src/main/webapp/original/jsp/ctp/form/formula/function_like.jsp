...
function OK(){
	...
	if($("#radio1").attr("checked")!=null){
        isOk=checkScriptTag($("#field2value1"));
        ...
        isOk=checkScriptTag($("#field2value2"));
...
//特殊需求，暂时不改动
function checkScriptTag(obj) {
    <%--if(obj.val().indexOf("<script>")!=-1){--%>
