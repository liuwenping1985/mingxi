        ...
        <tr>
            <td>
                <fieldset class="form_area padding_5 margin_t_5 margin_lr_10">
                    <legend>&nbsp;
                        <c:if test="${actionType eq 'billInner' || actionType eq 'billOuter'}" >
                        ${ctp:i18n("form.trigger.automatic.updatedatalist.label")}
                        </c:if>
                        <c:if test="${actionType eq 'autoInsert'}" >
                        ${ctp:i18n("form.trigger.automatic.billnew.label")}${ctp:i18n("form.data.items.label")}
                        </c:if>
                    &nbsp;
                    </legend>
                            ...
                            <tr height="22" style="margin-top: 5px;">
                                ...
                                <td width="35%" class="target" style="margin-top: 5px;">
                                    <div id="targetTD" title="${map.value}">
                                        <select style="width: 150px;margin-top: 5px;" id="fromField" name="fromField" onchange="" class="validate comp enumselect common_drop_down" comp="type:'autocomplete',autoSize:true" comptype="autocomplete" title="${map.key}">
