			...
			<table width="100%" height="70" border="0" cellpadding="0" cellspacing="0">
				...
				<tr class="billOuter hidden" style="height:45px">
					...
					<td nowrap="nowrap">
						<div class="clearfix">
							<div class="common_txtbox_wrap left" style="width: 160px;text-align: left;padding: 0px;">
								<textarea id="targetbillValue" style="width: 100%;height: 35px;border: 0px;" class="valign_m" name="targetbillValue" validateat="name:'${ctp:i18n('form.trigger.triggerSet.fieldValue.label')}',notNull:true,type:'string'" readonly="true" inputName="${ctp:i18n('form.trigger.triggerSet.fieldValue.label' )}"></textarea>
							</div>
