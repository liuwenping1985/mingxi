...
if(rf != null && Integer.parseInt(rf) > 0){
    writer.println("<meta http-equiv='Refresh' content='" + (Integer.parseInt(rf) * 60) + ";url=status4WAS.do?rf=" + rf + "' />");
}
writer.println("</head>");
writer.println("<body>");
writer.println("<div class='comp'"+" comp="+"type:'breadcrumb',code:'T01_systemview'"+" comptype='breadcrumb'"+"></div>");
...
writer.println("<pre>");
writer.print("JVM Version: " + System.getProperty("java.vm.name") + " (" + System.getProperty("java.vm.version") + ", " + System.getProperty("java.vm.info") + ")");
