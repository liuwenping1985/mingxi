<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="com.seeyon.ctp.event.*,com.seeyon.ctp.common.*,com.seeyon.ctp.util.annotation.*,com.seeyon.ctp.common.aspect.*"%>
...
<html>
	...
	<body>
		...
		%>
		<%
			out.println("<hr/>ClassAnnotation:");
			...
			out.println("<hr/>MethodAnnotation:");
