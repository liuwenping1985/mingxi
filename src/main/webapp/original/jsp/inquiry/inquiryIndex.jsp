...
<input type="hidden" name="listSelect" id = "listSelect" value="${listSelect}">
                    ...
                    <div class="company_discuss">
                        <div class="user_msg_info">
                            ...
                            <ul class="msg_info_body">
                                <%--<li class="msg_info_li hand">取消显示--%>
                        ...
                        <ul class="discuss_ul" id="groupTypeList">
                            ...
                            <li class="discuss_title hand">
                                ...
                                <img class="current_title hidden" src="${path}/skin/default/images/cultural/inquiry/cover_current.png">
                            </li>
                                                ...
                                                <c:choose>
                                                    <c:when test="${groupType.hasManageAuth&&groupType.hasPublicAuth}">
                                                        ...
                                                        <div class="discuss_cover right">
                                                            ...
                                                            <em class="icon24 admin_cover_right_24" onclick="inquiryCreate('${groupType.spaceType}','${groupType.spaceId}','${groupType.inquirySurveytype.id}');"></em>
                        ...
                        <ul class="discuss_ul" id="accountTypeList">
                            ...
                            <c:if test="${fn:length(accountInquiryTypeList)>5 }">
                                <li class="discuss_cover_page" id="accountPage">
                                    ...
                                    <input type="hidden" name="accountInquiryTypeListPageNum" id="accountInquiryTypeListPageNum" value="${accountInquiryTypeListPageNum}">
                                    <span class="discuss_page">
                        ...
                        <ul class="discuss_ul" id="customTypeList">
                            <li class="ling_4_group"></li>
                            <li class="discuss_title hand">
                                <span class="discuss_title_name" onclick="changeType(100);">${ctp:i18n('inquiry.type.custom')}</span><%--i18n 自定义团队--%>
                                <img class="current_title hidden" src="${path}/skin/default/images/cultural/inquiry/cover_current.png">
                            </li>
                            <li class="discuss_body">
                                <ul class="discuss_body_page">
                                            ...
                                            <li class="discuss_cover_name hand" id='side_${customType.inquirySurveytype.id}'>
                                                <c:choose>
                                                    <c:when test="${customType.hasManageAuth&&customType.hasPublicAuth}">
                                                        <div class="hand left" style="width: 190px" onclick="toBoardIndex('${customType.inquirySurveytype.id}','custom');" title="${ctp:toHTML(customType.inquirySurveytype.typeName)}">${ctp:toHTML(v3x:getLimitLengthString(customType.inquirySurveytype.typeName,29,"..."))}</div>
                                                        <div class="discuss_cover right">
                                                            <em class="icon24 admin_cover_left_24" onclick="showDropList(this);"></em>
                                                            <em class="icon24 admin_cover_right_24" onclick="inquiryCreate('${groupType.spaceType}','${groupType.spaceId}','${groupType.inquirySurveytype.id}');"></em>
                                                            <div class="drop_component">
                                                    ...
                                                    <c:when test="${(!customType.hasManageAuth)&&customType.hasPublicAuth}">
                                                        <div class="hand left" style="width: 205px" onclick="toBoardIndex('${customType.inquirySurveytype.id}','custom');" title="${ctp:toHTML(customType.inquirySurveytype.typeName)}">${ctp:toHTML(v3x:getLimitLengthString(customType.inquirySurveytype.typeName,29,"..."))}</div>
                                                        <div class="discuss_talk right" style="right:16px">
                                                    ...
                                                    <c:otherwise>
                                                        <div class="hand left" onclick="toBoardIndex('${customType.inquirySurveytype.id}','custom');" title="${ctp:toHTML(customType.inquirySurveytype.typeName)}">${ctp:toHTML(v3x:getLimitLengthString(customType.inquirySurveytype.typeName,29,"..."))}</div>
                                                    </c:otherwise>
                                                </c:choose>
