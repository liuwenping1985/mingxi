...
<script type="text/javascript">
	...
	function saveAsTemplate(){
    	...
    	myBar.add(new WebFXMenuButton("submit", "<fmt:message key='common.toolbar.save.label' bundle='${v3xCommonI18N}' />", "if($('dataForm').onsubmit()){saveAttachment();meetingSaveOffice();validata(); isFormSumit = true; disableButtons();trimTitle();$('dataForm').submit();}", "<c:url value='/common/images/toolbar/save.gif'/>", "", null));    	
