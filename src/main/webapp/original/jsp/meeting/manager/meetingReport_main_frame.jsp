...
var _url = "${meetingURL }?method=listMeetingByReportIframe&status=${param.status}&statType=${param.statType}&fieldType=${param.fieldType}&time=${param.time}&end_time=${param.end_time }&userid=${param.userid }&start_time=${param.start_time }&user_id=${param.user_id }&enddate=${param.enddate }&begindate=${param.begindate }&reportId=${param.reportId }&personGroupTab=${param.personGroupTab}&reportName=";
