...
function init(){
	if("${audier_Disabled}" != null && "${audier_Disabled}" != ""){
		alert(v3x.getMessage("meetingLang.meeting_user_checkLeader")+"${audier_Disabled} " + v3x.getMessage("meetingLang.meeting_user_checkLeader1"));
	}
}
</script>
...
<!-- Edit By Lif Start 缩短了行间距 -->					
    					    ...
    					    <TR>
						      ...
						      <% 
						     	 if (com.seeyon.ctp.common.SystemEnvironment.hasPlugin("zhbg")){
						      %>
