...
<style>
.tab-tag-middel,.tab-tag-middel-sel{
	height:26px;
	line-height:26px;
}
</style>
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td valign="bottom" height="30" style="padding-bottom:2px;" class="tab-tag border-left border-right">
			...
			<% if(com.seeyon.v3x.meeting.contants.MeetingConfig.HAS_MEETING_LEFT) { %>
				<c:if test="${ctp:hasResourceCode('F03_meetingRight') == true}">
					<span class="resCode">
			...
			<% if(!com.seeyon.v3x.meeting.contants.MeetingConfig.HAS_MEETING_LEFT) { %>
				...
				<% if(com.seeyon.v3x.meeting.contants.MeetingConfig.HAS_MEETING_APP || com.seeyon.v3x.meeting.contants.MeetingConfig.HAS_MEETING_LEADER) { %>
					<c:if test="${ctp:hasResourceCode('F03_meetingRightSet') == true}">
						<span class="resCode">
				...
				<% } %>
				<c:if test="${ctp:hasResourceCode('F03_meetingRoomAdmin') == true}">
	                <span class="resCode">
	                <!-- suyu add -->
			...
			<% if(com.seeyon.v3x.meeting.contants.MeetingConfig.HAS_MEETING_TYPE) { %>
				...
				<% } %>
				<c:if test="${ctp:hasResourceCode('F03_meetingType') == true}">
					<span class="resCode">
						<div class="tab-separator"></div>
