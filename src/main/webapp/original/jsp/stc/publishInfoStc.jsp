...
<script type="text/javascript" charset="UTF-8" src="${path}/apps_res/stc/js/publishInfoStc.js${ctp:resSuffix()}"></script>
...
<body class="h100b over_hidden bg_color">
          ...
          <tbody>
            <tr>
              ...
              <td align="left" width="240"><select id="stcWay" class="common_drop_down w100b" onchange="fnStcWayOnChange()">
                  ...
                  <option value="publishMember">${ctp:i18n('news.template.createUser.js')}</option>
            ...
            <tr>
              <td><table border="0" cellSpacing="0" cellPadding="0">
                  <tr id="prindClearTr">
                    ...
                    <td align="left" width="375"><div id="toolBar"></div></td>
                  </tr>
                </table>
              </td>
            </tr>
  ...
  <div id="sendToCollTitleDiv" class="hidden">
      <table class="w100b margin_tb_5" border="0" cellSpacing="0" cellPadding="0" style="width:690px;">
        <tr>
