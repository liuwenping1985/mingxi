                            ...
                            <div class="mainText_head_msg">
                                ...
                                <span class="left Wopacity mainText_head_msgSpan ">
                                    <span  class="pubMsg">
                                        ...
                                        <span class="pubMsg_span" title="${v3x:toHTML(bean.title)}">${v3x:getLimitLengthString(ctp:toHTML(bean.title),44,"...")}</span>
                                    </span>
                                    <span  class="pubMsg">
                                    ...
                                    <c:if test="${bean.showPublishUserFlag}">
                                        <span  class="pubMsg">
                                            ...
                                            <span class="pubMsg_span" title="${ctp:showMemberName(bean.createUser)}">${v3x:getLimitLengthString(ctp:showMemberName(bean.createUser),44,"...")}</span>
                                        </span>
                                    </c:if>
                                    <span  class="pubMsg">
