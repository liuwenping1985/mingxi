        ...
        <div class="container bulentin" id="container1">
            ...
            <div class="content_container">
                ...
                <div class="container_auto" id="page_height1" style="${bean.ext4=='form' ? 'width:100%;' : ''}">
                    ...
                    <div class="container_discuss detail moduleTHREE" id="page_height" style="${bean.ext4=='form' ? 'width:100%;' : ''};">
                        <div class="discuss_left" style="${bean.ext4=='form' ? 'width:100%;' : ''};">
                            ...
                            <div class="attrNotice overflow" id="foot2_height">
                                <div class="mainText_head_msg overflow">
                                    <span class="left Wopacity mainText_head_msgSpan ">
                                        <div class="left msgBor borLeft">
                                            <span  class="pubMsg">
                                                <em class="pubMsg_bar">${ctp:i18n('bulletin.titleView')} :</em>
                                                <span class="pubMsg_span" title="${ctp:toHTML(bean.title)}">${ctp:toHTML(v3x:getLimitLengthString(bean.title,40,"..."))}</span>
                                            </span>
                                            ...
                                            <c:if test="${bean.auditUserId !=null && bean.auditUserId != 0 && bean.auditUserId != -1}">
                                                <span class="pubMsg">
                                                    ...
                                                    <span class="pubMsg_span" title="${ctp:showMemberName(bean.auditUserId)}">
                                                        ${v3x:getLimitLengthString(ctp:showMemberName(bean.auditUserId),40,"...")}</span>
                                                </span>
                                            </c:if>
                                            <span  class="pubMsg">
                                                <em class="pubMsg_bar">${ctp:i18n('bulletin.publishDep')} :</em>
                                                <span class="pubMsg_span" title="${v3x:toHTML(bean.publishDeptName)}">${v3x:getLimitLengthString(ctp:toHTML(bean.publishDeptName),40,"...")}</span>
                                            </span>
                                            <span  class="pubMsg">
                                        ...
                                        <div class="left msgBor">
                                            <span  class="pubMsg">
                                                ...
                                                <span class="pubMsg_span" title="${v3x:toHTML(publishScopeStr)}">${v3x:getLimitLengthString(ctp:toHTML(publishScopeStr),40,"...")}</span>
                                            </span>
                                            <span  class="pubMsg">
                                            ...
                                            <c:if test="${bean.showPublishUserFlag}">
                                                <span class="pubMsg">
                                                    ...
                                                    <span class="pubMsg_span" title="${v3x:toHTML(bean.publishMemberName)}">${v3x:getLimitLengthString(ctp:toHTML(bean.publishMemberName),40,"...")}</span>
                                                </span>
                                            </c:if>
                                            <c:if test="${bean.auditUserId !=null && bean.auditUserId != 0 && bean.auditUserId != -1}">
                                                <span class="pubMsg">
