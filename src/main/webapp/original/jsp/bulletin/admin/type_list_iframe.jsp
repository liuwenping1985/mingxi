...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	<tr class="hidden">
		<td height="26" class="tab-tag" style="height:30px; background:#fff;">
			<div class="div-float">
	...
	<tr>
		<td height="100%" valign="top" colspan="1">
			...
			<form>
			<v3x:table htmlId="listTable" data="list" var="bean" leastSize="0" subHeight="38">
			...
			<c:set var="auditor" value="${v3x:getMember(bean.auditUser)}" />
				...
				<v3x:column width="25%" type="String" onClick="editTypeLine('${bean.id}');" onDblClick="editDbTypeLine('${bean.id}')"
					label="bul.type.typeName" className="cursor-hand sort" property="typeName" alt="${bean.typeName}" />
...
function toHtml(spaceName,padName){
    var html = '<span class="nowLocation_content"><a href="#">'+spaceName+'</a>'+
            ' > '+
            '<a href="###" onclick="showMenu(\''+parent.parent.window.location.href+'\')">'+padName+'</a></span>';
    return html;
}
