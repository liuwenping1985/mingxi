        ...
        <div class="container bulentin" id="container1">
            ...
            <div class="content_container" id="page_width">
                ...
                <c:if test="${already_audit_myCreate || already_audit ||noPass_audit}">
                        <div class="msg_check container_check_width2">
                                    ...
                                    <span class="left Wopacity mainText_head_msgSpan ">
                                        <div class="left msgBor borLeft">
                                            <span  class="pubMsg">
                                                ...
                                                <span class="pubMsg_span" title="${v3x:toHTML(bean.title)}">${v3x:getLimitLengthString(ctp:toHTML(bean.title),40,"...")}</span>
                                            </span>
                                            <span  class="pubMsg">
                                            ...
                                            <c:if test="${bean.showPublishUserFlag}">
                                                <span  class="pubMsg">
                                                    ...
                                                    <span class="pubMsg_span" title="${ctp:showMemberName(bean.createUser)}">${v3x:getLimitLengthString(ctp:showMemberName(bean.createUser),40,"...")}</span>
                                                </span>
                                            </c:if>
                                        </div>
