...
<input type="hidden" id="filename1" name="filename1" value="<%=request.getParameter("filename")%>">
<input type="hidden" id="filename2" name="filename2" value="">
<div style="height: 85%;overflow-y: hidden;background:#f7fbfe;">
<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%" style="padding:0px 20px;">
    <tr>
        <td width="75%" height="100%" valign="top">
            <table cellspacing="0"  cellpadding="0" width="100%" height="100%" style="padding-top:5px;  padding-left:5px;  padding-right:5px;">
                <tr bgcolor="#ecf4fe">
                    <td colspan="4" height="10%" style="height:20px;"><b><fmt:message key="hr.staffInfo.ladyself.label" bundle="${v3xHRI18N}" /></b></td>
                </tr>
                <tr>
            ...
            <table cellspacing="0" cellpadding="0" width="100%" height="100%" style="padding:2px;">
                ...
                <tr>
                    <td align="center" class="description-lable">
                        ...
                        104*104px
                        <br><br>
                        <input type="button" value="<fmt:message key="hr.staffInfo.local.label" bundle="${v3xHRI18N}" />" onclick="doOnclick()" style="background:#6eb0fc;color:#FFF;height:25px;width:70px;border:1px solid #6eb0fc;overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">
                        <br><br>
                    </td>
                </tr>
            </table>
...
<div style="height: 15%">
    <table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
        ...
        <td height="35" align="right" class="bg-advance-bottom" colspan="2">
            <input type="submit" id="check" name="check" value="<fmt:message key='common.button.ok.label' bundle="${v3xCommonI18N}" />" class="button-default_emphasize" onclick="returnText();" style="margin-right:8px;">
