...
<script type="text/javascript">
    ...
    function twclose(){
    	if (parent.parentDialogObj && parent.parentDialogObj['showMessageSet']) {
    	    parent.parentDialogObj['showMessageSet'].close();
    	} else {
    	  self.history.back();
    	}
    }
...
<input type="hidden" name="messageType" value="${type}">
        <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                    <tr align="left" valign="top">
                                        ...
                                        <table width="100%" cellspacing="10" cellpadding="0" border="0">
                                           ...
                                           <fmt:message key='personal.message.23.label' var="wdzx" bundle="${v3xPersonalAffairI18N}" />
                                            ...
                                            <tr>
                                                ...
                                                <label for="App_53011">
                                                    <input type="checkbox" id="App_53011"  onclick="selectAndSetAll1('53011')" ${main:isSelectedOfMessageSetting(messageConfigMap, type, 14, null)||main:isSelectedOfMessageSetting(messageConfigMap, type, 30, null)||main:isSelectedOfMessageSetting(messageConfigMap, type, 5, null)||main:isSelectedOfMessageSetting(messageConfigMap, type, 11, null)? 'checked':''}><b>${TargetLable}</b>
                                                </label>
                                                ...
                                                <table class="tr_53011_all" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-left: 15px;margin-top: 5px;">
                                                 <c:if test="${v3x:hasPlugin('project') && type != 'wechat'}">
                                                	<tr>
                                                        <td>
                                                          <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                              <tr>
                                                                 <td width="100%">
                                                                 <input type="checkbox" id="App_14" name="App" value="14" onclick="selectAndSetAll2(14, '53011')" ${main:isSelectedOfMessageSetting(messageConfigMap, type,14, null)? 'checked':''} ><b><fmt:message key='project.menu.project.name' bundle="${v3xCommonI18N}" /></b>
                                                                 <span class="ico16 arrow_2_b" onclick="trShowOrHide(this,'14_all');"></span>
                                                                 <input type="hidden" id="AllInput_14" name="AllInput_14" value="${main:isSelectedOfMessageSetting(messageConfigMap, type, 14, 'ALL') ? 'ALL':''}" >
                                                                 </td>
                                                              </tr>
                                                              <tr style="display: none;" class="tr_14_all">
                                                               <td width="100%">
                                                               <div class="margin_t_5">
                                                               <label for="CollOption_project1" style="margin-left: 15px;">
                                                                          <input type="checkbox" id="CollOption_project1" name="Option_14" value="1" onclick="checkParentNode3(this,14,53011)" ${main:isSelectedOfMessageSetting(messageConfigMap, type, 14,'1')? 'checked':''} ><fmt:message key='personal.message.30.label' bundle="${v3xPersonalAffairI18N}" />
                                                                       </label>
                                                               <label for="CollOption_project2" style="margin-left: 15px;"">
                                                                          <input type="checkbox" id="CollOption_project2" name="Option_14" value="2" onclick="checkParentNode3(this,14,53011)" ${main:isSelectedOfMessageSetting(messageConfigMap, type, 14,'2')? 'checked':''} ><fmt:message key='personal.message.31.label' bundle="${v3xPersonalAffairI18N}" />
                                                                       </label>
                                                                <label for="CollOption_project3" style="margin-left: 15px;"">
                                                                          <input type="checkbox" id="CollOption_project3" name="Option_14" value="3" onclick="checkParentNode3(this,14,53011)" ${main:isSelectedOfMessageSetting(messageConfigMap, type, 14,'3')? 'checked':''} ><fmt:message key='personal.message.32.label' bundle="${v3xPersonalAffairI18N}" />
                                                                       </label>
                                                               </div>
                                                               </td>
                                                              </tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                          <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                              <tr>
                                                                 <td width="100%">
                                                                 <input type="checkbox" id="App_30" name="App" value="30" onclick="selectAndSetAll2(30, '53011')" ${main:isSelectedOfMessageSetting(messageConfigMap, type,30, null)? 'checked':''} ><b><fmt:message key='project.menu.task.name' bundle="${v3xCommonI18N}" /></b>
                                                ...
                                                <c:if test="${v3x:hasPlugin('plan') && type != 'wechat'}">
                                                    <tr>
                                                        <td>
                                                          <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                              <tr>
                                            ...
                                            <%--综合办公--%>
                                            <c:if test="${v3x:hasPlugin('office') && type != 'wechat'}">
                                              <tr>
                                                  <td>
                                                  <div style="margin-top: 10px;">
                                                  <label for="App_26">
                                            ...
                                            <%--信息报送 --%>
                                            <c:if test="${v3x:hasPlugin('infosend') && type != 'wechat'}">
                                            <tr>
                                                <td>
                                                <div style="margin-top: 10px;">
                                                    <label for="App_32">
                                            ...
                                            <c:if test="${!empty otherMsgSystemList && type != 'wechat'}">
                                        ...
                                        <table width="100%" cellspacing="10" cellpadding="0">
                                              ...
                                              <c:if test="${!empty inquiryTypes}">
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    ...
                                                    <c:forEach items="${inquiryTypes}" var="inquiryType" varStatus="status">
                                                        <input type="hidden" id="InquiryOptionHidden${status.index}" name="Option_Hidden_10_${list_index_10}" value="${inquiryType.id}" />
                                                        <td width="30%" style="padding-left: 15px;">
                                                        <label for="InquiryOption${status.index}" title="${inquiryType.typeName}">
                                                           <input type="checkbox" id="InquiryOption${status.index}" name="Option10_${list_index_10}" value="${inquiryType.id}" onclick="checkParentNode2(this, 10,${list_index_10})" ${main:isSelectedOfMessageSetting(messageConfigMap, type, 10, inquiryType.id)? 'checked':''} >${v3x:toHTML(v3x:getLimitLengthString(inquiryType.typeName, 20, '...'))}
                                                        </label>
                                                        </td>
                                                ...
                                                <c:if test="${!empty groupInquiryTypes}">
                                                    ...
                                                    <c:forEach items="${groupInquiryTypes}" var="groupInquiryType" varStatus="status">
                                                        <input type="hidden" id="GroupInquiryOptionHidden${status.index}" name="Option_Hidden_10_${list_index_10}" value="${groupInquiryType.id}" />
                                                        <td width="30%" style="padding-left: 15px;">
                                                        <label for="GroupInquiryOption${status.index}" title="${groupInquiryType.typeName}" >
                                                            <input type="checkbox" id="GroupInquiryOption${status.index}" name="Option10_${list_index_10}" value="${groupInquiryType.id}" onclick="checkParentNode2(this, 10,${list_index_10 })" ${main:isSelectedOfMessageSetting(messageConfigMap, type, 10, groupInquiryType.id)? 'checked':''} >${v3x:toHTML(v3x:getLimitLengthString(groupInquiryType.typeName, 20, '...'))}
                                                        </label>
                                                        </td>
                                               ...
                                               <c:if test="${!empty AllPublicCustomInquiryList}">
                                                ...
                                                <c:if test="${!empty AllPublicCustomGroupInquiryList}">
                                                 ...
                                                 <%-- 大秀 --%>
	                                            <c:if test="${v3x:hasPlugin('show')}">
	                                            <div>
	                                                <label for="App_40">
	                                                    <input type="checkbox" id="App_40" name="App" value="40" onclick="selectAndSetAll2(40,'78910')" ${main:isSelectedOfMessageSetting(messageConfigMap, type, 40, null)? 'checked':''}><b><fmt:message key='application.40.label' /></b>
	                                                </label>
	                                                <span class="ico16 arrow_2_b" onclick="trShowOrHide(this,'40_all');"></span>
	                                                <input type="hidden" id="AllInput_40" name="AllInput_40" value="${main:isSelectedOfMessageSetting(messageConfigMap, type, 40, 'ALL') ? 'ALL':''}" >
	                                                <table class="tr_40_all hidden">
		                                                <tr>
		                                                  <td width="50" align="right">
		                                                     <fmt:message key='personal.message.show.theme.label' />:
		                                                  </td>
		                                                  <td width="100">
		                                                  <label for="ShowOption1">
		                                                    <input type="checkbox" id="ShowOption1" name="Option_40" value="1" onclick="checkParentNode(this,40)" ${main:isSelectedOfMessageSetting(messageConfigMap, type, 40, '1') ? 'checked' : ''} ><fmt:message key='personal.message.show.1.label' />
		                                                  </label>
		                                                  </td>
		                                                  <td width="100">
		                                                  <label for="ShowOption2" class="margin_l_10">
		                                                    <input type="checkbox" id="ShowOption2" name="Option_40" value="2" onclick="checkParentNode(this,40)" ${main:isSelectedOfMessageSetting(messageConfigMap, type, 40, '2') ? 'checked' : ''} ><fmt:message key='personal.message.show.2.label' />
		                                                  </label>
		                                                  </td>
		                                                  <td width="100">
		                                                  <label for="ShowOption3" class="margin_l_10">
		                                                    <input type="checkbox" id="ShowOption3" name="Option_40" value="3" onclick="checkParentNode(this,40)" ${main:isSelectedOfMessageSetting(messageConfigMap, type, 40, '3') ? 'checked' : ''} ><fmt:message key='personal.message.show.3.label' />
		                                                  </label>
		                                                  </td>
		                                                   <td width="100">
		                                                  		&ensp;<!--格式占位  -->
		                                                ...
		                                                <tr>
		                                                  <td width="50" align="right">
		                                                     <fmt:message key='personal.message.show.show.label' />:
		                                                  </td>
		                                                  <td width="100">
		                                                  <label for="ShowOption1">
		                                                    <input type="checkbox" id="ShowOption7" name="Option_40" value="7" onclick="checkParentNode(this,40)" ${main:isSelectedOfMessageSetting(messageConfigMap, type, 40, '7') ? 'checked' : ''} ><fmt:message key='personal.message.show.1.label' />
		                                                  </label>
		                                                  </td>
		                                                  <td width="100">
		                                                  <label for="ShowOption4" class="margin_l_10">
		                                                    <input type="checkbox" id="ShowOption4" name="Option_40" value="4" onclick="checkParentNode(this,40)" ${main:isSelectedOfMessageSetting(messageConfigMap, type, 40, '4') ? 'checked' : ''} ><fmt:message key='personal.message.show.4.label' />
		                                                  </label>
		                                                  </td>
		                                                  <td width="100">
		                                                  <label for="ShowOption5" class="margin_l_10">
		                                                    <input type="checkbox" id="ShowOption5" name="Option_40" value="5" onclick="checkParentNode(this,40)" ${main:isSelectedOfMessageSetting(messageConfigMap, type, 40, '5') ? 'checked' : ''} ><fmt:message key='personal.message.show.5.label' />
		                                                  </label>
		                                                  </td>
		                                                   <td width="100">
		                                                  <label for="ShowOption3" class="margin_l_10">
		                                                    <input type="checkbox" id="ShowOption3" name="Option_40" value="6" onclick="checkParentNode(this,40)" ${main:isSelectedOfMessageSetting(messageConfigMap, type, 40, '6') ? 'checked' : ''} ><fmt:message key='personal.message.show.3.label' />
		                                                  </label>
		                                                  </td>
		                                                </tr>
	                                                </table>
                                            ...
                                            <%--协同驾驶舱 >行为绩效 --%>
                                            <c:if test="${v3x:hasPlugin('behavioranalysis')}">
                                            <tr>
                                                <td>
                                                <div style="margin-top: 10px;">
                                                    <label for="App_42">
                                                        <input type="checkbox" id="App_42" name="App" value="42" onclick="selectAndSetAll(42)" ${main:isSelectedOfMessageSetting(messageConfigMap, type, 42, null)? 'checked':''}><b><fmt:message key='personal.message.behavioranalysis.label' /></b>
                                                    </label>
                                                    <input type="hidden" id="AllInput_42" name="AllInput_42" value="${main:isSelectedOfMessageSetting(messageConfigMap, type, 42, 'ALL') ? 'ALL':''}" >
                                                </div>
                                                </td>
                                            </tr>
                                            </c:if>
                                            <c:if test="${type != 'sms' && v3x:hasPlugin('guestbook') && type != 'wechat'}">
                                            <%--留言板 --%>
                                            <tr>
                                                <td>
                                                <div style="margin-top: 10px;">
            ...
            <c:if test="${empty errorMsg && !(!isAdmin && !isAllowCustom)}">
                <tr>
                    <td height="42" style="padding-top:0;" align="center" class="bg-advance-bottom">
                    <input
