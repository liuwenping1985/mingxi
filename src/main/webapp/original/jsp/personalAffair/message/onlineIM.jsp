...
<!--
	...
	$(document).ready(function(){
		...
		$("#onlineUserTreeIframe").attr("src","${onlineURL}?method=showOnlineUserTree");
		$("#onlineUserListIframe").attr("src","${onlineURL}?method=showOnlineUserList");
	});
...
<body class="easyui-layout">
	...
	<div region="west" id="west_region" border="true" split="true" style="width:205px;overflow:hidden;">
    	<iframe src='' name='onlineUserTreeIframe' id='onlineUserTreeIframe' frameborder='0' width='100%' height='100%' scrolling='no'></iframe>
	</div>
