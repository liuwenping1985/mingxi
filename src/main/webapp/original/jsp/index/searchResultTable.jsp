...
// var sss = $.parseJSON(resultData);
    ...
    function clickRow(data, rowIndex, colIndex){
        openIndexResult(data.appType, data.linkId, data.startMemberId);
    }
    ...
    function initGrid(){
        var index = window.localStorage.getItem("showIndex");
        if(index == 1){//简易搜索
            $(".flexigrid").css("height",parseInt($(".flexigrid").height()) + 70 + "px").find(".bDiv").css("height",parseInt($(".bDiv").height()) + 70 + "px");
            // $("#indexResultTable").css("height",);
        }else if(index == 2){//高级搜索
            $(".flexigrid").css("height","188px").find(".bDiv").css("height","154px");
        }
    }
 $(function() {
    var $height;
    ...
    // 表格加载
     grid = $('#indexResultTable').ajaxgrid({
         ...
         colModel : [{
             ...
             display : "${ctp:i18n('index.com.seeyon.v3x.index.accessoryName')}",
             name : 'accessoryNames',
             sortable : true,
             width : '10%'
         }, {
            ...
            <c:if test="${isAfterSearch}">
                <tr style="height:30px;line-height:30px;">
                    <td height="20" style="padding: 0 5px" valign="top">
                        <div class="gov_border gov_nobackground" style="padding: 5px 30px 0px 5px" id="resultBarId">
...
<%--                                     <td class="">&nbsp;&nbsp;&nbsp;<fmt:message
									...
									<a style="margin-right:25px;" href="javascript:searchAction(3)" title="${ctp:i18n('index.view.list')}"><span class="ico16 view_list_16"></span></a>
									</td>
                            ...
                            <tr>
                                <td>
                                    <table border="0" cellSpacing="0" cellPadding="0" width="100%" height="100%"
                                        ...
                                        <tr>
                                            <td valign="top">
                                                <div class="content_area_body" style="padding-left:0px;overflow-y:hidden;-ms-overflow-y:hidden;">
                                                <script>
                                                        var $this = setInterval(function(){
                                                            if($(".content_area_body div.flexigrid")){
                                                                $(".content_area_body div.flexigrid").eq(0).css("width", $('body').width() + "px");
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" style="padding: 5px 25px; width:100%;" valign="bottom"
                                                        class="portal-layout-cell gov_border gov_nobackground">
                                                        <tr>
...
<%--                                                             <fmt:message key='index.com.seeyon.v3x.index.everypage' />
												            ...
												            <div style="width:100%;padding-top:10px;padding-bottom:10px;color:#9d9c9c;font-size:12px;background:#fff;text-align:right;">
												            <fmt:message key='index.com.seeyon.v3x.index.everypage' />
