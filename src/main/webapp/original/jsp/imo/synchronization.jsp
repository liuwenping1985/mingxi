...
isovr=1;
	...
	this.invoke = function(ds) {
		...
		var requestCaller = new XMLHttpRequestCaller(this, "ajaxIMOSynchronController", "asynchronism",true);
		...
		<td width="100%" height="60" valign="top">
			 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="page2-header-line">
			        <tr>
						...
						<td class="page2-header-bg">&nbsp;<fmt:message key="org.synchron.imo" /></td>
						<td>&nbsp;</td>
			      </tr>
			 </table>
		</td>
