		...
		<td align="center" height="120" class="page-list-border-LRD padding-T">
			<div class="fastLeaveMessageDiv" onkeydown="keyDownSubmit(event,'fastLeaveMessageAction')">
				...
				<div class="fastLeaveMessageBtnDiv">
					...
					<div class="fastLeaveMessageRange"><label for='sendMessage'><input id='sendMessage' type='checkbox' /><fmt:message key="guestbook.leaveword.sent.message"></fmt:message></label></div>
                        ...
                        <fmt:message key='taglib.list.table.page.html' bundle="${v3xCommonI18N}">
                            ...
                            <fmt:param>
                            	<c:choose>
									<c:when test="${page == 1 && size > pageSize}">
										<a href="javascript:void(0);" class="pFirst pButton common_over_page_btn" title="<fmt:message key='taglib.list.table.page.first.label' bundle='${v3xCommonI18N}'/>"><em class="pageFirst"></em></a>
										<a href="javascript:void(0);" class="pPrev pButton common_over_page_btn" title="<fmt:message key='taglib.list.table.page.prev.label' bundle='${v3xCommonI18N}'/>"><em class="pagePrev"></em></a>
										<a href="javascript:next(this)" class="pNext pButton common_over_page_btn" title="<fmt:message key='taglib.list.table.page.next.label' bundle='${v3xCommonI18N}'/>"><em class="pageNext"></em></a>
										<a href="javascript:last(this, '${pages }')" class="pLast pButton common_over_page_btn" title="<fmt:message key='taglib.list.table.page.last.label' bundle='${v3xCommonI18N}'/>"><em class="pageLast"></em></a>
									</c:when>
									<c:when test="${page == pages && size > pageSize}">
										<a href="javascript:first(this)" class="pFirst pButton common_over_page_btn"  title="<fmt:message key='taglib.list.table.page.first.label' bundle='${v3xCommonI18N}'/>"><em class=pageFirst></em></a>
										<a href="javascript:prev(this)" class="pPrev pButton common_over_page_btn" title="<fmt:message key='taglib.list.table.page.prev.label' bundle='${v3xCommonI18N}'/>"><em class="pagePrev"></em></a>
										<a href="javascript:void(0);" class="pNext pButton common_over_page_btn" title="<fmt:message key='taglib.list.table.page.next.label' bundle='${v3xCommonI18N}'/>"><em class="pageNext"></em></a>
										<a href="javascript:void(0);" class="pLast pButton common_over_page_btn" title="<fmt:message key='taglib.list.table.page.last.label' bundle='${v3xCommonI18N}'/>"><em class="pageLast"></em></a>
									</c:when>
                            ...
                            <fmt:param>
                                <input type="text" maxlength="10" class="pager-input-25-undrag" value="${page}" onChange="pageChange(this)" pageCount="${size}" onkeypress="enterSubmit(this, 'intpage')">
                         		...
                         		<a id="grid_go" class="common_button  common_over_page_go" href="javascript:pageGo(this);">GO</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
								</form>
								</td>
							</tr>
