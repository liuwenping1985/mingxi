						                				...
						                				<tr>
						                					<td>
						                						<c:choose>
																	...
																	<c:set var="relateMemberName" value="${v3x:escapeJavascript(m.relateMemberName)}"/>
																		<div class="memDiv">
																			<div><a href="${url}" target="_self">
																			...
																			<ul>
																				<li><a title='<fmt:message key="addressbook.set.sendcollaboration" />' href="javascript:sendColl('${m.relateMemberId}')"><fmt:message key="addressbook.set.sendcollaboration" /> </a></li>
																				<li><a title='<fmt:message key="addressbook.set.sendemail" />' href="javascript:sendMail('${m.relateMemberEmail}')"><fmt:message key="addressbook.set.sendemail" /> </a></li>
																				<li><a title='<fmt:message key="addressbook.set.viewStaff" />' href="javascript:showV3XMemberCard('${m.relateMemberId}')"><fmt:message key="addressbook.set.viewStaff" /></a></li>
																			</ul>
																		</div>
																	</c:when>
																	<c:otherwise>
