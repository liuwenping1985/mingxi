...
<body class="h100b over_hidden">
	<div class="crumbly">
		<div class="before">${ctp:i18n("weixin.system.menu.portalManagement")}</div><span class="gap">/</span><span class="current">${ctp:i18n("weixin.system.menu.portalWorkbenchWechatEnterprise")}</span>
	</div>
	<div id="workbenchScroll">
		<div class="set">
			...
			<div class="setContent" style="margin-top: 17px;">
				<span>${ctp:i18n("weixin.workbench.setinfo2")}</span>
			</div>
		</div>
		<div id="wechatWorkbench">
			<div class="wQrocess">
				...
				<div class="firstStep">
					<div class="blocks">
						<div class="block">
							<span style="display: inline-block;margin-top: 15px;">${ctp:i18n("weixin.workbench.login2")}</span>
							<div class="blockBtn" style="cursor: pointer" onclick="window.open('https://work.weixin.qq.com/wework_admin/loginpage_wx'); ">
						...
						<div class="block1">
							...
							<span style="display: inline-block;margin-top: 5px;">${ctp:i18n("weixin.workbench.getidtext1")}</span>
						</div>
						<div style="clear: both;"></div>
					</div>
					<div class="content">
						<span>${ctp:i18n("weixin.workbench.login4")}</span>
					</div>
				</div>
			...
			<div class="cropID">
				<div class="cropIDName">
					...
					<span>${ctp:i18n("weixin.workbench.corpId2")}:</span>
				</div>
...
<script type="text/javascript">
    ...
    if(navigator.userAgent.indexOf('MSIE 8') != -1){
		...
		'<use xlink:href="#icon-qiyeweixintubiao"></use>'+
		'</svg>');
	}
