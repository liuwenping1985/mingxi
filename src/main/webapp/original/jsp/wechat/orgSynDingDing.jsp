...
<body class="h100b over_hidden">
	<div class="crumbly">
	    <div class="before">${ctp:i18n('weixin.system.menu.orgSyn')}</div><span class="gap">/</span><span class="current">${ctp:i18n('weixin.system.menu.orgSynDingDing')}</span>
	</div>
	<div class="w-server-set">
	    ...
	    <div class="setContent" style="margin-top: 5px;color: red;">
	        <span>1、组织机构向钉钉同步为全量同步，即每次同步将删除钉钉端已有数据，重新同步!</span>
	    </div>
	    <div class="setContent" style="margin-top: 5px;">
	        <span>2、${ctp:i18n('weixin.dingding.org.configurationDescription1')}</span>
	    </div>
	</div>
	<div id="wechatDing">
	    <div class="block">
