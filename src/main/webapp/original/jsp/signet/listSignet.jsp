...
<table height="100%" width="100%" border="0" cellspacing="0" cellpadding="0" class="">
	<tr>
		<td height="22" style="height:40px;" colspan="2"   id="toolbar-top-border" class="webfx-menu-bar border_b"><script type="text/javascript">
		...
		<div class="div-float-right">
			<div class="div-float">
				<select style="height:24px;" name="condition" id="condition"  onChange="showNextCondition(this)">
			...
			<div id="1Div" class="div-float hidden">
					<input style="height:22px;" type='text' class='textfield' name='textfield' />
			</div>
			<div id="2Div" class="div-float hidden">
					<select name="textfield" style="width:133px; height:24px;">
		...
		<form id="signetListform" method="post">
			...
			<c:set var="dbclick" value="showDbDetailSignet('${signet.id}',parent.detailFrame)" />
				<v3x:column width="5%" align="center" label="<input type='checkbox' id='allCheckbox' onclick='selectAll(this, \"id\")'/>">
					<input id="id" type="checkbox" name="id" value="${signet.id}" markName="${fn:escapeXml(signet.markName)}" />
				</v3x:column>
