...
<script type="text/javascript">
	$().ready(function(){
		...
		$("#tab1iframe").click(function(){
			divHide();
			$("#tab1_iframe").attr("src","${path}/videoConference.do?method=framesetThree&time="+Math.random());
		});	
		...
		<div id="tabs_head" class="common_tabs clearfix">
			<ul class="left">
				<li><a hidefocus="true" href="javascript:void(0)" 
					tgt="tab1_iframe" id="tab1iframe"><span title="${ctp:i18n('cip.meet.pers.syn')}">${ctp:i18n('cip.meet.pers.syn')}</span></a></li>
			</ul>
		</div>
				 ...
				 <div class="content backColor2" onclick="$('#tab1iframe').trigger('click');">
					<div class="img-block">
						<div class="img backColor2">
							<i class="icon11" style="background-position:-112px 0px;"></i>
						</div>
					</div>
					<div class="name">
						<span>${ctp:i18n('cip.meet.pers.syn')}</span>
					</div>
				</div>
				<div class="operation backColor2"  onclick="javascript:openD(701);">
				...
				<div class="content backColor3" style ="cursor:auto;">
					<div class="img-block">
						<div class="img backColor3" style ="cursor:auto;">
							<i class="icon11" style="background-position:-112px -28px;"></i>
						</div>
					</div>
					<div class="name">
						<span>${ctp:i18n('cip.meet.create.conference')}</span>
					</div>
				</div>
				<div class="operation backColor3" onclick="javascript:openD(702);">
					<div class="operation-block">
						<div class="button">
							<span>${ctp:i18n('cip.intenet.set.case')}</span>
						</div>
				...
				<div class="content backColor1" style ="cursor:auto;">
					<div class="img-block">
						<div class="img backColor1" style ="cursor:auto;">
							<i class="icon01" style="background-position:-112px -56px;"></i>
						</div>
					</div>
					<div class="name">
						<span>${ctp:i18n('cip.meet.att.conference')}</span>
					</div>
				</div>
				<div class="operation backColor1"  onclick="javascript:openD(703);">
					<div class="operation-block">
						<div class="button">
							<span>${ctp:i18n('cip.intenet.set.case')}</span>
						</div>
