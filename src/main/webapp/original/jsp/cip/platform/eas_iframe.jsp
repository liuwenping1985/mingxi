...
<script type="text/javascript">
	$().ready(function(){
		...
		$("#tab1iframe").click(function(){
			divHide();
			$("#tab1_iframe").attr("src","${path}/ncOrgController.do?method=handSynch&from=eas&time="+Math.random());
		});
		$("#tab2iframe").click(function(){
			divHide();
			$("#tab2_iframe").attr("src","${path}/ncAutoSynch.do?method=autoSynch&from=eas&time="+Math.random());
		});
		$("#tab3iframe").click(function(){
			divHide();
			$("#tab3_iframe").attr("src","${path}/ncSynchLog.do?method=synchLog&from=eas&time="+Math.random());
		});
		...
		<div id="bgimg" style="margin:20px 0 0 100px;">
			<div>
				<div class="cip-block">
					...
					<div class="operation backColor1" onclick="javascript:openD(501);" >
				...
				<div class="cip-block" style="margin-top: 20px;margin-left:50px;">
					...
					<div class="operation backColor1" onclick="javascript:openD(502);">
						<div class="operation-block">
							<div class="button">
								<span>${ctp:i18n('cip.intenet.set.case')}</span>
							</div>
				...
				<div class="cip-block" style="margin-top: 20px;margin-left:50px;">
					...
					<div class="operation backColor1" onclick="javascript:openD(503);">
						<div class="operation-block">
							<div class="button">
								<span>${ctp:i18n('cip.intenet.set.case')}</span>
							</div>
