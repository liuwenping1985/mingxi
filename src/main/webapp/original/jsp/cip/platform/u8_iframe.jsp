...
<script type="text/javascript">
	$().ready(function(){
		...
		$("#tab0iframe").click(function(){
			divHide();
			$("#tab0_iframe").attr("src","${path}/u8ServerController.do?method=initU8Server&time="+Math.random());
		});
		$("#tab1iframe").click(function(){
			divHide();
			$("#tab1_iframe").attr("src","${path}/u8OrgController.do?method=handSynch&time="+Math.random());
		});
		$("#tab2iframe").click(function(){
			divHide();
			$("#tab2_iframe").attr("src","${path}/u8AutoSynch.do?method=autoSynch&time="+Math.random());
		});
		$("#tab3iframe").click(function(){
			divHide();
			$("#tab3_iframe").attr("src","${path}/u8SynchLogController.do?method=synchLog&time="+Math.random());
		});
		$("#tab4iframe").click(function(){
			divHide();
			$("#tab4_iframe").attr("src","${path}/u8UserMapper.do?method=userMapper&time="+Math.random());
		});
...
<body>
	<div id='layout' class="comp" comp="type:'layout'">
		...
		<div id="tabs_head" class="common_tabs clearfix">
			<ul class="left">
				<li><a hidefocus="true" href="javascript:void(0)" 
					tgt="tab0_iframe" id="tab0iframe"><span title="${ctp:i18n('cip.u8.serv.ope')}">${ctp:i18n('cip.u8.serv.ope')}</span></a></li>
				<li><a hidefocus="true" href="javascript:void(0)" 
				...
				<li><a hidefocus="true" href="javascript:void(0)"
					tgt="tab4_iframe" id="tab4iframe"><span title="${ctp:i18n('cip.u8.acc.bind')}">${ctp:i18n('cip.u8.acc.bind')}</span></a></li>
			</ul>
		</div>
		<div id="bgimg" style="margin-top:20px;margin-left:60px;">
			<div style="width: 200px;float: left;margin-top: 175px;margin-left:20px;">
				<div class="cip-block">
					<div class="content backColor3"  onclick="$('#tab0iframe').trigger('click');">
						<div class="img-block">
						...
						<div class="name">
							<span>${ctp:i18n('cip.u8.serv.ope')}</span>
						</div>
					</div>
					<div class="operation backColor3" onclick="javascript:openD(300);">
			...
			<div style="width: 200px;float: left;margin-left:20px;">
				<div class="cip-block">
					...
					<div class="operation backColor1" onclick="javascript:openD(301);" >
						<div class="operation-block">
							<div class="button">
								<span>${ctp:i18n('cip.intenet.set.case')}</span>
							</div>
				...
				<div class="cip-block" style="margin-top: 35px;">
					...
					<div class="operation backColor1" onclick="javascript:openD(302);">
						<div class="operation-block">
							<div class="button">
								<span>${ctp:i18n('cip.intenet.set.case')}</span>
							</div>
				...
				<div class="cip-block" style="margin-top: 35px;">
					...
					<div class="operation backColor1" onclick="javascript:openD(303);">
						<div class="operation-block">
							<div class="button">
								<span>${ctp:i18n('cip.intenet.set.case')}</span>
							</div>
			...
			<div style="width: 200px;float: left;margin-top:175px;margin-left:20px;">
				<div class="cip-block">
					<div class="content backColor2"  onclick="$('#tab4iframe').trigger('click');">
						<div class="img-block">
							<div class="img backColor2">
								<i class="icon02" style="background-position:-168px -0px;"></i>
							</div>
						</div>
						<div class="name">
							<span>${ctp:i18n('cip.u8.acc.bind')}</span>
						</div>
					</div>
					<div class="operation backColor2" onclick="javascript:openD(304);">
						<div class="operation-block" >
							<div class="button">
								<span>${ctp:i18n('cip.intenet.set.case')}</span>
							</div>
		...
		<div id="tabs_body" class="common_tabs_body" style="height: 100%;">
			<iframe id="tab0_iframe" width="100%" height="100%" frameborder="no" src ="" border="0" 
				class="hidden"></iframe>
