    ...
    <div class="form_area" >
        <div class="one_row" style="width:50%;">
            ...
            <input type="hidden" id="id" name="id" value="-1">
                   <tr id="appCodetr">
                        <th nowrap="nowrap"><label class="margin_r_10" for="text"><font color="red">*</font>${ctp:i18n('cip.manager.register.appcode')}:</label></th>
                        <td width="100%">
                                <input type="text" id="appCode"   class="w100b validate"></input>
                        </td>
                    </tr>        
                    <tr>
                        <th nowrap="nowrap"><label class="margin_r_10" for="text"><font color="red">*</font>${ctp:i18n('cip.manager.register.appname')}:</label></th>
                        <td width="100%">
                                <input type="text" id="appName" name="appName" class="w100b validate"  validate="type:'string',name:'${ctp:i18n('cip.manager.register.appname')}',notNull:true,maxLength:12,avoidChar:'\\\/|><:*?&%$|,&quot;-_+'"/>
                        </td>
                    </tr>
                    <tr>
                        <th nowrap="nowrap" ><label class="margin_r_10" for="text">${ctp:i18n('cip.manager.register.iconupload')}:</label></th>
                       <td width="100%" >
                       <input type = "hidden" id = "iconPC" name = "iconPC">
                          ...
                          <table id="imgtb">
                             ...
                             <tr><td>
                              ...
                              <td><input type="radio" value="1" id="icontype" name="icontype" class="radio_com">${ctp:i18n('cip.manager.register.mobile')}</td>
                             </tr>
                          </table>
					        </td>
                    </tr>
                        ...
                        <tr>
                        <th nowrap="nowrap"><label class="margin_r_10" for="text"><font color="red">*</font>${ctp:i18n('cip.manager.register.versionno')}:</label></th>
                        <td width="100%">
                                <select  id = "versionNO" class="w100b validate"></select>
                        </td>
                    </tr>
                      <tr>
                        <th nowrap="nowrap"><label class="margin_r_10" for="text"><font color="red">*</font>${ctp:i18n('cip.manager.register.versiontip')}:</label></th>
                   <td width="100%" >
                            <input type="text" id="versionIntroduction" name="versionIntroduction" class="w100b validate" validate="notNull:true,name:'${ctp:i18n('cip.manager.register.versiontip')}',maxLength:100,avoidChar:'\\\/|><:*?&%$|,&quot;-_+'">
                         </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th nowrap="nowrap"><label class="margin_r_10" for="text">${ctp:i18n('cip.manager.register.applable')}:</th>
                        <td width="100%">
                    ...
                    <tr>
                        <th nowrap="nowrap"><label class="margin_r_10" for="text"><font color="red">*</font>${ctp:i18n('cip.manager.register.appprovider')}:</label></th>
                        <td width="100%" colspan="5">
                            <div class="common_txtbox clearfix">
                               <input type="text" id="appProvider" name="appProvider" class="w100b validate" validate="notNull:true,maxLength:10,name:'${ctp:i18n('cip.manager.register.appprovider')}',avoidChar:'\\\/|><:*?&%$|,&quot;-_+'">
                            </div> 
                        </td>
                    </tr>
                    <tr>
                        <th nowrap="nowrap"><label class="margin_r_10"><font color="red">*</font>${ctp:i18n('cip.manager.register.access')}:</th>
                        <td width="100%">
