        ...
        <div class="layout_north" layout="height:40,sprit:false,border:false">
       	...
       	<div class="layout_center over_hidden" layout="border:true" id="center">
			<div class="stadic_layout form_area" id='form_area'>
				<form id="auth_form" method="post" action="<c:url value='/m3/mobileAuthController.do' />?method=orgAuth">
					...
					<tr>
						...
						<fieldset ><legend><font><fmt:message key="label.mm.orgauth.legend" bundle="${mobileManageBundle}"/>
							...
							<table id="tablestyle" >
							<tr class="trstyle">
					   			<td class="bg-gray"  nowrap="nowrap"><fmt:message key="label.mm.m3version" bundle="${mobileManageBundle}"/>:</td>
