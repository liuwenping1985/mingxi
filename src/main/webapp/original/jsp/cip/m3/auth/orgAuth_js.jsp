...
<fmt:setBundle basename="com.seeyon.apps.m3.authorization.resouces.i18n.MobileManageResources" var="mobileManageBundle"/>
<link type="text/css" rel="stylesheet"  href="<c:url value='/apps_res/m3/css/orgAuth.css${v3x:resSuffix()}' />">
<link rel="stylesheet" type="text/css" href="<c:url value="/common/css/default.css${v3x:resSuffix()}" />">
<script type="text/javascript" charset="UTF-8" 
src="<c:url value='/apps_res/m3/js/SimpleMap.js${v3x:resSuffix()}'/>">
</script>
...
function hidden_edit() {
	...
	var authedC = parseInt(allauthed) + parseInt(authedNum) - parseInt(authedNum);
	if (authedType == 23){
		document.getElementById("authableNum_td_1").innerHTML = authedNum;
		...
		document.getElementById("authableNum_td").innerHTML = orgCount - authedNum;
		document.getElementById("authedCount_td").innerHTML = authedNum;
	}
}
