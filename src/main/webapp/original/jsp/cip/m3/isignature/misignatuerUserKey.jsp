...
<%@ include file="./msignatureKey_js.jsp"%>
</head>
<body>
<div id='layout' class="comp" comp="type:'layout'">
  <div class="comp" comp="type:'breadcrumb',code:'m3_isignatureUserKey'"></div> 
                ...
                <div class="stadic_layout_body stadic_body_top_bottom">
                    <div id="welcome">
                        <div class="color_gray margin_l_20">
                            <div class="clearfix">
                                <h2 class="left" style="font-size: 26px;font-family: Verdana;font-weight: bolder;color: #888888;">${ctp:i18n("m1.isignature.userkey.infoLabel")}</h2>
                    ...
                    <div id="signatureKeyForm">
                        <%@include file="signatureKeyForm.jsp" %></div>
                </div>
                <div class="stadic_layout_footer stadic_footer_height" style="height:37px;">
