...
<div id='layout' class="comp" comp="type:'layout'">
  <div class="comp" ></div>
	    ...
	    <div id="center"  class="layout_center" layout="border:true">
		    <form id="form1" action="<c:url value='/m3/mClientBindController.do'/>?method=setSafeLevel" method="post">
				<input type="hidden" id="entityId" name="entityId" value="<c:out value='${entityId}'/>" />
				</br>
				</br>
				<fieldset>
					<legend><font>${ctp:i18n("m3.bind.safelevel.label")}</font></legend>
					<table>
						<tr></tr>
						<tr></tr>
						<tr>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${ctp:i18n("m3.bind.high.safelevel")}:</td>
							<td>
								...
								<br/>
								<br/>
								<span>${ctp:i18n("m3.bind.safeLevel.label")}</span>
							</td>
						</tr>
					</table>
				</fieldset>
		...
		<div id="btnArea" class="stadic_layout_footer" style="height:50px;">
