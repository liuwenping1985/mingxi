...
$().ready(function() {
    ...
    $("#tab1").click(function() {
        ...
        $("#tab1_iframe").attr('src','${path}/m3/mClientBindController.do?method=toBindManage').show();
    ...
    $("#tab4").click(function() {
        ...
        $("#tab7_iframe").attr('src','');
        $("#tab4_iframe").attr('src','${path}/m3/mClientBindController.do?method=toSetSafeLevel').show();
        $("#tab1").attr('class', '');
        $("#tab7").attr('class', '');
    ...
    $("#tab7").click(function() {
        $("#tab1_iframe").attr('src','');
        $("#tab4_iframe").attr('src','');
        $("#tab7_iframe").attr('src','${path}/m3/mClientBindController.do?method=toSetBindNum').show();
        $("#tab1").attr('class', '');
        $("#tab4").attr('class', '');
...
<body class="h100b over_hidden">
    <div id='layout' class="comp" comp="type:'layout'">
        <div class="layout_north" layout="height:28,maxHeight:100,minHeight:30,sprit:false">
            <div class="comp" comp="type:'breadcrumb',code:'m3_orgBind'"></div>
