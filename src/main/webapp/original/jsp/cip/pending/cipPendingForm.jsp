		...
		<p class="align_right"><font color="red">*</font>${ctp:i18n('cip.form.must')}</p>
			<table border="0" cellspacing="0" cellpadding="0">
				...
				<input type="hidden" name="type" id="type" value="${type}" />
					...
					<tr>
						<th nowrap="nowrap"><label class="margin_r_10" for="text"><font color="red">*</font>${ctp:i18n('cip.pending.get.module')}:</label></th>
						<td>
							<div class="common_selectbox_wrap">
					...
					<tr>
						...
						<td>
							<div class="common_txtbox_wrap">
								<input type="text" class="w100b validate" id="accessMethodName" disabled/>
							</div>
						</td>
					</tr>
