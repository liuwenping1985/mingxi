...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" align="center" class="CollTable">
		...
		<td height="10" class="detail-summary">
			<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
				<tr>
					...
					<td class="detail-subject" width="30%"><fmt:message key="mt.mtSubject.label" /><fmt:message key="label.colon" />${v3x:toHTML(bean.templateName)}</td>
  ...
  <tr>
		<td valign="top">
      		<iframe src="${contentTemplateURL}?method=detail&id=${bean.id}&oper=showContent" width="100%" height="97%" name="contentIframe" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"></iframe>
		</td>
	</tr>
