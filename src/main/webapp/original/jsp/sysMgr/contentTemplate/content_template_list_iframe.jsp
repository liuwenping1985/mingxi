  ...
  <div class="right_div_row2">
    <div class="top_div_row2">
		<table height="40" width="100%"  border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td height="40" width="80%" class="webfx-menu-bar" style="background:#f0f0f0;">
					<script type="text/javascript">
	...
	<div class="center_div_row2" id="scrollListDiv" style="top:40px;">
		<form>
			<v3x:table htmlId="listTable" data="list" var="bean">
				...
				<v3x:column width="35%" type="String" onDblClick="editTemplateLine('${bean.id}');" onClick="displayDetail('${bean.id}');"
				...
				<v3x:column width="40%" type="String" onDblClick="editTemplateLine('${bean.id}');" onClick="displayDetail('${bean.id}');"
					label="mt.mtContentTemplate.AuthorizedScope" className="cursor-hand sort" value="${v3x:showOrgEntitiesOfTypeAndId(bean.scopes,pageContext)}" alt="${v3x:showOrgEntitiesOfTypeAndId(bean.scopes,pageContext)}"/>
			</v3x:table>
			</form>
			</div>
		</div>
