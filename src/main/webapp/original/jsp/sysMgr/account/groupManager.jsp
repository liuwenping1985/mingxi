...
<body scroll="no" class="padding5">
	<form id="postForm" target="temp_iframe" method="post" action="<html:link renderURL='/accountManager.do' />?method=modifyGroupManager" 
				...
				<table width="300" border="0" cellspacing="0" cellpadding="0"
					...
					<c:set var="disabled"
						...
						<td class="new-column" width="80%">
							<input disabled name="name"  maxLength="40" maxSize="40" style="width:325px;height:28px;border: 1px solid #e4e4e4;" onfocus="this.style.borderColor = '#68BAFF'" onblur="this.style.borderColor = '#e4e4e4'" class="input-100per" type="text" id="name" value="<c:out value="${logerName }" escapeXml="true"/>" inputName="<fmt:message key="manager.name.notnull" />" validate="notNull,isWord" />
						</td>
					</tr>		
					<tr height="40">
								<td class="bg-gray" width="20%" nowrap="nowrap"><label
