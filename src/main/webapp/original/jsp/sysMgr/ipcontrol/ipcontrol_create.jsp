				...
				<table width="550" border="0" cellspacing="0" cellpadding="0" align="center">
					<tr>
						...
						<td class="new-column" nowrap colspan="2">
							<select name="type" id="type" style="width: 350px" onchange="switchDisplay(this)" ${v3x:outConditionExpression(readonly == null, '', 'disabled')}>
					...
					<tr>
						...
						<td class="new-column" width="70%" colspan="2">
					        ...
					        <input name="name" type="text" id="name"  deaultValue="${defName}" style="width: 350px"
					               ...
					               title="<c:out value="${ipcontrol.name}" escapeXml="true" default='${defName}' />"
					...
					<tr id="tr0">
						<td class="bg-gray" nowrap><font color="red">*</font><fmt:message key="sysMgr.lockedUser.ip.target" bundle='${v3xCommonI18N}'/>:</td>
						<td class="new-column" nowrap colspan="2">
							<input name='authName' id="authName" style="width: 350px"
							value="<c:out value='${authStr}' default='${defaultSP}' escapeXml='true' />" 
							readonly class="cursor-hand" onclick="selectPeopleFun_auth()" title="${authStr}"
					...
					<tr id="tr1">
					<td class="bg-gray" nowrap><font color="red">*</font><fmt:message key="sysMgr.lockedUser.ip.range" bundle='${v3xCommonI18N}'/>:</td>
					<td class="new-column" nowrap style="padding-top:12px;">
						<SELECT name="IPSelect" size="8" id="select" style="width:124px;" ondblclick="${v3x:outConditionExpression(readonly == null, 'removeIPOption()', '')}" ${v3x:outConditionExpression(readonly == null, '', 'readonly')}>
					...
					<td align="left" ><input type="button" name="add" value="<fmt:message key='common.button.add.label' bundle='${v3xCommonI18N}'/>" class="button-default-2" onclick="addIPOption(ipAddress.getIPValue())"></td>
					</tr>
					<%--
					<tr id="tr3"> 
