...
<div class="top_div_row2" style="background:#f0f0f0;">
<table border="0" width="100%" align="center"  cellpadding="0" cellspacing="0">	
    <tr>
	   <td style="color:black; padding-left: 5px; height:35px; vertical-align:middle;">
	   	<script type="text/javascript">
	   ...
	   <td  width="50%" height="100%" style="padding-top:7px; height:35px; vertical-align:top;">
