...
function submitQuery(){
  ...
  //  return false;
  //}
	document.getElementById("fm").action="${mobileManagerURL}?method=stateQuery&startDate="+startDate+"&toDate="+toDate+"&tjType="+tjType+"&tjId="+tjId+"&tjValue="+encodeURIComponent(tjValue);
        	    ...
        	    <div>
        	       ...
        	       <table>
        	           ...
        	           <tr>
                           ...
                           <td><input type="button" class="button-default-2 button-default_emphasize" value="<fmt:message key='common.button.condition.search.label' bundle="${v3xCommonI18N}" />" onclick="submitQuery()"></td>
