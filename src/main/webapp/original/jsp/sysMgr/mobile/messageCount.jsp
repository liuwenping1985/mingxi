...
function submitQuery(){
    ...
    //  return false;
    //}
    document.getElementById("fm").action="${mobileManagerURL}?method=messageCount&startDate="+startDate+"&toDate="+toDate+"&tjType="+tjType+"&tjId="+tjId+"&tjValue="+encodeURIComponent(tjValue)+"&toType="+toType;
...
<body scroll="no" class="padding5" onload="initTitle()">
...
<fmt:message var="isDepartment"  key='system.statequery.Department' bundle='${v3xSysI18N}'  />
    ...
    <tr>
          <td valign="bottom" height="26" class="tab-tag">
                <div class="div-float">
                    <c:choose>
                        <c:when test="${productEdition=='ENT'}">
                            <div class="tab-tag-left"></div>
                            <div class="tab-tag-middel cursor-hand" onclick="javascript:location.href='${mobileManagerURL}?method=popedomManageENT'">
                        ...
                        <c:otherwise>
                            <div class="tab-tag-left"></div>
                            <div class="tab-tag-middel cursor-hand" 
                                onclick="javascript:location.href='${mobileManagerURL}?method=messagePopedom'">
