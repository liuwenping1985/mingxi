...
<body scroll='no' style="overflow: hidden;" onkeydown="listenerKeyESC()" id="typeBody">
		...
		<td class="bg-advance-middel">
			<div style="border: solid 1px #666666;overflow:auto;height:265;background-color:rgb(255, 255, 255)" id="listDiv">
				<table class="sort" width="100%"  border="0" cellspacing="0" cellpadding="0" onClick="sortColumn(event, true)">
					<thead>
					<tr class="sort">
						<td type="String" colspan="2"><fmt:message key="news.type.typeName" bundle='${v3xCommonI18N}' /></td>
					</tr>
					</thead>
					<tbody>
...
$(document).ready(function() { 
	...
	if(ua.indexOf('MSIE 8.0')>-1){
		$('#listDiv').height($('#typeBody').parent().height()-62);
	}else{
