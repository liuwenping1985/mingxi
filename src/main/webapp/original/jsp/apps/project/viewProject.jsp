        ...
        <div id="tabs2_body" class="common_tabs_body color_gray2 font_size14">
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="common_txtbox  clearfix">
                                <textarea ${empty projectState || projectState == 1 ? "readonly='readonly'" : ""} style="${empty projectState || projectState == 1 ? 'background-color:#F8F8F8' : ''}" cols="30" rows="5" class="w100b" name="${ctp:i18n('project.body.desc.label')}" id="projectDesc" class="validate" validate="maxLength:1000"></textarea>
                            </div>
                        </td>
                    </tr>
            ...
            <div id="tab2_div" class="hidden padding_lr_15">
                <table width="100%" border="0" cellspacing="5" cellpadding="0" align="center">
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="common_txtbox  clearfix">
                                <textarea ${empty projectState || projectState == 1 ? "readonly='readonly'" : ""} id="members_text" name="members_text" cols="30" rows="3" class="w100b" style="cursor: default; ${empty projectState || projectState == 1 ? 'background-color:#F8F8F8;color:d-color: #F8F8F8;color: rgb(84, 84, 84);' : ''}" ></textarea>
            ...
            <div id="tab3_div" class="hidden padding_l_20 padding_r_20">
                ...
                <div class="common_selectbox_wrap" >
                    ...
                    <input type="checkbox" name="autoChangePhase" disabled="disabled" id="autoChangePhase"/>${ctp:i18n('project.phase.auto.change.label')}
                </div>
