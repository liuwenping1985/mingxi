...
function closeMe() {
		window.parentDialogObj['ldapImportdialog'].close();
	}
</script>
</head>
...
<form enctype="multipart/form-data" method="POST" name="uploadForm" target="fileUploadFrame" action="/seeyon/ldap/ldap.do?method=uploadProcess">
   ...
   <tr>
      <td height="42" align="right" class="bg-advance-bottom">
         ...
         <input id="submintCancel" type="button" onclick="closeMe()" value="<fmt:message key='common.button.cancel.label' bundle='${v3xCommonI18N}'/>" class="button-default-2">
      </td>
   </tr>
</table>
</form>
