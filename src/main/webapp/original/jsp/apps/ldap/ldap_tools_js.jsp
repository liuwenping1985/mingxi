...
$().ready(function() {
  ...
  var hasPlugin = ${ctp:hasPlugin('ldap')};
  if ($.ctx.plugins.contains('ldap') || hasPlugin) {
  ...
  function openUserTree(editstate, isModify) {
    ...
    var sendResult = $.dialog({
        url: "/seeyon/ldap/ldap.do?method=viewUserTree&checkOnlyLoginName="+checked+"&accountId="+loginAccountId,
        title: " ",
        width: "440",
        height: "325",
        isDrag: false,
