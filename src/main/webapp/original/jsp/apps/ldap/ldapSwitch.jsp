				...
				<table  width="100%" height="100%"  border="0" align="center">
				 <tr>
			         ...
			         <tr>
			         	<td width="10%"></td>
			         	<td width="30%" align="right">
			         		<label for="canOAUserLogon">
			         		<input type="checkbox" id="ldapCanOauserLogon" name="ldapCanOauserLogon" value="1" <c:if test="${v3xLdapSwitchBean.ldapEnabled==1 && v3xLdapSwitchBean.ldapCanOauserLogon == 1}">checked="checked"</c:if>/></label>
			         	</td>
			         	<td width="50%" align="left">
							<fmt:message key='ldap.system.canoauserlogon' />                       	
                        </td>
			         	  <td width="10%"></td>
					     <td width="10%"></td>
					     <td width="10%"></td>
