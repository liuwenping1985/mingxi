...
$(function(){
	...
	$('#total').addClass('font_color').siblings().removeClass('font_color');
	$('#week').click(function(){
		$('#week').addClass('font_color').siblings().removeClass('font_color');
	...
	$('#month').click(function(){
		$('#month').addClass('font_color').siblings().removeClass('font_color');
		$('#knowledgeRanking').html('');
		openProce();
	...
	kpManager.getAccountPropaganda(ajaxPropagandaBean, {
        success: function(list){
            ...
            if(list.length == 0){
                ...
                $("#divPropagandaId").addClass("").html("<a href='javascript:toAccountPropaganda();'>${ctp:i18n('doc.jsp.knowledge.more')}</a>");
            }
