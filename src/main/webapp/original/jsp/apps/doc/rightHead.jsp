...
<script>
    <!--
		...
		menu.AddExtendMenu("sendto","<fmt:message key='doc.menu.sendto.label'/>",[9,1],"rbpm");
...
function docSelectAll(allButton, targetName){
	...
	if(allButton.checked){
		...
		if(myFavority){
			docListAclMap.put('parent', new docListAcl('true', 'true', 'true',
			'true', 'true', 'true', 'false', 'false', 'false', appData.doc, 'false'));
		}else{
