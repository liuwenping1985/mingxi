		...
		<tr><td>
			<div id="contentDiv" style="display:none">
				<table width="95%" border="0" cellspacing="0" align="center" cellpadding="2" class="ellipsis">
					<tr>
						<td align="right" width="23%" valign="top" style="height: 40px;line-height:25px;">${ctp:i18n('doc.jsp.knowledge.query.key')}:</td>
						<td valign="top">
							<input type="text" id="keyword" style="height:25px;line-height:25px;" name="keyword" size="52" value="<c:out value='${doc.keyWords}' escapeXml='true' />"
					...
					<tr>
						...
						<td valign="top">
							<textarea id="description" wrap="hard" style="word-wrap: break-word;white-space: normal" onchange="propertiesChanged();" name="description" rows="4" cols="51" maxSize="500" validate="maxLength" inputName="${ctp:i18n('doc.desc')}" ><c:out value="${doc.frDesc}" escapeXml="true"/></textarea>
						</td>
					</tr>
