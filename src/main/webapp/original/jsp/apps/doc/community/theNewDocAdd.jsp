...
<script type="text/javascript" src="${path}/apps_res/doc/js/doc.js${ctp:resSuffix()}"></script>
<script type="text/javascript" charset="UTF-8">
	...
	window.onload = function (){
		if(v3x.isMSIE8){
			document.getElementById("hrefFnSaveId").style.height = "30px";
		}
	}
                ...
                <div class="form_area align_center">
                    <div id="dataSubmitDomain">
                        <table id="dataSubmitDomainTabId" border="0" cellSpacing="0" cellPadding="0" class="w100b font_size12">
                            <tbody>
                                <tr>
                                    <td rowspan="2" valign="top" width="1%" class="padding_t_5 padding_l_10" nowrap="nowrap"><a href="javascript:void(0)" id="hrefFnSaveId" onClick="fnSave();" class="margin_r_10 display_inline-block align_center new_btn">${ctp:i18n('doc.log.save')}</a></td>
