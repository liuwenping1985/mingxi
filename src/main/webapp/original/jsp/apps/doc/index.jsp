...
<title>${v3x:_(pageContext, "doc.center.lable")}</title>
...
<frameset cols="137,*" id="layout" frameBorder="10" frameSpacing="5" class="border_all bg_color" style="border:none;">
