...
<!--
	...
	var _shareEnabled = '${docLib.shareEnabled}' ;
	...
	var shareEnabled = document.getElementById("shareEnabled");
	...
	shareEnabled.checked = _shareEnabled == 'true';
	shareEnabled.value = _shareEnabled == 'true' ? 1 : 0;
...
<script>
  bindOnresize('docLibBody',20,100);
</script>