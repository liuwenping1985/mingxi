...
<form name="mainForm" id="mainForm" action="" method="post" target="folderIframe">
	<table class="popupTitleRight" width="100%" height="${param.showComment eq 'true' && param.showRecommend eq 'true' && param.showVersion eq 'true' ? '350' : '190'}" border="0" cellspacing="0" cellpadding="0" align="center">
	<c:if test="${param.showComment eq 'true'}">
		<%-- 评论属性修改范围影响设置 --%>
		<tr>
			<td colspan="2" height="20" class="padding_l_10">
