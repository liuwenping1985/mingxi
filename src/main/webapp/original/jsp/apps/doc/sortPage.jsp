...
window.onload = function() {
    singleSelect("id");
    document.getElementById("hDivdocSortPage").style.width = "618px";
    document.getElementById("hDivdocSortPage").style.border = "1px solid rgb(221,221,221)";
    document.getElementById("bDivdocSortPage").style.width = "618px";
    document.getElementById("bDivdocSortPage").style.border = "1px solid rgb(221,221,221)";
    var divs = getClassNames('fDIV' , 'div');
    divs[0].style.width = "635px";
   };
...
<body onkeydown="listenerKeyESC();" scroll="no">
	<div class="main_div_row2" style="width:620px;padding:0px 20px;">
		<div class="right_div_row2" style="width:620px;padding:0px 20px;background: rgb(250,250,250);">
    		<div class="top_div_row2" style="left:0">
		...
		<div id="sortProperty" >
		  	<v3x:table data="docs" var="doc" isChangeTRColor="true" className="ellipsis sort" showHeader="true" htmlId="docSortPage" showPager="true" pageSize="0" dragable="true">
                ...
                <v3x:column label="doc.metadata.def.name" width="37%" alt="${doc.docName}" value="${doc.docName}"></v3x:column> 
                <c:choose>
