...
<div class="form_area h100b bg_color_white">
  <FORM id=tableForm action="${path}/doc/knowledgeController.do?method=favorite" class="display_block h100b w100b">
          <div id='favoritedDiv' style="background: rgb(250,250,250);color:#333;">
        ...
        <div id="divCenter" class="border_t" style="background: rgb(250,250,250);color:#333;">
        <table class="w100b" border="0" cellpadding="0" cellspacing="0">
	        <tr>
	        ...
	        <tr>
	            <td></td>
	            <td>
              		<DIV class="common_txtbox clearfix over_auto border_all" style="height: 180px; width: 210px;border:1px solid rgb(221,221,221);">
	        ...
	        <tr>
	            ...
	            <td>
              		<INPUT style="background:#fff;" type="text" id="keyword" name="keyword" value="<c:out value='${keyword}'/>"
