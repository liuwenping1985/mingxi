...
<form name="mainForm" id="mainForm" action="" method="post"  target="alertIframe">
	<table class="popupTitleRight" width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" align="center">
		<tr>
			<td  height="20" class="PopupTitle" colspan="2" nowrap="nowrap" style="background: rgb(250,250,250);padding-left: 20px;height:20px;line-height:20px;padding-top:0;color:#333;"><fmt:message key="doc.jsp.alert.object" />:&nbsp;&nbsp;${v3x:getLimitLengthString(v3x:_(pageContext, name), 25,'...')}</td>
		</tr>
		
		<tr height="100"><td colspan="2" align="center" style="background: rgb(250,250,250);">		
			<fieldset style="width:89%;border:1px solid rgb(221,221,221);font-weight: normal;" align="center"><legend><strong>
				<c:if test="${editFlag == true}">
				<fmt:message key="doc.jsp.alert.title.edit" />
				</c:if>
				<c:if test="${editFlag == false}">
		...
		<tr>
						<td height="40" style="background: rgb(250,250,250);">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<label for="check_box_add" style="color:#333;">
					...
					<fmt:message key="doc.jsp.alert.add" />					
						...
						<td height="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<label for="check_box_edit" style="color:#333;">
		...
		<tr>			<td height="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<label for="check_box_delete" style="color:#333;">
				...
				<label for="check_box_forum" style="color:#333;">
		...
		<tr >
			<td colspan="2" height="40" valign="top" style="background:rgb(250,250,250);">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<label for="check_box_message" style="color:#333;">
