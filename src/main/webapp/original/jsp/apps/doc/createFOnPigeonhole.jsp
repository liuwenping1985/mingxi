...
<table class="popupTitleRight" width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top:10px;background:#fafafa;height:110px;">
	<tr>
		<td align="right" nowrap="nowrap" style="padding-left:10px;">${ctp:i18n('doc.jsp.createf.name')}&nbsp;</td>
        <td align="left">
	...
	<tr style="padding-top: 10px;padding-bottom: 10px;background:#4d4d4d;">
      <td align="right" colspan="2" style="height:46px;">
        ...
        <a id="btncancel" onclick="calcle();" class="common_button common_button_gray" style="width:40px;height:28px;line-height:28px;text-align:center;margin-left:-4px;margin-right:3px;">${ctp:i18n('common.button.cancel.label')}</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	</tr>
</table>
</form>
</body>
