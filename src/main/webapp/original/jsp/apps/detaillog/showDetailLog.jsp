...
<head>
    ...
    <style type="text/css">
        .stadic_head_height { height: 33px; }
        .stadic_body_top_bottom { overflow-y:hidden; bottom: 0px; top: 33px; }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
           ...
           $('#processLog').click(function(){
               var url = _ctxPath + "/detaillog/detaillog.do?method=showProcessLog&processId=${ctp:escapeJavascript(processId)}";
               $('#resource').attr("src",url);
               $('#tabID li').click(function(){
                   $('#tabID li').removeClass("current");
                   $(this).addClass("current");
           ...
           $('#exportExcel').click(function(){
               ...
               if(exportExcelFlag === '1'){
                   ...
                   url = _ctxPath + "/detaillog/detaillog.do?method=exportProcessExcel&processId=${ctp:escapeJavascript(processId)}";
...
<body class="page_color  h100b over_hidden">
    <div class="stadic_layout">
        <div class="stadic_layout_head stadic_head_height margin_t_5" style="background: #fafafa;">
           <div class="clearfix">
               ...
               <div class="right margin_r_10 toolbar_l">
                   ...
                   <a href="#" id="printButton"><span class="hand ico16 print_16"></span>${ctp:i18n("print.label")}</a><%--打印 --%>
               </div>
           </div>
        </div>
        <!-- 处理明细 -->
