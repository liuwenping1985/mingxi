        ...
        <c:choose>
			...
			<div class="stadic_layout_body stadic_body_top_bottom" id="reportResult">
				<div id="tabs" name="tabs" class="stadic_layout" style="*position:absolute;height:90%;width:100%">
					...
					<ul id="queryResult" class="align_center border_tb common_tabs_body stadic_body_top_bottom stadic_layout_body" style="position:absolute;width:100%;top:25px;bottom:35px;background:#fff;">
					</ul>
