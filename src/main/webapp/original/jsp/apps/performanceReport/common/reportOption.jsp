...
<title>
	<c:if test = "${ctp:getSystemProperty('system.ProductId') eq 0 || ctp:getSystemProperty('system.ProductId') eq 7  || ctp:getSystemProperty('system.ProductId') eq 12}">
		${ctp:i18n('performanceReport.queryMain.reportName')}
	</c:if>
</title>
<script type="text/javascript">
    ...
    function checkInputValue(){
		if(!$("#start_time,#end_time").validate()){
			return false;
		}
