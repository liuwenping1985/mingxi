...
$().ready(function() {
    ...
    $("#cMemberBat").click(function() {
        ...
        $.selectPeople({
           ...
           // onlyShowChildrenAccount: true, 此页面是给集团管理员用的，所以不用设置这个条件，允许支持查询全集团
...
<body>
    <div id="banch_form_area" class="form_area over_hidden" layout="width:240">
        <form name="conPostFormBat" id="conPostFormBat" method="post" action="conPost.do?method=batAddCon">
            ...
            <div class="align_center">
                <a id="submitbtnBat" href="javascript:void(0)" class="common_button common_button_emphasize">${ctp:i18n('guestbook.leaveword.ok')}</a>&nbsp;&nbsp;
