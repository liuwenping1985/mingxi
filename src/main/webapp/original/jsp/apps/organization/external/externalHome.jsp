...
$().ready(function() {
    $("#tab1").click(function() {
        ...
        $("#tab1_iframe").attr('src','${path}/organization/department.do?method=showDepartmentFrame&style=external&accountId=${accountId}').show();
    ...
    $("#tab4").click(function() {
        ...
        $("#tab4_iframe").attr('src','${path}/organization/member.do?method=listExtMember&accountId=${accountId}').show();
        $("#tab1").attr('class', '');
