...
$().ready(function() {
    ...
    $("#btnok").click(function() {
        ...
        lManager.saveLevel(accountId, $("#addForm").formobj(), {
                    ...
                    <div id="welcome">
                        <div class="color_gray margin_l_20">
                            ...
                            <div class="line_height160 font_size14">
                                <c:if test="${isGroup}">${ctp:i18n('organization.detail_info_level_group')}</c:if>
                                <c:if test="${!isGroup}">${ctp:i18n('organization.detail_info_level')}</c:if>
                            </div>
                        </div>
                    </div>
