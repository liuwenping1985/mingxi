						...
						<td>
							<div class="common_txtbox_wrap">
								<input type="text" id="name" class="validate"
									validate="type:'string',name:'${ctp:i18n('org.level_form.name.label')}',notNullWithoutTrim:true,minLength:1,maxLength:80,avoidChar:'\\/|><:*!@#$%^&amp;*+|,\'&quot'">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="common_txtbox_wrap">
								<input type="text" id="code" class="validate" validate="type:'string',name:'${ctp:i18n('org.level_form.code.label')}',notNull:false,maxLength:80,avoidChar:'!@#$%^&amp;*+|,'">
							</div>
