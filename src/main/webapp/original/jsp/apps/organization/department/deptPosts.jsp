...
<form name="deptForm" id="deptForm" method="post" target="deptFormFrame" action="${organizationPortalURL}&method=updateDeptPosts&id=${dept.v3xOrgDepartment.id}" onsubmit="return(checkForm(this))" style="height:100%">   
