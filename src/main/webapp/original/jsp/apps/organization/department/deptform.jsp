...
$().ready(function() {
    $("#exportDptmember").click(function() {
        if(oManager.getOrgExportFlag() || oManager.getOrgExportFlag() == 'true') {
            $.alert($.i18n('org.deptForm.importing.wait'));
            return;
        } else {
            $.alert({
...
<body>
    <form name="addForm" id="addForm" method="post" target="addDeptFrame"
		...
		<div class="">
			<table width="60%" align="center" border="0" cellspacing="0" cellpadding="0" style="margin-left:-10%;">
				<tbody>
					...
					<tr>
						<th width="20%" nowrap="nowrap"><label class="margin_r_10" for="text"><font color="red">*</font>${ctp:i18n('org.dept_form.name.label')}:</label></th>
						<td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="common_txtbox_wrap" style="background:#F8F8F8">
                                <input type="text" id="deptLevel" readonly="readonly" onfocus='this.blur();' style="background:#F8F8F8">
                            </div>
						...
						<td>
							<div class="common_txtbox_wrap">
								<input type="text" id="sortId" class="validate"
									validate="isInteger:true,minValue:1,maxValue:99999999,name:'${ctp:i18n('common.sort.label')}',notNull:true">
							</div>
					...
					<tr>
						...
						<td>
							<div class="common_txtbox_wrap">
								...
								notNull:true,minLength:1,maxLength:500" comp="type:'selectPeople',panels:'Department',selectType:'Department,Account',maxSize:'1',onlyLoginAccount:true,accountId:'${accountId}'"/> 
							</div>
						</td>
					</tr>
					<tr>
				    ...
				    var rolelist = dManager.getDepRoles(accountId)["deproles"];
						for(i=0;i<rolelist.length;i++){
							document.write("<tr><th nowrap=\"nowrap\"><label id=\"role"+i+"\" class=\"margin_r_10\" for=\"text\"></label></th><td><div class=\"common_txtbox_wrap\">"+
									"<input type=\"text\" id=\"deptrole"+i+"\" class=\"comp\" comp=\"type:\'selectPeople\',minSize:0,onlyLoginAccount:true,accountId:\'${accountId}\',isNeedCheckLevelScope:false,panels:\'Department\',selectType:\'Member\'\"></div></td></tr>");
					...
					<tr>
						...
						<td>
							<div class="common_txtbox_wrap clearfix">
								...
								<input type="text" id="deptpost" class="comp" comp="type:'selectPeople',panels:'Post',minSize:0,selectType:'Post',onlyLoginAccount:true,accountId:'${accountId}'"/>
							</div>
						</td>
					</tr>
					<tr >
