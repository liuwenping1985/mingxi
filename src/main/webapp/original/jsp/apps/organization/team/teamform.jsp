            ...
            <table width="90%" border="0" cellspacing="0" cellpadding="0">
				<tbody>
					...
					<tr>
						...
						<td width="90%">
							<div class="common_txtbox_wrap">
								<input id="name" type="text" value="" class="validate word_break_all" validate="type:'string',name:'${ctp:i18n('team.name')}',notNullWithoutTrim:true,minLength:1,maxLength:120,avoidChar:'\'\\/|><:*?&quot&%$'">
							</div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th nowrap="nowrap">
							<label class="margin_r_10" for="text">
							<font id="mustScope" color="red">*</font>
					...
					<tr>
						...
						<th nowrap="nowrap" id="showownerId">
							<label class="margin_r_10" for="text">
							<font id="mustBelong" color="red">*</font>
								${ctp:i18n('team.belong')}:
							</label>
						</th>
						<td>
							<div class="common_txtbox_wrap" >
							<input type="text" id="ownerId" class="comp"  comp="type:'selectPeople',panels:'Department',selectType:'Account,Department',maxSize:'1',minSize:'0',onlyLoginAccount:true,isNeedCheckLevelScope:false,accountId:'${accountId}'"/> 
							</div>
						</td>
					...
					<tbody>
						...
						<tr>
							...
							<td width="90%">
				    			...
				    			if (isgroup){
				    			//集团 
				    				document.write("<input id=\"teamLeader\"  type=\"text\"  class=\"comp\" comp=\"type:'selectPeople',callback:selpeople1,minSize:0,panels:'Department,Post',selectType:'Member',isNeedCheckLevelScope:false,accountId:'${accountId}'\">");
				    			}else{
				    			//单位
				    				document.write("<input id=\"teamLeader\"  type=\"text\"  class=\"comp\" comp=\"type:'selectPeople',callback:selpeople1,minSize:0,panels:'Department,Post,Outworker',selectType:'Member',isNeedCheckLevelScope:false,accountId:'${accountId}'\">");
				    			}
				    			</script> 
								</div>
							</td>
						...
						<tr>
							...
							<td width="90%">
				    			...
				    			if (isgroup){
				    			//集团 
				    				document.write("<textarea id=\"teamMember\" rows=\"3\" validate=\"type:'string',name:'${ctp:i18n('team.member')}',notNull:true,minLength:1\"  class=\"comp w100b validate\" comp=\"type:'selectPeople',callback:selpeople2,minSize:1,mode:'open',showTeamType: '2,3',isConfirmExcludeSubDepartment:true,panels:'Department,Post,Level',selectType:'Department,Post,Level,Member',isNeedCheckLevelScope:false,accountId:'${accountId}'\">");
				    			}else{
				    			//单位
				    				document.write("<textarea id=\"teamMember\" rows=\"3\" validate=\"type:'string',name:'${ctp:i18n('team.member')}',notNull:true,minLength:1\"  class=\"comp w100b validate\" comp=\"type:'selectPeople',callback:selpeople2,minSize:1,mode:'open',showTeamType: '2,3',isConfirmExcludeSubDepartment:true, panels:'Department,Post,Level,Outworker',selectType:'Department,Post,Level,Member',isNeedCheckLevelScope:false,accountId:'${accountId}'\">");
				    			}
				    			</script>
								</textarea>
								</div>
						...
						<tr>
							...
							<td width="90%">
								<div class="common_txtbox_wrap w100b">
				    				...
				    				if (isgroup){
				    				//集团 
				    					document.write("<input id=\"teamSuperVisor\" type=\"text\"  class=\"comp\" comp=\"type:'selectPeople',callback:selpeople3,minSize:0,mode:'open',panels:'Department,Post',selectType:'Member',isNeedCheckLevelScope:false,accountId:'${accountId}'\">");
				    				}else{
				    				//单位
				    					document.write("<input id=\"teamSuperVisor\" type=\"text\"  class=\"comp\" comp=\"type:'selectPeople',callback:selpeople3,minSize:0,mode:'open',panels:'Department,Post,Outworker',selectType:'Member',isNeedCheckLevelScope:false,accountId:'${accountId}'\">");
				    				}
				    				</script> 
								</div>
							</td>
						...
						<tr>
							...
							<td width="90%">
								<div class="common_txtbox clearfix">
					    			...
					    			if (isgroup){
					    			//集团 
					    				document.write("<textarea id=\"teamRelative\" rows=\"3\"  class=\"comp padding_5 w100b\" comp=\"type:'selectPeople',callback:selpeople4,minSize:0,panels:'Department,Post',selectType:'Member',isNeedCheckLevelScope:false,accountId:'${accountId}'\">");
					    			}else{
					    			//单位
					    				document.write("<textarea id=\"teamRelative\" rows=\"3\"  class=\"comp padding_5 w100b\" comp=\"type:'selectPeople',callback:selpeople4,minSize:0,panels:'Department,Post,Outworker',selectType:'Member',isNeedCheckLevelScope:false,accountId:'${accountId}'\">");
					    			}
					    			</script>
									</textarea>
								</div>
