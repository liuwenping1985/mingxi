            ...
            <div class="stadic_layout form_area"  id="form_area">
            	...
            	<div id="all-blocks" style="width:100%;height:90px;overflow-y:hidden;">
                    <div style="min-width:1142px;height:85px;">
                        <%-- 集团 --%>
                        <div class="block-div groupSizeDiv hidden" onclick="openOrgWindow('1')">
                        ...
                        <div class="block-div groupSizeDiv hidden" onclick="openOrgWindow('2')">
                            <div class="block-div-inner">
                        ...
                        <div class="block-div groupSizeDiv hidden" onclick="openOrgWindow('3')">
                            <div class="block-div-inner">
                        ...
                        <div class="block-div groupSizeDiv hidden" onclick="openOrgWindow('4')">
                            <div class="block-div-inner">
                        ...
                        <div class="block-div groupSizeDiv hidden" onclick="openOrgWindow('5')">
                            <div class="block-div-inner">
