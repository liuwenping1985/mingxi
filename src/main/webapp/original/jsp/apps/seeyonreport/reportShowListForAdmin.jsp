...
<script type="text/javascript" src="${path}/common/seeyonreport/reportShowListForAdmin.js${ctp:resSuffix()}"></script>
<script type="text/javascript">
var subject = '${subject}', categoryName = '${categoryName}';
var searchobj;
