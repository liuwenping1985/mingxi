...
$().ready(function() {
    ...
    var MxVersion = perinfo.MxVersion;
    ...
    var toolbar = $("#toolbar").toolbar({
        toolbar: [
        {
            ...
            type: "select",
            value:"1",
            text:MxVersion+": ${ctp:i18n('licensePermission.m1.ctrl.no')}",
            onchange:changem1type,
            items: [ {
                text: MxVersion+": ${ctp:i18n('licensePermission.m1.ctrl.yes')}",
                value: '2'
            }]
            ...
            click: function() {
                ...
                $("#MxVersion").val(permissionDisInfo.MxVersion);
                showAccount();
                getlevelnum();
    ...
    function changem1type(){
        ...
        if($("#selectm1type").val()=="1"){
            $.infor(MxVersion+": ${ctp:i18n('licensePermission.m1.ctrl.no')}");
        }else{
            $.infor(MxVersion+": ${ctp:i18n('licensePermission.m1.ctrl.yes')}");
        }
        isshowdistributeBtn();
    }
    ...
    function showAccount() {
          ...
          var dialog = $.dialog({
               ...
               title: "${ctp:i18n('org.allocation.unit.license')}",
               buttons: [{
                   id: 'ok',
                   isEmphasize:true,
