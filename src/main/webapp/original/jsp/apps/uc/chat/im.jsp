...
<head>
    ...
    <script>
			...
			if(!msg.is_self){
		        ...
		        if (microtalk != null) {
					...
					htmlStr +="<tr class='ucChat_gap'><td colspan='5'></td></tr>"; */
		        	 	htmlStr +="<td colspan='2' valign='top'>";
		              htmlStr +="<span class='left'><span class='ucChat_arrow'><span></span></span></span>";
		              htmlStr += '<div class="ucChat_content"><span class="color_blue"><a onclick=\"openIM("' + msg.username + '", "' + msg.userjid + '")\">' + msg.username + ':&nbsp;</a></span><span class="font_size12 color_gray2">' + time + '</span><br><p class="margin_l_5"> '+$.i18n('uc.message.microtalk.js')+ '</p></div>'
				...
				htmlStr +='<tr class="ucChat_gap"><td colspan="5"></td></tr>';
				 ...
				 if (msg.type == 'image') {
					 var _type ="image";
		                ...
		                htmlStr +='<div class="ucChat_content">';
		                htmlStr +="<span class='color_gray2'><a onclick=\"openIM('" + msg.username + "', '" + msg.userjid + "')\">" + msg.username + ":&nbsp;</a></span><span class='font_size12 color_gray2'>" + time + "</span><br />";
			        ...
			        htmlStr += "<span class='color_gray2'>" + $.i18n('uc.titleMy.js') + "&nbsp;</span><span class='font_size12 color_gray2'>" + time + "</span><br />";
			        htmlStr += "<p class='margin_l_5' style='word-wrap: break-word;'>"+ body +"</p>";
			       // htmlStr +="<p class='margin_l_5'>"+body+"</p>";
		            var atts = msg.atts;
		            if (atts.size() > 0) {
		            	htmlStr += "<p class='padding_l_10'>";
        ...
        function getHisMessage(toId,startTime,endTime){
            ...
            query.appendChild(iq.buildNode('count', '60'));
