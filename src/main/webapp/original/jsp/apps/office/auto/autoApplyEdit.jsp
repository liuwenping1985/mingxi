...
$(function() {
  ...
  var fromDate1=toDay.print("%Y-%m-%d %H:%M");
  $("#applyOuttime").val(fromDate);
  $("#applyBacktime").val(fromDate1);
});
...
function preSubmit() {
  ...
  var UseLevel = $("#applyLevel").val().split("|")[1];//用车人职务
  ...
  officeData = "{\"UseMember\":\"" + UseMember + "\",\"UseLevel\":\"" + UseLevel + "\",\"UseDept\":\"" + UseDept + "\",\"UseType\":\"" + UseType + "\",\"UseReason\":\"" + UseReason + "\",\"UseAutoNum\":\"" + UseAutoNum + "\"}";
  preSendOrHandleWorkflow(window,"-1",officeWorkFlowTemp.workflowId,"-1","start", "${CurrentUser.id}","-1","${CurrentUser.loginAccount}",officeData,"office",null,window,officeSubmitForm);
}
</script>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>${ctp:i18n('office.portlet.auto.apply.js')}-${ctp:i18n('office.edit.js')}</title>
