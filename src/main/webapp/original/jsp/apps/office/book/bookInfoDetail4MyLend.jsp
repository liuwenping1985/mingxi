...
<script type="text/javascript" charset="UTF-8"
	src="${path}/apps_res/office/js/book/bookInfoDetail4MyLend.js"></script>
</head>
						...
						<tr>
							...
							<td colspan="2">
								<div class="common_selectbox_wrap">
                                    <input type="hidden" id="bookType" value="${bookApplyVO.bookInfoVO.bookType}"/> 
...
<!-- 								</div> -->
						...
						<tr>
							...
							<td colspan="2">
								<div id="lendedDateDiv" name="lendedDateDiv" class="common_txtbox_wrap">
									<input id="lendedDate" name="lendedDate" class="comp validate font_size12"
										comp="type:'calendar',ifFormat:'%Y-%m-%d %H:%M',showsTime:true"
										validate="name:'借出时间',notNull:true"
							...
							<td  align="right" colspan="2">
								<div id="rebackDateDiv" name="rebackDateDiv" class="common_txtbox_wrap">
									<input id="rebackDate" name="rebackDate" class="comp validate font_size12"
										comp="type:'calendar',ifFormat:'%Y-%m-%d %H:%M',showsTime:true"
										validate="name:'${ctp:i18n('office.book.bookInfoDetail4Remand.pghsj.js') }',notNull:true"
										 value="${bookApplyVO.rebackDate }"
										disabled="disabled" type="text" />
								</div>
							</td>
						</tr>
