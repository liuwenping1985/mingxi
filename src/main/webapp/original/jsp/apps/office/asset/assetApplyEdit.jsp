    ...
    <div class="layout_center" layout="border:false">
      <div id="assetUseTab" class="form_area common_center w80b">
        <table id="assetApplyInfo" class="w100b margin_t_5" border="0" cellSpacing="0" cellPadding="0" align="center" style="table-layout:fixed;">
          <tr>
            <th width="85" noWrap="nowrap" align="right"><span class="color_red">*</span><label for="text" class="margin_r_5">${ctp:i18n('office.asset.apply.applyUser.js')}:</label></th>
            <td align="left">
            ...
            <th noWrap="nowrap" width="90" align="right"><span class="color_red">*</span><label class="margin_r_5"  for="text">${ctp:i18n('office.asset.apply.applyDept.js')}:</label></th>
            <td align="left">
          ...
          <tr>
            ...
            <td colspan="3">
              <table border="0" class="w100b" cellSpacing="0" cellPadding="0" style="table-layout:fixed;">
                <tr>
                  <td align="left">
                    <div id="useStartTimeDiv" class="common_txtbox_wrap left clearfix w80b">
                  ...
                  <td align="left">
                    <div id="useEndTimeDiv" class="common_txtbox_wrap clearfix w80b left">
          ...
          <tr id="applyDescTR">
            ...
            <td colspan="3" align="left">
             <c:if test="${(param.operate eq 'add') or (param.operate eq 'modify') or (param.operate eq 'dLend')}">
                <div class="common_txtbox  margin_t_5 clearfix">
                  <textarea id="applyDesc" style="width: 98%; height: 45px;" class="validate font_size12 " validate="type:'string',notNull:true,maxLength:600,name:'${ctp:i18n('office.asset.apply.applyDesc.js')}'"></textarea>
                </div>
              </c:if>
