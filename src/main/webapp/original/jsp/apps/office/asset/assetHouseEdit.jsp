  ...
  <div class="stadic_layout h100b font_size12">
    ...
    <div id="centerDIV" class="stadic_layout_body stadic_body_top_bottom margin_b_5">
      ...
      <div id="assetHouseDiv" class="form_area set_search align_center">
        <table border="0" cellSpacing="0" cellPadding="0" align="center" style="table-layout: fixed;" width='600'>
          <tr>
            <th class="padding_r_5" width="20%" noWrap="nowrap" align="right"><span class="color_red">*</span><label for="text">${ctp:i18n('office.assethouse.name.js') }:</label>
            </th>
            <td>
