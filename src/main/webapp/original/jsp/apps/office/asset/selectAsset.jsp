...
<title>${ctp:i18n('office.asset.assetUse.xzbgsb.js') }</title>
<script type="text/javascript" charset="UTF-8" src="${path}/apps_res/office/js/asset/assetUse.js${ctp:resSuffix()}"></script>
<script type="text/javascript" charset="UTF-8" src="${path}/apps_res/office/js/asset/selectAsset.js"></script>
</head>
  ...
  <div class="layout_center" id="layoutCenterDiv" layout="border:false">
    ...
    <div id="centerTableDiv" class="stadic_layout border_l">
      ...
      <div id="staticBodyDiv" class="stadic_layout_body">
        <table id="assetTab" style="display: none;"></table>
      </div>
    </div>
  </div>
</div>
