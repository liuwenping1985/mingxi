...
<div id='layout' class="comp" comp="type:'layout'">
  <div class="layout_north" layout="height:${isAddOrModify ? 100:70 },border:false,sprit:false">
    <div id="stockDiv" class="form_area common_center w80b">
      <table id="stockApplyInfo" class="w100b margin_t_5" border="0" cellSpacing="0" cellPadding="0" align="center" style="table-layout:fixed;">
        <!-- 申请 -->
        <tr>
          <th width="75" noWrap="nowrap" align="right"><label class="margin_r_5 font_size12"  for="text">${ctp:i18n('office.stock.use.user.js')}:</label></th>
          <td align="left">
          ...
          <td></td> 
          <th width="75" noWrap="nowrap" align="right"><label class="margin_r_5 font_size12"  for="text">${ctp:i18n('office.stock.use.applydate.js')}:</label></th>
          <td align="left">
      ...
      <tr id="countTr">
        ...
        <td align="left" class="clearfix">
          <div id="depDiv" style="height: 20px;margin-top: 1px;" class="common_txtbox_wrap clearfix">
            <div id="applyTotalDiv" style="height: 20px;margin-left:-4px;margin-top:1px;" class="color_gray2"></div>
          </div>
        </td>
 ...
 <c:if test="${param.operate eq 'add' or param.operate eq 'modify' or (param.operate eq 'grant' and state eq 5)}">
   <div id="btnDiv" class="stadic_layout_footer stadic_footer_height border_t padding_tb_10 align_right bg_color_black" style="z-index: 2;bottom:-12px;">
