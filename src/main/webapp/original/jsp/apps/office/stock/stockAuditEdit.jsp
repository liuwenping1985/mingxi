...
<title>办公用品领用申请</title>
<script type="text/javascript" charset="UTF-8" src="${path}/apps_res/office/js/stock/stockUse.js${ctp:resSuffix()}"></script>
<script type="text/javascript" charset="UTF-8" src="${path}/apps_res/office/js/stock/stockAuditEdit.js"></script>
<script type="text/javascript">
$(function() {
    $("#stockApplyIframe").attr("src", "${path}/office/stockUse.do?method=stockApplyIframe&applyId=${applyId}&v=${ctp:digest_1(applyId)}");
});
</script>
</head>
...
<div id='layout'>
  <div id="east" class="layout_east over_hidden">
    <div id="deal_area_show" class="font_size12 align_center h100b hidden hand">
      ...
      ${ctp:i18n('office.stock.right.title.js')}
    </div>
      ...
      <div class="padding_lr_10 font_size12 h100b bg_color">
        <div id="auditDiv" class="common_radio_box margin_10 form_area clearfix">
          <div class="left">
            ...
            <textarea id="auditOpinion" style="width:95%;height:200px;" class="padding_5 margin_5 validate" validate="name:'${ctp:i18n('office.autoapply.audit.js')}',type:'string',maxLength:600"></textarea>
          </div>
  ...
  <div id="center" class="layout_center over_hidden h100b">
    <iframe id="stockApplyIframe" border="0" src="" frameBorder="0" height="100%" width="100%"></iframe>
  </div>
</div>
</body>
</html>