...
<title>${ctp:i18n('office.tbar.storage.js')}</title>
						...
						<td style="width: 30%;">
							<div id="stockCountDiv" class="common_txtbox_wrap">
								<input id="stockCount" name="stockCount"
									class="font_size12 validate" maxlength="9" validate="name:'${ctp:i18n('office.stock.storagecount.js')}',notNull:true,regExp:'^-?[0-9]{1,9}$',errorMsg:'${ctp:i18n('office.stock.zlsr9wzs.stc.title.js')}'"  value="" />
							</div>
						</td>
					</tr>
					<tr>
