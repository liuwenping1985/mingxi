...
<body onload="init();">
  <div id="scheduler_here" class="dhx_cal_container"
    ...
    <div class="dhx_cal_navline">
      <a id="newEvent" class="common_button common_button_gray" style="margin-left:50px;" 
        href="javascript:AddCalEvent();">${ctp:i18n("calendar.event.view.add")}</a>
        <div style="position:absolute; top: 2px; right:255px; margin-top:10px;">
      ...
      <div id="top_right">
        <div id="dhx_cal_common_tabs" class="common_tabs clearfix"
          style="position: absolute; top: 6px; right: 75px; background: none;">
          <ul class="left">
