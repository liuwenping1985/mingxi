...
<script type="text/javascript" src="${path}/apps_res/calendar/js/statistics_CalEvent.js${ctp:resSuffix()}"></script>
</head>
        ...
        <tr>
          ...
          <td style="width:160px;">
              <div class="common_txtbox_wrap"><input id="beginDate" readonly="readonly" type="text" class="comp validate"
                  validate='name:"${ctp:i18n('calendar.event.create.beginDate')}",notNull:true' comp="type:'calendar',ifFormat:'%Y-%m-%d %H:%M',showsTime:true" />
              </div>
          </td>
          ...
          <td style="width:160px;">
            <div class="common_txtbox_wrap"><input id="endDate" readonly="readonly" type="text" class="comp validate" 
                validate='name:"${ctp:i18n('calendar.event.create.endDate')}",notNull:true' comp="type:'calendar',ifFormat:'%Y-%m-%d %H:%M',showsTime:true" />
            </div>
          </td>
        </tr>
        <tr>
...
<%@ include file="/WEB-INF/jsp/ctp/report/chart/chart_pie.jsp"%>
</html>