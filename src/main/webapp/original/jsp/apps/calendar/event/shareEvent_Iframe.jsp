...
var curButtonClick = "${ctp:toHTML(param.curTab)}";
var searchobj;
var toobar;
var curTransParams = {
...
function detailPer(obj) {
	...
	document.getElementById(obj).innerHTML = "<span class='font_bold'>" + document.getElementById(obj).innerHTML + "</span>";
	curButtonClick = obj;
	search(null);
}
...
<body class="h100b over_hidden page_color">
	...
	<div id='layout' class="comp" comp="type:'layout'">
		<div class="layout_north" layout="height:40,maxHeight:100,sprit:false,border:false">
		...
		<div class="layout_center over_hidden list" id="id" layout="border:false">
			...
			<form id="ExportEventForm" action="" method="post">
				<input type="hidden" id="EventListtype" name="EventListtype" /> <input type="hidden" id="curPeople" name="curPeople" value="other" />
			</form>
		</div>
		<div class="layout_west" layout="width:0,minWidth:50,maxWidth:300,sprit:false">
			<div id="peopeleList">
