...
<script type="text/javascript" src="${path}/apps_res/calendar/js/editTimeLine.js${ctp:resSuffix()}"></script>
</head>
          ...
          <tr>
            <td class="padding_t_5">
                <label class="margin_r_10 hand" for="Checkbox3">
                    ...
                    <a title="" href="javascript:selectCheckBox('Checkbox3')"  style="color:black" value="3">${ctp:i18n('calendar.editTimeLine.nomy.ztask')}</a>
                </label>
            </td>
          </tr>
      </c:if>
