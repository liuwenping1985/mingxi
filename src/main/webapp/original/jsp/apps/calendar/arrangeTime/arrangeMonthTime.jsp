...
<body onload="init();" style="height:100%;overflow:hidden;" class="bg_color_none">
  <div id="scheduler_here" class="dhx_cal_container month_view" style='overflow:hidden; width: 100%; height: 100%; margin-top:-1px;'>
...
<script type="text/javascript" src="${path}/common/js/ui/scheduler/dhtmlxscheduler-debug.js${ctp:resSuffix()}"></script>
<script type="text/javascript" src="${path}/common/js/ui/scheduler/<%=locale%>-debug.js${ctp:resSuffix()}"></script>
