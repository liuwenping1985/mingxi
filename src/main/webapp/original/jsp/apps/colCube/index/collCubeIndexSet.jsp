            ...
            <div class="comp" comp="type:'breadcrumb',comptype:'location',code:'F08_cubeAuth'"></div>
	         <div id="tabs2_head" class="common_tabs clearfix padding_t_5 padding_l_5">
		        <ul class="left">
			        ...
			        <c:if test="${!isG6}">
			            <li><a id="btn2" class="last_tab no_b_border" href="javascript:void(0)" tgt="tab2_div" style="max-width: 150px;"><span>${ctp:i18n('colCube.common.crumbs.indexSet')}</span></a></li>
			        </c:if>
		        </ul>
		    </div>
       </div>
