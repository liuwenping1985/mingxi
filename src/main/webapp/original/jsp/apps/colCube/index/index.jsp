        	...
        	<div id="tabs2" class="comp" comp="type:'tab',width:'100%',parentId:'cubeAuthDiv'">
			    <div id="tabs2_head" class="common_tabs clearfix padding_t_5 padding_l_5">
			        <ul class="left">
			            ...
			            <c:if test="${!isG6}">
			            <li><a id="btn2" href="javascript:void(0)" class="last_tab no_b_border" tgt="tab2_div" style="max-width: 150px;"><span>${ctp:i18n('colCube.common.crumbs.indexSet')}</span></a></li>
			        	</c:if>
			        </ul>
			    </div>
