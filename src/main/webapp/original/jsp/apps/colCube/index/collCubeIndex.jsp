 ...
 var width;
  ...
  function createSlider(obj, value, id){
	  ...
	  sliderTemp.slider({
		  ...
		  max: 10,
		  slide: update,
		  text: ["", $.i18n("colCube.auth.notimportant"), "", "", "", "", "", "", "","", $.i18n("colCube.auth.important")]
		  });
	  }
        ...
        <div class="stadic_layout_head stadic_head_height clearfix">
               ...
               <div class="common_tabs clearfix left padding_t_5 padding_l_5">
                    <ul class="left">
                        ...
                        <li class="current"><a hideFocus="true" class="last_tab" href="javascript:void(0)" style="max-width: 150px;" title="${ctp:i18n('colCube.common.crumbs.indexSet')}">${ctp:i18n('colCube.common.crumbs.indexSet')}</a></li>
                    </ul>
               </div>
