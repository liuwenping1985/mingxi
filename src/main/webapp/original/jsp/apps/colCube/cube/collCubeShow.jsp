...
//         	getA8Top().opener=getA8Top();
        ...
        function printListCol(){
        	var event_type="${event_type}";
        	if(event_type==4||event_type==1||event_type==6){
          ...
          //拖动列表打印样式替换
            ...
            if(mxtgrid.length > 0 ){
                ...
                if(mxtgrid.hasClass('dataTable')){
                  str+="<table class='table-header-print table-header-print-dataTable only_table' border='0' cellspacing='0' cellpadding='0'>"
                }else{
                  str+="<table class='table-header-print only_table' width='100%' border='0' cellspacing='0' cellpadding='0'>"
                }
                str+="<thead>";
                str+=headerHtml;
                str+="</thead>";
