    ...
    <script type="text/javascript">
        $(document).ready(function () {
           $("#discuss").click(function(){
            	...
            	ext1=$(this).attr('name');
            	$("#collShow").attr("src","${path}/colCube/colCube.do?method=collCubeShow&user_Id1=${user_Id1}&user_Id2=${user_Id2}&dateType=${dateType}&event_type=${event_type}&ext1="+ext1);
            })
           ...
           if("${event_type}"=='7'){
           		$("#collShow").attr("src","${path}/colCube/colCube.do?method=collCubeShow&user_Id1=${user_Id1}&user_Id2=${user_Id2}&dateType=${dateType}&event_type=${event_type}&ext1=bbs");
           }else{
           		$("#collShow").attr("src","${path}/colCube/colCube.do?method=collCubeShow&user_Id1=${user_Id1}&user_Id2=${user_Id2}&dateType=${dateType}&event_type=${event_type}");
           }
        })
    </script>
</head>
	...
	<div id='layout' class="comp" comp="type:'layout'">
        <div class="layout_north" layout="height:30,maxHeight:30,minHeight:30">
             <div id="tabs2_head" class="common_tabs clearfix">
                    <ul class=left>
						<li class=current><a class=no_b_border id='discuss' name='bbs' href="javascript:void(0)" tgt="tab1_div"><span>${ctp:i18n('colCube.index.penetrate.discuss')}</span></a></li>
        ...
        <div id="center" class="layout_center page_color over_hidden" layout="border:false">
             	<iframe id="collShow" src='' width="100%" height="100%" frameborder="0"></iframe>
        </div>
    </div>
    </c:when>
    <c:otherwise>
