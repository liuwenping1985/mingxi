...
<body class="color_gray" style="padding-left:20px;">
    <div class="clearfix">
    ...
    <div class="line_height160 font_size12 margin_l_10">
        ...
        <c:if test="${type eq 'listWaitSend'}">
              <!-- 待发事项指存储没有发出的流程事项。 -->
