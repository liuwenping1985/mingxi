...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="${path}/apps_res/collaboration/js/listWaitSend.js${ctp:resSuffix()}"></script>
...
<body>
    <div id='layout'>
        <div class="layout_north f0f0f0 border_t" id="north">
            <!-- 如果是业务生成器创建的一个列表菜单，则不显示面包屑 -->
            <c:if test="${param.srcFrom ne 'bizconfig' }">
                <div class="comp" comp="type:'breadcrumb',comptype:'location',code:'F01_listWaitSend'"></div>
            </c:if>
