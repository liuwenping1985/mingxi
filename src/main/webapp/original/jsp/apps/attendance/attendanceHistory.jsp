    ...
    <div class="stadic_layout">
        <div class="classification h100b">
            <div class="list h100b">
	          <div class="button_box clearfix h100b" id="history-parent">
	              <table id="historyTab" style="display: none"></table>
	          </div>
      		</div>
        </div>
    </div>
...
<script type="text/javascript" src="${path}/apps_res/attendance/js/attendanceHistory.js${ctp:resSuffix()}"></script>
</html>
