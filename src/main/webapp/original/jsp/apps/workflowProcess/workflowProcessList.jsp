    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if("${isAdmin}"=='false'){
            	 toolbarArray.push({
                     id: "ForwardCol",
                     name: "${ctp:i18n('workflowProcess.queryMain.tools.reportForwardCol')}",
            ...
            toolbarArray.push({
                id: "pigeonhole",
                name: "${ctp:i18n('workflowProcess.queryMain.tools.reportToExcel')}",
            ...
            grid = $('#listStatistic').ajaxgrid({
                ...
                managerName : "workflowProcessManager",
        ...
        function getTotal(total){
     	   	//页面底部说明加载
         	$('#summary').attr("src",_ctxPath + "/collaboration/listDesc.do?method=listDesc&type=listStatistic&size="+total);
     	}
        function getColumn(){
        	var state="${state}";
        	var arr = new Array();
     	 	var object1 = new Object();
     	 	object1.display="${ctp:i18n('workflowProcess.queryMain_js.reportType.printTitle')}"
      		...
      		object1 = new Object()
      		object1.display="${ctp:i18n('workflowProcess.workFlowAnalysis.create.person')}"
      		object1.name = "sender";
      		object1.sortable = true;
      		if(state=='2'){
      			object1.width='25%'
      		...
      		if(state!='-1'){
      			object1 = new Object()
      			object1.display="${ctp:i18n('workflowProcess.queryMain.textbox.sendTime.name')}"
        	...
        	if(state=='-1'||state=="3"){
        		object1 = new Object()
      			object1.display="${ctp:i18n('workflowProcess.workflow.recevie.time')}"
        	...
        	if(state=='-1'||state=='4'){
        	    object1 = new Object()
      			object1.display="${ctp:i18n('workflowProcess.workFlowAnalysis.runWorkTim')}"//处理时间
        	...
        	if(state=='4'){
        		object1 = new Object()
      			object1.display="${ctp:i18n('workflowProcess.workflow.dealTime.date')}"
        	...
        	if(state=='-1'){
        		object1 = new Object()
      			object1.display="${ctp:i18n('workflowProcess.workflow.timeouts.label')}"//超时时长
        	...
        	if(state!=='1'&&state!='2'){
        	    object1 = new Object()
      			object1.display="${ctp:i18n('workflowProcess.workflow.processing.period')}"//处理期限
        	 	...
        	 	object1 = new Object()
      			object1.display="${ctp:i18n('workflowProcess.workFlowAnalysis.isfinished')}"
        ...
        function transmitCol(){
            gridChangeTable();
            var reportTitle = "${ctp:i18n('workflowProcess.queryMain_js.throughQueryDialog.title')}";//绩效报表穿透查询列表;
        ...
        function exportExcel(){
				...
				var url = "${path}/workflowProcess.do?method=exportExcelWorkflowState";
        ...
        function printListCol(){
        	var printSubject ="";
        	var printsub = "<center><span style='font-size:24px;line-height:24px;'>"+"${ctp:i18n('workflowProcess.queryMain_js.throughQueryDialog.title')}"+"</span><hr style='height:1px' class='Noprint'&lgt;</hr><input type='hidden' name='rrsu' id='rrsu'/></center>";
        	
        	var printColBody = "${ctp:i18n('workflowProcess.queryMain_js.reportType.printTitle')}";
        	 $("#printContent").html($('#center').html());
             $("#printContent").find("#grid_detail").remove();
             var colBody ="<div>"+ $("#printContent").html() + "</div>";
...
<body>
    ...
    <div id='layout'>
        ...
        <div id="printContent" class="hide"></div>
    </div>
    <iframe id="temp_iframe" name="temp_iframe" width="100%" height="100%" frameborder="0"  style="overflow-y:hidden"></iframe>
</body>
</html>
