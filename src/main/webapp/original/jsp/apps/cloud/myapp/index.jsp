	...
	<body>
		...
		<div class="m_content">
			...
			<div class="m_content_right">
				<!-- 我的应用横向导航 -->
				<%@ include file="../common/oa_cloud_myapp_nav.jsp"%>
						...
						<c:forEach items="${goodsList}" var="goodsArray">
							<li class="li">
			                        ...
			                        <div class="m_list_bottom">
			                            ...
			                            <div class="num" title="点击数"><img src="${path}/${resources_cloud_img}/icon/eye.png" class="icon">${goodsArray.click_count}</div>
			                        </div>
			                        <div class="m_list_bg">
			                        	<div class="bg"></div>
			                        	<!-- 收藏 -->
				...
				<div>
					...
					<input type="hidden" value="${oa_tabname}" id="oa_cloud_tab_name_id">
				</div>
			</div>
		</div>
        <!-- 账户绑定 -->
