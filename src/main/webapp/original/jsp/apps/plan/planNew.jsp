...
<body class="h100b over_hidden page_color border_r" onunload="removeSessionMasterData();">
    ...
    <div class="stadic_layout" id="colDomain" >
        <div class="" id="formArea">
             <div class="padding_l_5 border_b out_toolbar_box">
                ...
                <form id="planform" name="planform"  method="post" action="${path}/plan/plan.do?method=saveAttachment">
                    <div id="area1">
                        <table id="plan_table" border="0" cellspacing="0" cellpadding="0" width="100%">
                            <input type="hidden" id="id" name="id" value="${simplePlan.id}"/>
                            ...
                            <tr>
                                <td rowspan="5" width="80" style="vertical-align: top;"><a class="margin_10 display_inline-block align_center new_btn" id="send">${ctp:i18n('common.toolbar.send.label')}</a></td>
                                ...
                                <td width="208"><div class="common_txtbox_wrap">
                                    <input type="text" id="startTime" readonly class="comp validate" validate='type:"string",notNull:true,name:"${ctp:i18n("common.date.begindate.label")}"' comp="type:'calendar',onUpdate:checkStartTime,ifFormat:'%Y-%m-%d',showsTime:false" /></div>
                                </td>
                                <th nowrap="nowrap" width="1%" style="padding-left:30px;"><label for="text">&nbsp;&nbsp;${ctp:i18n('common.date.enddate.label')}：</label></th>
                                <td width="208"><div class="common_txtbox_wrap">
                                    <input type="text" id="endTime" readonly class="comp validate" validate='type:"string",notNull:true,name:"${ctp:i18n("common.date.enddate.label")}"' comp="type:'calendar',onUpdate:checkEndTime,ifFormat:'%Y-%m-%d',showsTime:false"/></div>
                                </td>
                            ...
                            <tr>
                                ...
                                <th nowrap="nowrap" width="1%" style="padding-left:30px;"><label for="text">&nbsp;&nbsp;${ctp:i18n('plan.toolbar.button.cc')}：</label></th>
                                <td  width="208"><div class="common_txtbox_wrap">
                                        <input type="text" id="planSubMainUser" readonly name="planSubMainUser" class="comp" comp="type:'selectPeople',panels:'Department,Team,Outworker',callback:changeSubPeople,selectType:'Member',showMe:false,minSize:0,isNeedCheckLevelScope:false" style="width:100%;" />
                                    </div></td>
                                <th nowrap="nowrap" width="1%" style="padding-left:30px;"><label for="text">&nbsp;&nbsp;${ctp:i18n('plan.toolbar.button.apprize')}：</label></th>
                                <td width="208"><div class="common_txtbox_wrap">
                                        <input type="text" id="planTellUser" readonly name="planTellUser" class="comp" comp="type:'selectPeople',panels:'Department,Team,Outworker',callback:changeTellPeople,selectType:'Member',showMe:false,minSize:0,isNeedCheckLevelScope:false"  style="width:100%;"/>
                                    </div></td>
                            </tr>
                            <tr>
                                ...
                                <td><div style="width:100%;">
                                        <select id="templateId" name="templateId" onchange="changeTemplate()" class="w100b">
                                            ...
                                            <c:forEach var="normalTemplates" items="${contentTemplates}">
                                                <option title="${ctp:toHTML(normalTemplates.templateName)}" value="${normalTemplates.id}">${ctp:toHTML(normalTemplates.templateName)}</option>
                                            </c:forEach>
                                            <c:forEach var="formTemplates" items="${templates}">
                                                <option title="${ctp:toHTML(formTemplates.subject)}" value="${formTemplates.id}">${ctp:toHTML(formTemplates.subject)}</option>
                                            </c:forEach>
                                        </select>
                                    </div></td>
                                <th nowrap="nowrap" width="1%" style="padding-left:25px;">&nbsp;<label class="margin_l_10" for="text">${ctp:i18n('plan.toolbar.button.relatedep')}：</label></th>
                                <td width="208"><div class="common_txtbox_wrap">
                                        <input type="text" id="relateDepartment" readonly name="relateDepartment" class="comp" comp="type:'selectPeople',mode:'open',panels:'Department',selectType:'Department',maxSize:1,minSize:0" style="width:206px;" />
                                    </div></td>
                                <th nowrap="nowrap" width="1%" style="padding-left:25px;">&nbsp;<label class="margin_l_10" for="text">${ctp:i18n('plan.toolbar.button.relateproject')}：</label></th>
                                <td width="208">
                                    <div id="projectDiv">
                                    </div>
                                </td>
