...
<script type="text/javascript">
  ...
  var array = new Array();
  array["myPlan"] = "plan.do?method=getPlanList&to=myplan&type="+'${simplePlan.type}';<%-- 我的计划  --%>
  array["othersPlan"] = "plan.do?method=getPlanList&to=planmanage&type="+'${simplePlan.type}';<%-- 他人计划  --%>
  array["planSearch"] = "../form/queryResult.do?method=queryIndex&formType=4";<%-- 计划查询 --%>
  array["planStatics"] = "../report/queryReport.do?method=index&formType=4";<%-- 计划项统计 --%>
...
<body class="h100b over_hidden">
    ...
    <div id='layout' class="comp" comp="type:'layout'">
        <div class="layout_north" layout="height:36,sprit:false,border:false" id="north">
            <div id="tabs" class="comp page_color" comp="type:'tab'" style="overflow:hidden">
                <div id="tabs_head" class="common_tabs clearfix margin_t_5" style="overflow:hidden">
                    <ul class="left">
