...
function fBuildCal (iYear, iMonth){
  ...
  aMonth[0][0] = '${ctp:i18n("plan.date.week.sun")}';
  aMonth[0][1] = '${ctp:i18n("plan.date.week.mon")}';
  aMonth[0][2] = '${ctp:i18n("plan.date.week.tue")}';
  aMonth[0][3] = '${ctp:i18n("plan.date.week.wed")}';
  aMonth[0][4] = '${ctp:i18n("plan.date.week.thu")}';
  aMonth[0][5] = '${ctp:i18n("plan.date.week.fri")}';
  aMonth[0][6] = '${ctp:i18n("plan.date.week.sat")}';
