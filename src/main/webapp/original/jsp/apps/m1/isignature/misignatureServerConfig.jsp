...
<div id='layout' class="comp" comp="type:'layout'">
	<div class="comp" comp="type:'breadcrumb',code:'M1_signatuerServer'"></div> 
     <div class="layout_north" layout="height:30,sprit:false,border:false">
         <div id="toolbar"></div>
     </div>
	 <div id="center"  class="layout_center" layout="border:true">
		    <form id="form1" action="<c:url value='/m1/msignature.do'/>?method=isignatureConfig" method="post">
				<br>
				<fieldset>
					<legend><font>${ctp:i18n("m1.isignature.server.configLebel")}</font></legend>
					<table>
						<tr></tr>
						<tr>
							<th><span>&nbsp;&nbsp;&nbsp;&nbsp;${ctp:i18n("m1.isignature.server.serverLibel")}</span></th>
							<td>
								<input type="text" id="address" name = "address" class="validate w100b"  style="width:500px ;height:30px"
									validate="type:'string',name:'${ctp:i18n("m1.isignature.server.serverLibel")}',notNull:true,minLength:1,maxLength:100,avoidChar:'-!@#$%><^&amp;*()_+'">
