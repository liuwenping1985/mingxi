...
<style type="text/css">
	#pageCustomBody{border-top: 2px #CDCDCD solid; }
	#d1{position: relative;z-index:0;top:3%;left:11%;width:400px;height:270px;text-align:center;}
	#bgv{position:absolute;left:0px;top:0px;width:100%;height:100%;z-Index:-1; border:1px solid white;}
	#d3{filter:alpha(opacity=70);background:#ffffff;position: absolute;top:36px;left:40px;width:319px;height:200px;border-top:2px solid red;border-left:2px solid red;border-bottom:2px solid red;border-right:2px solid red;}
	...
	#plogo{position: relative;top:0px;width:100%;}
