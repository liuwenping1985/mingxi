...
body{border-top: 2px #CDCDCD solid; }
	...
	#d1{position: relative;z-index:0;top:1%;left:12%;width:180px;height:285px;text-align:center;}
	...
	#d3{border-top:2px solid red;border-left:2px solid red;border-bottom:2px solid red;border-right:2px solid red;filter:alpha(opacity=70);background:#ffffff;position: absolute;top:54px;left:18px;width:143px;height:190px;}
	#loginpageimg{position:relative;left:0px;width:100%;height:100%;}
