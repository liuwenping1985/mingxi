...
$().ready(function() {
  ...
  var toolbar = $("#toolbar").toolbar({
    ...
    {
      id: "delete",
      name: "${ctp:i18n('m1.bind.binded.delete')}",
      ...
      click: function() {
        ...
        if (v.length < 1) {
          ...
          $.confirm({
            ...
            'msg': "${ctp:i18n('m1.bind.binded.delete.ok')}",
            ok_fn: function() {
    ...
    {
      id: "starting",
      name: "${ctp:i18n('m1.bind.binded.starting')}",
        ...
        if (v.length < 1) {
		 ...
		 var  clientNums = new Array();
          ...
          $.confirm({
		   ...
		   msg: "${ctp:i18n('m1.bind.binded.starting.ok')}",
            ok_fn: function() {
    ...
    {
      id: "forbidden",
      name: "${ctp:i18n('m1.bind.binded.forbidden')}",
      ...
      click: function() {
        ...
        if (v.length < 1) {
          ...
          $.confirm({
		  title: "${ctp:i18n('common.prompt')}",
            msg: "${ctp:i18n('m1.bind.binded.forbidden.ok')}",
            ok_fn: function() {
   ...
   grid = $("#mytable").ajaxgrid({
    ...
    colModel: [{
      ...
      {
        display: "${ctp:i18n('m1.bind.binded.date')}",
        name: 'bindDate',
        sortable: true,
        width: '20%'
      },
      {
          display:"${ctp:i18n('m1.bind.binded.state')}",
          name: 'state',
          sortable: true,
          width: '10%'
        }],
  ...
  //切换列表
  function changeView(){
  	window.location = "<c:url value='/m1/mClientBindController.do'/>?method=toBindApply";
  }
  ...
  var searchobj = $.searchCondition({
    ...
    conditions: [{
      ...
      name: 'search_name',
      type: 'input',
      text: "${ctp:i18n('m1.bind.bind.memberNum')}",
      value: 'memberName'
    },
    {
      id: 's_code',
