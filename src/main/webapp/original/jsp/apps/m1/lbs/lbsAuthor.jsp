...
<div id='layout' class="comp" comp="type:'layout'">
   <c:choose>
   		<c:when test="${ctp:hasPlugin('m3')}">
		   <div class="comp" comp="type:'breadcrumb',code:'m3_lbsAuthor'"></div> 
   		</c:when>
   		<c:otherwise>
		   <div class="comp" comp="type:'breadcrumb',code:'M1_lbsAuthor'"></div> 
   		</c:otherwise>
   </c:choose>
                ...
                <div class="stadic_layout_body stadic_body_top_bottom">
                    <div id="welcome">
                        <div class="color_gray margin_l_20">
                            <div class="clearfix">
                                <h2 class="left" style="font-size: 26px;font-family: Verdana;font-weight: bolder;color: #888888;">${ctp:i18n('m1.lbs.authorInfo')}</h2>
                    ...
                    <div id="applyform">
                        <%@include file="lbsAuthorForm.jsp" %></div>
                </div>
