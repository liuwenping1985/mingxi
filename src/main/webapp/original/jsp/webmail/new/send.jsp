...
<!-- Edit By Lif Start -->
<body scroll="no" onload="paddingCss();">
<!-- Edit End -->
...
<!-- Edit By Lif Start -->
<table width="100%" height="100%"  border="0" cellpadding="1" cellspacing="0" id="tableBorder" style="background-color: rgb(237,237,237)">
<!-- Edit End -->
  <tr>
  ...
  <tr class="bg-summary">
    <TD class=bg-gray rowSpan=2 noWrap width="5"></TD>
    <TD class="bg-gray send_new" rowSpan=2 noWrap width="60">
    ...
    <td nowrap>
        <input name="to" type="text" id="to" class="input-100per" deaultValue="${mailAdd}" inputName="<fmt:message key='label.alert.to' />"
               validate="notNull,validEmail"
               escapeXml="true" value="${v3x:toHTML(mailAdd)}" >
        </td>
  ...
  <tr class="bg-summary">
    <td width="70" height="20" class="bg-gray"><fmt:message key='label.head.cc' />:</td>
    <td nowrap>
        <input name="cc" type="text" id="cc" class="input-100per" deaultValue="" inputName="<fmt:message key='label.alert.cc' />"
               validate="validEmail"
               escapeXml="true" value='' >
        </td>
		<td width="200" align="left" nowrap>
  ...
  <tr class="bg-summary">
    <TD class=bg-gray rowSpan=2 noWrap width="5"></TD>
    <TD class=bg-gray rowSpan=2 noWrap width="60"></TD>
    <td width="70" height="20" class="bg-gray"><fmt:message key='label.head.bc' />:</td>
    <td nowrap>
        <input name="bc" type="text" id="bc" class="input-100per" deaultValue="" inputName="<fmt:message key='label.alert.bc' />"
               validate="validEmail"
               escapeXml="true" value='' >
        </td>
		<td width="200" align="left" nowrap>
  ...
  <tr class="bg-summary">
    <td width="70" height="20" class="bg-gray"><fmt:message key="common.subject.label" bundle="${v3xCommonI18N}" />:</td>
    <td nowrap>
        <input name="subject" type="text" id="subject" class="input-100per" deaultValue="${v3x:toHTML(bean.subject)}" inputName="<fmt:message key="common.subject.label" bundle="${v3xCommonI18N}" />"
               validate="notNull" value="${v3x:toHTML(subject)}" maxlength="60"/>     
	</td>
	<td></td> 
  </tr>
  <tr class="bg-summary">
    <TD class=bg-gray noWrap width="5"></TD>
    <TD class=bg-gray noWrap width="60"></TD>
	<td width="70" height="20" class="bg-gray">
    	<fmt:message key='label.alert.sendleve'/>:
    </td>
    <td colspan="2"><select name="priority" id="priority">
  ...
  <tr id="attachmentTR" class="bg-summary" style="display:none;">
      ...
      <td valign="top" colspan="2"><div class="div-float">(<span id="attachmentNumberDiv"></span>个)</div>
    	<v3x:fileUpload attachments="${attachments}" canDeleteOriginalAtts="true" originalAttsNeedClone="${originalAttsNeedClone }"/>
    </td>
  </tr>  
  <tr>
  	<td colspan="8" height="6" class="bg-b"></td>
  </tr>
  <tr valign="top">
	<td colspan="8"><v3x:editor htmlId="content" type="HTML" category="<%=ApplicationCategoryEnum.collaboration.getKey()%>" content="${contentText}" /></td>
  </tr>
</table>
</form>
