        ...
        <input type="hidden" name="id" value="${category.id}" />
								...
								<table width="50%" border="0" cellspacing="0" cellpadding="0" align="center">
									...
									<tr>
										...
										<td class="new-column" width="75%">
										<textarea class="input-100per" name="memo" maxSize="70" validate="maxLength" inputName="<fmt:message key='hr.record.remark.label' bundle='${v3xHRI18N}'/>" id="memo" rows="6" ${dis}>${v3x:toHTMLescapeRN(category.memo)}</textarea>
										</td>
									</tr>
								</table>
		</td>
