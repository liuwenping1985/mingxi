                ...
                <div style="padding:8px">
			         ...
			         <tr>
                      ...
                      <tr>
			           ...
			           <td class="new-column" width="35%" nowrap="nowrap" colspan="3">  
			               <textarea class="input-100per" inputName="<fmt:message key='hr.staffInfo.assesscontent.label' bundle='${v3xHRI18N}' />" name="assess_content" id="assess_content" maxSize="200" validate="maxLength" rows="5" cols=""  ${ro} ${mro}>${v3x:toHTMLescapeRN(assess.assess_content)}</textarea> 
                       </td>
                      </tr>
...
<script>
  bindOnresize('editAssess',30,110);
</script>
</body>
</html>