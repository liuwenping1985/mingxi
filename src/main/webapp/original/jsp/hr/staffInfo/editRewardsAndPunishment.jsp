	             ...
	             <div style="padding:8px">
			         ...
			         <tr>
                      ...
                      <tr>
			           ...
			           <td class="new-column" width="35%" nowrap="nowrap" colspan="3">  
			               <textarea class="input-100per" name="reason" id="reason" rows="5" cols=""  ${ro} ${mro}>${v3x:toHTMLescapeRN(rewardsAndPunishment.reason)}</textarea>  			           
                       </td>
                      </tr>	
                      <tr>
			           <td class="bg-gray" width="12%" nowrap="nowrap">
			           ...
			           <td class="new-column" width="35%" nowrap="nowrap" colspan="3">  
			               <textarea class="input-100per" name="content" id="content" rows="5" cols=""  ${ro} ${mro}>${v3x:toHTMLescapeRN(rewardsAndPunishment.content)}</textarea>  			           
                       </td>
                      </tr>	          
		            </table>
                 </div>             
...
<script type="text/javascript">
	bindOnresize('editRewardsAndPunishment',30,105);
</script>
</body>
</html>