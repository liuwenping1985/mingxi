<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ include file="../../apps/organization/common/organizationHeader.jsp"%>
    ...
    <table width="99%" height="100%" border="0" cellspacing="0" cellpadding="0">
        <tr height="20"style="padding-top: 12px">
            ...
            <td colspan="2" style="padding-left: 5px">
                <c:if test="${importType=='member' }">
                    ${ctp:i18n('hr.staffInfo.import.staff')}
                </c:if>
			</td>
        </tr>
		<tr>
        ...
        <tr>
            <td height="42" align="right" class="bg-advance-bottom" colspan="3">
                <a id="exportReportBtn" class="common_button common_button_gray" href="${path}/hrStaff.do?method=exportReport">${ctp:i18n('org.button.exp.label')}${ctp:i18n('import.result')}</a>&nbsp;
            </td>
        </tr>
	</table>
</form>
</td></tr><tr><td>
 	<div class="scrollList"  id="scrollListDiv"  style="height:250px;" >
