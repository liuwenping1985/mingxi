			           ...
			           <td class="new-column" width="35%" nowrap="nowrap" colspan="3">  
			              <c:choose> 
			               <c:when test="${!ReadOnly && Manager}">
			                ...
			                <div class="div-float" style="height:30px;line-height:30px;">(<span id="attachmentNumberDiv"></span><fmt:message key='hr.staffInfo.attachment.count.label' bundle="${v3xHRI18N}" />)</div>
...
<script type="text/javascript">
	bindOnresize('editEduExperience',30,105);
</script>
</body>
</html>