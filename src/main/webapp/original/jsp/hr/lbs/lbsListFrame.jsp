...
<script type="text/javascript" charset="UTF-8" src="${path}/apps_res/hr/lbs/js/lbsPortalSearch.js${ctp:resSuffix()}"></script>
<head>
</head>
      ...
      <table class="w100b" id="lbsTab" style="padding-top:5px"class="margin_l_10" border="0" cellspacing="0" cellpadding="0">
      	<tbody>
      		<tr>
      			...
      			<th nowrap="nowrap"><label class='margin_r_10 th_name' style="font-size:12px" for='text'>${ctp:i18n("hr.name.label")}:</label></th>
      			<td nowrap="nowrap">
      				<div>
      			...
      			<th nowrap="nowrap" class="padding_l_10"><label class='margin_r_10 th_name' style="font-size:12px" for='text'>${ctp:i18n("hr.department.label")}:</label></th>
      			<td nowrap="nowrap">
      				<div>
      			...
      			<th nowrap="nowrap" class="padding_l_10"><label class='margin_r_10 th_name' style="font-size:12px" for='text'>${ctp:i18n("hr.time.label")}:</label></th>
      			<td nowrap="nowrap">
      				<div>
      			...
      			<td class="padding_l_10" nowrap="nowrap"> 
      				<div class="margin_l_10">
      					<input id="onlyOne" type="checkbox" value="1"/><label class="margin_l_10" style="font-size:12px">${ctp:i18n("hr.sign.onlyOne.label")}</label>
      				</div>
      			</td>
