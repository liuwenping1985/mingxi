...
<html>
<head>
<script type="text/javascript" charset="UTF-8" src="${path}/apps_res/hr/lbs/js/lbsListMore.js${ctp:resSuffix()}"></script>
...
<body>
	<div id='layout' class="comp page_color" comp="type:'layout'">
            ...
            <form id="execlToExport" action="${path}/hrLbsController.do?method=execlToExport">
