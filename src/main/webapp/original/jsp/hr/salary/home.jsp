...
function reflushExport(){
	document.getElementById("detailIframe").contentWindow.document.getElementById("detailFrame").src = "${urlHrSalary}?method=importReport";
}
