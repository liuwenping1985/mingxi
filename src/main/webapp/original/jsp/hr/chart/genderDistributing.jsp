...
<html>
	...
	<%@ include file="simpleheader.jsp" %>
		...
		var indexFlag = 0;
        var xTicks = [{label: "<fmt:message key='hr.statistic.male.label' bundle='${v3xHRI18N}' />", v: 0}, 
        			  {label: "<fmt:message key='hr.statistic.female.label' bundle='${v3xHRI18N}' />", v: 1}
                      ];
		...
		function easyDrawGraph() {
			...
			var opts = {
   			...
   			var data1 = [[0, ${gender[0]}], [1, ${gender[1]}]];
   			if (hasCanvas) {
...
<form id="statisticForm" name="statisticForm" method="post" action="${hrStatisticURL}?method=genderDistributing&newOrChanged=changed">
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" align="center" class="categorySet-bg">
		...
		<td class="categorySet-head" height="23">
			<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td class="categorySet-title" width="80" nowrap="nowrap"><fmt:message key="hr.statistic.gender.quantity.label" bundle="${v3xHRI18N}" /></td>
	...
	<tr>
		<td class="categorySet-head">
		  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
		   <tr>
		    <td class="categorySet-body" align="center"><div class="scrollList padding_t_10"  id="graphFm" style="height:160px; overflow:auto;">
	 		  <div id="graph" height="250" width="400"></div></div>
	 		</td>
		   </tr>
		 </table>  
		</td>
