...
function exportExcel(){
	if(document.getElementById("statistic").value == 'search'){
		...
		parent.detailFrame.location.href = "<c:url value='/m1/lbsRecordController.do'/>?method=exportExcel&advancedFromTime="+advancedFromTime+"&advancedToTime="+advancedToTime+"&advancedDepartmentIds="+advancedDepartmentIds+"&advancedPeopleIds="+advancedPeopleIds;
	}else{
