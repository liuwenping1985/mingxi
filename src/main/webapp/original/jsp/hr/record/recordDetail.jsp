                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                    <tr>
                                        <td class="bg-gray" width="100%">
                                            <textarea id="outRemark" name="remark" class="input-100per" rows="4" cols="" readonly="readonly" style="overflow-y: auto;">${v3x:toHTML(record.remark)}</textarea>
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
    ...
    $(function(){
      function fixHeight(){
          setTimeout(function(){
              ...
              $("#scrollList").height(bodyHeight-50);
          }, 10);
      }
      fixHeight();
