...
<script type="text/javascript">
	...
	function showCurrentHrefLocation(){
      ...
      html += "<a class=\"hand\" onclick=\"showMenu('/seeyon/portal/portalController.do?method=personalInfo')\"><span><fmt:message key="system.menuname.PersonalProfile" bundle="${v3xHRI18N}" /></a>";
