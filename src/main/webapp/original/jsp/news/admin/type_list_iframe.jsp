...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0"> 
	<tr>
		<td height="25" class="webfx-menu-bar-gray" style="height:38px; background:#fafafa;">
	...
	<tr>
		<td height="100%" valign="top" colspan="1">
			...
			<v3x:table htmlId="listTable" data="list" var="bean" leastSize="0" subHeight="38">
				...
				<v3x:column width="25%" type="String" onDblClick="editDBTypeLine('${bean.id}');"  onClick="editTypeLine('${bean.id}');"  label="news.type.typeName" className="cursor-hand sort" property="typeName" alt="${bean.typeName}">
				</v3x:column>
