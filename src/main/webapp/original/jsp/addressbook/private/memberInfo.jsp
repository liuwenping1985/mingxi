   ...
   <td width="50%" valign="top">
		...
		<tr>
			<td class="new-column" width="90%">
				<textarea class="input-300px" name="memo" id="memo" maxlength="200" rows="7" cols="" inputName="${descLable}" validate="maxLength" maxSize="200" ${dis } ${ro}>${v3x:toHTML(member.memo)}</textarea>
			</td>
		</tr>
		</table>
	<p></p>
