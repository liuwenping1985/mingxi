...
<title>
<fmt:message key='addressbook.toolbar.${titleLable}.team.label' />
</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" align="center" class="popupTitleRight" style="background:#fafafa;">
	<%-- <tr align="center">
		...
		<td class="categorySet-head" height="23">
			<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td class="categorySet-title" width="80" nowrap="nowrap"><fmt:message key='addressbook.zu.label'  /></td>
					<td class="categorySet-2" width="7"></td>
					<td class="categorySet-head-space">&nbsp;<font color="red">*</font><fmt:message key='addressbook.form.item.req.label'  /></td>
					 </td>
				</tr>
			</table>
		</td>
	...
	<c:if test="${!readOnly}">
	<tr>
		<td height="42" align="center" class="bg-advance-bottom" style="padding-left:165px;padding-right:0px;">
