...
<script type="text/javascript">
	//getA8Top().showLocation(1006,"<fmt:message key='addressbook.menu.public.label'  />" );
	//getA8Top().endProc('');
  ...
  <div class="right_div_row2">
    ...
    <div style="margin:0 10px;">
      <input type="hidden" id="resultCount" value="${resultCount}" />
			...
			<v3x:column  width="15%" align="left" label="addressbook.username.label"  onmouseover="${onmouseover }" onmouseout="${onmouseout}"   className="sort" type="string">
