...
<head>
    ...
    $().ready(function() {
    	...
    	creataAccountTree();
    	$("#treeFrame").attr("src","/seeyon/addressbook.do?method=treeSysTeam&addressbookType=1&accountId="+accountId);
    	var showType = $("#showType").val();
    	$("#listFrame").attr("src","/seeyon/addressbook.do?method=initList&addressbookType=3&showType="+showType+"&accountId="+accountId);
    	$("#frameUrl").val("/seeyon/addressbook.do?method=initList&addressbookType=3&showType="+showType+"&accountId="+accountId);
    	setHeight();
    	if(showType=="card"){
    		$("#cardButtonDiv").show();
    	}else{
