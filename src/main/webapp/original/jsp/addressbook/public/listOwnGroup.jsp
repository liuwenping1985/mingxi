...
<script type="text/javascript">
	//getA8Top().showLocation(1006,"<fmt:message key='addressbook.team.personal.label'  />" );
    showDetailPageBaseInfo("detailFrame", "<fmt:message key='addressbook.team.personal.label'  />" , "/common/images/detailBannner/110204.gif", ${resultCount}, v3x.getMessage("ADDRESSBOOKLang.detail_addressbook_110204"));
</script>
    ...
    <div style="margin:0 10px;">
       <input type="hidden" id="resultCount" value="${resultCount}" />
			<form id="memberform" method="post">
				...
				value="${v3x:showDepartmentFullPath(member.v3xOrgMember.orgDepartmentId)}" className="cursor-hand sort"  alt="${v3x:showDepartmentFullPath(member.v3xOrgMember.orgDepartmentId)}">
                </v3x:column>
