...
<head>
    ...
    $().ready(function() {
    	...
    	creataAccountTree();
    	$("#treeFrame").attr("src","/seeyon/addressbook.do?method=treeDept&addressbookType=1&accountId="+accountId);
    	var showType = $("#showType").val();
    	$("#listFrame").attr("src","/seeyon/addressbook.do?method=initList&addressbookType=1&showType="+showType+"&accountId="+accountId);
    	$("#frameUrl").val("/seeyon/addressbook.do?method=initList&addressbookType=1&showType="+showType+"&accountId="+accountId);
    	setHeight();
    	if(showType=="card"){
    		$("#cardButtonDiv").show();
    	}else{
...
<input type="hidden" id="showAccountOrDept" value="account"/>
     <div id='layout' class="container overflow comp" comp="type:'layout'" >
        <div class="layout_west" layout="width:273,minWidth:100,maxWidth:273" style="overflow: hidden;">
            	<div class="centerBar  left " style="width: 100%;">
					<div class="header">
						<div>
							<div class="searchBox">
					...
					<div class="orgnazitionTree overflow">
						<div class="companyCheck" onclick="showMenu();">
 						...
 						<div id="accountContent" class="border_all bg_color_white" style="width:100%; position: absolute;display: none;height:480px;overflow-y: auto;" >
						...
						<div class="btnSet overflow">
							<div class="left" id="cardButtonDiv">
								<ul class="overflow">
									...
									<li class="left innerChild"><em id="checkBox_h" style="background-color:#EFEDED;" class="checkBox_h icon16 containChildren_icon16 checkBox_h_current"></em><span>${ctp:i18n('addressbook.toolbar.department.lable')}</span></li>
								</ul>
							</div>
							<div class="right">
