...
<body scroll="no" style="overflow: no;background:#fafafa;">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" align="center" class="popupTitleRight">
					...
					<td class="categorySet-title" width="80" nowrap="nowrap">
						<c:choose>
							<c:when test="${param.tId != null}">
								<fmt:message key='addressbook.toolbar.modify.team.label'  />
							</c:when>
							<c:otherwise>
							<fmt:message key='addressbook.team_form.title.label'  />
							</c:otherwise>
						</c:choose>
					</td>
	...
	<c:if test="${!readOnly}">
	<tr>
		<td height="42" align="center" class="bg-advance-bottom" style="padding-left:265px;padding-right:0px;">
