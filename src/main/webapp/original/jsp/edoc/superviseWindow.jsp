		...
		<td class="bg-advance-middel">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			    ...
			    <tr>
			        ...
			        <td>
			           	<input type="text" name="superviseDate" id="superviseDate" class="cursor-hand input-100per" value="<c:if test="${supervisorId!=null&&supervisorId!=''}">${ctp:toHTMLWithoutSpace(awakeDate)}</c:if>" readonly="true"
			    ...
			    <tr>
			    	...
			    	<td>
						<textarea name="title" id="title" style="height:70px" cols="52"  ${temformParentId==null||temformParentId==''?'':'readonly' }><c:if test="${supervisorId!=null&&supervisorId!=''}">${ctp:toHTML(superviseTitle)} </c:if></textarea>
			    	</td>
			    </tr>  
			</table>
		</td>
