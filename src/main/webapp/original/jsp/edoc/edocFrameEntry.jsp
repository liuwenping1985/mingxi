...
<iframe frameborder="no" marginheight="0" marginwidth="0" src="${tempCurrentController}?method=${v3x:toHTML(entry)}${v3x:toHTML(otherParams)}" id="detailIframe" name="detailIframe" scrolling="no" class="page-list-border" style="display: block;border: 0;width: 100%;height: 100%"></iframe>
</body>
</html>