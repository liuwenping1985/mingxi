...
<table align="center" width="640px" border="0" cellspacing="0" cellpadding="0"  id="printSenderOpinionsTable" style="margin-bottom:10px;">
  <tr>
...
<%--显示未绑定公文元素的节点的处理意见 --%>
<table align="center" width="640px" border="0" cellspacing="0" cellpadding="0" id="printOtherOpinionsTable" <c:if test="${param.from eq'Pending' }">style="padding-top:40px"</c:if>>
	...
	<tr>
		<td>
			<div id="processOtherOpinions" name="processOtherOpinions"  style="display:none;"></div>
			<div id="displayOtherOpinions" name="displayOtherOpinions" style="visibility:hidden;"></div>
		</td>
	</tr>
</table>
