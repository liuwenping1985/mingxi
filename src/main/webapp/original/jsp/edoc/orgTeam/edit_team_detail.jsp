...
<tr>
	...
	<table width="100%" height="100%" border="0" cellspacing="0"
		...
		<tr>
			...
			<td class="categorySet-title" width="120" nowrap="nowrap"><fmt:message key='edoc.modify.agency.group'/></td>
					...
					<td width="15%" class="label" align="right"><font color="red">*</font><fmt:message key='common.name.label' bundle="${v3xCommonI18N}" />:</td>	
	 				<td class="new-column" nowrap="nowrap">	
						<input name="name" type="text" id="name" style="width:100%;height:22px;margin-top:10px;" deaultValue="${team.name}"
						     ...
						     validate="notNull,maxLength,isWord" inputName="<fmt:message key="common.name.label" bundle="${v3xCommonI18N}"	 />"	     
						     />
					</td>	
				</tr>
	 			...
	 			<tr>
					...
					<c:if test="${flag != 'readonly'}" >
	 				...
	 				<td class="new-column" nowrap="nowrap">						
						...
						<c:if test="${flag == 'readonly'}" >${v3x:showOrgEntitiesOfTypeAndId(team.selObjsStr, pageContext)}
						</c:if>
						<c:if test="${flag != 'readonly'}" >
	 			...
	 			<tr>
					...
					<td class="new-column" nowrap="nowrap">
		 				<textarea id="description" name="description" value="" class=""  rows="4"
						     ...
						     <c:if test="${flag == 'readonly'}" >${v3x:showOrgEntitiesOfTypeAndId(team.selObjsStr, pageContext)} readonly = "true"</c:if>
