			...
			<tr>
				<td width="65%">
			    	...
			    	if("${edocType}" == "1") {
			    		...
			    		//新建收文
					    myBar.add(new WebFXMenuButton("", "<fmt:message key='edoc.toolbar.paper.send.label'/>", "javascript:newEdoc('${edocType}', true)", [18,1], "", null));/* 分发纸质公文 */
					    ...
					    myBar.add(new WebFXMenuButton("", "<fmt:message key='edoc.register.electronicDocuments.send.label'/>", "javascript:newEdoc('${edocType}')", [18,2], "", null));/* 分发电子公文 */
					    if("${showBanwenYuewen}"=="true"){
						    myBar.add(/* 阅文批量分发 */
			                        new WebFXMenuButton(
			                            "newBtn", 
			                            "<fmt:message key='edoc.toolbar.Bulkdistribution.read.label'/>", 
