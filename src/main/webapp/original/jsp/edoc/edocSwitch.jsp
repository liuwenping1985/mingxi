...
function openCustomType(type){
    ...
    var url = "${pageContext.request.contextPath}/edocController.do?method=customerTypes&isAdminSet=true&edocType="+t+"&ndate="+new Date().getTime();
...
function taohongriqiShow(type){
    ...
    if(type==1){
        taohongshow.innerHTML="<fmt:message key='edoc.swaitch.example1' />";//示例：二〇一四年一月一日
    }else{
        taohongshow.innerHTML="<fmt:message key='edoc.swaitch.example' />";//示例：2014年1月1日
    }
}
function setHeight(){
                      ...
                      <c:choose>
                        <c:when test="${configItem.configItem=='defualtExchangeDeptType'}">
	                      ...
	                      <tr id="defualtExchangeDeptTypeTR">
	                        ...
	                        <td >
	                          <label for="defualtExchangeDeptType1" style="display: inline-block;">
	                          ...
	                          <label for="defualtExchangeDeptType2"  style="display: inline-block;">
	                      ...
	                      <tr>
	                        ...
	                        <c:choose>  
	                          ...
	                          <c:when test="${configItem.configItem=='defaultExchangeType'}">
	                            <label for="radio1" style=";display: inline-block;">
	                            ...
	                            <label for="radio2"  style="display: inline-block;">
	                          ...
	                          <c:when test="${configItem.configItem=='taohongriqi'}">
	                            <label for="${configItem.configItem}1"  style="display: inline-block;">
	                            ...
	                            <label for="${configItem.configItem}2"  style="display: inline-block;">
