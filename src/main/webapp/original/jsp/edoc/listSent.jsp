...
<table height="100%" width="100%"  border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td  class="webfx-menu-bar" width="3%">
			<form name="combForm" id="combForm" method="post" onsubmit="return false" style="margin: 0px">
			  ...
			  <INPUT TYPE="hidden" name="summaryState" id="comb_summaryState" value="${combQueryObj.summaryState}" />
			  ...
			  <INPUT TYPE="hidden" name="workflowDateB" id="comb_workflowDateB" value="<fmt:formatDate value="${combQueryObj.workflowDateB}" pattern="yyyy-MM-dd" />" />
			  <INPUT TYPE="hidden" name="workflowDateE" id="comb_workflowDateE" value="<fmt:formatDate value="${combQueryObj.workflowDateE}" pattern="yyyy-MM-dd" />" />
			  ...
			  <div style="font-size: 15px;	">
			  	<a id="combinedQuery" onclick="combQueryEvent(${edocType},2)" ><fmt:message key='edoc.advanced.lable'/></a>
              </div>
			</form>
		</td>
	</tr>
...
<%-- 					<script>
				...
				<v3x:column width="9%" type="String" align="center" label="edoc.isTrack.label">
					<div class="link-blue" style="display:inline;" onclick="preChangeTrack('${col.affairId}', '${col.track}','${col.finshed}')">
