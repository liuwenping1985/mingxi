...
<form name="form" method="post" style="padding:0;margin:0;">
	<div class="stadic_layout_body stadic_body_top_bottom border_t" style="width:100%;height:91.5%; overflow-x:hidden;overflow-y:auto;">
		<br />
  ...
  <div class=" stadic_layout_footer stadic_footer_height" align="right" style="position:absolute;bottom:0;width:100%;line-height:30px;background:#F3F3F3; height:40px;">
