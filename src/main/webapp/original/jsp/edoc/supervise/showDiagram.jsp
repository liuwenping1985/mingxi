...
<title><fmt:message key="edoc.title" /></title>
...
<tr id="workflowTR">
    <td colspan="3">
        <iframe src="<html:link renderURL='/genericController.do?ViewPage=collaboration/monitor&appName=edocSupervise&comm=toxml&isFromSupervise=true&fromList=${param.fromList}&isSupervise=${isSupervise }' />" name="monitorFrame"
