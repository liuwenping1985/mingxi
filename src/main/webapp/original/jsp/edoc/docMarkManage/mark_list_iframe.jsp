...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
      		...
      		<form action="" name="searchForm" id="searchForm" method="get" style="margin: 0px" onsubmit="return false" onkeydown="doSearchEnter()">
				...
				<div class="div-float-right">
					<div class="div-float">
				  	...
				  	<div id="markDiv" class="div-float hidden"><input type="text" id="mark" name="textfield" class="textfield" style="height:24px;"  maxlength="100"></div>
				  	...
				  	<div id="markReserveUpDiv" class="div-float hidden"><input type="text" id="textfield" name="textfield" class="textfield" style="height:24px;"  maxlength="100"></div>
				  	
				  	<div id="markReserveDownDiv" class="div-float hidden"><input type="text" id="textfield" name="textfield" class="textfield" style="height:24px;"  maxlength="100"></div>
    ...
    <div class="center_div_row2" id="scrollListDiv">
				...
				<v3x:table data="markNoList" var="bean" htmlId="listTable" showHeader="true" showPager="true">
					...
					<%-- 预留文号 --%>
					<v3x:column width="20%" type="String" onClick="editMarkDefPage('${bean.markDefinitionId}','view');" onDblClick="editMarkDefPage('${bean.markDefinitionId}','edit','${accountId}');" label="edoc.mark.reserve.up" className="cursor-hand sort" maxLength="60"  symbol="..." value="${bean.markReserveUp}" >
					</v3x:column>
					<%-- 线下占用 --%>
					<v3x:column width="20%" type="String" onClick="editMarkDefPage('${bean.markDefinitionId}','view');" onDblClick="editMarkDefPage('${bean.markDefinitionId}','edit','${accountId}');" label="edoc.mark.reserve.down.label" className="cursor-hand sort" maxLength="60"  symbol="..." value="${bean.markReserveDown}" >
					</v3x:column>
					<%-- 授权信息查了2次组织模型： 1：controller 2：标签 --%>
					<v3x:column width="26%" type="String" onClick="editMarkDefPage('${bean.markDefinitionId}','view');" onDblClick="editMarkDefPage('${bean.markDefinitionId}','edit','${accountId}');" label="edoc.docmark.grantdepart" className="cursor-hand sort" maxLength="60"  symbol="..." value="${v3x:showOrgEntities(bean.aclEntity, 'id', 'entityType', pageContext)}" >
					</v3x:column>
				</v3x:table>
