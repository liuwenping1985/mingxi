...
function loadData() {
   //表格加载
    grid = $('#sendTypeEnumItemList').ajaxgrid({
        colModel: [{
            display: 'id',
            name: 'value',
            label: 'label',
            ...
            display: "${ctp:i18n('edoc.docmark.name')}",//名称
            name: 'label',
            sortable : true,
            width: '82%'
        }],
   ...
   var obj = new Object();
   obj.fieldName = "send_type";
    $("#sendTypeEnumItemList").ajaxgridLoad(obj);
}

function loadSelected() {
	var enumitemIds = "${param.enumitemIds}";
	if(enumitemIds != "") {
...
<div id='layout'>
	<div class="layout_north bg_color" id="north">
       ...
       <div class="layout_center over_hidden" id="center">
           <table  class="flexme3" id="sendTypeEnumItemList"></table>
       </div>
</div>
</body>