...
<script type="text/javascript" charset="UTF-8" src="<c:url value="/apps_res/edoc/js/docstat/edoc_stat_list_sign.js${v3x:resSuffix()}" />"></script>
<title></title>
<script type="text/javascript">
	...
	var displayTimeType = "${param.displayTimeType}";
...
<div id='layout'>
    ...
    <div class="layout_center over_hidden" id="center">
    	<table  class="flexme3" id="edocStatListSign"></table>
	</div>
</div>
