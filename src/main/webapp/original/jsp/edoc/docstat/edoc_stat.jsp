      		...
      		<div class="border_alls">
           		<div class="form_area"  id="queryCondition" >
           			...
           			<div class="form_area set_search">
           				<table border="0" cellpadding="0" cellspacing="0" class="common_center w70b">
           					<tbody>
           						<tr class="margin_b_10">
									...
									<td class="padding_tb_5">
										<input id="startRangeTime" lastTime="${startRangeTime }" value="${startRangeTime }" readonly="readonly" style="width:105px;" class="comp validate" comp="type:'calendar',ifFormat:'%Y-%m-%d',showsTime:false,onUpdate:checkAwakeDate" validate="name:'开始日期',notNull:true"  />
										<span>-</span>
										<input id="endRangeTime" lastTime="${endRangeTime }" value="${endRangeTime }" readonly="readonly" style="width:105px;" class="comp" comp="type:'calendar',ifFormat:'%Y-%m-%d',showsTime:false,onUpdate:checkAwakeDate" />
									</td>
									<td style="width:130px;">&nbsp;</td>
	           						...
	           						<td colspan="2" class="padding_r_50">
	           							<div class="common_selectbox_wrap" style="width:150px;margin-left:0px;">
								             <select id="edocType" name="edocType">
								             	<option value="0" modelType="19">${ctp:i18n("edoc.stat.condition.edocType.0") }</option><%-- 发文 --%>
												<option value="1" modelType="20" selected>${ctp:i18n("edoc.stat.condition.edocType.1") }</option><%-- 收文 --%>
												<option value="2" modelType="21">${ctp:i18n("edoc.stat.condition.edocType.2") }</option><%-- 签报 --%>
								              </select>
										</div>
									</td>
           						</tr>
           						<tr>
									...
									<td>
										<div align="left" class="common_txtbox_wrap" style="width:225px;margin-left:0px;">
									...
									<td colspan="2" class="padding_tb_5 padding_r_50">
										<div align="left" class="common_txtbox_wrap" style="width:140px;margin-left:0px;">
           						...
           						<tr>
									...
									<td rowspan="2" class="padding_t_5">
										<table class="w100b" border="0" cellpadding="0" cellspacing="0">
           									<tr>
	           									<td width="90"><input type="radio" class="margin_r_5 margin_b_5" name="displayType" value="1" checked />${ctp:i18n("edoc.stat.condition.statTo.Department") }</td><%-- 部门 --%>
	           									<td></td>
	           								</tr>
		           							<tr>
           						...
           						<tr>
										...
										<td width="175">
											<div class="common_checkbox_box"  style="width: 235px;">
           						...
           						<tr>
           							...
           							<td class="align_center" colspan="3">
	           							<div class="align_left clear padding_lr_5 padding_b_10" id="button_div"> 
