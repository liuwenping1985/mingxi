 ...
 *
 */
public class TestPostPoneServlet {

	public static void main(String[] args) {
		String url = "http://192.168.1.222:8081/APWebPF/CertPostPoneOrServlet"; //申请对外开放接口
		/**
		 * XML请求
		 */
		httpostXml(url);
	...
	private static String getXmlString(){
		...
		certId.setText("4028815e58189fe2015818a424a70016");
		Element validity = required.addElement("validity");
		validity.setText("0");
	...
	public static String showReqJson(){
		String certId="4028815e57daacbe0157dab623150006";
		String validity="1";
		String str=getJsonData(certId,validity);
		return str;
	}
     ...
     * @return
     */
	public static String getJsonData(String certId,String validity){
			String query = 
			"{\"required\": "
			    + " [{\"certId\": \""+certId+"\","
			    + "\"validity\": \""+validity+"\"}]}";
