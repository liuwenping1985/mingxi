...
import com.xad.bullfly.apps.hhsd.po.HhadDubanTaskFeedBack;
 ...
 */
@Repository
public interface HhsdDubanTaskRepository extends BaseRepository<HhsdDubanTask,Long>{

     HhsdDubanTask findByTaskId(Long taskId);
