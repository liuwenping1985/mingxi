...
public class XadPasswordEncoder {
    ...
    public static String encode(String charSeq){

        return passwordEncoder.encode(charSeq);
    }
    public static boolean matches(String inputPsd,String encodedPsd){
        return passwordEncoder.matches(inputPsd,encodedPsd);
    }
