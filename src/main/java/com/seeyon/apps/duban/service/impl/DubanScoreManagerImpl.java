...
public class DubanScoreManagerImpl implements DubanScoreManager {
    ...
    public void caculateScoreWhenStartOrProcess(String templateCode,ColSummary colSummary,V3xOrgMember member){
    ...
    public void onFeedBackFinish(String templateCode, ColSummary colSummary, V3xOrgMember member) throws BusinessException {
    ...
    public void onDoneApplyFinish(String templateCode, ColSummary colSummary, V3xOrgMember member) throws BusinessException {
        FormTableDefinition ftd = MappingService.getInstance().getFormTableDefinitionDByCode(MappingCodeConstant.DUBAN_TASK);
        ...
        public void onDelayApplyFinish(String templateCode, ColSummary colSummary, V3xOrgMember member) throws BusinessException {
            FormTableDefinition ftd = MappingService.getInstance().getFormTableDefinitionDByCode(MappingCodeConstant.DUBAN_TASK);
    ...
    public void onDoneApplyProcess(String templateCode, ColSummary colSummary, V3xOrgMember member) throws BusinessException {
