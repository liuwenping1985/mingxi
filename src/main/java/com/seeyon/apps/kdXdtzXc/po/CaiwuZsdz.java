...
@POJO(desc = "财务住宿对账", tableName = "CAIWU_ZSDZ")
public class CaiwuZsdz implements Serializable{
	...
	@ColField(name = "手动合规校验", colCode = "sDhgjy")
    private String sDhgjy;
	...
	public String getsDhgjy() {
		return sDhgjy;
	}

	public void setsDhgjy(String sDhgjy) {
		this.sDhgjy = sDhgjy;
	}
