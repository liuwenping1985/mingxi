 ...
 *
 */
public class ZongChaiBanShyyFieldForm extends FormFieldCustomExtendDesignManager {
    /**
    ...
    @Override
    public String getId() {
        return "ZongChaiBanShyyFieldForm";
    }
    ...
    public String getName() {
        return "总裁办会议-上会原因"; //or return "xx.xx.xx.i18n"支持返回国际化key;
    }
