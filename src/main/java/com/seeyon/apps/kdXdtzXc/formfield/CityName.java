 ...
 */
public class CityName extends FormFieldCustomExtendDesignManager {
    ...
    public String getName() {
        return "城市选择"; //or return "xx.xx.xx.i18n"支持返回国际化key;
    }
    ...
    public String getJsFileURL() {
        //控件地址   *必填
        return "/seeyon/dinPiaoRenZiXinDinPiao.do?method=getCityNameList";
    }
