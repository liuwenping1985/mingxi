...
public class Base64Encrypt {
    ...
    public String decode2String(byte[] pArray) throws UnsupportedEncodingException {
        return new String(decode(pArray), "UTF-8");
    }

    public String decode2String(String s) throws UnsupportedEncodingException {
    ...
    public static byte[] encodeBase64(byte[] binaryData, boolean isChunked) {
        ...
        if (isChunked) {
            nbrChunks = CHUNK_SEPARATOR.length == 0 ? 0 :
                    (int) Math.ceil(encodedDataLength / 76.0F);
    ...
    public String encodeString(String pArray) throws UnsupportedEncodingException {
