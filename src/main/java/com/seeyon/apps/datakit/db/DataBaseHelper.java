...
import com.seeyon.apps.datakit.db.script.ScriptHook;
import com.seeyon.apps.datakit.po.CommonPo;
...
public final class DataBaseHelper {
    ...
    public static Integer executeUpdateByNativeSQLAndLink(DataLink link, String sql, List vals) throws Exception {
        ...
        try {
            ...
            conn = ConnectionHandler.openConnection(link);
    ...
    public static List<Map> queryColumnsByTableAndLink(DataLink link, String table) {
        ...
        ResultSet rs = null;
        try {
            conn = ConnectionHandler.openConnection(link);//数据库连接
            dm = conn.getMetaData();
