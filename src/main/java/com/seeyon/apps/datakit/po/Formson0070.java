...
public class Formson0070 {
    private static String TABLENAME="formson_0070";
    private Long ID;
    ...
    public Long getFormainId() {
        return formainId;
    }

    public void setFormainId(Long formainId) {
        this.formainId = formainId;
    }
