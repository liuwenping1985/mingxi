...
import com.seeyon.apps.datakit.constant.NbdConstant;
import com.seeyon.apps.datakit.db.DataBaseHelper;
import com.seeyon.apps.datakit.db.link.ConnectionHandler;
import com.seeyon.apps.datakit.entity.FormField;
import com.seeyon.apps.datakit.entity.FormTable;
import com.seeyon.apps.datakit.entity.FormTableDefinition;
import com.seeyon.apps.datakit.po.*;
import com.seeyon.apps.datakit.service.impl.MappingServiceManagerImpl;
import com.seeyon.apps.datakit.util.CommonUtils;
import com.seeyon.apps.datakit.util.UIUtils;
import com.seeyon.apps.datakit.util.XmlUtils;
...
public class NbdService {
    ...
    public NbdResponseEntity testConnection(CommonParameter p) {
        ...
        try {
            ...
            boolean isOk = ConnectionHandler.testConnection(dl);
            if (isOk) {
                entity.setResult(true);
