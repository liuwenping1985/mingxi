...
public class LeftTreeSection extends BaseSectionImpl{
	private static final Log log = LogFactory.getLog(LeftTreeSection.class);
	
	  private Map<Integer, Integer> newLine2Column = new HashMap();
	  private String rootCdoe = "07";
