...
public class Formmain1467 {
    /**
     * 商品信息
     * field0001   VARCHAR   255   商品ID   text   VARCHAR
     * field0002   VARCHAR   255   商品编码   text   VARCHAR
     * field0003   VARCHAR   255   商品名称   text   VARCHAR
     * field0004   VARCHAR   255   条码   text   VARCHAR
     * field0005   VARCHAR   255   商品单位   text   VARCHAR
     * field0006   VARCHAR   255   规格   text   VARCHAR
     * field0007   VARCHAR   255   重量   text   VARCHAR
     * field0008   VARCHAR   255   高   text   VARCHAR
     * field0009   VARCHAR   255   长   text   VARCHAR
     * field0010   VARCHAR   255   宽   text   VARCHAR
     * field0011   VARCHAR   255   货号   text   VARCHAR
     * field0012   VARCHAR   255   品类编码   text   VARCHAR
     * field0013   VARCHAR   255   品类名称   text   VARCHAR
     * field0014   VARCHAR   255   品牌编码   text   VARCHAR
     * field0015   VARCHAR   255   品牌名称   text   VARCHAR
     * field0016   VARCHAR   255   保质期天数   text   VARCHAR
     * field0017   VARCHAR   255   是否称重   text   VARCHAR
     * field0018   VARCHAR   255   是否管理库存   text   VARCHAR
     * field0019   VARCHAR   255   商品型号   text   VARCHAR
     * field0020   VARCHAR   255   商品类别   text   VARCHAR
     */
