...
public class Formmain1466 {
    /**
     * 客户档案
     * field0001   VARCHAR   255   组织编码   text   VARCHAR
     * field0002   VARCHAR   255   客户编码   text   VARCHAR
     * field0003   VARCHAR   255   客户名称   text   VARCHAR
     * field0004   VARCHAR   255   地址   text   VARCHAR
     * field0005   VARCHAR   255   联系人   text   VARCHAR
     * field0006   VARCHAR   255   联系电话   text   VARCHAR
     * field0007   VARCHAR   255   开户行   text   VARCHAR
     * field0008   VARCHAR   255   税号   text   VARCHAR
     * field0009   VARCHAR   255   卡户行账号   text   VARCHAR
     */
    private Long id;
