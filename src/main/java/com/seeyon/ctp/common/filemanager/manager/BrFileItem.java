...
public class BrFileItem implements FileItem {
    private static final Log log = CtpLogFactory.getLog(BrFileItem.class);
    private String name;
    private int size;
    private final File fileItem;
    private InputStream in = null;
    private List<String> messages = new ArrayList();
    public BrFileItem(String name,int size,File file){
        this.name = name;
        this.size=size;
        this.fileItem = file;
    }
