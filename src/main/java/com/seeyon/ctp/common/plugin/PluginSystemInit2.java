...
public final class PluginSystemInit2 {
    private static final Logger LOGGER = Logger.getLogger(PluginSystemInit2.class);
    ...
    private static PluginSystemInit2 instance = null;
    ...
    public static final PluginSystemInit2 getInstance() {
        if(instance == null) {
            instance = new PluginSystemInit2();
        }

        return instance;
    }

    private PluginSystemInit2() {
    }
