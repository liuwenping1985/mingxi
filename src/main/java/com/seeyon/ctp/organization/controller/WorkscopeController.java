...
public class WorkscopeController extends BaseController {
    ...
    public ModelAndView showWorkscopeframe(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ModelAndView mav = new ModelAndView("apps/organization/workscope/workscope");
