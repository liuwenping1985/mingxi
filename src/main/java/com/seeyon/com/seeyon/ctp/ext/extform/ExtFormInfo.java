...
public class ExtFormInfo extends FormFieldCustomExtendDesignManager {
    ...
    public String getImage() {
        return "/seeyon/apps_res/extform/if_search.png";
    }

    public String getJsFileURL() {
        return "/seeyon/form/testinfo.do?method=openPersonAffairLink";
    }
