...
/////////////////////////非数据库字段数据 结束///////////////////////////
	...
	// 客开
	public EdocBody getBodyByMaxContentNo() {
		if (this.edocBodies == null || this.edocBodies.size() == 0)
			return null;
		
		List<EdocBody> edocBodyList = new ArrayList<EdocBody>(this.edocBodies);
        //客开 排序 start
	        Collections.sort(edocBodyList, new Comparator<EdocBody>() {
	          @Override
	          public int compare(EdocBody o1, EdocBody o2) {
	            int v1 = o1.getContentNo().intValue();
	            int v2 = o2.getContentNo().intValue();
	            return v2 > v1 ? 1 : -1;
          }
        });
        //客开 end
        return edocBodyList.get(0);
    }
