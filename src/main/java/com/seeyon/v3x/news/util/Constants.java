...
public class Constants {
    ...
    public static final String NEWS_RESOURCE_BASENAME   = "com.seeyon.v3x.news.resources.i18n.NewsResource";
	...
	public static enum NewsTypeSpaceType {
		...
		none(-1), //全部新闻(暂时无用)
		custom(4), //自定义团队新闻
		public_custom(17), //自定义单位新闻
		public_custom_group(18); //自定义集团新闻

        private int order;
        
        private NewsTypeSpaceType(int order) {
            this.order = order;
        }
...
//		states.add(Constants.DATA_STATE_ALREADY_PIGEONHOLE);
	...
	//客开 start
	/**
     * 记录一条新闻最终发布前的排版状态，分为3种情况，保存在ext1扩展字段中：
     * 1.无审核员，新闻发送后即"直接发布"   对应值  0                 
     * 2.有审核员，其审核操作为"审核通过"   对应值  1  
     * 3.有审核员，其审核操作为"直接发布"   对应值  2 
     * 新闻管理员进入管理界面所查看到的全部已发布新闻，由ext1扩展字段来决定"审核意见"处显示内容
     */
	public static final int TYPESETTING_RECORD_NO = 0;
	public static final int TYPESETTING_RECORD_PASS = 1;
	public static final int TYPESETTING_RECORD_PUBLISH = 2;
	//客开 end
