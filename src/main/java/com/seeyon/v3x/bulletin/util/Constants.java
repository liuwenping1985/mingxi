...
public class Constants {
    public static final String BUL_RESOURCE_BASENAME    = "com.seeyon.v3x.bulletin.resources.i18n.BulletinResource";
	...
	public static enum BulTypeSpaceType {
		...
		none(-1), //不限空间，也即全部空间
		custom(4), //自定义团队空间公告
		public_custom(17), //自定义单位空间公告
		public_custom_group(18); //自定义集团空间公告
		
		private int order;
		
		private BulTypeSpaceType(int order) {
		    this.order = order;
		}
     ...
     * 排列顺序不宜变动<br>
     */
	//客开 start  增加typesetting枚举
    public static enum VisitRole {
        User, Poster, Auditor, Admin,Typesetting
    }
    //客开 end
    ...
    public static enum BulTypeAclType {
        manager, audit, writer,typesetting
    }
    //客开 end
    ...
    //	}
       ...
       * @return
       */
      public static SpaceType valueOfSpaceType(int key) {
          SpaceType[] enums = SpaceType.values();
          if (enums != null) {
              for (SpaceType enum1 : enums) {
     ...
     * 已经审核，但是没有排版
     */
    public static final int DATA_STATE_TYPESETTING_CREATE = 25; 
    
    /**
     * 已经排版，但是没有发布
     */
    public static final int DATA_STATE_TYPESETTING_PASS = 26;
    
    /**
     * 排版没通过
     */
    public static final int DATA_STATE_TYPESETTING_NOPASS = 27;
    //客开 end
    ...
    public static Set<Integer> getDataStatesNoPublish() {
        ...
        //客开start
        states.add(Constants.DATA_STATE_TYPESETTING_CREATE);
        states.add(Constants.DATA_STATE_TYPESETTING_NOPASS);
        states.add(Constants.DATA_STATE_TYPESETTING_PASS);
        //客开 end
        return states;
    }
    ...
    static {
        ...
        MS_WPS_Type.add(com.seeyon.ctp.common.constants.Constants.EDITOR_TYPE_OFFICE_EXCEL);
        MS_WPS_Type.add(com.seeyon.ctp.common.constants.Constants.EDITOR_TYPE_OFFICE_WORD);
        MS_WPS_Type.add(com.seeyon.ctp.common.constants.Constants.EDITOR_TYPE_WPS_EXCEL);
        MS_WPS_Type.add(com.seeyon.ctp.common.constants.Constants.EDITOR_TYPE_WPS_WORD);
    }
